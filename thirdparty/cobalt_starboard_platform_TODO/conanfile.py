...
class cobalt_starboard_common_conan_project(ConanFile):
    name = "cobalt_starboard_common"
    ...
    def requirements(self):
        ...
        self.requires("cobalt_starboard_eztime/master@conan/stable")
        self.requires("cobalt_starboard_icu_init/master@conan/stable")
    ...
    def package_info(self):
        self.cpp_info.libs = ["cobalt_starboard_common"]
