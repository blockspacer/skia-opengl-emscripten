...
class chromium_zlib_conan_project(ConanFile):
    name = "chromium_zlib"
    ...
    description = "modified `zlib` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_zlib"]
        ...
        #  os.path.join("base", "third_party", "zlib"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "zlib", "compat"))
