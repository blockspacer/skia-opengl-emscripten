...
class chromium_dynamic_annotations_conan_project(ConanFile):
    name = "chromium_dynamic_annotations"
    ...
    description = "modified `dynamic_annotations` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_dynamic_annotations"]
        ...
        #  os.path.join("base", "third_party", "dynamic_annotations"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "dynamic_annotations", "compat"))
