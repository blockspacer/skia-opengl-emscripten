...
class chromium_xdg_user_dirs_conan_project(ConanFile):
    name = "chromium_xdg_user_dirs"
    ...
    description = "modified `xdg_user_dirs` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_xdg_user_dirs"]
        ...
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "xdg_user_dirs", "compat"))
