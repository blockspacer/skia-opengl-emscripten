...
#ifndef GLIMP_STUB_EGL_WINDOW_SURFACE_IMPL_H_
#define GLIMP_STUB_EGL_WINDOW_SURFACE_IMPL_H_
...
class WindowSurfaceImplStub : public SurfaceImplStub {
 public:
...
#endif  // GLIMP_STUB_EGL_WINDOW_SURFACE_IMPL_H_
