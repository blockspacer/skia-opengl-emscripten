...
const int kInterfaceUniqueId = 145;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<MediaStream> new_object =
      new MediaStream();
...
void getAudioTracksMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaStream::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaStream* impl =
      wrapper_private->wrappable<MediaStream>().get();
...
void getTracksMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "MediaStream"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, MediaStream>::value,
        "Expected MediaStream to have C++ parent class "
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getAudioTracksMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getTracksMethod);
    method_template->RemovePrototype();
    method_template->SetLength(0);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaStream"),
...
v8::Local<v8::Object> V8cMediaStream::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaStream::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
