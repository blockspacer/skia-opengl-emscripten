...
const int kInterfaceUniqueId = 147;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaStreamTrack is not constructible.");
}




void getSettingsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaStreamTrack::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaStreamTrack* impl =
      wrapper_private->wrappable<MediaStreamTrack>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaStreamTrack"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, MediaStreamTrack>::value,
        "Expected MediaStreamTrack to have C++ parent class "
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getSettingsMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaStreamTrack"),
...
v8::Local<v8::Object> V8cMediaStreamTrack::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaStreamTrack::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
