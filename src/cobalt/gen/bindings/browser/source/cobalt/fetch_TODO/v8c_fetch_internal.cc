...
const int kInterfaceUniqueId = 72;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "FetchInternal is not constructible.");
}




void blobToArrayBufferStaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<scoped_refptr<Blob> >::ConversionType blob;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &blob);
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              FetchInternal::BlobToArrayBuffer(callwith_global_environment->GetEnvironmentSettings(), blob),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
...
void decodeFromUTF8StaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  // Non-optional arguments
  TypeTraits<::cobalt::script::Uint8Array >::ConversionType data;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              FetchInternal::DecodeFromUTF8(data, &exception_state),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void encodeToUTF8StaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              FetchInternal::EncodeToUTF8(callwith_global_environment->GetEnvironmentSettings(), text, &exception_state),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void isUrlValidStaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  TypeTraits<bool >::ConversionType allowCredentials;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
  ...
  FromJSValue(isolate,
              non_optional_value1,
              kNoConversionFlags,
              &exception_state, &allowCredentials);
  if (exception_state.is_exception_set()) {
    return;
  }
  V8cGlobalEnvironment* callwith_global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              FetchInternal::IsUrlValid(callwith_global_environment->GetEnvironmentSettings(), url, allowCredentials),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "FetchInternal"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, blobToArrayBufferStaticMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, decodeFromUTF8StaticMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, encodeToUTF8StaticMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, isUrlValidStaticMethod);
    method_template->RemovePrototype();
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "FetchInternal"),
...
v8::Local<v8::Object> V8cFetchInternal::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cFetchInternal::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
