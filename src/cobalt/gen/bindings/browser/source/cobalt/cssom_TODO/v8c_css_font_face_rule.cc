...
void familyAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<CSSFontFaceRule,
                                                    V8cCSSFontFaceRule>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CSSFontFaceRule* impl,
...
void familyAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<CSSFontFaceRule, V8cCSSFontFaceRule>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CSSFontFaceRule* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "family"
                  ,familyAttributeGetter
                  ,familyAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "weight"
                  ,weightAttributeGetter
                  ,weightAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "unicodeRange"
                  ,unicodeRangeAttributeGetter
                  ,unicodeRangeAttributeSetter
                  );
