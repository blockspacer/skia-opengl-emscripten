...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "AudioDestinationNode is not constructible.");
}



void maxChannelCountAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cAudioDestinationNode::GetTemplate(isolate)->HasInstance(object)) {
  ...
  AudioDestinationNode* impl =
      wrapper_private->wrappable<AudioDestinationNode>().get();


  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->max_channel_count(),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "AudioDestinationNode"));
...

  {
    ...
    static_assert(
        std::is_base_of<AudioNode, AudioDestinationNode>::value,
        "Expected AudioDestinationNode to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, maxChannelCountAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AudioDestinationNode"),
...
v8::Local<v8::Object> V8cAudioDestinationNode::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAudioDestinationNode::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
