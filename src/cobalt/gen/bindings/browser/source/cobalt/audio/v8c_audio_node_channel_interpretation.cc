...
void ToJSValue(
    v8::Isolate* isolate,
    AudioNodeChannelInterpretation in_enum,
    v8::Local<v8::Value>* out_value) {
  switch (in_enum) {
    case cobalt::audio::kAudioNodeChannelInterpretationSpeakers:
      ToJSValue(isolate, std::string("speakers"), out_value);
      return;
    case cobalt::audio::kAudioNodeChannelInterpretationDiscrete:
      ToJSValue(isolate, std::string("discrete"), out_value);
      return;
    default:
      NOTREACHED();
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 AudioNodeChannelInterpretation* out_enum) {
...
// 3. Return the enumeration value of type E that is equal to S.
 if (
      NewInternalString(isolate, "speakers")->Equals(value))
  {
    *out_enum = cobalt::audio::kAudioNodeChannelInterpretationSpeakers;
  }
 else  if (
      NewInternalString(isolate, "discrete")->Equals(value))
  {
    *out_enum = cobalt::audio::kAudioNodeChannelInterpretationDiscrete;
  }
  else {
