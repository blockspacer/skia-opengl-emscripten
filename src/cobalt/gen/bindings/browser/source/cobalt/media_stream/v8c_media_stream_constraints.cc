...
void ToJSValue(
    v8::Isolate* isolate,
    const MediaStreamConstraints& in_dictionary,
  ...
  if (in_dictionary.has_audio()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.audio(), &member_value);
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 MediaStreamConstraints* out_dictionary) {
  ...
  if (value->IsNullOrUndefined()) {
    ...
    *out_dictionary = MediaStreamConstraints();
    return;
  }
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "audio", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_audio(converted_value);
    }
  }
}
