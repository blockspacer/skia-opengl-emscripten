...
// This must be included above the check for ENABLE_WEBDRIVER, since
// ENABLE_WEBDRIVER may be defined within.
...
const int kInterfaceUniqueId = 181;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "ScriptExecutor is not constructible.");
}



void executeScriptHarnessAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cScriptExecutor::GetTemplate(isolate)->HasInstance(object)) {
  ...
  ScriptExecutor* impl =
      wrapper_private->wrappable<ScriptExecutor>().get();


  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->execute_script_harness(),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void executeScriptHarnessAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  ...
  ScriptExecutor* impl =
      wrapper_private->wrappable<ScriptExecutor>().get();
  TypeTraits<ScriptExecutor::ExecuteFunctionCallback >::ConversionType value;
  ...
  impl->set_execute_script_harness(value);
...
void elementToIdMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  TypeTraits<scoped_refptr<Element> >::ConversionType element;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &element);
  if (exception_state.is_exception_set()) {
    return;
  }
...
void idToElementMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  // Non-optional arguments
  TypeTraits<std::string >::ConversionType id;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "ScriptExecutor"));
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, executeScriptHarnessAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, executeScriptHarnessAttributeSetter);
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, elementToIdMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, idToElementMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "ScriptExecutor"),
...
v8::Local<v8::Object> V8cScriptExecutor::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cScriptExecutor::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
