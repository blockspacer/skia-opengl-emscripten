...
const int kInterfaceUniqueId = 182;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "ScriptExecutorParams is not constructible.");
}



void functionObjectAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cScriptExecutorParams::GetTemplate(isolate)->HasInstance(object)) {
  ...
  ScriptExecutorParams* impl =
      wrapper_private->wrappable<ScriptExecutorParams>().get();


  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->function_object(),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void asyncTimeoutAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "ScriptExecutorParams"));
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, functionObjectAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, jsonArgsAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, asyncTimeoutAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "ScriptExecutorParams"),
...
v8::Local<v8::Object> V8cScriptExecutorParams::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cScriptExecutorParams::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
