...
using cobalt::media_stream::MediaStreamConstraints;
...
const int kInterfaceUniqueId = 123;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaDevices is not constructible.");
}




void enumerateDevicesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaDevices::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaDevices* impl =
      wrapper_private->wrappable<MediaDevices>().get();
...
void getUserMediaMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  MediaDevices* impl =
      wrapper_private->wrappable<MediaDevices>().get();
  // Optional arguments
  TypeTraits<MediaStreamConstraints >::ConversionType constraints;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaDevices"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, MediaDevices>::value,
        "Expected MediaDevices to have C++ parent class "
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, enumerateDevicesMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getUserMediaMethod);
    method_template->RemovePrototype();
    method_template->SetLength(0);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaDevices"),
...
v8::Local<v8::Object> V8cMediaDevices::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaDevices::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
