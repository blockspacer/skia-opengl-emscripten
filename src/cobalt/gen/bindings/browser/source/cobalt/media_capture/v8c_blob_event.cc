...
using cobalt::media_capture::BlobEventInit;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<BlobEventInit >::ConversionType eventInitDict;
  ...
  scoped_refptr<BlobEvent> new_object =
      new BlobEvent(type, eventInitDict);
...
void dataAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cBlobEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  BlobEvent* impl =
      wrapper_private->wrappable<BlobEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "BlobEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, BlobEvent>::value,
        "Expected BlobEvent to have C++ parent class "
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, timecodeAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "BlobEvent"),
...
v8::Local<v8::Object> V8cBlobEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cBlobEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
