...
using cobalt::media_capture::MediaRecorderOptions;
using cobalt::media_capture::RecordingState;
...
const int kInterfaceUniqueId = 140;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<scoped_refptr<MediaStream> >::ConversionType stream;
  // Optional arguments
  TypeTraits<MediaRecorderOptions >::ConversionType options;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &stream);
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<MediaRecorder> new_object =
              new MediaRecorder(callwith_global_environment->GetEnvironmentSettings(), stream, &exception_state);
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<MediaRecorder> new_object =
              new MediaRecorder(callwith_global_environment->GetEnvironmentSettings(), stream, options, &exception_state);
          // In case that an exception is thrown from constructor.
          if (exception_state.is_exception_set()) {
            return;
          }
...
void mimeTypeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaRecorder::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaRecorder* impl =
      wrapper_private->wrappable<MediaRecorder>().get();
...
void ondataavailableAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
...
void ondataavailableAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  ...
  impl->set_ondataavailable(value);
...
void startMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  MediaRecorder* impl =
      wrapper_private->wrappable<MediaRecorder>().get();
  // Optional arguments
  TypeTraits<int32_t >::ConversionType timeslice;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "MediaRecorder"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, MediaRecorder>::value,
        "Expected MediaRecorder to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, mimeTypeAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, stateAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, ondataavailableAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, ondataavailableAttributeSetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, onstopAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, onstopAttributeSetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaRecorder"),
...
v8::Local<v8::Object> V8cMediaRecorder::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaRecorder::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
