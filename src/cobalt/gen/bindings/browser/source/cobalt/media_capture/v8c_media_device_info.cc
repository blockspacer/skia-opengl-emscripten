...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaDeviceInfo is not constructible.");
}
...
void kindAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaDeviceInfo::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaDeviceInfo* impl =
      wrapper_private->wrappable<MediaDeviceInfo>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaDeviceInfo"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaDeviceInfo"),
...
v8::Local<v8::Object> V8cMediaDeviceInfo::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaDeviceInfo::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
