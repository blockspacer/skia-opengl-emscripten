...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "AudioBufferSourceNode is not constructible.");
}



void bufferAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cAudioBufferSourceNode::GetTemplate(isolate)->HasInstance(object)) {
  ...
  AudioBufferSourceNode* impl =
      wrapper_private->wrappable<AudioBufferSourceNode>().get();
...
void bufferAttributeSetter(
  ...
  AudioBufferSourceNode* impl =
      wrapper_private->wrappable<AudioBufferSourceNode>().get();
  TypeTraits<scoped_refptr<AudioBuffer> >::ConversionType value;
  ...
  impl->set_buffer(value);
  result_value = v8::Undefined(isolate);
  return;
}


void onendedAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
...
void startMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<double >::ConversionType when =
      0;
  TypeTraits<double >::ConversionType offset =
      0;
  // Optional arguments
  TypeTraits<double >::ConversionType duration;
  ...
  if (info.Length() > 2) {
    v8::Local<v8::Value> optional_value2 = info[2];
    FromJSValue(isolate,
                optional_value2,
                (kConversionFlagRestricted),
                &exception_state,
  ...
  switch (num_set_arguments) {
    case 2:
      {
          impl->Start(when, offset, &exception_state);
          result_value = v8::Undefined(isolate);
      }
      break;
    case 3:
      {
          impl->Start(when, offset, duration, &exception_state);
          result_value = v8::Undefined(isolate);
      }
      break;
    default:
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "AudioBufferSourceNode"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cAudioNode::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<AudioNode, AudioBufferSourceNode>::value,
        "Expected AudioBufferSourceNode to have C++ parent class "
        "AudioNode, because that is its WebIDL parent.");
  }
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, bufferAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, bufferAttributeSetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, onendedAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, onendedAttributeSetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AudioBufferSourceNode"),
...
v8::Local<v8::Object> V8cAudioBufferSourceNode::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAudioBufferSourceNode::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
