...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<AudioContext> new_object =
      new AudioContext(callwith_global_environment->GetEnvironmentSettings());
...
void destinationAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cAudioContext::GetTemplate(isolate)->HasInstance(object)) {
  ...
  AudioContext* impl =
      wrapper_private->wrappable<AudioContext>().get();
...
void sampleRateAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
...
void createBufferMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  TypeTraits<uint32_t >::ConversionType numOfChannels;
  TypeTraits<uint32_t >::ConversionType length;
  TypeTraits<float >::ConversionType sample_rate;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &numOfChannels);
  if (exception_state.is_exception_set()) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->CreateBuffer(numOfChannels, length, sample_rate),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void createBufferSourceMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void decodeAudioDataMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  // Non-optional arguments
  TypeTraits<::cobalt::script::ArrayBuffer >::ConversionType audioData;
  TypeTraits<AudioContext::DecodeSuccessCallback >::ConversionType successCallback;
  // Optional arguments
  TypeTraits<AudioContext::DecodeErrorCallback >::ConversionType errorCallback;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &audioData);
  if (exception_state.is_exception_set()) {
    return;
  }
  DCHECK_LT(1, info.Length());
  ...
  FromJSValue(isolate,
              non_optional_value1,
              kNoConversionFlags,
              &exception_state, &successCallback);
  if (exception_state.is_exception_set()) {
    return;
  }
  ...
  switch (num_set_arguments) {
    case 2:
      {  V8cGlobalEnvironment* callwith_global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
          ...
          impl->DecodeAudioData(callwith_global_environment->GetEnvironmentSettings(), audioData, successCallback);
    ...
    case 3:
      {  V8cGlobalEnvironment* callwith_global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
          ...
          impl->DecodeAudioData(callwith_global_environment->GetEnvironmentSettings(), audioData, successCallback, errorCallback);
          result_value = v8::Undefined(isolate);
      }
      break;
    default:
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "AudioContext"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, AudioContext>::value,
        "Expected AudioContext to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, destinationAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, sampleRateAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, createBufferMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, createBufferSourceMethod);
    method_template->RemovePrototype();
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, decodeAudioDataMethod);
    method_template->RemovePrototype();
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AudioContext"),
...
v8::Local<v8::Object> V8cAudioContext::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAudioContext::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
