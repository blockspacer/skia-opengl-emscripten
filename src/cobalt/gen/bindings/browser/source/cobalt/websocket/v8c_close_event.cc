...
using cobalt::websocket::CloseEventInit;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  // Optional arguments
  TypeTraits<CloseEventInit >::ConversionType eventInitDict;
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<CloseEvent> new_object =
              new CloseEvent(type);
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<CloseEvent> new_object =
              new CloseEvent(type, eventInitDict);
          v8::Local<v8::Value> result_value;
          ToJSValue(isolate, new_object, &result_value);
          DCHECK(result_value->IsObject());
          info.GetReturnValue().Set(result_value);
...
void wasCleanAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCloseEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CloseEvent* impl =
      wrapper_private->wrappable<CloseEvent>().get();
...
void initCloseEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  // Non-optional arguments
  TypeTraits<std::string >::ConversionType type;
  TypeTraits<bool >::ConversionType canBubble;
  TypeTraits<bool >::ConversionType cancelable;
  TypeTraits<bool >::ConversionType wasClean;
  ...
  FromJSValue(isolate,
              non_optional_value3,
              kNoConversionFlags,
              &exception_state, &wasClean);
  if (exception_state.is_exception_set()) {
    return;
  }
  DCHECK_LT(4, info.Length());
  v8::Local<v8::Value> non_optional_value4 = info[4];
  FromJSValue(isolate,
              non_optional_value4,
              kNoConversionFlags,
  ...
  DCHECK_LT(5, info.Length());
  v8::Local<v8::Value> non_optional_value5 = info[5];
  FromJSValue(isolate,
              non_optional_value5,
              kNoConversionFlags,
  ...
  impl->InitCloseEvent(type, canBubble, cancelable, wasClean, code, reason);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "CloseEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, CloseEvent>::value,
        "Expected CloseEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, wasCleanAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, reasonAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, initCloseEventMethod);
    method_template->RemovePrototype();
    method_template->SetLength(6);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CloseEvent"),
...
v8::Local<v8::Object> V8cCloseEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCloseEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
