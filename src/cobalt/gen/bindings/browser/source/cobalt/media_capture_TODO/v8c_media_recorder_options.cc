...
void ToJSValue(
    v8::Isolate* isolate,
    const MediaRecorderOptions& in_dictionary,
  ...
  if (in_dictionary.has_mime_type()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.mime_type(), &member_value);
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 MediaRecorderOptions* out_dictionary) {
  ...
  if (value->IsNullOrUndefined()) {
    ...
    *out_dictionary = MediaRecorderOptions();
    return;
  }
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "mimeType", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_mime_type(converted_value);
    }
  }
}
