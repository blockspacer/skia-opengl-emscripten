...
void ToJSValue(
    v8::Isolate* isolate,
    const MediaImage& in_dictionary,
  ...
  if (in_dictionary.has_src()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.src(), &member_value);
  ...
  if (in_dictionary.has_sizes()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.sizes(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
  ...
  if (in_dictionary.has_type()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.type(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "src", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_src(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "sizes", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_sizes(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_type(converted_value);
    }
  }
}
