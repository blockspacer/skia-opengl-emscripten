...
const int kInterfaceUniqueId = 85;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "H5vccPlatformService is not constructible.");
}
...
void closeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cH5vccPlatformService::GetTemplate(isolate)->HasInstance(object)) {
  ...
  H5vccPlatformService* impl =
      wrapper_private->wrappable<H5vccPlatformService>().get();
...
void hasStaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  // Non-optional arguments
  TypeTraits<std::string >::ConversionType service_name;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &service_name);
  if (exception_state.is_exception_set()) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              H5vccPlatformService::Has(service_name),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void openStaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  // Non-optional arguments
  TypeTraits<std::string >::ConversionType service_name;
  TypeTraits<H5vccPlatformService::ReceiveCallback >::ConversionType receive_callback;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
  ...
  FromJSValue(isolate,
              non_optional_value1,
              kNoConversionFlags,
              &exception_state, &receive_callback);
  if (exception_state.is_exception_set()) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              H5vccPlatformService::Open(callwith_global_environment->GetEnvironmentSettings(), service_name, receive_callback),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "H5vccPlatformService"));
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, hasStaticMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, openStaticMethod);
    method_template->RemovePrototype();
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "H5vccPlatformService"),
...
v8::Local<v8::Object> V8cH5vccPlatformService::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cH5vccPlatformService::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
