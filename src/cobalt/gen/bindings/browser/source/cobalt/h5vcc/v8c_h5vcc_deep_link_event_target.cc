...
const int kInterfaceUniqueId = 84;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "H5vccDeepLinkEventTarget is not constructible.");
}
...
void addListenerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cH5vccDeepLinkEventTarget::GetTemplate(isolate)->HasInstance(object)) {
  ...
  H5vccDeepLinkEventTarget* impl =
      wrapper_private->wrappable<H5vccDeepLinkEventTarget>().get();
  ...
  TypeTraits<H5vccDeepLinkEventTarget::H5vccDeepLinkEventCallback >::ConversionType callback;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "H5vccDeepLinkEventTarget"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "H5vccDeepLinkEventTarget"),
...
v8::Local<v8::Object> V8cH5vccDeepLinkEventTarget::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cH5vccDeepLinkEventTarget::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
