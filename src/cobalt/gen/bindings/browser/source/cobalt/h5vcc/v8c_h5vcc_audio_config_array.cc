...
const int kInterfaceUniqueId = 82;
...
void IndexedPropertyGetterCallback(
  ...
  H5vccAudioConfigArray* impl =
      wrapper_private->wrappable<H5vccAudioConfigArray>().get();
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "H5vccAudioConfigArray is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cH5vccAudioConfigArray::GetTemplate(isolate)->HasInstance(object)) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "H5vccAudioConfigArray"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "H5vccAudioConfigArray"),
...
v8::Local<v8::Object> V8cH5vccAudioConfigArray::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cH5vccAudioConfigArray::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
