...
const int kInterfaceUniqueId = 57;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "DialHttpRequest is not constructible.");
}
...
void pathAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cDialHttpRequest::GetTemplate(isolate)->HasInstance(object)) {
  ...
  DialHttpRequest* impl =
      wrapper_private->wrappable<DialHttpRequest>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "DialHttpRequest"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DialHttpRequest"),
...
v8::Local<v8::Object> V8cDialHttpRequest::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDialHttpRequest::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
