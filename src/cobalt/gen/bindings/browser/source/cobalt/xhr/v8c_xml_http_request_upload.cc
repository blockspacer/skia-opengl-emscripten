...
const int kInterfaceUniqueId = 229;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "XMLHttpRequestUpload is not constructible.");
}
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "XMLHttpRequestUpload"));
...

  {
    ...
    static_assert(
        std::is_base_of<XMLHttpRequestEventTarget, XMLHttpRequestUpload>::value,
        "Expected XMLHttpRequestUpload to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "XMLHttpRequestUpload"),
...
v8::Local<v8::Object> V8cXMLHttpRequestUpload::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cXMLHttpRequestUpload::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
