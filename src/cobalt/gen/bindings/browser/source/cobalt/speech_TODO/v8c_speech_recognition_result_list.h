...
#ifndef V8cSpeechRecognitionResultList_h
#define V8cSpeechRecognitionResultList_h
...
class V8cSpeechRecognitionResultList {
 public:
...
#endif  // V8cSpeechRecognitionResultList_h
