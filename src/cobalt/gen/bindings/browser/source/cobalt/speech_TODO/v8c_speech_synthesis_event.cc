...
const int kInterfaceUniqueId = 195;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SpeechSynthesisEvent is not constructible.");
}



void utteranceAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cSpeechSynthesisEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  SpeechSynthesisEvent* impl =
      wrapper_private->wrappable<SpeechSynthesisEvent>().get();
...
void elapsedTimeAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SpeechSynthesisEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, SpeechSynthesisEvent>::value,
        "Expected SpeechSynthesisEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, utteranceAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, charIndexAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, elapsedTimeAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SpeechSynthesisEvent"),
...
v8::Local<v8::Object> V8cSpeechSynthesisEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSpeechSynthesisEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
