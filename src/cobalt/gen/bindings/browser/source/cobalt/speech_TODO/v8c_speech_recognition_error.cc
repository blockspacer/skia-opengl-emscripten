...
const int kInterfaceUniqueId = 189;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SpeechRecognitionError is not constructible.");
}
...
void errorAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cSpeechRecognitionError::GetTemplate(isolate)->HasInstance(object)) {
  ...
  SpeechRecognitionError* impl =
      wrapper_private->wrappable<SpeechRecognitionError>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SpeechRecognitionError"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, SpeechRecognitionError>::value,
        "Expected SpeechRecognitionError to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SpeechRecognitionError"),
...
v8::Local<v8::Object> V8cSpeechRecognitionError::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSpeechRecognitionError::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
