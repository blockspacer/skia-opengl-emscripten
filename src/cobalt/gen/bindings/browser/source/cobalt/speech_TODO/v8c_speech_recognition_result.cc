...
void IndexedPropertyGetterCallback(
  ...
  SpeechRecognitionResult* impl =
      wrapper_private->wrappable<SpeechRecognitionResult>().get();
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SpeechRecognitionResult is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cSpeechRecognitionResult::GetTemplate(isolate)->HasInstance(object)) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SpeechRecognitionResult"));
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, isFinalAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SpeechRecognitionResult"),
...
v8::Local<v8::Object> V8cSpeechRecognitionResult::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSpeechRecognitionResult::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
