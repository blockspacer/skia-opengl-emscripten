...
const int kInterfaceUniqueId = 194;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SpeechSynthesisErrorEvent is not constructible.");
}
...
void errorAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cSpeechSynthesisErrorEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  SpeechSynthesisErrorEvent* impl =
      wrapper_private->wrappable<SpeechSynthesisErrorEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SpeechSynthesisErrorEvent"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cSpeechSynthesisEvent::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<SpeechSynthesisEvent, SpeechSynthesisErrorEvent>::value,
        "Expected SpeechSynthesisErrorEvent to have C++ parent class "
        "SpeechSynthesisEvent, because that is its WebIDL parent.");
  }
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SpeechSynthesisErrorEvent"),
...
v8::Local<v8::Object> V8cSpeechSynthesisErrorEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSpeechSynthesisErrorEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
