...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "EventTarget is not constructible.");
}




void addEventListenerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cEventTarget::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<::cobalt::script::CallbackInterfaceTraits<EventListener > >::ConversionType listener;
  // Optional arguments with default values
  TypeTraits<bool >::ConversionType useCapture =
      false;
...
void dispatchEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cEventTarget::GetTemplate(isolate), isolate, object)) {
    return;
  ...
  // Non-optional arguments
  TypeTraits<scoped_refptr<Event> >::ConversionType event;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &event);
  if (exception_state.is_exception_set()) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->DispatchEvent(event, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void removeEventListenerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cEventTarget::GetTemplate(isolate), isolate, object)) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "EventTarget"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, addEventListenerMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, dispatchEventMethod);
    method_template->RemovePrototype();
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, removeEventListenerMethod);
    method_template->RemovePrototype();
    method_template->SetLength(2);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "EventTarget"),
...
v8::Local<v8::Object> V8cEventTarget::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cEventTarget::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
