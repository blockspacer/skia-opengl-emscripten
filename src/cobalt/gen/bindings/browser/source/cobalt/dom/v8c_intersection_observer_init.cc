...
void ToJSValue(
    v8::Isolate* isolate,
    const IntersectionObserverInit& in_dictionary,
  ...
  if (in_dictionary.has_root()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.root(), &member_value);
  ...
  if (in_dictionary.has_root_margin()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.root_margin(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
  ...
  if (in_dictionary.has_threshold()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.threshold(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 IntersectionObserverInit* out_dictionary) {
  ...
  if (value->IsNullOrUndefined()) {
    ...
    *out_dictionary = IntersectionObserverInit();
    return;
  }
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "root", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_root(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "rootMargin", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_root_margin(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "threshold", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ::cobalt::script::UnionType2<double, ::cobalt::script::Sequence< double > > converted_value;
      FromJSValue(isolate,
                  member_value,
                  kNoConversionFlags,
                  exception_state,
                  &converted_value);
      out_dictionary->set_threshold(converted_value);
    }
  }
}
