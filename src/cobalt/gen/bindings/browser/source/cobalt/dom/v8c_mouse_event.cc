...
const int kInterfaceUniqueId = 159;
...
void screenXAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MouseEvent,
                                                    V8cMouseEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MouseEvent* impl,
...
void getModifierStateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMouseEvent::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void initMouseEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (info.Length() > 8) {
    ...
    if (!optional_value7->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value7,
                  kNoConversionFlags,
                  &exception_state,
  ...
  if (info.Length() > 9) {
    ...
    if (!optional_value8->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value8,
                  kNoConversionFlags,
                  &exception_state,
  ...
  if (info.Length() > 10) {
    ...
    if (!optional_value9->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value9,
                  kNoConversionFlags,
                  &exception_state,
  ...
  if (info.Length() > 11) {
    ...
    if (!optional_value10->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value10,
                  kNoConversionFlags,
                  &exception_state,
  ...
  if (info.Length() > 12) {
    ...
    if (!optional_value11->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value11,
                  kNoConversionFlags,
                  &exception_state,
  ...
  if (info.Length() > 13) {
    ...
    if (!optional_value12->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value12,
                  kNoConversionFlags,
                  &exception_state,
  ...
  if (info.Length() > 14) {
    ...
    if (!optional_value13->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value13,
                  (kConversionFlagNullable),
                  &exception_state,
