...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<CDATASection> new_object =
      new CDATASection(callwith_global_environment->GetEnvironmentSettings(), data);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "CDATASection"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cText::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<Text, CDATASection>::value,
        "Expected CDATASection to have C++ parent class "
        "Text, because that is its WebIDL parent.");
  }
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CDATASection"),
...
v8::Local<v8::Object> V8cCDATASection::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCDATASection::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
