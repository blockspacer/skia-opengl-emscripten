...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLBodyElement is not constructible.");
}
...
void offsetWidthAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cHTMLBodyElement::GetTemplate(isolate)->HasInstance(object)) {
  ...
  HTMLBodyElement* impl =
      wrapper_private->wrappable<HTMLBodyElement>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLBodyElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLBodyElement>::value,
        "Expected HTMLBodyElement to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLBodyElement"),
...
v8::Local<v8::Object> V8cHTMLBodyElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLBodyElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
