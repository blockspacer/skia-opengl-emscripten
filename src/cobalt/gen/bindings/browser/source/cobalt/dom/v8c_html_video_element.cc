...
const int kInterfaceUniqueId = 114;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLVideoElement is not constructible.");
}
...
void widthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLVideoElement,
                                                    V8cHTMLVideoElement>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLVideoElement* impl,
...
void widthAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<HTMLVideoElement, V8cHTMLVideoElement>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLVideoElement* impl,
...
void videoWidthAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLVideoElement,
                                                    V8cHTMLVideoElement>(
                    info,
...
void videoHeightAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLVideoElement,
                                                    V8cHTMLVideoElement>(
                    info,
...
void getVideoPlaybackQualityMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cHTMLVideoElement::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;

  HTMLVideoElement* impl =
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->GetVideoPlaybackQuality(callwith_global_environment->GetEnvironmentSettings()),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
#if defined(COBALT_ENABLE_SET_MAX_VIDEO_CAPABILITIES)


void setMaxVideoCapabilitiesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cHTMLVideoElement::GetTemplate(isolate), isolate, object)) {
    return;
  ...
  TypeTraits<std::string >::ConversionType max_video_capabilities;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &max_video_capabilities);
  if (exception_state.is_exception_set()) {
    return;
  }

  impl->SetMaxVideoCapabilities(max_video_capabilities, &exception_state);
result_value = v8::Undefined(isolate);

}

#endif  // COBALT_ENABLE_SET_MAX_VIDEO_CAPABILITIES
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLVideoElement"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cHTMLMediaElement::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<HTMLMediaElement, HTMLVideoElement>::value,
        "Expected HTMLVideoElement to have C++ parent class "
        "HTMLMediaElement, because that is its WebIDL parent.");
  }
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getVideoPlaybackQualityMethod);
...
#if defined(COBALT_ENABLE_SET_MAX_VIDEO_CAPABILITIES)
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, setMaxVideoCapabilitiesMethod);
    method_template->RemovePrototype();
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLVideoElement"),
...
v8::Local<v8::Object> V8cHTMLVideoElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLVideoElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
