...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SourceBufferList is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<SourceBufferList,
                                                    V8cSourceBufferList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, SourceBufferList* impl,
...
void itemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cSourceBufferList::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SourceBufferList"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, SourceBufferList>::value,
        "Expected SourceBufferList to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SourceBufferList"),
...
v8::Local<v8::Object> V8cSourceBufferList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSourceBufferList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
