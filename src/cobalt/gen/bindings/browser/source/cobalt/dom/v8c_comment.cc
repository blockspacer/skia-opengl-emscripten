...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<Comment> new_object =
      new Comment(callwith_global_environment->GetEnvironmentSettings(), data);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "Comment"));
...

  {
    ...
    static_assert(
        std::is_base_of<CharacterData, Comment>::value,
        "Expected Comment to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "Comment"),
...
v8::Local<v8::Object> V8cComment::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cComment::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
