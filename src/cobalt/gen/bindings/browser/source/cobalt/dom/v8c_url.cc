...
const int kInterfaceUniqueId = 213;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "URL is not constructible.");
}



void createObjectURLStaticMethod1(
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              URL::CreateObjectURL(callwith_global_environment->GetEnvironmentSettings(), blob),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
...
void createObjectURLStaticMethod2(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  // Non-optional arguments
  TypeTraits<scoped_refptr<MediaSource> >::ConversionType mediaSource;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &mediaSource);
  if (exception_state.is_exception_set()) {
    return;
  }
  V8cGlobalEnvironment* callwith_global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              URL::CreateObjectURL(callwith_global_environment->GetEnvironmentSettings(), mediaSource),
              &result_value);
  }
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void createObjectURLStaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ...
  switch(info.Length()) {
    case(1): {
      ...
      if (arg->IsObject() ? wrapper_factory->DoesObjectImplementInterface(object, base::GetTypeId<Blob>()) : false) {
        createObjectURLStaticMethod1(
                  info);
        return;
      }
      if (arg->IsObject() ? wrapper_factory->DoesObjectImplementInterface(object, base::GetTypeId<MediaSource>()) : false) {
        createObjectURLStaticMethod2(
                  info);
        return;
      }
      break;
...
void revokeObjectURLStaticMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  URL::RevokeObjectURL(callwith_global_environment->GetEnvironmentSettings(), url);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "URL"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, createObjectURLStaticMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, revokeObjectURLStaticMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
...
v8::Local<v8::Object> V8cURL::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cURL::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
