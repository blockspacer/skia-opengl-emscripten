...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "DOMRectList is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<DOMRectList,
                                                    V8cDOMRectList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, DOMRectList* impl,
...
void itemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cDOMRectList::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "DOMRectList"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DOMRectList"),
...
v8::Local<v8::Object> V8cDOMRectList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDOMRectList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
