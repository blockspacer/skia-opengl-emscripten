...
void ToJSValue(
    v8::Isolate* isolate,
    const WheelEventInit& in_dictionary,
  ...
  if (in_dictionary.has_delta_x()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.delta_x(), &member_value);
  ...
  if (in_dictionary.has_delta_y()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.delta_y(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
  ...
  if (in_dictionary.has_delta_z()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.delta_z(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
  ...
  if (in_dictionary.has_delta_mode()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.delta_mode(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "deltaX", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_delta_x(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "deltaY", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_delta_y(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "deltaZ", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_delta_z(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "deltaMode", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_delta_mode(converted_value);
    }
  }
}
