...
using cobalt::dom::Blob;
using cobalt::dom::BlobPropertyBag;
using cobalt::dom::V8cBlob;
...
void Constructor1(
  ...
  scoped_refptr<Blob> new_object =
      new Blob(callwith_global_environment->GetEnvironmentSettings());
...
void Constructor2(
  ...
  TypeTraits<::cobalt::script::Sequence< ::cobalt::script::UnionType5<::cobalt::script::Handle<::cobalt::script::ArrayBuffer>, ::cobalt::script::Handle<::cobalt::script::ArrayBufferView>, ::cobalt::script::Handle<::cobalt::script::DataView>, scoped_refptr<Blob>, std::string > > >::ConversionType blobParts;
  // Optional arguments
  TypeTraits<BlobPropertyBag >::ConversionType options;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &blobParts);
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<Blob> new_object =
              new Blob(callwith_global_environment->GetEnvironmentSettings(), blobParts);
          v8::Local<v8::Value> result_value;
          ToJSValue(isolate, new_object, &result_value);
          DCHECK(result_value->IsObject());
          info.GetReturnValue().Set(result_value);
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<Blob> new_object =
              new Blob(callwith_global_environment->GetEnvironmentSettings(), blobParts, options);
          v8::Local<v8::Value> result_value;
          ToJSValue(isolate, new_object, &result_value);
          DCHECK(result_value->IsObject());
          info.GetReturnValue().Set(result_value);
...
void sizeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cBlob::GetTemplate(isolate)->HasInstance(object)) {
  ...
  Blob* impl =
      wrapper_private->wrappable<Blob>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "Blob"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "Blob"),
...
v8::Local<v8::Object> V8cBlob::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cBlob::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
