...
const int kInterfaceUniqueId = 119;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<IntersectionObserverEntryInit >::ConversionType intersectionObserverEntryInit;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &intersectionObserverEntryInit);
  ...
  scoped_refptr<IntersectionObserverEntry> new_object =
...
void timeAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserverEntry,
                                                    V8cIntersectionObserverEntry>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, IntersectionObserverEntry* impl,
...
void rootBoundsAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserverEntry,
                                                    V8cIntersectionObserverEntry>(
                    info,
...
void boundingClientRectAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserverEntry,
                                                    V8cIntersectionObserverEntry>(
                    info,
...
void intersectionRectAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserverEntry,
                                                    V8cIntersectionObserverEntry>(
                    info,
...
void isIntersectingAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserverEntry,
                                                    V8cIntersectionObserverEntry>(
                    info,
...
void intersectionRatioAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserverEntry,
                                                    V8cIntersectionObserverEntry>(
                    info,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "IntersectionObserverEntry"));
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "boundingClientRect"
                  ,boundingClientRectAttributeGetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "intersectionRect"
                  ,intersectionRectAttributeGetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "intersectionRatio"
                  ,intersectionRatioAttributeGetter
                  );
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "IntersectionObserverEntry"),
...
v8::Local<v8::Object> V8cIntersectionObserverEntry::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cIntersectionObserverEntry::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
