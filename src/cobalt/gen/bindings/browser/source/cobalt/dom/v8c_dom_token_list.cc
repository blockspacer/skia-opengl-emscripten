...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "DOMTokenList is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<DOMTokenList,
                                                    V8cDOMTokenList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, DOMTokenList* impl,
...
void addMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cDOMTokenList::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  // Variadic argument
  TypeTraits<std::vector<std::string> >::ConversionType tokens;

  // Get variadic arguments.
  const size_t kFirstVariadicArgIndex = 0;
  if (info.Length() > kFirstVariadicArgIndex) {
    tokens.resize(info.Length() - kFirstVariadicArgIndex);
...
void Stringifier(const v8::FunctionCallbackInfo<v8::Value>& info) {
  auto* impl = script::v8c::shared_bindings::get_impl_class_from_info<DOMTokenList, V8cDOMTokenList>(info);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "DOMTokenList"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, addMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DOMTokenList"),
...
v8::Local<v8::Object> V8cDOMTokenList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDOMTokenList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
