...
const int kInterfaceUniqueId = 136;
...
void sessionIdAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MediaKeySession,
                                                    V8cMediaKeySession>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaKeySession* impl,
...
void onkeystatuseschangeAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<MediaKeySession, V8cMediaKeySession>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaKeySession* impl,
...
void closeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaKeySession::GetTemplate(isolate), isolate, object)) {
    return;
  }
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onkeystatuseschange"
                  ,onkeystatuseschangeAttributeGetter
                  ,onkeystatuseschangeAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onmessage"
                  ,onmessageAttributeGetter
                  ,onmessageAttributeSetter
                  );
