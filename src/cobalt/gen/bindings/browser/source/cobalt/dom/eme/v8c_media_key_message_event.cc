...
using cobalt::dom::eme::MediaKeyMessageEventInit;
...
const int kInterfaceUniqueId = 128;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<MediaKeyMessageEventInit >::ConversionType eventInitDict;
  ...
  scoped_refptr<MediaKeyMessageEvent> new_object =
      new MediaKeyMessageEvent(type, eventInitDict);
...
void messageTypeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaKeyMessageEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaKeyMessageEvent* impl =
      wrapper_private->wrappable<MediaKeyMessageEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "MediaKeyMessageEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, MediaKeyMessageEvent>::value,
        "Expected MediaKeyMessageEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, messageTypeAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaKeyMessageEvent"),
...
v8::Local<v8::Object> V8cMediaKeyMessageEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaKeyMessageEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
