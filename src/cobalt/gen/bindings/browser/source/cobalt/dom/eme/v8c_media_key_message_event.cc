...
const int kInterfaceUniqueId = 134;
...
void messageTypeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MediaKeyMessageEvent,
                                                    V8cMediaKeyMessageEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaKeyMessageEvent* impl,
