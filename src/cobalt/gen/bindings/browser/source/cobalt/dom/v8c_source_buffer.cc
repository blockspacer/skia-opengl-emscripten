...
const int kInterfaceUniqueId = 192;
...
void bufferedAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<SourceBuffer,
                                                    V8cSourceBuffer>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, SourceBuffer* impl,
...
void timestampOffsetAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<SourceBuffer, V8cSourceBuffer>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, SourceBuffer* impl,
...
void abortMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cSourceBuffer::GetTemplate(isolate), isolate, object)) {
    return;
  }
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "timestampOffset"
                  ,timestampOffsetAttributeGetter
                  ,timestampOffsetAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "appendWindowStart"
                  ,appendWindowStartAttributeGetter
                  ,appendWindowStartAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "appendWindowEnd"
                  ,appendWindowEndAttributeGetter
                  ,appendWindowEndAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "trackDefaults"
                  ,trackDefaultsAttributeGetter
                  ,trackDefaultsAttributeSetter
                  );
