...
const int kInterfaceUniqueId = 164;
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<NamedNodeMap,
                                                    V8cNamedNodeMap>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, NamedNodeMap* impl,
...
void getNamedItemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cNamedNodeMap::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
