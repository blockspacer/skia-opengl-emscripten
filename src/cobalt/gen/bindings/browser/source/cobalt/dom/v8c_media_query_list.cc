...
const int kInterfaceUniqueId = 146;
...
void mediaAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MediaQueryList,
                                                    V8cMediaQueryList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaQueryList* impl,
