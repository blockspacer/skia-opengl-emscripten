...
const int kInterfaceUniqueId = 165;
...
void systemCaptionSettingsAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Navigator,
                                                    V8cNavigator>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Navigator* impl,
...
void requestMediaKeySystemAccessMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cNavigator::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->RequestMediaKeySystemAccess(callwith_global_environment->GetEnvironmentSettings(), keySystem, supportedConfigurations),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  ,systemCaptionSettingsAttributeGetter
                  );
