...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "AbortSignal is not constructible.");
}



void abortedAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<AbortSignal,
                                                    V8cAbortSignal>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AbortSignal* impl,
...
void onabortAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<AbortSignal, V8cAbortSignal>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AbortSignal* impl,
...
void followMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cAbortSignal::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<scoped_refptr<AbortSignal> >::ConversionType parentSignal;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &parentSignal);
  if (exception_state.is_exception_set()) {
    return;
  }

  impl->Follow(parentSignal);
result_value = v8::Undefined(isolate);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "AbortSignal"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, AbortSignal>::value,
        "Expected AbortSignal to have C++ parent class "
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onabort"
                  ,onabortAttributeGetter
                  ,onabortAttributeSetter
                  );
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, followMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AbortSignal"),
...
v8::Local<v8::Object> V8cAbortSignal::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAbortSignal::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
