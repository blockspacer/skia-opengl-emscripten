...
const int kInterfaceUniqueId = 101;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLHtmlElement is not constructible.");
}
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLHtmlElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLHtmlElement>::value,
        "Expected HTMLHtmlElement to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLHtmlElement"),
...
v8::Local<v8::Object> V8cHTMLHtmlElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLHtmlElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
