...
void NamedPropertyGetterCallback(
  ...
  DOMStringMap* impl =
      wrapper_private->wrappable<DOMStringMap>().get();
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->AnonymousNamedGetter(property_name, &exception_state),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void NamedPropertySetterCallback(
  ...
  impl->AnonymousNamedSetter(property_name, native_value, &exception_state);
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "DOMStringMap is not constructible.");
}
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "DOMStringMap"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DOMStringMap"),
...
v8::Local<v8::Object> V8cDOMStringMap::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDOMStringMap::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
