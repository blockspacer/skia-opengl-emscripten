...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "Crypto is not constructible.");
}




void getRandomValuesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cCrypto::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<::cobalt::script::ArrayBufferView >::ConversionType array;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &array);
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->GetRandomValues(array, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "Crypto"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getRandomValuesMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "Crypto"),
...
v8::Local<v8::Object> V8cCrypto::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCrypto::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
