...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLUnknownElement is not constructible.");
}
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLUnknownElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLUnknownElement>::value,
        "Expected HTMLUnknownElement to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLUnknownElement"),
...
v8::Local<v8::Object> V8cHTMLUnknownElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLUnknownElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
