...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "TimeRanges is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<TimeRanges,
                                                    V8cTimeRanges>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, TimeRanges* impl,
...
void endMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cTimeRanges::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->End(index, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void startMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->Start(index, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "TimeRanges"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, endMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "TimeRanges"),
...
v8::Local<v8::Object> V8cTimeRanges::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cTimeRanges::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
