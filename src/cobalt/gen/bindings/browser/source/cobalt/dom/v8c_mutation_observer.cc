...
const int kInterfaceUniqueId = 161;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<MutationObserver::MutationCallback >::ConversionType callback;
  ...
  scoped_refptr<MutationObserver> new_object =
      new MutationObserver(callwith_global_environment->GetEnvironmentSettings(), callback);
...
void disconnectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMutationObserver::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void observeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  // Non-optional arguments
  TypeTraits<scoped_refptr<Node> >::ConversionType target;
  TypeTraits<MutationObserverInit >::ConversionType options;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "MutationObserver"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MutationObserver"),
...
v8::Local<v8::Object> V8cMutationObserver::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMutationObserver::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
