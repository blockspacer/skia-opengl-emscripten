...
void idAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<AudioTrack,
                                                    V8cAudioTrack>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AudioTrack* impl,
...
void enabledAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<AudioTrack, V8cAudioTrack>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AudioTrack* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "enabled"
                  ,enabledAttributeGetter
                  ,enabledAttributeSetter
                  );
