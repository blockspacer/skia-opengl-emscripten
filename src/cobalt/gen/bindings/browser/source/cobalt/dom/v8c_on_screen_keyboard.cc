...
const int kInterfaceUniqueId = 178;
...
void shownAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<OnScreenKeyboard,
                                                    V8cOnScreenKeyboard>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, OnScreenKeyboard* impl,
...
void keepFocusAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<OnScreenKeyboard, V8cOnScreenKeyboard>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, OnScreenKeyboard* impl,
...
void blurMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cOnScreenKeyboard::GetTemplate(isolate), isolate, object)) {
    return;
  }
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  ,suggestionsSupportedAttributeGetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "keepFocus"
                  ,keepFocusAttributeGetter
                  ,keepFocusAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onshow"
                  ,onshowAttributeGetter
                  ,onshowAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onhide"
                  ,onhideAttributeGetter
                  ,onhideAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "oninput"
                  ,oninputAttributeGetter
                  ,oninputAttributeSetter
                  );
