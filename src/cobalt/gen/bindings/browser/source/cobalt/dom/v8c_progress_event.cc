...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<ProgressEvent> new_object =
...
void lengthComputableAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cProgressEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  ProgressEvent* impl =
      wrapper_private->wrappable<ProgressEvent>().get();


  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->length_computable(),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "ProgressEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, ProgressEvent>::value,
        "Expected ProgressEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, lengthComputableAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, loadedAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, totalAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "ProgressEvent"),
...
v8::Local<v8::Object> V8cProgressEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cProgressEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
