...
void lengthComputableAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<ProgressEvent,
                                                    V8cProgressEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, ProgressEvent* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "lengthComputable"
                  ,lengthComputableAttributeGetter
                  );
