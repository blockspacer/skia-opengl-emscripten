...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8cExceptionState exception_state(isolate);
  // Optional arguments
  TypeTraits<::cobalt::script::Sequence< scoped_refptr<TrackDefault> > >::ConversionType trackDefaults;
  ...
  switch (num_set_arguments) {
    case 0:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<TrackDefaultList> new_object =
              new TrackDefaultList(&exception_state);
    ...
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<TrackDefaultList> new_object =
              new TrackDefaultList(trackDefaults, &exception_state);
          // In case that an exception is thrown from constructor.
          if (exception_state.is_exception_set()) {
            return;
          }
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<TrackDefaultList,
                                                    V8cTrackDefaultList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, TrackDefaultList* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "TrackDefaultList"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "TrackDefaultList"),
...
v8::Local<v8::Object> V8cTrackDefaultList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cTrackDefaultList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
