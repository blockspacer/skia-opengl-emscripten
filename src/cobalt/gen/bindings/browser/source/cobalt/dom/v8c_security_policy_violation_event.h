...
#ifndef V8cSecurityPolicyViolationEvent_h
#define V8cSecurityPolicyViolationEvent_h
...
class V8cSecurityPolicyViolationEvent {
 public:
...
#endif  // V8cSecurityPolicyViolationEvent_h
