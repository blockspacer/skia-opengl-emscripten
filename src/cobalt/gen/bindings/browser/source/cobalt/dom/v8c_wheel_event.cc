...
void deltaXAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<WheelEvent,
                                                    V8cWheelEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, WheelEvent* impl,
...
void initWheelEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cWheelEvent::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  if (info.Length() > 15) {
    ...
    if (!optional_value14->IsUndefined()) {
      FromJSValue(isolate,
                  optional_value14,
                  kNoConversionFlags,
                  &exception_state,
