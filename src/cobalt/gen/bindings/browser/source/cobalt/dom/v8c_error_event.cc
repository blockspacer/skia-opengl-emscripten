...
const int kInterfaceUniqueId = 66;
...
void messageAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<ErrorEvent,
                                                    V8cErrorEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, ErrorEvent* impl,
