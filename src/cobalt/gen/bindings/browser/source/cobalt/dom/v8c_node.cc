...
void nodeTypeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Node,
                                                    V8cNode>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Node* impl,
...
void nodeValueAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<Node, V8cNode>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Node* impl,
...
void appendChildMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cNode::GetTemplate(isolate), isolate, object)) {
    return;
  }
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "nodeValue"
                  ,nodeValueAttributeGetter
                  ,nodeValueAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "textContent"
                  ,textContentAttributeGetter
                  ,textContentAttributeSetter
                  );
