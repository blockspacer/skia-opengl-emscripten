...
using cobalt::dom::TrackDefaultType;
...
const int kInterfaceUniqueId = 207;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<TrackDefaultType >::ConversionType type;
  TypeTraits<std::string >::ConversionType language;
  TypeTraits<std::string >::ConversionType label;
  TypeTraits<::cobalt::script::Sequence< std::string > >::ConversionType kinds;
  // Optional arguments with default values
  TypeTraits<std::string >::ConversionType byteStreamTrackID =
      "";
  ...
  FromJSValue(isolate,
              non_optional_value3,
              kNoConversionFlags,
              &exception_state, &kinds);
  if (exception_state.is_exception_set()) {
    return;
  }
  size_t num_set_arguments = 5;
  if (info.Length() > 4) {
    v8::Local<v8::Value> optional_value0 = info[4];
    FromJSValue(isolate,
                optional_value0,
                kNoConversionFlags,
                &exception_state,
  ...
  scoped_refptr<TrackDefault> new_object =
      new TrackDefault(type, language, label, kinds, byteStreamTrackID, &exception_state);
...
void typeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cTrackDefault::GetTemplate(isolate)->HasInstance(object)) {
  ...
  TrackDefault* impl =
      wrapper_private->wrappable<TrackDefault>().get();
...
void byteStreamTrackIDAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
...
void getKindsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "TrackDefault"));
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, byteStreamTrackIDAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, labelAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getKindsMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "TrackDefault"),
...
v8::Local<v8::Object> V8cTrackDefault::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cTrackDefault::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
