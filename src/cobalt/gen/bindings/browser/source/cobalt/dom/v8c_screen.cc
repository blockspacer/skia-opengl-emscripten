...
const int kInterfaceUniqueId = 186;
...
void availWidthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Screen,
                                                    V8cScreen>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Screen* impl,
