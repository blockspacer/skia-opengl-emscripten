...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLCollection is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLCollection,
                                                    V8cHTMLCollection>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLCollection* impl,
...
void itemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cHTMLCollection::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void namedItemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cHTMLCollection::GetTemplate(isolate), isolate, object)) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLCollection"));
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, namedItemMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLCollection"),
...
v8::Local<v8::Object> V8cHTMLCollection::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLCollection::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
