...
using cobalt::dom::eme::MediaKeySessionType;
...
const int kInterfaceUniqueId = 141;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaKeys is not constructible.");
}




void createSessionMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaKeys::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<MediaKeySessionType >::ConversionType sessionType =
      kMediaKeySessionTypeTemporary;
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->CreateSession(sessionType, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void setServerCertificateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaKeys::GetTemplate(isolate), isolate, object)) {
    return;
  ...
  TypeTraits<::cobalt::script::UnionType2<::cobalt::script::Handle<::cobalt::script::ArrayBufferView>, ::cobalt::script::Handle<::cobalt::script::ArrayBuffer> > >::ConversionType serverCertificate;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &serverCertificate);
  if (exception_state.is_exception_set()) {
    return;
  }
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->SetServerCertificate(serverCertificate),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaKeys"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, createSessionMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, setServerCertificateMethod);
    method_template->RemovePrototype();
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaKeys"),
...
v8::Local<v8::Object> V8cMediaKeys::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaKeys::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
