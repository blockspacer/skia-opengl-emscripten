...
const int kInterfaceUniqueId = 174;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "PerformanceTiming is not constructible.");
}



void navigationStartAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cPerformanceTiming::GetTemplate(isolate)->HasInstance(object)) {
  ...
  PerformanceTiming* impl =
      wrapper_private->wrappable<PerformanceTiming>().get();


  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->navigation_start(),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "PerformanceTiming"));
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, navigationStartAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "PerformanceTiming"),
...
v8::Local<v8::Object> V8cPerformanceTiming::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cPerformanceTiming::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
