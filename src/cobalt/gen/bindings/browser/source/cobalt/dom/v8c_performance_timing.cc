...
void navigationStartAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<PerformanceTiming,
                                                    V8cPerformanceTiming>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, PerformanceTiming* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "navigationStart"
                  ,navigationStartAttributeGetter
                  );
