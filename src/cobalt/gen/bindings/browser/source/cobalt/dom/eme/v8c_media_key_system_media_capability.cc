...
void ToJSValue(
    v8::Isolate* isolate,
    const MediaKeySystemMediaCapability& in_dictionary,
  ...
  if (in_dictionary.has_content_type()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.content_type(), &member_value);
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 MediaKeySystemMediaCapability* out_dictionary) {
  ...
  if (value->IsNullOrUndefined()) {
    ...
    *out_dictionary = MediaKeySystemMediaCapability();
    return;
  }
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "contentType", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_content_type(converted_value);
    }
  }
}
