...
const int kInterfaceUniqueId = 209;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<TrackEvent> new_object =
      new TrackEvent(type);
...
void trackAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cTrackEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  TrackEvent* impl =
      wrapper_private->wrappable<TrackEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "TrackEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, TrackEvent>::value,
        "Expected TrackEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, trackAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "TrackEvent"),
...
v8::Local<v8::Object> V8cTrackEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cTrackEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
