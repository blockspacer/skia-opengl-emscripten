...
const int kInterfaceUniqueId = 73;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<FocusEvent> new_object =
      new FocusEvent(type);
...
void relatedTargetAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cFocusEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  FocusEvent* impl =
      wrapper_private->wrappable<FocusEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "FocusEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<UIEvent, FocusEvent>::value,
        "Expected FocusEvent to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "FocusEvent"),
...
v8::Local<v8::Object> V8cFocusEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cFocusEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
