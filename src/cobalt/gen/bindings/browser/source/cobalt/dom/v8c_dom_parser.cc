...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<DOMParser> new_object =
      new DOMParser(callwith_global_environment->GetEnvironmentSettings());
...
void parseFromStringMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cDOMParser::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  TypeTraits<std::string >::ConversionType str;
  TypeTraits<DOMParserSupportedType >::ConversionType type;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "DOMParser"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, parseFromStringMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DOMParser"),
...
v8::Local<v8::Object> V8cDOMParser::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDOMParser::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
