...
const int kInterfaceUniqueId = 56;
...
void alphaAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<DeviceOrientationEvent,
                                                    V8cDeviceOrientationEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, DeviceOrientationEvent* impl,
