...
const int kInterfaceUniqueId = 126;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaError is not constructible.");
}
...
void codeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaError::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaError* impl =
      wrapper_private->wrappable<MediaError>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaError"));
  ...
  }
  {
    ...
    // constant's IDL value to an ECMAScript value.
    v8::Local<v8::Value> constant_value;
    ToJSValue(isolate, 1000, &constant_value);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaError"),
...
v8::Local<v8::Object> V8cMediaError::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaError::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
