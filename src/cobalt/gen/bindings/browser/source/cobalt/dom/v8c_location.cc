...
const int kInterfaceUniqueId = 127;
...
void hrefAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Location,
                                                    V8cLocation>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Location* impl,
...
void hrefAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<Location, V8cLocation>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Location* impl,
...
void assignMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cLocation::GetTemplate(isolate), isolate, object)) {
    return;
  }
...
void Stringifier(const v8::FunctionCallbackInfo<v8::Value>& info) {
  auto* impl = script::v8c::shared_bindings::get_impl_class_from_info<Location, V8cLocation>(info);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "protocol"
                  ,protocolAttributeGetter
                  ,protocolAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "hostname"
                  ,hostnameAttributeGetter
                  ,hostnameAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "pathname"
                  ,pathnameAttributeGetter
                  ,pathnameAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "search"
                  ,searchAttributeGetter
                  ,searchAttributeSetter
                  );
