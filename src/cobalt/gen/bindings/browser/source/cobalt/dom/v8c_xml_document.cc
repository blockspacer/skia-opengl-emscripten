...
const int kInterfaceUniqueId = 233;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "XMLDocument is not constructible.");
}
...
void locationAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<XMLDocument,
                                                    V8cXMLDocument>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, XMLDocument* impl,
...
void locationAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<XMLDocument, V8cXMLDocument>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, XMLDocument* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "XMLDocument"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cDocument::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<Document, XMLDocument>::value,
        "Expected XMLDocument to have C++ parent class "
        "Document, because that is its WebIDL parent.");
  }
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "XMLDocument"),
...
v8::Local<v8::Object> V8cXMLDocument::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cXMLDocument::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
