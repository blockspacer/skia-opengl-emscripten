...
const int kInterfaceUniqueId = 103;
...
void hrefAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cHTMLLinkElement::GetTemplate(isolate)->HasInstance(object)) {
  ...
  HTMLLinkElement* impl =
      wrapper_private->wrappable<HTMLLinkElement>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, relAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, relAttributeSetter);
