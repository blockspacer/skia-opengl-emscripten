...
void ToJSValue(
    v8::Isolate* isolate,
    const MediaKeyMessageEventInit& in_dictionary,
  ...
  if (in_dictionary.has_message_type()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.message_type(), &member_value);
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 MediaKeyMessageEventInit* out_dictionary) {
  ...
  if (value->IsNullOrUndefined()) {
    ...
    *out_dictionary = MediaKeyMessageEventInit();
    return;
  }
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "messageType", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      MediaKeyMessageType converted_value;
      FromJSValue(isolate,
                  member_value,
                  kNoConversionFlags,
                  exception_state,
                  &converted_value);
      out_dictionary->set_message_type(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
    ...
    if (!member_value->IsUndefined()) {
      TypeTraits<::cobalt::script::ArrayBuffer>::ConversionType converted_value;
      FromJSValue(isolate,
                  member_value,
                  kNoConversionFlags,
                  exception_state,
