...
const int kInterfaceUniqueId = 138;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaKeySystemAccess is not constructible.");
}



void keySystemAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<MediaKeySystemAccess,
                                                    V8cMediaKeySystemAccess>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaKeySystemAccess* impl,
...
void createMediaKeysMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaKeySystemAccess::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;

  MediaKeySystemAccess* impl =
...
void getConfigurationMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaKeySystemAccess::GetTemplate(isolate), isolate, object)) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaKeySystemAccess"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, createMediaKeysMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getConfigurationMethod);
    method_template->RemovePrototype();
    method_template->SetLength(0);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaKeySystemAccess"),
...
v8::Local<v8::Object> V8cMediaKeySystemAccess::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaKeySystemAccess::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
