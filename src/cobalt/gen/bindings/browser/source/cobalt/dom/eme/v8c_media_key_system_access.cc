...
const int kInterfaceUniqueId = 132;
...
void keySystemAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaKeySystemAccess::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaKeySystemAccess* impl =
      wrapper_private->wrappable<MediaKeySystemAccess>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, keySystemAttributeGetter);
