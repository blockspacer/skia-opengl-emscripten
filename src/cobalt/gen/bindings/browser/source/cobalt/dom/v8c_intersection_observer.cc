...
using cobalt::dom::IntersectionObserverInit;
...
const int kInterfaceUniqueId = 118;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<IntersectionObserver::IntersectionObserverCallback >::ConversionType callback;
  // Optional arguments
  TypeTraits<IntersectionObserverInit >::ConversionType options;
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<IntersectionObserver> new_object =
              new IntersectionObserver(callwith_global_environment->GetEnvironmentSettings(), callback, &exception_state);
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<IntersectionObserver> new_object =
              new IntersectionObserver(callwith_global_environment->GetEnvironmentSettings(), callback, options, &exception_state);
          // In case that an exception is thrown from constructor.
          if (exception_state.is_exception_set()) {
            return;
          }
...
void rootAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserver,
                                                    V8cIntersectionObserver>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, IntersectionObserver* impl,
...
void rootMarginAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserver,
                                                    V8cIntersectionObserver>(
                    info,
...
void thresholdsAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<IntersectionObserver,
                                                    V8cIntersectionObserver>(
                    info,
...
void disconnectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cIntersectionObserver::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;

  IntersectionObserver* impl =
...
void observeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cIntersectionObserver::GetTemplate(isolate), isolate, object)) {
    return;
  ...
  // Non-optional arguments
  TypeTraits<scoped_refptr<Element> >::ConversionType target;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &target);
  if (exception_state.is_exception_set()) {
    return;
  }
...
void takeRecordsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cIntersectionObserver::GetTemplate(isolate), isolate, object)) {
    return;
...
void unobserveMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cIntersectionObserver::GetTemplate(isolate), isolate, object)) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "IntersectionObserver"));
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, observeMethod);
    method_template->RemovePrototype();
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, takeRecordsMethod);
    method_template->RemovePrototype();
    method_template->SetLength(0);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, unobserveMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "IntersectionObserver"),
...
v8::Local<v8::Object> V8cIntersectionObserver::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cIntersectionObserver::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
