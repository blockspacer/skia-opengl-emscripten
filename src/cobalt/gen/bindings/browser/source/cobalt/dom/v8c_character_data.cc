...
void dataAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<CharacterData,
                                                    V8cCharacterData>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CharacterData* impl,
...
void dataAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<CharacterData, V8cCharacterData>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CharacterData* impl,
