...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CharacterData is not constructible.");
}
...
void dataAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCharacterData::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CharacterData* impl =
      wrapper_private->wrappable<CharacterData>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CharacterData"));
...

  {
    ...
    static_assert(
        std::is_base_of<Node, CharacterData>::value,
        "Expected CharacterData to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CharacterData"),
...
v8::Local<v8::Object> V8cCharacterData::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCharacterData::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
