...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<AnimationEvent> new_object =
...
void animationNameAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cAnimationEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  AnimationEvent* impl =
      wrapper_private->wrappable<AnimationEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "AnimationEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, AnimationEvent>::value,
        "Expected AnimationEvent to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AnimationEvent"),
...
v8::Local<v8::Object> V8cAnimationEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAnimationEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
