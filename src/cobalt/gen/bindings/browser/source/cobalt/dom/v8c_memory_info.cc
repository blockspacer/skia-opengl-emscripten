...
const int kInterfaceUniqueId = 149;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MemoryInfo is not constructible.");
}



void totalJSHeapSizeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMemoryInfo::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MemoryInfo* impl =
      wrapper_private->wrappable<MemoryInfo>().get();

  V8cGlobalEnvironment* callwith_global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);

  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->total_js_heap_size(callwith_global_environment->GetEnvironmentSettings()),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void usedJSHeapSizeAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->used_js_heap_size(callwith_global_environment->GetEnvironmentSettings()),
              &result_value);
  }
  if (exception_state.is_exception_set()) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MemoryInfo"));
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, totalJSHeapSizeAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, usedJSHeapSizeAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MemoryInfo"),
...
v8::Local<v8::Object> V8cMemoryInfo::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMemoryInfo::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
