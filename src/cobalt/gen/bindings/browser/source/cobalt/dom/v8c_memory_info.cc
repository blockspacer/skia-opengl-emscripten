...
void totalJSHeapSizeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MemoryInfo,
                                                    V8cMemoryInfo>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MemoryInfo* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "totalJSHeapSize"
                  ,totalJSHeapSizeAttributeGetter
                  );
