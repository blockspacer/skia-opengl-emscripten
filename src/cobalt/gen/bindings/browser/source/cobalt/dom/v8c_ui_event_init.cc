...
void ToJSValue(
    v8::Isolate* isolate,
    const UIEventInit& in_dictionary,
  ...
  if (in_dictionary.has_view()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.view(), &member_value);
  ...
  if (in_dictionary.has_detail()) {
    v8::Local<v8::Value> member_value;
    ToJSValue(isolate, in_dictionary.detail(), &member_value);
    v8::Maybe<bool> maybe_result = dictionary_object->DefineOwnProperty(
      context,
      v8::String::NewFromUtf8(
        isolate,
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
...

  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "view", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    ...
    if (!member_value->IsUndefined()) {
      scoped_refptr<Window> converted_value;
      FromJSValue(isolate,
                  member_value,
                  (kConversionFlagNullable),
                  exception_state,
                  &converted_value);
      out_dictionary->set_view(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
        context,
        v8::String::NewFromUtf8(isolate, "detail", v8::NewStringType::kInternalized).ToLocalChecked());
    v8::Local<v8::Value> member_value;
    if (!maybe_member_value.ToLocal(&member_value)) {
      exception_state->SetSimpleException(kSimpleError);
      return;
    ...
    if (!member_value->IsUndefined()) {
      ...
      FromJSValue(isolate,
                  ...
                  exception_state,
                  &converted_value);
      out_dictionary->set_detail(converted_value);
    }
  }
  {
    v8::MaybeLocal<v8::Value> maybe_member_value = dictionary_object->Get(
