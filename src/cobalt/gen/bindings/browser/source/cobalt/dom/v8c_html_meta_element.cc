...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLMetaElement is not constructible.");
}
...
void nameAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLMetaElement,
                                                    V8cHTMLMetaElement>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLMetaElement* impl,
...
void nameAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<HTMLMetaElement, V8cHTMLMetaElement>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLMetaElement* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLMetaElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLMetaElement>::value,
        "Expected HTMLMetaElement to have C++ parent class "
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "httpEquiv"
                  ,httpEquivAttributeGetter
                  ,httpEquivAttributeSetter
                  );
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLMetaElement"),
...
v8::Local<v8::Object> V8cHTMLMetaElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLMetaElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
