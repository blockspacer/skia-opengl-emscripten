...
void nameAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cHTMLMetaElement::GetTemplate(isolate)->HasInstance(object)) {
  ...
  HTMLMetaElement* impl =
      wrapper_private->wrappable<HTMLMetaElement>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, nameAttributeSetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, httpEquivAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, httpEquivAttributeSetter);
