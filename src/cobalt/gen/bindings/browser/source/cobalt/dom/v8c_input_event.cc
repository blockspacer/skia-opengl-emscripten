...
using cobalt::dom::InputEventInit;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  // Optional arguments
  TypeTraits<InputEventInit >::ConversionType eventInitDict;
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<InputEvent> new_object =
              new InputEvent(type);
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<InputEvent> new_object =
              new InputEvent(type, eventInitDict);
          v8::Local<v8::Value> result_value;
          ToJSValue(isolate, new_object, &result_value);
          DCHECK(result_value->IsObject());
          info.GetReturnValue().Set(result_value);
...
void dataAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cInputEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  InputEvent* impl =
      wrapper_private->wrappable<InputEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "InputEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<UIEvent, InputEvent>::value,
        "Expected InputEvent to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "InputEvent"),
...
v8::Local<v8::Object> V8cInputEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cInputEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
