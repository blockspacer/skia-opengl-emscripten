...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "DOMImplementation is not constructible.");
}




void createDocumentMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cDOMImplementation::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<base::Optional<std::string > >::ConversionType namespaceName;
  TypeTraits<std::string >::ConversionType qualifiedName;
  // Optional arguments with default values
  TypeTraits<scoped_refptr<DocumentType> >::ConversionType doctype =
      NULL;
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->CreateDocument(namespaceName, qualifiedName, doctype),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "DOMImplementation"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, createDocumentMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DOMImplementation"),
...
v8::Local<v8::Object> V8cDOMImplementation::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDOMImplementation::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
