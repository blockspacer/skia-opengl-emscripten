...
using cobalt::dom::eme::MediaEncryptedEventInit;
...
const int kInterfaceUniqueId = 124;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  // Optional arguments
  TypeTraits<MediaEncryptedEventInit >::ConversionType eventInitDict;
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<MediaEncryptedEvent> new_object =
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<MediaEncryptedEvent> new_object =
              new MediaEncryptedEvent(type, eventInitDict);
          v8::Local<v8::Value> result_value;
          ToJSValue(isolate, new_object, &result_value);
          DCHECK(result_value->IsObject());
          info.GetReturnValue().Set(result_value);
...
void initDataTypeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaEncryptedEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaEncryptedEvent* impl =
      wrapper_private->wrappable<MediaEncryptedEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "MediaEncryptedEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, MediaEncryptedEvent>::value,
        "Expected MediaEncryptedEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, initDataTypeAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, initDataAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaEncryptedEvent"),
...
v8::Local<v8::Object> V8cMediaEncryptedEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaEncryptedEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
