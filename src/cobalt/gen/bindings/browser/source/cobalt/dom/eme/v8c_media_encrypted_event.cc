...
void initDataTypeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MediaEncryptedEvent,
                                                    V8cMediaEncryptedEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaEncryptedEvent* impl,
