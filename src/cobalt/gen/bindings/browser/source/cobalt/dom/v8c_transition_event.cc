...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<TransitionEvent> new_object =
...
void propertyNameAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cTransitionEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  TransitionEvent* impl =
      wrapper_private->wrappable<TransitionEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "TransitionEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, TransitionEvent>::value,
        "Expected TransitionEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, propertyNameAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "TransitionEvent"),
...
v8::Local<v8::Object> V8cTransitionEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cTransitionEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
