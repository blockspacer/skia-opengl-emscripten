...
void propertyNameAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<TransitionEvent,
                                                    V8cTransitionEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, TransitionEvent* impl,
