...
using cobalt::dom::CustomEventInit;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  // Optional arguments
  TypeTraits<CustomEventInit >::ConversionType eventInitDict;
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<CustomEvent> new_object =
...
void detailAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<CustomEvent,
                                                    V8cCustomEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CustomEvent* impl,
...
void initCustomEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cCustomEvent::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  TypeTraits<::cobalt::script::ValueHandle >::ConversionType detail;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "CustomEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, CustomEvent>::value,
        "Expected CustomEvent to have C++ parent class "
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, initCustomEventMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CustomEvent"),
...
v8::Local<v8::Object> V8cCustomEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCustomEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
