...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "DocumentType is not constructible.");
}
...
void nameAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cDocumentType::GetTemplate(isolate)->HasInstance(object)) {
  ...
  DocumentType* impl =
      wrapper_private->wrappable<DocumentType>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "DocumentType"));
...

  {
    ...
    static_assert(
        std::is_base_of<Node, DocumentType>::value,
        "Expected DocumentType to have C++ parent class "
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, publicIdAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, systemIdAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DocumentType"),
...
v8::Local<v8::Object> V8cDocumentType::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDocumentType::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
