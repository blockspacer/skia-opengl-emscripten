...
const int kInterfaceUniqueId = 150;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MessageEvent is not constructible.");
}
...
void dataAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMessageEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MessageEvent* impl =
      wrapper_private->wrappable<MessageEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MessageEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, MessageEvent>::value,
        "Expected MessageEvent to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MessageEvent"),
...
v8::Local<v8::Object> V8cMessageEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMessageEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
