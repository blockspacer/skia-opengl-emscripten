...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "Attr is not constructible.");
}



void valueAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<Attr,
                                                    V8cAttr>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Attr* impl,
...
void valueAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<Attr, V8cAttr>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Attr* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "Attr"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "Attr"),
...
v8::Local<v8::Object> V8cAttr::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAttr::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
