...
const int kInterfaceUniqueId = 151;
...
void sourceBuffersAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<MediaSource,
                                                    V8cMediaSource>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaSource* impl,
...
void durationAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<MediaSource, V8cMediaSource>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaSource* impl,
...
void addSourceBufferMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaSource::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->AddSourceBuffer(callwith_global_environment->GetEnvironmentSettings(), type, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
    info.GetReturnValue().Set(result_value);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "activeSourceBuffers"
                  ,activeSourceBuffersAttributeGetter
                  );
