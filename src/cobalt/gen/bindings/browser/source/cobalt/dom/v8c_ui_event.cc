...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  // Optional arguments
  TypeTraits<UIEventInit >::ConversionType eventInitDict;
  ...
  switch (num_set_arguments) {
    case 1:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<UIEvent> new_object =
              new UIEvent(type);
    ...
    case 2:
      {  if (!info.IsConstructCall()) {
          ...
          scoped_refptr<UIEvent> new_object =
              new UIEvent(type, eventInitDict);
          v8::Local<v8::Value> result_value;
          ToJSValue(isolate, new_object, &result_value);
          DCHECK(result_value->IsObject());
          info.GetReturnValue().Set(result_value);
...
void viewAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cUIEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  UIEvent* impl =
      wrapper_private->wrappable<UIEvent>().get();
...
void initUIEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "UIEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, UIEvent>::value,
        "Expected UIEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, viewAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, whichAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, initUIEventMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "UIEvent"),
...
v8::Local<v8::Object> V8cUIEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cUIEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
