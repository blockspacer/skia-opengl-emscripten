...
void viewAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<UIEvent,
                                                    V8cUIEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, UIEvent* impl,
...
void initUIEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cUIEvent::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
