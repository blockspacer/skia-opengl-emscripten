...
void ToJSValue(
    v8::Isolate* isolate,
    MediaKeySessionType in_enum,
    v8::Local<v8::Value>* out_value) {
  switch (in_enum) {
    case cobalt::dom::eme::kMediaKeySessionTypeTemporary:
      ToJSValue(isolate, std::string("temporary"), out_value);
      return;
    default:
      NOTREACHED();
...
// 3. Return the enumeration value of type E that is equal to S.
 if (
      NewInternalString(isolate, "temporary")->Equals(value))
  {
    *out_enum = cobalt::dom::eme::kMediaKeySessionTypeTemporary;
  }
  else {
