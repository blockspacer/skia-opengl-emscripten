...
const int kInterfaceUniqueId = 131;
...
void sizeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaKeyStatusMap::GetTemplate(isolate)->HasInstance(object)) {
  ...
  MediaKeyStatusMap* impl =
      wrapper_private->wrappable<MediaKeyStatusMap>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, sizeAttributeGetter);
