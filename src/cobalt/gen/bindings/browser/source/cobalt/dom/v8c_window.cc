...
#include "cobalt/dom/v8c_abort_controller.h"
#include "cobalt/dom/v8c_abort_signal.h"
...
#include "cobalt/dom/v8c_html_audio_element.h"
...
#include "cobalt/dom/v8c_intersection_observer.h"
#include "cobalt/dom/v8c_intersection_observer_entry.h"
...
#endif  // defined(ENABLE_DEBUGGER)
using cobalt::dom::AbortController;
using cobalt::dom::AbortSignal;
...
using cobalt::dom::HTMLAudioElement;
...
using cobalt::dom::IntersectionObserver;
using cobalt::dom::IntersectionObserverEntry;
...
using cobalt::dom::V8cAbortController;
using cobalt::dom::V8cAbortSignal;
...
using cobalt::dom::V8cHTMLAudioElement;
...
using cobalt::dom::V8cIntersectionObserver;
using cobalt::dom::V8cIntersectionObserverEntry;
...
const int kInterfaceUniqueId = 228;
...
// Nothing for {'getter_function_name': 'abort_controller', 'conditional': None, 'on_prototype': False, 'unsupported': False, 'is_read_only': False, 'is_named_constructor_attribute': False, 'idl_name': 'AbortController', 'is_static': False, 'call_with': None, 'on_instance': True, 'is_constructor_attribute': True, 'raises_exception': False, 'setter_function_name': 'set_abort_controller', 'on_interface': False, 'has_setter': True, 'conversion_flags': 'kNoConversionFlags', 'interface_name': 'AbortController', 'type': 'scoped_refptr<AbortController>'}.  We will just give them the v8::FunctionTemplate.

// Nothing for {'getter_function_name': 'abort_signal', 'conditional': None, 'on_prototype': False, 'unsupported': False, 'is_read_only': False, 'is_named_constructor_attribute': False, 'idl_name': 'AbortSignal', 'is_static': False, 'call_with': None, 'on_instance': True, 'is_constructor_attribute': True, 'raises_exception': False, 'setter_function_name': 'set_abort_signal', 'on_interface': False, 'has_setter': True, 'conversion_flags': 'kNoConversionFlags', 'interface_name': 'AbortSignal', 'type': 'scoped_refptr<AbortSignal>'}.  We will just give them the v8::FunctionTemplate.
...
// Nothing for {'getter_function_name': 'html_audio_element', 'conditional': None, 'on_prototype': False, 'unsupported': False, 'is_read_only': False, 'is_named_constructor_attribute': False, 'idl_name': 'HTMLAudioElement', 'is_static': False, 'call_with': None, 'on_instance': True, 'is_constructor_attribute': True, 'raises_exception': False, 'setter_function_name': 'set_html_audio_element', 'on_interface': False, 'has_setter': True, 'conversion_flags': 'kNoConversionFlags', 'interface_name': 'HTMLAudioElement', 'type': 'scoped_refptr<HTMLAudioElement>'}.  We will just give them the v8::FunctionTemplate.
...
// Nothing for {'getter_function_name': 'intersection_observer', 'conditional': None, 'on_prototype': False, 'unsupported': False, 'is_read_only': False, 'is_named_constructor_attribute': False, 'idl_name': 'IntersectionObserver', 'is_static': False, 'call_with': None, 'on_instance': True, 'is_constructor_attribute': True, 'raises_exception': False, 'setter_function_name': 'set_intersection_observer', 'on_interface': False, 'has_setter': True, 'conversion_flags': 'kNoConversionFlags', 'interface_name': 'IntersectionObserver', 'type': 'scoped_refptr<IntersectionObserver>'}.  We will just give them the v8::FunctionTemplate.

// Nothing for {'getter_function_name': 'intersection_observer_entry', 'conditional': None, 'on_prototype': False, 'unsupported': False, 'is_read_only': False, 'is_named_constructor_attribute': False, 'idl_name': 'IntersectionObserverEntry', 'is_static': False, 'call_with': None, 'on_instance': True, 'is_constructor_attribute': True, 'raises_exception': False, 'setter_function_name': 'set_intersection_observer_entry', 'on_interface': False, 'has_setter': True, 'conversion_flags': 'kNoConversionFlags', 'interface_name': 'IntersectionObserverEntry', 'type': 'scoped_refptr<IntersectionObserverEntry>'}.  We will just give them the v8::FunctionTemplate.
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "speechSynthesis"
                  ,speechSynthesisAttributeGetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "devicePixelRatio"
                  ,devicePixelRatioAttributeGetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onunload"
                  ,onunloadAttributeGetter
                  ,onunloadAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onbeforeunload"
                  ,onbeforeunloadAttributeGetter
                  ,onbeforeunloadAttributeSetter
                  );
...
#if defined(COBALT_ENABLE_ON_SCREEN_KEYBOARD)
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "onScreenKeyboard"
                  ,onScreenKeyboardAttributeGetter
                  );
  ...
  {
    {
      ...
      instance_template->Set(
          ...
          // Note that we use "attribute.interface_name", and not
          // "attribute.idl_name", because of named constructors.
          V8cAbortController::GetTemplate(isolate)
      );
    }
  }
  {
    {
      ...
      instance_template->Set(
          ...
          // Note that we use "attribute.interface_name", and not
          // "attribute.idl_name", because of named constructors.
          V8cAbortSignal::GetTemplate(isolate)
      );
    }
  }
  {
  ...
  {
    {
      ...
      instance_template->Set(
          ...
          // Note that we use "attribute.interface_name", and not
          // "attribute.idl_name", because of named constructors.
          V8cHTMLAudioElement::GetTemplate(isolate)
      );
    }
  }
  {
  ...
  {
    {
      ...
      instance_template->Set(
          ...
          // Note that we use "attribute.interface_name", and not
          // "attribute.idl_name", because of named constructors.
          V8cIntersectionObserver::GetTemplate(isolate)
      );
    }
  }
  {
    {
      ...
      instance_template->Set(
          ...
          // Note that we use "attribute.interface_name", and not
          // "attribute.idl_name", because of named constructors.
          V8cIntersectionObserverEntry::GetTemplate(isolate)
      );
    }
  }
  {
...
void V8cGlobalEnvironment::CreateGlobalObject(
  ...
  wrapper_factory_->RegisterWrappableType(
      AbortController::AbortControllerWrappableType(),
      base::Bind(V8cAbortController::CreateWrapper),
      base::Bind(V8cAbortController::GetTemplate));
  wrapper_factory_->RegisterWrappableType(
      AbortSignal::AbortSignalWrappableType(),
      base::Bind(V8cAbortSignal::CreateWrapper),
      base::Bind(V8cAbortSignal::GetTemplate));
  wrapper_factory_->RegisterWrappableType(
  ...
  wrapper_factory_->RegisterWrappableType(
      HTMLAudioElement::HTMLAudioElementWrappableType(),
      base::Bind(V8cHTMLAudioElement::CreateWrapper),
      base::Bind(V8cHTMLAudioElement::GetTemplate));
  wrapper_factory_->RegisterWrappableType(
  ...
  wrapper_factory_->RegisterWrappableType(
      IntersectionObserver::IntersectionObserverWrappableType(),
      base::Bind(V8cIntersectionObserver::CreateWrapper),
      base::Bind(V8cIntersectionObserver::GetTemplate));
  wrapper_factory_->RegisterWrappableType(
      IntersectionObserverEntry::IntersectionObserverEntryWrappableType(),
      base::Bind(V8cIntersectionObserverEntry::CreateWrapper),
      base::Bind(V8cIntersectionObserverEntry::GetTemplate));
  wrapper_factory_->RegisterWrappableType(
