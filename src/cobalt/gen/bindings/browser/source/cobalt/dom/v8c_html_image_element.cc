...
void srcAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLImageElement,
                                                    V8cHTMLImageElement>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLImageElement* impl,
...
void srcAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<HTMLImageElement, V8cHTMLImageElement>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLImageElement* impl,
