...
const int kInterfaceUniqueId = 102;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<HTMLImageElement> new_object =
      new HTMLImageElement(callwith_global_environment->GetEnvironmentSettings());
...
void srcAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cHTMLImageElement::GetTemplate(isolate)->HasInstance(object)) {
  ...
  HTMLImageElement* impl =
      wrapper_private->wrappable<HTMLImageElement>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "HTMLImageElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLImageElement>::value,
        "Expected HTMLImageElement to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLImageElement"),
...
v8::Local<v8::Object> V8cHTMLImageElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLImageElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
