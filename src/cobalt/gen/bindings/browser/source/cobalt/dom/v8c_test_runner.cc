...
const int kInterfaceUniqueId = 211;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "TestRunner is not constructible.");
}




void AdvanceClockByMsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cTestRunner::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<int64_t >::ConversionType amount;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &amount);
  if (exception_state.is_exception_set()) {
    return;
  }

  impl->AdvanceClockByMs(amount);
...
void collectGarbageAndThenDoMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cTestRunner::GetTemplate(isolate), isolate, object)) {
    return;
  ...
  // Non-optional arguments
  TypeTraits<TestRunner::TestRunnerCallback >::ConversionType callback;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
  ...
  impl->CollectGarbageAndThenDo(callwith_global_environment->GetEnvironmentSettings(), callback);
result_value = v8::Undefined(isolate);
...
void DoNonMeasuredLayoutMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cTestRunner::GetTemplate(isolate), isolate, object)) {
    return;
...
void notifyDoneMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cTestRunner::GetTemplate(isolate), isolate, object)) {
    return;
...
void waitUntilDoneMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cTestRunner::GetTemplate(isolate), isolate, object)) {
    return;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "TestRunner"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, AdvanceClockByMsMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, collectGarbageAndThenDoMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, DoNonMeasuredLayoutMethod);
    method_template->RemovePrototype();
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, notifyDoneMethod);
    method_template->RemovePrototype();
    method_template->SetLength(0);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, waitUntilDoneMethod);
    method_template->RemovePrototype();
    method_template->SetLength(0);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "TestRunner"),
...
v8::Local<v8::Object> V8cTestRunner::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cTestRunner::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
