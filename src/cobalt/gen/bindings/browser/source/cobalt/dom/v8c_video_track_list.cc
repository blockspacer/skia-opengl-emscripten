...
const int kInterfaceUniqueId = 224;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "VideoTrackList is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<VideoTrackList,
                                                    V8cVideoTrackList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, VideoTrackList* impl,
...
void selectedIndexAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<VideoTrackList,
                                                    V8cVideoTrackList>(
                    info,
...
void getTrackByIdMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cVideoTrackList::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "VideoTrackList"));
...

  {
    ...
    static_assert(
        std::is_base_of<EventTarget, VideoTrackList>::value,
        "Expected VideoTrackList to have C++ parent class "
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getTrackByIdMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "VideoTrackList"),
...
v8::Local<v8::Object> V8cVideoTrackList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cVideoTrackList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
