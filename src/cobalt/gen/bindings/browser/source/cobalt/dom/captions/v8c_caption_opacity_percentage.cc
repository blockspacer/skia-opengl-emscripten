...
using cobalt::dom::captions::CaptionOpacityPercentage;
...
void ToJSValue(
    v8::Isolate* isolate,
    CaptionOpacityPercentage in_enum,
    v8::Local<v8::Value>* out_value) {
  switch (in_enum) {
    case cobalt::dom::captions::kCaptionOpacityPercentage0:
      ToJSValue(isolate, std::string("0"), out_value);
      return;
    case cobalt::dom::captions::kCaptionOpacityPercentage25:
      ToJSValue(isolate, std::string("25"), out_value);
      return;
    case cobalt::dom::captions::kCaptionOpacityPercentage50:
      ToJSValue(isolate, std::string("50"), out_value);
      return;
    case cobalt::dom::captions::kCaptionOpacityPercentage75:
      ToJSValue(isolate, std::string("75"), out_value);
      return;
    case cobalt::dom::captions::kCaptionOpacityPercentage100:
...
void FromJSValue(v8::Isolate* isolate, v8::Local<v8::Value> value,
                 ...
                 CaptionOpacityPercentage* out_enum) {
...
// 3. Return the enumeration value of type E that is equal to S.
 if (
      NewInternalString(isolate, "0")->Equals(value))
  {
    *out_enum = cobalt::dom::captions::kCaptionOpacityPercentage0;
  }
 else  if (
      NewInternalString(isolate, "25")->Equals(value))
  {
    *out_enum = cobalt::dom::captions::kCaptionOpacityPercentage25;
  }
 else  if (
      NewInternalString(isolate, "50")->Equals(value))
  {
    *out_enum = cobalt::dom::captions::kCaptionOpacityPercentage50;
  }
 else  if (
      NewInternalString(isolate, "75")->Equals(value))
  {
    *out_enum = cobalt::dom::captions::kCaptionOpacityPercentage75;
  }
 else  if (
      NewInternalString(isolate, "100")->Equals(value))
  {
    *out_enum = cobalt::dom::captions::kCaptionOpacityPercentage100;
  }
  else {
