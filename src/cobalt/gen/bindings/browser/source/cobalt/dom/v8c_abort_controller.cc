...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<AbortController> new_object =
      new AbortController();
...
void signalAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<AbortController,
                                                    V8cAbortController>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AbortController* impl,
...
void abortMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cAbortController::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "AbortController"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AbortController"),
...
v8::Local<v8::Object> V8cAbortController::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAbortController::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
