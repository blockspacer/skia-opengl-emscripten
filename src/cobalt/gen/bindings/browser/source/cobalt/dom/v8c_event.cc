...
const int kInterfaceUniqueId = 68;
...
void typeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Event,
                                                    V8cEvent>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Event* impl,
...
void initEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cEvent::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "defaultPrevented"
                  ,defaultPreventedAttributeGetter
                  );
