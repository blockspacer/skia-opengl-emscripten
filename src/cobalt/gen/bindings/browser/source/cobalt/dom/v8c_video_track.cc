...
const int kInterfaceUniqueId = 223;
...
void idAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<VideoTrack,
                                                    V8cVideoTrack>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, VideoTrack* impl,
...
void selectedAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<VideoTrack, V8cVideoTrack>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, VideoTrack* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "selected"
                  ,selectedAttributeGetter
                  ,selectedAttributeSetter
                  );
