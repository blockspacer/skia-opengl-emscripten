...
void xAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<DOMRect,
                                                    V8cDOMRect>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, DOMRect* impl,
...
void xAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<DOMRect, V8cDOMRect>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, DOMRect* impl,
