...
void Constructor1(
  ...
  scoped_refptr<DOMRect> new_object =
      new DOMRect();
...
void xAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cDOMRect::GetTemplate(isolate)->HasInstance(object)) {
  ...
  DOMRect* impl =
      wrapper_private->wrappable<DOMRect>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "DOMRect"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cDOMRectReadOnly::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<DOMRectReadOnly, DOMRect>::value,
        "Expected DOMRect to have C++ parent class "
        "DOMRectReadOnly, because that is its WebIDL parent.");
  }
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, xAttributeSetter);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, yAttributeSetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DOMRect"),
...
v8::Local<v8::Object> V8cDOMRect::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDOMRect::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
