...
const int kInterfaceUniqueId = 180;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "Performance is not constructible.");
}



void timingAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<Performance,
                                                    V8cPerformance>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Performance* impl,
...
void nowMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cPerformance::GetTemplate(isolate), isolate, object)) {
    return;
  }
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "Performance"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, nowMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "Performance"),
...
v8::Local<v8::Object> V8cPerformance::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cPerformance::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
