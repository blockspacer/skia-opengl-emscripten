...
const int kInterfaceUniqueId = 173;
...
void timingAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cPerformance::GetTemplate(isolate)->HasInstance(object)) {
  ...
  Performance* impl =
      wrapper_private->wrappable<Performance>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, timingAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, memoryAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
