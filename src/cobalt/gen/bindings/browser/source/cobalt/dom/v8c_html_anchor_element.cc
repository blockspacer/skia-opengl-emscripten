...
const int kInterfaceUniqueId = 94;
...
void hrefAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLAnchorElement,
                                                    V8cHTMLAnchorElement>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLAnchorElement* impl,
...
void hrefAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<HTMLAnchorElement, V8cHTMLAnchorElement>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLAnchorElement* impl,
...
void Stringifier(const v8::FunctionCallbackInfo<v8::Value>& info) {
  auto* impl = script::v8c::shared_bindings::get_impl_class_from_info<HTMLAnchorElement, V8cHTMLAnchorElement>(info);
