...
const int kInterfaceUniqueId = 93;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLAnchorElement is not constructible.");
}
...
void hrefAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cHTMLAnchorElement::GetTemplate(isolate)->HasInstance(object)) {
  ...
  HTMLAnchorElement* impl =
      wrapper_private->wrappable<HTMLAnchorElement>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLAnchorElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLAnchorElement>::value,
        "Expected HTMLAnchorElement to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLAnchorElement"),
...
v8::Local<v8::Object> V8cHTMLAnchorElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLAnchorElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
