...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "HTMLStyleElement is not constructible.");
}
...
void typeAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cHTMLStyleElement::GetTemplate(isolate)->HasInstance(object)) {
  ...
  HTMLStyleElement* impl =
      wrapper_private->wrappable<HTMLStyleElement>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "HTMLStyleElement"));
...

  {
    ...
    static_assert(
        std::is_base_of<HTMLElement, HTMLStyleElement>::value,
        "Expected HTMLStyleElement to have C++ parent class "
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, sheetAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "HTMLStyleElement"),
...
v8::Local<v8::Object> V8cHTMLStyleElement::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cHTMLStyleElement::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
