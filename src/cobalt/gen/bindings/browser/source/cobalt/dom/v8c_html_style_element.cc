...
const int kInterfaceUniqueId = 111;
...
void typeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<HTMLStyleElement,
                                                    V8cHTMLStyleElement>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLStyleElement* impl,
...
void typeAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<HTMLStyleElement, V8cHTMLStyleElement>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, HTMLStyleElement* impl,
