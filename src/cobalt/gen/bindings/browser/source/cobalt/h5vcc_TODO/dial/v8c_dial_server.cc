...
const int kInterfaceUniqueId = 59;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TypeTraits<std::string >::ConversionType serviceName;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &serviceName);
  ...
  scoped_refptr<DialServer> new_object =
      new DialServer(callwith_global_environment->GetEnvironmentSettings(), serviceName);
...
void serviceNameAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cDialServer::GetTemplate(isolate)->HasInstance(object)) {
  ...
  DialServer* impl =
      wrapper_private->wrappable<DialServer>().get();
...
void onDeleteMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  // Non-optional arguments
  TypeTraits<std::string >::ConversionType path;
  TypeTraits<DialServer::DialHttpRequestCallback >::ConversionType listener;
  DCHECK_LT(0, info.Length());
  v8::Local<v8::Value> non_optional_value0 = info[0];
  FromJSValue(isolate,
              non_optional_value0,
              kNoConversionFlags,
              &exception_state, &path);
  if (exception_state.is_exception_set()) {
    return;
  }
...
void onGetMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void onPostMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "DialServer"));
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, serviceNameAttributeGetter);
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, onDeleteMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, onGetMethod);
    method_template->RemovePrototype();
    method_template->SetLength(2);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, onPostMethod);
    method_template->RemovePrototype();
    method_template->SetLength(2);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "DialServer"),
...
v8::Local<v8::Object> V8cDialServer::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cDialServer::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
