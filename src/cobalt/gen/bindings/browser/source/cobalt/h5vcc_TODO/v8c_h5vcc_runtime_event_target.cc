...
const int kInterfaceUniqueId = 87;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "H5vccRuntimeEventTarget is not constructible.");
}
...
void addListenerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cH5vccRuntimeEventTarget::GetTemplate(isolate)->HasInstance(object)) {
  ...
  H5vccRuntimeEventTarget* impl =
      wrapper_private->wrappable<H5vccRuntimeEventTarget>().get();
  ...
  TypeTraits<H5vccRuntimeEventTarget::H5vccRuntimeEventCallback >::ConversionType callback;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "H5vccRuntimeEventTarget"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "H5vccRuntimeEventTarget"),
...
v8::Local<v8::Object> V8cH5vccRuntimeEventTarget::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cH5vccRuntimeEventTarget::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
