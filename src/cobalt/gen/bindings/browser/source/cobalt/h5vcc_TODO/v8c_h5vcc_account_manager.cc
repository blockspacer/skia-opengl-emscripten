...
// This must be included above the check for COBALT_ENABLE_ACCOUNT_MANAGER, since
// COBALT_ENABLE_ACCOUNT_MANAGER may be defined within.
...
const int kInterfaceUniqueId = 80;
...
void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  scoped_refptr<H5vccAccountManager> new_object =
      new H5vccAccountManager();
...
void getAuthTokenMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cH5vccAccountManager::GetTemplate(isolate)->HasInstance(object)) {
  ...
  H5vccAccountManager* impl =
      wrapper_private->wrappable<H5vccAccountManager>().get();
  ...
  TypeTraits<H5vccAccountManager::AccessTokenCallback >::ConversionType callback;
...
void requestPairingMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
...
void requestUnpairingMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  WrapperFactory* wrapper_factory = global_environment->wrapper_factory();
  ...
  impl->RequestUnpairing(callback);
  result_value = v8::Undefined(isolate);
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  function_template->SetClassName(NewInternalString(isolate, "H5vccAccountManager"));
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, getAuthTokenMethod);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, requestPairingMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, requestUnpairingMethod);
    method_template->RemovePrototype();
    method_template->SetLength(1);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "H5vccAccountManager"),
...
v8::Local<v8::Object> V8cH5vccAccountManager::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cH5vccAccountManager::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
