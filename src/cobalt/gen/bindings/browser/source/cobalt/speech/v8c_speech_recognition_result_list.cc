...
void IndexedPropertyGetterCallback(
  ...
  SpeechRecognitionResultList* impl =
      wrapper_private->wrappable<SpeechRecognitionResultList>().get();
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SpeechRecognitionResultList is not constructible.");
}
...
void lengthAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cSpeechRecognitionResultList::GetTemplate(isolate)->HasInstance(object)) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SpeechRecognitionResultList"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SpeechRecognitionResultList"),
...
v8::Local<v8::Object> V8cSpeechRecognitionResultList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSpeechRecognitionResultList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
