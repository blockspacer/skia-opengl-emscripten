...
#ifndef V8cSpeechRecognitionAlternative_h
#define V8cSpeechRecognitionAlternative_h
...
class V8cSpeechRecognitionAlternative {
 public:
...
#endif  // V8cSpeechRecognitionAlternative_h
