...
const int kInterfaceUniqueId = 190;
...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "SpeechRecognitionEvent is not constructible.");
}



void resultIndexAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cSpeechRecognitionEvent::GetTemplate(isolate)->HasInstance(object)) {
  ...
  SpeechRecognitionEvent* impl =
      wrapper_private->wrappable<SpeechRecognitionEvent>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "SpeechRecognitionEvent"));
...

  {
    ...
    static_assert(
        std::is_base_of<Event, SpeechRecognitionEvent>::value,
        "Expected SpeechRecognitionEvent to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, resultIndexAttributeGetter);
  ...
  }
  {
    ...
    // the relevant Realm of the object that is the location of the property.
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, resultsAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter;
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "SpeechRecognitionEvent"),
...
v8::Local<v8::Object> V8cSpeechRecognitionEvent::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cSpeechRecognitionEvent::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
