...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSGroupingRule is not constructible.");
}
...
void cssRulesAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<CSSGroupingRule,
                                                    V8cCSSGroupingRule>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CSSGroupingRule* impl,
...
void insertRuleMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cCSSGroupingRule::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;

  CSSGroupingRule* impl =
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSGroupingRule"));
...

  {
    ...
    static_assert(
        std::is_base_of<CSSRule, CSSGroupingRule>::value,
        "Expected CSSGroupingRule to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSGroupingRule"),
...
v8::Local<v8::Object> V8cCSSGroupingRule::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSGroupingRule::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
