...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSMediaRule is not constructible.");
}



void mediaAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCSSMediaRule::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CSSMediaRule* impl =
      wrapper_private->wrappable<CSSMediaRule>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSMediaRule"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cCSSConditionRule::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<CSSConditionRule, CSSMediaRule>::value,
        "Expected CSSMediaRule to have C++ parent class "
        "CSSConditionRule, because that is its WebIDL parent.");
  }
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, mediaAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSMediaRule"),
...
v8::Local<v8::Object> V8cCSSMediaRule::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSMediaRule::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
