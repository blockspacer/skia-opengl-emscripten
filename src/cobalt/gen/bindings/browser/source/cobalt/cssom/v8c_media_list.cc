...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "MediaList is not constructible.");
}



void mediaTextAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<MediaList,
                                                    V8cMediaList>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaList* impl,
...
void mediaTextAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<MediaList, V8cMediaList>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, MediaList* impl,
...
void appendMediumMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cMediaList::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "MediaList"));
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "mediaText"
                  ,mediaTextAttributeGetter
                  ,mediaTextAttributeSetter
                  );
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, appendMediumMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "MediaList"),
...
v8::Local<v8::Object> V8cMediaList::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cMediaList::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
