...
void IndexedPropertyGetterCallback(
  ...
  MediaList* impl =
      wrapper_private->wrappable<MediaList>().get();
...
void mediaTextAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cMediaList::GetTemplate(isolate)->HasInstance(object)) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, mediaTextAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, mediaTextAttributeSetter);
