...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSKeyframeRule is not constructible.");
}



void keyTextAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCSSKeyframeRule::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CSSKeyframeRule* impl =
      wrapper_private->wrappable<CSSKeyframeRule>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSKeyframeRule"));
...

  {
    ...
    static_assert(
        std::is_base_of<CSSRule, CSSKeyframeRule>::value,
        "Expected CSSKeyframeRule to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, keyTextAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSKeyframeRule"),
...
v8::Local<v8::Object> V8cCSSKeyframeRule::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSKeyframeRule::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
