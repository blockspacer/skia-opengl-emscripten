...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSStyleSheet is not constructible.");
}



void cssRulesAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<CSSStyleSheet,
                                                    V8cCSSStyleSheet>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CSSStyleSheet* impl,
                       cobalt::script::ExceptionState& exception_state,
                       v8::Local<v8::Value>& result_value) {
  
      ToJSValue(isolate,
              impl->css_rules(&exception_state),
              &result_value);
...
void insertRuleMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  v8::Local<v8::Object> object = info.Holder();
  if (!script::v8c::shared_bindings::object_implements_interface(V8cCSSStyleSheet::GetTemplate(isolate), isolate, object)) {
    return;
  }
  ...
  TypeTraits<std::string >::ConversionType rule;
  ...
  if (!exception_state.is_exception_set()) {
    ToJSValue(isolate,
              impl->InsertRule(rule, index, &exception_state),
              &result_value);
}
  if (!exception_state.is_exception_set()) {
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSStyleSheet"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cStyleSheet::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<StyleSheet, CSSStyleSheet>::value,
        "Expected CSSStyleSheet to have C++ parent class "
        "StyleSheet, because that is its WebIDL parent.");
  }
  ...
  // The characteristics of this property are as follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> method_template =
        v8::FunctionTemplate::New(isolate, insertRuleMethod);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSStyleSheet"),
...
v8::Local<v8::Object> V8cCSSStyleSheet::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSStyleSheet::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
