...
void cssRulesAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCSSStyleSheet::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CSSStyleSheet* impl =
      wrapper_private->wrappable<CSSStyleSheet>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, cssRulesAttributeGetter);
