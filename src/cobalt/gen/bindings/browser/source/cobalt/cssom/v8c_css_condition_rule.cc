...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSConditionRule is not constructible.");
}



void conditionTextAttributeGetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeGetterImpl<CSSConditionRule,
                                                    V8cCSSConditionRule>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CSSConditionRule* impl,
...
void conditionTextAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<CSSConditionRule, V8cCSSConditionRule>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, CSSConditionRule* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSConditionRule"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cCSSGroupingRule::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<CSSGroupingRule, CSSConditionRule>::value,
        "Expected CSSConditionRule to have C++ parent class "
        "CSSGroupingRule, because that is its WebIDL parent.");
  }
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "conditionText"
                  ,conditionTextAttributeGetter
                  ,conditionTextAttributeSetter
                  );
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSConditionRule"),
...
v8::Local<v8::Object> V8cCSSConditionRule::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSConditionRule::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
