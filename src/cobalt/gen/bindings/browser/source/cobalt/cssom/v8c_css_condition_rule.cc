...
void conditionTextAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCSSConditionRule::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CSSConditionRule* impl =
      wrapper_private->wrappable<CSSConditionRule>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, conditionTextAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, conditionTextAttributeSetter);
