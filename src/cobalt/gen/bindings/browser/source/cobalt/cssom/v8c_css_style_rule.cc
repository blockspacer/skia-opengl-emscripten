...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSStyleRule is not constructible.");
}



void selectorTextAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCSSStyleRule::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CSSStyleRule* impl =
      wrapper_private->wrappable<CSSStyleRule>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSStyleRule"));
...

  {
    ...
    static_assert(
        std::is_base_of<CSSRule, CSSStyleRule>::value,
        "Expected CSSStyleRule to have C++ parent class "
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, selectorTextAttributeGetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSStyleRule"),
...
v8::Local<v8::Object> V8cCSSStyleRule::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSStyleRule::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
