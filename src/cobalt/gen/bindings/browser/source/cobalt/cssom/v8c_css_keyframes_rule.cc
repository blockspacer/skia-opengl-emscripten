...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "CSSKeyframesRule is not constructible.");
}
...
void nameAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cCSSKeyframesRule::GetTemplate(isolate)->HasInstance(object)) {
  ...
  CSSKeyframesRule* impl =
      wrapper_private->wrappable<CSSKeyframesRule>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "CSSKeyframesRule"));
...

  {
    ...
    static_assert(
        std::is_base_of<CSSRule, CSSKeyframesRule>::value,
        "Expected CSSKeyframesRule to have C++ parent class "
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "CSSKeyframesRule"),
...
v8::Local<v8::Object> V8cCSSKeyframesRule::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cCSSKeyframesRule::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
