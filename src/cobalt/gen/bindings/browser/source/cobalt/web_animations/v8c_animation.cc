...
void effectAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Animation,
                                                    V8cAnimation>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Animation* impl,
...
void effectAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<Animation, V8cAnimation>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Animation* impl,
...
void cancelMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!script::v8c::shared_bindings::object_implements_interface(V8cAnimation::GetTemplate(isolate), isolate, object)) {
    return;
  }
  V8cExceptionState exception_state{isolate};
  v8::Local<v8::Value> result_value;
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "effect"
                  ,effectAttributeGetter
                  ,effectAttributeSetter
                  );
  ...
  }
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "startTime"
                  ,startTimeAttributeGetter
                  ,startTimeAttributeSetter
                  );
