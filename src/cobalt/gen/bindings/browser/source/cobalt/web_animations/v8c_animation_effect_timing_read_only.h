...
#ifndef V8cAnimationEffectTimingReadOnly_h
#define V8cAnimationEffectTimingReadOnly_h
...
class V8cAnimationEffectTimingReadOnly {
 public:
...
#endif  // V8cAnimationEffectTimingReadOnly_h
