...
void delayAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<AnimationEffectTimingReadOnly,
                                                    V8cAnimationEffectTimingReadOnly>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AnimationEffectTimingReadOnly* impl,
