...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "AnimationEffectReadOnly is not constructible.");
}
...
void timingAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cAnimationEffectReadOnly::GetTemplate(isolate)->HasInstance(object)) {
  ...
  AnimationEffectReadOnly* impl =
      wrapper_private->wrappable<AnimationEffectReadOnly>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "AnimationEffectReadOnly"));
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "AnimationEffectReadOnly"),
...
v8::Local<v8::Object> V8cAnimationEffectReadOnly::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cAnimationEffectReadOnly::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
