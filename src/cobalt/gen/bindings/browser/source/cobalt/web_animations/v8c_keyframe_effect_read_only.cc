...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "KeyframeEffectReadOnly is not constructible.");
}
...
void targetAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cKeyframeEffectReadOnly::GetTemplate(isolate)->HasInstance(object)) {
  ...
  KeyframeEffectReadOnly* impl =
      wrapper_private->wrappable<KeyframeEffectReadOnly>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "KeyframeEffectReadOnly"));
...

  {
    ...
    // inherited interface.
    v8::Local<v8::FunctionTemplate> parent_template = V8cAnimationEffectReadOnly::GetTemplate(isolate);
    function_template->Inherit(parent_template);
    static_assert(
        std::is_base_of<AnimationEffectReadOnly, KeyframeEffectReadOnly>::value,
        "Expected KeyframeEffectReadOnly to have C++ parent class "
        "AnimationEffectReadOnly, because that is its WebIDL parent.");
  }
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "KeyframeEffectReadOnly"),
...
v8::Local<v8::Object> V8cKeyframeEffectReadOnly::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cKeyframeEffectReadOnly::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
