...
const int kInterfaceUniqueId = 125;
...
void targetAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<KeyframeEffectReadOnly,
                                                    V8cKeyframeEffectReadOnly>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, KeyframeEffectReadOnly* impl,
