...
void currentTimeAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<AnimationTimeline,
                                                    V8cAnimationTimeline>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, AnimationTimeline* impl,
