...
void offsetAttributeGetter(
  ...
  script::v8c::shared_bindings::AttributeGetterImpl<Keyframe,
                                                    V8cKeyframe>(
                    info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Keyframe* impl,
...
void offsetAttributeSetter(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  script::v8c::shared_bindings::AttributeSetterImpl<Keyframe, V8cKeyframe>(info,
                    false,
                    false,
                    [](v8::Isolate* isolate, Keyframe* impl,
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  // follows:
  {
    ...
    // true otherwise;
                  ...
                  prototype_template,
                  "offset"
                  ,offsetAttributeGetter
                  ,offsetAttributeSetter
                  );
