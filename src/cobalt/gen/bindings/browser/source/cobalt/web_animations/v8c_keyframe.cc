...
void DummyConstructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  exception.SetSimpleException(
      script::kTypeError, "Keyframe is not constructible.");
}



void offsetAttributeGetter(
  ...
  if (!WrapperPrivate::HasWrapperPrivate(object) ||
      !V8cKeyframe::GetTemplate(isolate)->HasInstance(object)) {
  ...
  Keyframe* impl =
      wrapper_private->wrappable<Keyframe>().get();
...
void InitializeTemplate(v8::Isolate* isolate) {
  ...
  v8::Local<v8::FunctionTemplate> function_template =
      v8::FunctionTemplate::New(
          ...
          0);
  function_template->SetClassName(NewInternalString(isolate, "Keyframe"));
  ...
  // follows:
  {
    ...
    v8::Local<v8::FunctionTemplate> getter =
        v8::FunctionTemplate::New(isolate, offsetAttributeGetter);
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, offsetAttributeSetter);
  ...
  }
  {
    ...
    v8::Local<v8::FunctionTemplate> setter =
        v8::FunctionTemplate::New(isolate, easingAttributeSetter);
  ...
  prototype_template->Set(
      ...
      NewInternalString(isolate, "Keyframe"),
...
v8::Local<v8::Object> V8cKeyframe::CreateWrapper(
...
v8::Local<v8::FunctionTemplate> V8cKeyframe::GetTemplate(v8::Isolate* isolate) {
  V8cGlobalEnvironment* global_environment = V8cGlobalEnvironment::GetFromIsolate(isolate);
  if (!global_environment->HasInterfaceData(kInterfaceUniqueId)) {
    InitializeTemplate(isolate);
  }
