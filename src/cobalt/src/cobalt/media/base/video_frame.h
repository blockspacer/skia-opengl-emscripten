...
class MEDIA_EXPORT VideoFrame : public base::RefCountedThreadSafe<VideoFrame> {
 public:
  ...
  static scoped_refptr<VideoFrame> CreateColorFrame(const cobalt::math::Size& size,
                                                    uint8_t y, uint8_t u,
                                                    uint8_t v,
                                                    base::TimeDelta timestamp);
  ...
  static scoped_refptr<VideoFrame> CreateBlackFrame(const cobalt::math::Size& size);
  ...
  // Returns the plane cobalt::math::Size (in bytes) for a plane of the given coded size
  // and format.
  static cobalt::math::Size PlaneSize(VideoPixelFormat format, size_t plane,
                             const cobalt::math::Size& coded_size);
  ...
  gfx::CbColorSpace ColorSpace() const;
  void set_color_space(const gfx::CbColorSpace& color_space);

  VideoPixelFormat format() const { return format_; }
  StorageType storage_type() const { return storage_type_; }

  const cobalt::math::Size& coded_size() const { return coded_size_; }
  const cobalt::math::Rect& visible_rect() const { return visible_rect_; }
  const cobalt::math::Size& natural_size() const { return natural_size_; }
 ...
 protected:
  ...
  static cobalt::math::Size DetermineAlignedSize(VideoPixelFormat format,
 ...
 private:
  ...
  static cobalt::math::Size SampleSize(VideoPixelFormat format, size_t plane);
  ...
  static cobalt::math::Size CommonAlignment(VideoPixelFormat format);
  ...
  const cobalt::math::Size coded_size_;
