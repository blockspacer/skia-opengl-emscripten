...
typedef base::Callback<void(base::CobToken type, const dom::KeyboardEventInit&)>
...
class KeyEventHandler {
 public:
  ...
  virtual void HandleKeyboardEvent(base::CobToken type,
 ...
 protected:
  ...
  void DispatchKeyboardEvent(base::CobToken type,
