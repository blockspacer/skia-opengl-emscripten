...
#include "starboard/win/x64x11/system_get_property_impl.h"
...
const char* kFriendlyName = "win Desktop";
const char* kPlatformName = "X11; win x86_64";
...
// Omit namespace win due to symbol name conflict.
namespace starboard {
namespace x64x11 {
