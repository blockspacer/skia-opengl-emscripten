...
#include "renderer_stub/backend/display_stub.h"
#include "renderer_stub/backend/graphics_context_stub.h"
...
class GraphicsSystemStub : public GraphicsSystem {
 public:
  std::unique_ptr<Display> CreateDisplay(
    ...
    return std::unique_ptr<Display>(new DisplayStub(system_window->GetWindowSize()));
  }
