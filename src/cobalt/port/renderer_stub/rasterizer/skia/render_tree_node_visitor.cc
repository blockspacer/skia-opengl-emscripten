...
///#include "renderer_stub/rasterizer/skia/skia/src/effects/SkYUV2RGBShader.h"
    ...
    if (image) {
      sk_sp<SkShader> image_shader =
          ...
          image->makeShader(SkTileMode::kRepeat,
                            SkTileMode::kRepeat, &skia_local_transform);
...
void SkiaBrushVisitor::Visit(
  ...
  sk_sp<SkShader> shader(SkGradientShader::MakeLinear(
      ...
      linear_gradient_brush->color_stops().size(),
...
void SkiaBrushVisitor::Visit(
  ...
  sk_sp<SkShader> shader(SkGradientShader::MakeRadial(
      ...
      radial_gradient_brush->color_stops().size(),
      //SkShader::kClamp_TileMode,
      SkTileMode::kClamp,
