...
// TODO: OnPaintLayer
class component_node_ContainerView :
  public views::View,
 ...
 public:
  ...
  explicit component_node_ContainerView(
 ...
 public:
  ...
  ComponentNode* m_ComponentNode = nullptr;

  // TODO: AddStyleRange

  DISALLOW_COPY_AND_ASSIGN(component_node_ContainerView);
};
