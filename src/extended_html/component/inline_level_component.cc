...
InlineLevelComponent::InlineLevelComponent(
...
Box::Level InlineLevelComponent::GetLevel() const { return kInlineLevel; }

bool InlineLevelComponent::DoesFulfillEllipsisPlacementRequirement() const {
...
void InlineLevelComponent::DoPreEllipsisPlacementProcessing() {
  was_hidden_by_ellipsis_ = is_hidden_by_ellipsis_;
  is_hidden_by_ellipsis_ = false;
}

void InlineLevelComponent::DoPostEllipsisPlacementProcessing() {
  if (was_hidden_by_ellipsis_ != is_hidden_by_ellipsis_) {
    InvalidateRenderTreeNodesOfBoxAndAncestors();
  }
}

bool InlineLevelComponent::IsHiddenByEllipsis() const {
  return is_hidden_by_ellipsis_;
}

void InlineLevelComponent::UpdateHorizontalMargins(
...
void InlineLevelComponent::DumpClassName(std::ostream* stream) const {
  *stream << "InlineLevelComponent ";
}

#endif  // COBALT_BOX_DUMP_ENABLED

void InlineLevelComponent::DoPlaceEllipsisOrProcessPlacedEllipsis(
