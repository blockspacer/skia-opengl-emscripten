...
// not in spec
class ComponentNode final : public CustomNode {
 public:
  ...
  explicit ComponentNode(Args&&... args) : data_(std::forward<Args>(args)...) {}
  ...
  base::TypeId GetTypeId() const override {
    return base::GetTypeId<ComponentNode>();
  }

  const Builder& data() const override { return data_; }

  /*ComponentNode* CreateWithBuilder(ComponentNode::Builder builder) override {
    return new ComponentNode(builder);
  }*/

  void SetCustomGeneratingNode(HTMLComponentElement* custom_generating_node);

 public: // TODO
  //cobalt::layout::Component* custom_generating_node_ = nullptr;
