...
class InputBoxGenerator : public cobalt::cssom::NotReachedPropertyValueVisitor {
 public:
  InputBoxGenerator(const scoped_refptr<cobalt::cssom::CSSComputedStyleDeclaration>&
                           css_computed_style_declaration,
                       //const InputBox::GetInputBoxAnimCB& replace_input_animation_cb,
                       const scoped_refptr<cobalt::layout::Paragraph>& paragraph,
                       int32 text_position,
  ...
  const scoped_refptr<cobalt::layout::InputBox>& input_box() { return input_box_; }
 ...
 private:
  ...
  const scoped_refptr<cobalt::layout::Paragraph> paragraph_;
  ...
  scoped_refptr<cobalt::layout::InputBox> input_box_;
};
