...
## TODO ## add_mojo_prefixes_3(${CUR_OUT_DIR}badging/badging "COLLECTED_MOJO_SOURCES")
if(ENABLE_GNET)
...
## TODO ## add_mojo_prefixes_3(${CUR_OUT_DIR}commit_result/commit_result "COLLECTED_MOJO_SOURCES")
## TODO ## add_mojo_prefixes_3(${CUR_OUT_DIR}contacts/contacts_manager "COLLECTED_MOJO_SOURCES")
if(ENABLE_GNET)
...
## TODO ## add_mojo_prefixes_3(${CUR_OUT_DIR}locks/lock_manager "COLLECTED_MOJO_SOURCES")
if(ENABLE_GNET)
...
target_link_libraries(BLINK_PUBLIC_MOJOM PRIVATE
  #public_deps = [
