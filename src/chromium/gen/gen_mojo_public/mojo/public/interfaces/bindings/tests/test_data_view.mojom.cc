...
TestStruct::TestStruct(
    ...
    const std::vector<bool>& f_bool_array_in,
    const std::vector<int32_t>& f_int32_array_in,
    const std::vector<TestEnum>& f_enum_array_in,
    std::vector<mojo::PendingRemote<TestInterface>> f_interface_array_in,
    const std::vector<std::vector<int32_t>>& f_nested_array_in,
