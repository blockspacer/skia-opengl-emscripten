...
#define GPU_DRIVER_BUG_WORKAROUNDS(GPU_OP)                                  \
  ...
  GPU_OP(CLAMP_TEXTURE_BASE_LEVEL_AND_MAX_LEVEL,                            \
  ...
  GPU_OP(DISABLE_DIRECT_COMPOSITION_LAYERS,                                 \
  ...
  GPU_OP(DISABLE_ES3_GL_CONTEXT_FOR_TESTING,                                \
  ...
  GPU_OP(USE_ES2_FOR_OOPR,                                                  \
         use_es2_for_oopr)                                                  \
  GPU_OP(USE_FRAMEBUFFER_CMAA,                                              \
