...
class BLINK_COMMON_EXPORT DevToolsAgentHost
 ...
 public:
  ...
  virtual void ChildWorkerCreated(DevToolsAgentPtr worker_devtools_agent, DevToolsAgentHostRequest worker_devtools_agent_host, const GURL& url, const std::string& name, const base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger) = 0;
};
...
class BLINK_COMMON_EXPORT DevToolsSession
 ...
 public:
  ...
  virtual void DispatchProtocolCommand(int32_t call_id, const std::string& method, DevToolsMessagePtr message) = 0;
};
...
class BLINK_COMMON_EXPORT DevToolsAgentHostProxy
 ...
 public:
  ...
  void ChildWorkerCreated(DevToolsAgentPtr worker_devtools_agent, DevToolsAgentHostRequest worker_devtools_agent_host, const GURL& url, const std::string& name, const base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger) final;
...
class BLINK_COMMON_EXPORT DevToolsSessionProxy
 ...
 public:
  ...
  void DispatchProtocolCommand(int32_t call_id, const std::string& method, DevToolsMessagePtr message) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DevToolsMessage::DataView, std::vector<uint8_t>>(input);
  }
...
class BLINK_COMMON_EXPORT DevToolsSessionState {
 public:
  ...
  explicit DevToolsSessionState(
      const base::flat_map<std::string, base::Optional<std::vector<uint8_t>>>& entries);
  ...
  base::flat_map<std::string, base::Optional<std::vector<uint8_t>>> entries;
