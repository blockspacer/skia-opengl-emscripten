...
#include "services/viz/public/interfaces/compositing/surface_id.mojom-forward.h"
...
class BLINK_COMMON_EXPORT PictureInPictureDelegate
 ...
 public:
  ...
  virtual void PictureInPictureWindowSizeChanged(const gfx::Size& size) = 0;
};
...
class BLINK_COMMON_EXPORT PictureInPictureService
 ...
 public:
  ...
  using StartSessionCallback = base::OnceCallback<void(const gfx::Size&)>;
  
  virtual void StartSession(uint32_t player_id, const base::Optional<viz::SurfaceId>& surface_id, const gfx::Size& natural_size, bool show_play_pause_button, bool show_mute_button, StartSessionCallback callback) = 0;
  ...
  virtual void UpdateSession(uint32_t player_id, const base::Optional<viz::SurfaceId>& surface_id, const gfx::Size& natural_size, bool show_play_pause_button, bool show_mute_button) = 0;

  
  virtual void SetDelegate(PictureInPictureDelegatePtr delegate) = 0;
};

class BLINK_COMMON_EXPORT PictureInPictureDelegateProxy
 ...
 public:
  ...
  void PictureInPictureWindowSizeChanged(const gfx::Size& size) final;
...
class BLINK_COMMON_EXPORT PictureInPictureServiceProxy
 ...
 public:
  ...
  void StartSession(uint32_t player_id, const base::Optional<viz::SurfaceId>& surface_id, const gfx::Size& natural_size, bool show_play_pause_button, bool show_mute_button, StartSessionCallback callback) final;
  void EndSession(EndSessionCallback callback) final;
  void UpdateSession(uint32_t player_id, const base::Optional<viz::SurfaceId>& surface_id, const gfx::Size& natural_size, bool show_play_pause_button, bool show_mute_button) final;
  void SetDelegate(PictureInPictureDelegatePtr delegate) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_COMMON_EXPORT PictureInPictureDelegateStubDispatch {
 public:
...
class BLINK_COMMON_EXPORT PictureInPictureDelegateRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
