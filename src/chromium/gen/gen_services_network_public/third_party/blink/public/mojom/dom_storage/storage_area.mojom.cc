...
bool StorageArea::GetAll(StorageAreaGetAllCallbackAssociatedPtrInfo complete_callback, bool* out_success, std::vector<KeyValuePtr>* out_data) {
  NOTREACHED();
  return false;
}
...
class StorageArea_GetAll_HandleSyncResponse
 ...
 public:
  StorageArea_GetAll_HandleSyncResponse(
      bool* result, bool* out_success, std::vector<KeyValuePtr>* out_data)
...
bool StorageAreaProxy::GetAll(
    StorageAreaGetAllCallbackAssociatedPtrInfo param_complete_callback, bool* out_param_success, std::vector<KeyValuePtr>* out_param_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class StorageArea_GetAll_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_success, std::vector<KeyValuePtr> in_data);
