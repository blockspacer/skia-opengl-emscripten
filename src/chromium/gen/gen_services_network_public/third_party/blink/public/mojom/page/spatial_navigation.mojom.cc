...
#include "third_party/blink/public/mojom/page/spatial_navigation.mojom-import-headers.h"


#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_PAGE_SPATIAL_NAVIGATION_MOJOM_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_PAGE_SPATIAL_NAVIGATION_MOJOM_JUMBO_H_
#endif
namespace blink {
namespace mojom {
...
size_t SpatialNavigationState::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->can_exit_focus);
  seed = mojo::internal::Hash(seed, this->can_select_element);
  seed = mojo::internal::Hash(seed, this->has_next_form_element);
  seed = mojo::internal::Hash(seed, this->has_default_video_controls);
  return seed;
}
...
// static
bool StructTraits<::blink::mojom::SpatialNavigationState::DataView, ::blink::mojom::SpatialNavigationStatePtr>::Read(
    ::blink::mojom::SpatialNavigationState::DataView input,
    ::blink::mojom::SpatialNavigationStatePtr* output) {
  bool success = true;
  ::blink::mojom::SpatialNavigationStatePtr result(::blink::mojom::SpatialNavigationState::New());
