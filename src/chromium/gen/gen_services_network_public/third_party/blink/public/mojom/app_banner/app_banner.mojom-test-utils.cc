...
void AppBannerControllerInterceptorForTesting::BannerPromptRequest(AppBannerServicePtr service, AppBannerEventRequest event, const std::vector<std::string>& platform, bool require_gesture, BannerPromptRequestCallback callback) {
