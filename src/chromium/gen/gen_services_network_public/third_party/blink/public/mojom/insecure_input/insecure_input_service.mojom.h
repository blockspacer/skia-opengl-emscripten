...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_INSECURE_INPUT_INSECURE_INPUT_SERVICE_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_INSECURE_INPUT_INSECURE_INPUT_SERVICE_MOJOM_H_
...
class BLINK_COMMON_EXPORT InsecureInputService
...
class BLINK_COMMON_EXPORT InsecureInputServiceProxy
...
class BLINK_COMMON_EXPORT InsecureInputServiceStubDispatch {
 public:
...
class BLINK_COMMON_EXPORT InsecureInputServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_INSECURE_INPUT_INSECURE_INPUT_SERVICE_MOJOM_H_