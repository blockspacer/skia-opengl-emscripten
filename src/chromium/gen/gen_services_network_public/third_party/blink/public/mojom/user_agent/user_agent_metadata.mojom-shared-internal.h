...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) UserAgentMetadata_Data {
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(UserAgentMetadata_Data));
      new (data()) UserAgentMetadata_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    UserAgentMetadata_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<UserAgentMetadata_Data>(index_);
    }
    UserAgentMetadata_Data* operator->() { return data(); }
  ...
  mojo::internal::Pointer<mojo::internal::String_Data> major_version;
...
static_assert(sizeof(UserAgentMetadata_Data) == 56,
...
struct UserAgentMetadata_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    UserAgentMetadata_Data::BufferWriter writer;
