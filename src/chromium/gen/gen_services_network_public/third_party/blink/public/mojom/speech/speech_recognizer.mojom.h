...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StartSpeechRecognitionRequestParams::DataView,
  ...
  static  decltype(::blink::mojom::StartSpeechRecognitionRequestParams::session_request)& session_request(
  ...
  static const decltype(::blink::mojom::StartSpeechRecognitionRequestParams::origin)& origin(
      const ::blink::mojom::StartSpeechRecognitionRequestParamsPtr& input) {
    return input->origin;
  }
