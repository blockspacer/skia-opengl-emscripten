...
#include "media/mojo/interfaces/video_encode_accelerator.mojom-import-headers.h"
...
VideoBitrateAllocation::VideoBitrateAllocation(
    const std::vector<int32_t>& bitrates_in)
...
bool VideoEncodeAccelerator::Initialize(const media::VideoEncodeAccelerator::Config& config, VideoEncodeAcceleratorClientPtr client, bool* out_result) {
  NOTREACHED();
  return false;
}
...
bool VideoEncodeAcceleratorProxy::Initialize(
    const media::VideoEncodeAccelerator::Config& param_config, VideoEncodeAcceleratorClientPtr param_client, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void VideoEncodeAcceleratorProxy::Initialize(
    const media::VideoEncodeAccelerator::Config& in_config, VideoEncodeAcceleratorClientPtr in_client, InitializeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::VideoEncodeAccelerator::Initialize");
#endif
  const bool kExpectsResponse = true;
