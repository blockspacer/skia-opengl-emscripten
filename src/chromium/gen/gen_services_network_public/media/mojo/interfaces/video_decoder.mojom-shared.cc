...
bool SupportedVideoDecoderConfig_Data::Validate(
  ...
  const SupportedVideoDecoderConfig_Data* object = static_cast<const SupportedVideoDecoderConfig_Data*>(data);
...
bool VideoDecoder_GetSupportedConfigs_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoDecoder_GetSupportedConfigs_Params_Data* object = static_cast<const VideoDecoder_GetSupportedConfigs_Params_Data*>(data);
...
bool VideoDecoder_GetSupportedConfigs_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoDecoder_GetSupportedConfigs_ResponseParams_Data* object = static_cast<const VideoDecoder_GetSupportedConfigs_ResponseParams_Data*>(data);
...
bool VideoDecoder_Construct_Params_Data::Validate(
  ...
  if (!::media::mojom::internal::VideoDecoderImplementation_Data
        ::Validate(object->implementation, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->target_color_space, 7, validation_context)) {
    return false;
  }
...
bool VideoDecoderClient_OnWaiting_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoDecoderClient_OnWaiting_Params_Data* object = static_cast<const VideoDecoderClient_OnWaiting_Params_Data*>(data);
