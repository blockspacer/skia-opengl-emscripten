...
HttpAuthStaticParams::HttpAuthStaticParams(
    const std::vector<std::string>& supported_schemes_in,
...
HttpAuthDynamicParams::HttpAuthDynamicParams(
    const std::string& server_whitelist_in,
    const std::string& delegate_whitelist_in,
...
size_t HttpAuthDynamicParams::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->server_whitelist);
  seed = mojo::internal::Hash(seed, this->delegate_whitelist);
...
void NetworkServiceClientProxy::OnAuthRequired(
    uint32_t in_process_id, uint32_t in_routing_id, uint32_t in_request_id, const GURL& in_url, bool in_first_auth_attempt, const net::AuthChallengeInfo& in_auth_info, const base::Optional<network::ResourceResponseHead>& in_head, AuthChallengeResponderPtr in_auth_challenge_responder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceClientProxy::OnCertificateRequested(
    const base::Optional<base::UnguessableToken>& in_window_id, uint32_t in_process_id, uint32_t in_routing_id, uint32_t in_request_id, const scoped_refptr<net::SSLCertRequestInfo>& in_cert_info, OnCertificateRequestedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceClientProxy::OnSSLCertificateError(
    uint32_t in_process_id, uint32_t in_routing_id, const GURL& in_url, int32_t in_net_error, const net::SSLInfo& in_ssl_info, bool in_fatal, OnSSLCertificateErrorCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceClientProxy::OnFileUploadRequested(
    uint32_t in_process_id, bool in_async, const std::vector<base::FilePath>& in_file_paths, OnFileUploadRequestedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceClientProxy::OnCookieChange(
    int32_t in_process_id, int32_t in_routing_id, const GURL& in_url, const GURL& in_frame_url, const net::CanonicalCookie& in_cookie, bool in_blocked_by_policy) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceClientProxy::OnCookiesRead(
    int32_t in_process_id, int32_t in_routing_id, const GURL& in_url, const GURL& in_frame_url, const std::vector<net::CanonicalCookie>& in_cookie_list, bool in_blocked_by_policy) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class NetworkServiceClient_OnCertificateRequested_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const scoped_refptr<net::X509Certificate>& in_x509_certificate, const std::string& in_provider_name, const std::vector<uint16_t>& in_algorithm_preferences, SSLPrivateKeyPtr in_ssl_private_key, bool in_cancel_certificate_selection);
...
bool NetworkServiceClientStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kNetworkServiceClient_OnAuthRequired_Name: {
      ...
      base::Optional<network::ResourceResponseHead> p_head{};
...
std::move(p_blocked_by_policy));
    ...
    case internal::kNetworkServiceClient_OnCookiesRead_Name: {
      ...
      GURL p_url{};
      GURL p_frame_url{};
      std::vector<net::CanonicalCookie> p_cookie_list{};
      bool p_blocked_by_policy{};
...
void NetworkServiceProxy::StartNetLog(
    base::File in_file, ::network::mojom::NetLogCaptureMode in_capture_mode, base::Value in_constants) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::ConfigureStubHostResolver(
    bool in_stub_resolver_enabled, base::Optional<std::vector<::network::mojom::DnsOverHttpsServerPtr>> in_dns_over_https_servers) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::SetRawHeadersAccess(
    uint32_t in_process_id, const std::vector<url::Origin>& in_origins) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::GetNetworkQualityEstimatorManager(
    ::network::mojom::NetworkQualityEstimatorManagerRequest in_network_quality_estimator_manager) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::GetDnsConfigChangeManager(
    ::network::mojom::DnsConfigChangeManagerRequest in_dns_config_change_manager) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::UpdateCRLSet(
    base::span<const uint8_t> in_crl_set) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_network_change_manager));
    ...
    case internal::kNetworkService_GetNetworkQualityEstimatorManager_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::network::mojom::NetworkQualityEstimatorManagerRequest p_network_quality_estimator_manager{};
...
std::move(p_network_quality_estimator_manager));
    ...
    case internal::kNetworkService_GetDnsConfigChangeManager_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::network::mojom::DnsConfigChangeManagerRequest p_dns_config_change_manager{};
...
// static
bool StructTraits<::network::mojom::CryptConfig::DataView, ::network::mojom::CryptConfigPtr>::Read(
    ::network::mojom::CryptConfig::DataView input,
    ::network::mojom::CryptConfigPtr* output) {
  bool success = true;
  ::network::mojom::CryptConfigPtr result(::network::mojom::CryptConfig::New());
