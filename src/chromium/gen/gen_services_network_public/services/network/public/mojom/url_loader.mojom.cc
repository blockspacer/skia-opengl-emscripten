...
URLRequest::URLRequest(
    ...
    const GURL& url_in,
    const GURL& site_for_cookies_in,
    ...
    ::network::mojom::FetchRequestMode fetch_request_mode_in,
    ::network::mojom::FetchCredentialsMode fetch_credentials_mode_in,
    ::network::mojom::FetchRedirectMode fetch_redirect_mode_in,
    ...
    const base::Optional<std::string>& devtools_request_id_in)
...
DataElement::DataElement(
    ...
    ::network::mojom::DataPipeGetterPtrInfo data_pipe_getter_in,
    ::network::mojom::ChunkedDataPipeGetterPtrInfo chunked_data_pipe_getter_in,
    uint64_t offset_in,
    uint64_t length_in,
...
void URLLoaderProxy::FollowRedirect(
    const std::vector<std::string>& in_removed_headers, const net::HttpRequestHeaders& in_modified_headers, const base::Optional<GURL>& in_new_url) {
...
void URLLoaderClientProxy::OnReceiveResponse(
    const network::ResourceResponseHead& in_head) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
// static
bool StructTraits<::network::mojom::DataElement::DataView, ::network::mojom::DataElementPtr>::Read(
    ::network::mojom::DataElement::DataView input,
    ::network::mojom::DataElementPtr* output) {
  bool success = true;
  ::network::mojom::DataElementPtr result(::network::mojom::DataElement::New());
