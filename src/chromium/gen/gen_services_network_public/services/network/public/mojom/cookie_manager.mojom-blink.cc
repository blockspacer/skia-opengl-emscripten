...
CookieManagerParams::CookieManagerParams(
    ...
    const WTF::Vector<WTF::String>& secure_origin_cookies_allowed_schemes_in,
    const WTF::Vector<WTF::String>& matching_scheme_cookies_allowed_schemes_in,
    const WTF::Vector<WTF::String>& third_party_cookies_allowed_schemes_in,
...
CookieOptions::CookieOptions()
    : exclude_httponly(true),
      same_site_cookie_context(CookieSameSiteContext::CROSS_SITE),
...
CookieOptions::CookieOptions(
    ...
    CookieSameSiteContext same_site_cookie_context_in,
...
CookieWithStatus::CookieWithStatus(
    const ::blink::WebCanonicalCookie& cookie_in,
    CookieInclusionStatus status_in)
...
void CookieChangeListenerProxy::OnCookieChange(
    const ::blink::WebCanonicalCookie& in_cookie, CookieChangeCause in_cause) {
...
void CookieManagerProxy::SetCanonicalCookie(
    const ::blink::WebCanonicalCookie& in_cookie, const WTF::String& in_source_scheme, CookieOptionsPtr in_cookie_options, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CookieManagerProxy::DeleteCanonicalCookie(
    const ::blink::WebCanonicalCookie& in_cookie, DeleteCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class CookieManager_GetCookieList_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const WTF::Vector<::blink::WebCanonicalCookie>& in_cookies, WTF::Vector<CookieWithStatusPtr> in_excluded_cookies);
...
bool CookieManager_GetCookieList_ForwardToCallback::Accept(
  ...
  bool success = true;
  WTF::Vector<::blink::WebCanonicalCookie> p_cookies{};
  WTF::Vector<CookieWithStatusPtr> p_excluded_cookies{};
...
class CookieManager_SetCanonicalCookie_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      CookieInclusionStatus in_status);
...
bool CookieManager_SetCanonicalCookie_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  CookieInclusionStatus p_status{};
...
// static
bool StructTraits<::network::mojom::blink::CookieWithStatus::DataView, ::network::mojom::blink::CookieWithStatusPtr>::Read(
    ::network::mojom::blink::CookieWithStatus::DataView input,
    ::network::mojom::blink::CookieWithStatusPtr* output) {
  bool success = true;
  ::network::mojom::blink::CookieWithStatusPtr result(::network::mojom::blink::CookieWithStatus::New());
