...
bool ProxyConfigClient_FlushProxyConfig_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProxyConfigClient_FlushProxyConfig_Params_Data* object = static_cast<const ProxyConfigClient_FlushProxyConfig_Params_Data*>(data);
...
bool ProxyConfigClient_FlushProxyConfig_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProxyConfigClient_FlushProxyConfig_ResponseParams_Data* object = static_cast<const ProxyConfigClient_FlushProxyConfig_ResponseParams_Data*>(data);
...
bool ProxyErrorClient_OnPACScriptError_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProxyErrorClient_OnPACScriptError_Params_Data* object = static_cast<const ProxyErrorClient_OnPACScriptError_Params_Data*>(data);
...
bool ProxyErrorClient_OnRequestMaybeFailedDueToProxySettings_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProxyErrorClient_OnRequestMaybeFailedDueToProxySettings_Params_Data* object = static_cast<const ProxyErrorClient_OnRequestMaybeFailedDueToProxySettings_Params_Data*>(data);
