...
class  TCPBoundSocket
 ...
 public:
  ...
  using ConnectCallback = base::OnceCallback<void(int32_t, const base::Optional<net::IPEndPoint>&, const base::Optional<net::IPEndPoint>&, mojo::ScopedDataPipeConsumerHandle, mojo::ScopedDataPipeProducerHandle)>;
  
  virtual void Connect(const net::AddressList& remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, TCPConnectedSocketRequest socket, SocketObserverPtr observer, ConnectCallback callback) = 0;
};
...
class  TCPConnectedSocket
 ...
 public:
  ...
  using UpgradeToTLSCallback = base::OnceCallback<void(int32_t, mojo::ScopedDataPipeConsumerHandle, mojo::ScopedDataPipeProducerHandle, const base::Optional<net::SSLInfo>&)>;
  
  virtual void UpgradeToTLS(const net::HostPortPair& host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr options, const net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::TLSClientSocketRequest request, SocketObserverPtr observer, UpgradeToTLSCallback callback) = 0;
...
class  TCPBoundSocketProxy
 ...
 public:
  ...
  void Connect(const net::AddressList& remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, TCPConnectedSocketRequest socket, SocketObserverPtr observer, ConnectCallback callback) final;
...
class  TCPConnectedSocketProxy
 ...
 public:
  ...
  void UpgradeToTLS(const net::HostPortPair& host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr options, const net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::TLSClientSocketRequest request, SocketObserverPtr observer, UpgradeToTLSCallback callback) final;
