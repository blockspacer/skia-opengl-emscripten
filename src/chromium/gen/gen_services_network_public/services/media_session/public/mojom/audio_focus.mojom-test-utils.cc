...
void AudioFocusManagerInterceptorForTesting::RequestAudioFocus(AudioFocusRequestClientRequest client, ::media_session::mojom::MediaSessionPtr media_session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) {
...
void AudioFocusManagerInterceptorForTesting::SetSourceName(const std::string& name) {
