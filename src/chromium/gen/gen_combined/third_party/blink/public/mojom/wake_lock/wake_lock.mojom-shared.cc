...
// static
bool WakeLockService_GetWakeLock_Params_Data::Validate(
    const void* data,
  ...
  const WakeLockService_GetWakeLock_Params_Data* object = static_cast<const WakeLockService_GetWakeLock_Params_Data*>(data);
