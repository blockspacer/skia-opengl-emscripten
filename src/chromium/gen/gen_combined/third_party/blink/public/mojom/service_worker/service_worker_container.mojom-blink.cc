...
void ServiceWorkerContainerHostProxy::Register(
    const ::blink::KURL& in_script_url, ::blink::mojom::blink::ServiceWorkerRegistrationOptionsPtr in_options, RegisterCallback callback) {
...
void ServiceWorkerContainerHostProxy::EnsureControllerServiceWorker(
    ::blink::mojom::blink::ControllerServiceWorkerRequest in_controller, ControllerServiceWorkerPurpose in_purpose) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool ServiceWorkerContainerHostStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kServiceWorkerContainerHost_EnsureControllerServiceWorker_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::blink::ControllerServiceWorkerRequest p_controller{};
