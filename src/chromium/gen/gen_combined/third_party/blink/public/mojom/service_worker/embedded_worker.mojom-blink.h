...
class CORE_EXPORT EmbeddedWorkerStartParams {
 public:
  ...
  EmbeddedWorkerStartParams(
      ...
      ::blink::mojom::blink::ServiceWorkerRequest service_worker_request,
      ::blink::mojom::blink::ControllerServiceWorkerRequest controller_request,
      ...
      ::blink::mojom::blink::WorkerContentSettingsProxyPtrInfo content_settings_proxy,
      ::blink::mojom::blink::RendererPreferenceWatcherRequest preference_watcher_request,
...
struct CORE_EXPORT StructTraits<::blink::mojom::blink::EmbeddedWorkerStartParams::DataView,
  ...
  static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::worker_devtools_agent_route_id) worker_devtools_agent_route_id(
      const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input) {
  ...
  static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::v8_cache_options) v8_cache_options(
      const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input) {
  ...
  static  decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::service_worker_request)& service_worker_request(
       ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input) {
    return input->service_worker_request;
  }

  static  decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::controller_request)& controller_request(
       ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input) {
  ...
  static  decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::preference_watcher_request)& preference_watcher_request(
       ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input) {
