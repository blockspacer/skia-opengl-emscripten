...
PluginMimeType::PluginMimeType(
    ...
    const std::vector<std::string>& file_extensions_in)
...
PluginInfo::PluginInfo(
    ...
    std::vector<PluginMimeTypePtr> mime_types_in,
...
bool PluginRegistry::GetPlugins(bool refresh, const url::Origin& main_frame_origin, std::vector<PluginInfoPtr>* out_plugins) {
  NOTREACHED();
  return false;
}
class PluginRegistry_GetPlugins_HandleSyncResponse
 ...
 public:
  PluginRegistry_GetPlugins_HandleSyncResponse(
      bool* result, std::vector<PluginInfoPtr>* out_plugins)
 ...
 private:
  bool* result_;
  std::vector<PluginInfoPtr>* out_plugins_;DISALLOW_COPY_AND_ASSIGN(PluginRegistry_GetPlugins_HandleSyncResponse);
};
...
bool PluginRegistryProxy::GetPlugins(
    bool param_refresh, const url::Origin& param_main_frame_origin, std::vector<PluginInfoPtr>* out_param_plugins) {
...
void PluginRegistryProxy::GetPlugins(
    bool in_refresh, const url::Origin& in_main_frame_origin, GetPluginsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::PluginRegistry::GetPlugins");
#endif
  const bool kExpectsResponse = true;
...
class PluginRegistry_GetPlugins_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<PluginInfoPtr> in_plugins);
...
bool StructTraits<::blink::mojom::PluginMimeType::DataView, ::blink::mojom::PluginMimeTypePtr>::Read(
    ::blink::mojom::PluginMimeType::DataView input,
    ::blink::mojom::PluginMimeTypePtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::PluginInfo::DataView, ::blink::mojom::PluginInfoPtr>::Read(
    ::blink::mojom::PluginInfo::DataView input,
    ::blink::mojom::PluginInfoPtr* output) {
  bool success = true;
