...
#include "third_party/blink/public/mojom/appcache/appcache_info.mojom-blink-import-headers.h"
#include "mojo/public/cpp/bindings/lib/wtf_serialization.h"


#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_APPCACHE_APPCACHE_INFO_MOJOM_BLINK_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_APPCACHE_APPCACHE_INFO_MOJOM_BLINK_JUMBO_H_
...
AppCacheInfo::AppCacheInfo(
    const ::blink::KURL& manifest_url_in,
...
// static
bool StructTraits<::blink::mojom::blink::AppCacheInfo::DataView, ::blink::mojom::blink::AppCacheInfoPtr>::Read(
    ::blink::mojom::blink::AppCacheInfo::DataView input,
    ::blink::mojom::blink::AppCacheInfoPtr* output) {
  bool success = true;
  ::blink::mojom::blink::AppCacheInfoPtr result(::blink::mojom::blink::AppCacheInfo::New());
