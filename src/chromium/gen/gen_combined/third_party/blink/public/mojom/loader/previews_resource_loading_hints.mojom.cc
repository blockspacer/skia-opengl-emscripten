...
#include "third_party/blink/public/mojom/loader/previews_resource_loading_hints.mojom-import-headers.h"
...
PreviewsResourceLoadingHints::PreviewsResourceLoadingHints(
    ...
    const std::vector<std::string>& subresources_to_block_in)
...
// static
bool StructTraits<::blink::mojom::PreviewsResourceLoadingHints::DataView, ::blink::mojom::PreviewsResourceLoadingHintsPtr>::Read(
    ::blink::mojom::PreviewsResourceLoadingHints::DataView input,
    ::blink::mojom::PreviewsResourceLoadingHintsPtr* output) {
  bool success = true;
  ::blink::mojom::PreviewsResourceLoadingHintsPtr result(::blink::mojom::PreviewsResourceLoadingHints::New());
