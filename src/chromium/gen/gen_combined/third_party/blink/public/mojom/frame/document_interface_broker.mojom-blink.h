...
class PLATFORM_EXPORT DocumentInterfaceBroker
 ...
 public:
  ...
  virtual void GetAudioContextManager(::blink::mojom::blink::AudioContextManagerRequest request) = 0;

  
  virtual void GetAuthenticator(::blink::mojom::blink::AuthenticatorRequest request) = 0;

  
  virtual void GetCredentialManager(::blink::mojom::blink::CredentialManagerRequest request) = 0;

  
  virtual void GetFrameHostTestInterface(::blink::mojom::blink::FrameHostTestInterfaceRequest request) = 0;

  
  virtual void GetVirtualAuthenticatorManager(::blink::test::mojom::blink::VirtualAuthenticatorManagerRequest request) = 0;
};
...
class PLATFORM_EXPORT DocumentInterfaceBrokerProxy
 ...
 public:
  ...
  void GetAudioContextManager(::blink::mojom::blink::AudioContextManagerRequest request) final;
  void GetAuthenticator(::blink::mojom::blink::AuthenticatorRequest request) final;
  void GetCredentialManager(::blink::mojom::blink::CredentialManagerRequest request) final;
  void GetFrameHostTestInterface(::blink::mojom::blink::FrameHostTestInterfaceRequest request) final;
  void GetVirtualAuthenticatorManager(::blink::test::mojom::blink::VirtualAuthenticatorManagerRequest request) final;
