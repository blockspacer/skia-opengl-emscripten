...
class PLATFORM_EXPORT WebUsbService
 ...
 public:
  ...
  virtual void GetDevice(const WTF::String& guid, ::device::mojom::blink::UsbDeviceRequest device_requestd) = 0;
...
class PLATFORM_EXPORT WebUsbServiceProxy
 ...
 public:
  ...
  void GetDevice(const WTF::String& guid, ::device::mojom::blink::UsbDeviceRequest device_requestd) final;
