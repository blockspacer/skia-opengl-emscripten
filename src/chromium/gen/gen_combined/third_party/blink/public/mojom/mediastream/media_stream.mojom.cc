...
MediaStreamDevice::MediaStreamDevice(
    blink::MediaStreamType type_in,
    const std::string& id_in,
    media::VideoFacingMode video_facing_in,
    const base::Optional<std::string>& group_id_in,
    const base::Optional<std::string>& matched_output_device_id_in,
...
TrackControls::TrackControls(
    bool requested_in,
    blink::MediaStreamType stream_type_in,
...
void MediaStreamDispatcherHostProxy::GenerateStream(
    int32_t in_request_id, const blink::StreamControls& in_controls, bool in_user_gesture, GenerateStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::OpenDevice(
    int32_t in_request_id, const std::string& in_device_id, blink::MediaStreamType in_type, OpenDeviceCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::SetCapturingLinkSecured(
    int32_t in_session_id, blink::MediaStreamType in_type, bool in_is_secure) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class MediaStreamDispatcherHost_GenerateStream_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      blink::MediaStreamRequestResult in_result, const std::string& in_label, const std::vector<blink::MediaStreamDevice>& in_audio_devices, const std::vector<blink::MediaStreamDevice>& in_video_devices);
...
bool MediaStreamDispatcherHost_GenerateStream_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  blink::MediaStreamRequestResult p_result{};
  std::string p_label{};
  std::vector<blink::MediaStreamDevice> p_audio_devices{};
  std::vector<blink::MediaStreamDevice> p_video_devices{};
