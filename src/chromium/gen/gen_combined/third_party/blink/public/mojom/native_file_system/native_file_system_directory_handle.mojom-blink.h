...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_NATIVE_FILE_SYSTEM_NATIVE_FILE_SYSTEM_DIRECTORY_HANDLE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_NATIVE_FILE_SYSTEM_NATIVE_FILE_SYSTEM_DIRECTORY_HANDLE_MOJOM_BLINK_H_
...
class PLATFORM_EXPORT NativeFileSystemDirectoryHandle
 ...
 public:
  ...
  using GetFileCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, ::blink::mojom::blink::NativeFileSystemFileHandlePtr)>;
  
  virtual void GetFile(const WTF::String& name, bool create, GetFileCallback callback) = 0;


  using GetDirectoryCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, NativeFileSystemDirectoryHandlePtr)>;
  
  virtual void GetDirectory(const WTF::String& name, bool create, GetDirectoryCallback callback) = 0;


  using GetEntriesCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, WTF::Vector<NativeFileSystemEntryPtr>)>;
  
  virtual void GetEntries(GetEntriesCallback callback) = 0;


  using MoveFromCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, NativeFileSystemEntryPtr)>;
  
  virtual void MoveFrom(::blink::mojom::blink::NativeFileSystemTransferTokenPtr source, const WTF::String& name, MoveFromCallback callback) = 0;


  using CopyFromCallback = base::OnceCallback<void(::blink::mojom::blink::NativeFileSystemErrorPtr, NativeFileSystemEntryPtr)>;
  
  virtual void CopyFrom(::blink::mojom::blink::NativeFileSystemTransferTokenPtr source, const WTF::String& name, CopyFromCallback callback) = 0;
...
class PLATFORM_EXPORT NativeFileSystemDirectoryHandleProxy
 ...
 public:
  ...
  void GetFile(const WTF::String& name, bool create, GetFileCallback callback) final;
  void GetDirectory(const WTF::String& name, bool create, GetDirectoryCallback callback) final;
  void GetEntries(GetEntriesCallback callback) final;
  void MoveFrom(::blink::mojom::blink::NativeFileSystemTransferTokenPtr source, const WTF::String& name, MoveFromCallback callback) final;
  void CopyFrom(::blink::mojom::blink::NativeFileSystemTransferTokenPtr source, const WTF::String& name, CopyFromCallback callback) final;
...
class PLATFORM_EXPORT NativeFileSystemDirectoryHandleStubDispatch {
 public:
...
class PLATFORM_EXPORT NativeFileSystemDirectoryHandleRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT NativeFileSystemDirectoryHandleResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class PLATFORM_EXPORT NativeFileSystemHandle {
 public:
  ...
  NewFile(
      ::blink::mojom::blink::NativeFileSystemFileHandlePtrInfo file) {
  ...
  ::blink::mojom::blink::NativeFileSystemFileHandlePtrInfo& get_file() const {
...
class PLATFORM_EXPORT NativeFileSystemEntry {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        NativeFileSystemEntry::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::NativeFileSystemEntry::DataView,
                                         ::blink::mojom::blink::NativeFileSystemEntryPtr> {
  static bool IsNull(const ::blink::mojom::blink::NativeFileSystemEntryPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::NativeFileSystemEntryPtr* output) { output->reset(); }

  static  decltype(::blink::mojom::blink::NativeFileSystemEntry::entry_handle)& entry_handle(
       ::blink::mojom::blink::NativeFileSystemEntryPtr& input) {
    return input->entry_handle;
  }

  static const decltype(::blink::mojom::blink::NativeFileSystemEntry::name)& name(
      const ::blink::mojom::blink::NativeFileSystemEntryPtr& input) {
    return input->name;
  }

  static bool Read(::blink::mojom::blink::NativeFileSystemEntry::DataView input, ::blink::mojom::blink::NativeFileSystemEntryPtr* output);
};


template <>
struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::NativeFileSystemHandle::DataView,
                                        ::blink::mojom::blink::NativeFileSystemHandlePtr> {
  static bool IsNull(const ::blink::mojom::blink::NativeFileSystemHandlePtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::NativeFileSystemHandlePtr* output) { output->reset(); }

  static ::blink::mojom::blink::NativeFileSystemHandle::Tag GetTag(const ::blink::mojom::blink::NativeFileSystemHandlePtr& input) {
    return input->which();
  }

  static  ::blink::mojom::blink::NativeFileSystemFileHandlePtrInfo& file( ::blink::mojom::blink::NativeFileSystemHandlePtr& input) {
    return input->get_file();
  }

  static  ::blink::mojom::blink::NativeFileSystemDirectoryHandlePtrInfo& directory( ::blink::mojom::blink::NativeFileSystemHandlePtr& input) {
    return input->get_directory();
  }

  static bool Read(::blink::mojom::blink::NativeFileSystemHandle::DataView input, ::blink::mojom::blink::NativeFileSystemHandlePtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_NATIVE_FILE_SYSTEM_NATIVE_FILE_SYSTEM_DIRECTORY_HANDLE_MOJOM_BLINK_H_