...
bool ControllerServiceWorkerInfo_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->used_features, 6, validation_context)) {
    return false;
  }
...
bool ControllerServiceWorkerConnector_UpdateController_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ControllerServiceWorkerConnector_UpdateController_Params_Data* object = static_cast<const ControllerServiceWorkerConnector_UpdateController_Params_Data*>(data);
