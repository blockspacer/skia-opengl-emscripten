...
class MediaDevicesDispatcherHost_EnumerateDevices_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<WTF::Vector<MediaDeviceInfoPtr>> in_enumeration, WTF::Vector<VideoInputDeviceCapabilitiesPtr> in_video_input_device_capabilities, WTF::Vector<AudioInputDeviceCapabilitiesPtr> in_audio_input_device_capabilities);
