...
class PLATFORM_EXPORT RendererPreferenceWatcher
 ...
 public:
  ...
  virtual void NotifyUpdate(::blink::mojom::blink::RendererPreferencesPtr new_prefs) = 0;
};
...
class PLATFORM_EXPORT RendererPreferenceWatcherProxy
 ...
 public:
  ...
  void NotifyUpdate(::blink::mojom::blink::RendererPreferencesPtr new_prefs) final;
