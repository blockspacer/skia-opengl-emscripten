...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_UKM_UKM_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_UKM_UKM_MOJOM_H_
...
#include "third_party/blink/public/mojom/ukm/ukm.mojom-forward.h"
#include <string>
#include <vector>
...
class BLINK_COMMON_EXPORT UkmSourceIdFrameHost
...
class BLINK_COMMON_EXPORT UkmSourceIdFrameHostProxy
...
class BLINK_COMMON_EXPORT UkmSourceIdFrameHostStubDispatch {
 public:
...
class BLINK_COMMON_EXPORT UkmSourceIdFrameHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_UKM_UKM_MOJOM_H_