...
void NotificationServiceProxy::DisplayNonPersistentNotification(
    const WTF::String& in_token, ::blink::mojom::blink::NotificationDataPtr in_notification_data, ::blink::mojom::blink::NotificationResourcesPtr in_notification_resources, NonPersistentNotificationListenerPtr in_event_listener) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
