...
void DevToolsAgentHostInterceptorForTesting::ChildWorkerCreated(DevToolsAgentPtr worker_devtools_agent, DevToolsAgentHostRequest worker_devtools_agent_host, const GURL& url, const std::string& name, const base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger) {
...
void DevToolsSessionInterceptorForTesting::DispatchProtocolCommand(int32_t call_id, const std::string& method, DevToolsMessagePtr message) {
