...
void DedicatedWorkerHostFactoryClientProxy::OnWorkerHostCreated(
    ::service_manager::mojom::blink::InterfaceProviderPtr in_interface_provider) {
...
void DedicatedWorkerHostFactoryProxy::CreateWorkerHostAndStartScriptLoad(
    const ::blink::KURL& in_script_url, const scoped_refptr<const ::blink::SecurityOrigin>& in_origin, ::blink::mojom::blink::BlobURLTokenPtr in_blob_url_token, DedicatedWorkerHostFactoryClientPtr in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
