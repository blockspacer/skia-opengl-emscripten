...
#include "third_party/blink/public/mojom/frame/document_interface_broker.mojom-blink-import-headers.h"
...
void DocumentInterfaceBrokerProxy::GetAudioContextManager(
    ::blink::mojom::blink::AudioContextManagerRequest in_request) {
...
void DocumentInterfaceBrokerProxy::GetAuthenticator(
    ::blink::mojom::blink::AuthenticatorRequest in_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DocumentInterfaceBrokerProxy::GetCredentialManager(
    ::blink::mojom::blink::CredentialManagerRequest in_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DocumentInterfaceBrokerProxy::GetFrameHostTestInterface(
    ::blink::mojom::blink::FrameHostTestInterfaceRequest in_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DocumentInterfaceBrokerProxy::GetVirtualAuthenticatorManager(
    ::blink::test::mojom::blink::VirtualAuthenticatorManagerRequest in_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool DocumentInterfaceBrokerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kDocumentInterfaceBroker_GetAudioContextManager_Name: {
      ...
      bool success = true;
      ::blink::mojom::blink::AudioContextManagerRequest p_request{};
...
std::move(p_request));
    ...
    case internal::kDocumentInterfaceBroker_GetAuthenticator_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::blink::AuthenticatorRequest p_request{};
...
std::move(p_request));
    ...
    case internal::kDocumentInterfaceBroker_GetCredentialManager_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::blink::CredentialManagerRequest p_request{};
...
std::move(p_request));
    ...
    case internal::kDocumentInterfaceBroker_GetFrameHostTestInterface_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::blink::FrameHostTestInterfaceRequest p_request{};
...
std::move(p_request));
    ...
    case internal::kDocumentInterfaceBroker_GetVirtualAuthenticatorManager_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::test::mojom::blink::VirtualAuthenticatorManagerRequest p_request{};
