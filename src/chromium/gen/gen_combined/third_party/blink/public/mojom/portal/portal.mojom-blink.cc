...
void PortalProxy::Activate(
    ::blink::BlinkTransferableMessage in_data, ActivateCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PortalProxy::PostMessageToGuest(
    ::blink::BlinkTransferableMessage in_message, const scoped_refptr<const ::blink::SecurityOrigin>& in_target_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PortalClientProxy::ForwardMessageFromGuest(
    ::blink::BlinkTransferableMessage in_message, const scoped_refptr<const ::blink::SecurityOrigin>& in_source_origin, const scoped_refptr<const ::blink::SecurityOrigin>& in_target_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
