...
EmbeddedWorkerStartParams::EmbeddedWorkerStartParams(
    ...
    ::blink::mojom::ServiceWorkerRequest service_worker_request_in,
    ::blink::mojom::ControllerServiceWorkerRequest controller_request_in,
    ...
    ::blink::mojom::RendererPreferenceWatcherRequest preference_watcher_request_in,
    std::unique_ptr<blink::URLLoaderFactoryBundleInfo> subresource_loader_factories_in)
...
void EmbeddedWorkerInstanceClientProxy::UpdateSubresourceLoaderFactories(
    std::unique_ptr<blink::URLLoaderFactoryBundleInfo> in_subresource_loader_factories) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
