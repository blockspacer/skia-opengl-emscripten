...
size_t PaymentHandlerMethodData::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->stringified_data);
  return seed;
}
...
PaymentMethodChangeResponse::PaymentMethodChangeResponse(
    ::payments::mojom::blink::PaymentCurrencyAmountPtr total_in,
    base::Optional<WTF::Vector<PaymentHandlerModifierPtr>> modifiers_in,
...
// static
bool StructTraits<::payments::mojom::blink::PaymentMethodChangeResponse::DataView, ::payments::mojom::blink::PaymentMethodChangeResponsePtr>::Read(
    ::payments::mojom::blink::PaymentMethodChangeResponse::DataView input,
    ::payments::mojom::blink::PaymentMethodChangeResponsePtr* output) {
  bool success = true;
  ::payments::mojom::blink::PaymentMethodChangeResponsePtr result(::payments::mojom::blink::PaymentMethodChangeResponse::New());
