...
void SharedWorkerConnectorProxy::Connect(
    ::blink::mojom::SharedWorkerInfoPtr in_info, ::blink::mojom::SharedWorkerClientPtr in_client, ::blink::mojom::SharedWorkerCreationContextType in_creation_context_type, mojo::ScopedMessagePipeHandle in_message_port, ::blink::mojom::BlobURLTokenPtr in_blob_url_token) {
...
bool SharedWorkerConnectorStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kSharedWorkerConnector_Connect_Name: {
      ...
      ::blink::mojom::SharedWorkerClientPtr p_client{};
