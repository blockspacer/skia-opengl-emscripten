...
#include "third_party/blink/public/mojom/appcache/appcache.mojom-blink-import-headers.h"
...
bool AppCacheHost::GetStatus(::blink::mojom::blink::AppCacheStatus* out_status) {
  NOTREACHED();
  return false;
}
...
bool AppCacheHost::GetResourceList(WTF::Vector<AppCacheResourceInfoPtr>* out_resources) {
  NOTREACHED();
  return false;
}
class AppCacheHost_GetStatus_HandleSyncResponse
 ...
 public:
  AppCacheHost_GetStatus_HandleSyncResponse(
      bool* result, ::blink::mojom::blink::AppCacheStatus* out_status)
 ...
 private:
  bool* result_;
  ::blink::mojom::blink::AppCacheStatus* out_status_;DISALLOW_COPY_AND_ASSIGN(AppCacheHost_GetStatus_HandleSyncResponse);
};
...
class AppCacheHost_GetResourceList_HandleSyncResponse
 ...
 public:
  AppCacheHost_GetResourceList_HandleSyncResponse(
      bool* result, WTF::Vector<AppCacheResourceInfoPtr>* out_resources)
 ...
 private:
  bool* result_;
  WTF::Vector<AppCacheResourceInfoPtr>* out_resources_;DISALLOW_COPY_AND_ASSIGN(AppCacheHost_GetResourceList_HandleSyncResponse);
};
...
void AppCacheHostProxy::SelectCache(
    const ::blink::KURL& in_document_url, int64_t in_appcache_document_was_loaded_from, const ::blink::KURL& in_opt_manifest_url) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AppCacheHostProxy::MarkAsForeignEntry(
    const ::blink::KURL& in_document_url, int64_t in_appcache_document_was_loaded_from) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool AppCacheHostProxy::GetStatus(
    ::blink::mojom::blink::AppCacheStatus* out_param_status) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool AppCacheHostProxy::GetResourceList(
    WTF::Vector<AppCacheResourceInfoPtr>* out_param_resources) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class AppCacheHost_GetStatus_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::AppCacheStatus in_status);
...
bool AppCacheHost_GetStatus_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  ::blink::mojom::blink::AppCacheStatus p_status{};
...
class AppCacheHost_GetResourceList_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<AppCacheResourceInfoPtr> in_resources);
...
bool AppCacheHost_GetResourceList_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  WTF::Vector<AppCacheResourceInfoPtr> p_resources{};
...
void AppCacheFrontendProxy::CacheSelected(
    ::blink::mojom::blink::AppCacheInfoPtr in_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AppCacheFrontendProxy::ProgressEventRaised(
    const ::blink::KURL& in_url, int32_t in_total, int32_t in_complete) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AppCacheFrontendProxy::LogMessage(
    ::blink::mojom::blink::ConsoleMessageLevel in_log_level, const WTF::String& in_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool AppCacheFrontendStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kAppCacheFrontend_CacheSelected_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::blink::AppCacheInfoPtr p_info{};
...
std::move(p_message));
    ...
    case internal::kAppCacheFrontend_SetSubresourceFactory_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::network::mojom::blink::URLLoaderFactoryPtr p_url_loader_factory{};
...
// static
bool StructTraits<::blink::mojom::blink::AppCacheResourceInfo::DataView, ::blink::mojom::blink::AppCacheResourceInfoPtr>::Read(
    ::blink::mojom::blink::AppCacheResourceInfo::DataView input,
    ::blink::mojom::blink::AppCacheResourceInfoPtr* output) {
  bool success = true;
  ::blink::mojom::blink::AppCacheResourceInfoPtr result(::blink::mojom::blink::AppCacheResourceInfo::New());
...
// static
bool StructTraits<::blink::mojom::blink::AppCacheErrorDetails::DataView, ::blink::mojom::blink::AppCacheErrorDetailsPtr>::Read(
    ::blink::mojom::blink::AppCacheErrorDetails::DataView input,
    ::blink::mojom::blink::AppCacheErrorDetailsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::AppCacheErrorDetailsPtr result(::blink::mojom::blink::AppCacheErrorDetails::New());
