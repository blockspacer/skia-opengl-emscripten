...
WebBluetoothScanResult::WebBluetoothScanResult(
    ...
    const WTF::String& name_in,
    const WTF::Vector<WTF::String>& uuids_in,
...
// static
bool StructTraits<::blink::mojom::blink::WebBluetoothScanResult::DataView, ::blink::mojom::blink::WebBluetoothScanResultPtr>::Read(
    ::blink::mojom::blink::WebBluetoothScanResult::DataView input,
    ::blink::mojom::blink::WebBluetoothScanResultPtr* output) {
  bool success = true;
  ::blink::mojom::blink::WebBluetoothScanResultPtr result(::blink::mojom::blink::WebBluetoothScanResult::New());
...
// static
bool UnionTraits<::blink::mojom::blink::RequestScanningStartResult::DataView, ::blink::mojom::blink::RequestScanningStartResultPtr>::Read(
    ::blink::mojom::blink::RequestScanningStartResult::DataView input,
    ::blink::mojom::blink::RequestScanningStartResultPtr* output) {
  using UnionType = ::blink::mojom::blink::RequestScanningStartResult;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::ERROR_RESULT: {
      ::blink::mojom::blink::WebBluetoothResult result_error_result;
    ...
    case Tag::OPTIONS: {
      ::blink::mojom::blink::WebBluetoothRequestLEScanOptionsPtr result_options;
