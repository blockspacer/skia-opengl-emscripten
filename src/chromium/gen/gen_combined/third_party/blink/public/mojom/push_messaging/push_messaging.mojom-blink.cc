...
PushSubscriptionOptions::PushSubscriptionOptions(
    ...
    const WTF::String& application_server_key_in)
...
size_t PushSubscriptionOptions::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->user_visible_only);
  seed = mojo::internal::WTFHash(seed, this->application_server_key);
  return seed;
}
...
void PushMessagingProxy::Subscribe(
    int32_t in_render_frame_id, int64_t in_service_worker_registration_id, PushSubscriptionOptionsPtr in_options, bool in_user_gesture, SubscribeCallback callback) {
...
class PushMessaging_Subscribe_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::PushRegistrationStatus in_status, const base::Optional<::blink::KURL>& in_endpoint, PushSubscriptionOptionsPtr in_options, const base::Optional<WTF::Vector<uint8_t>>& in_p256dh, const base::Optional<WTF::Vector<uint8_t>>& in_auth);
...
bool PushMessaging_Subscribe_ForwardToCallback::Accept(
  ...
  base::Optional<::blink::KURL> p_endpoint{};
  PushSubscriptionOptionsPtr p_options{};
  base::Optional<WTF::Vector<uint8_t>> p_p256dh{};
  base::Optional<WTF::Vector<uint8_t>> p_auth{};
...
class PushMessaging_GetSubscription_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::PushGetRegistrationStatus in_status, const base::Optional<::blink::KURL>& in_endpoint, PushSubscriptionOptionsPtr in_options, const base::Optional<WTF::Vector<uint8_t>>& in_p256dh, const base::Optional<WTF::Vector<uint8_t>>& in_auth);
