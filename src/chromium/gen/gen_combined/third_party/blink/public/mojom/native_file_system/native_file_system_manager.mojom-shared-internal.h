...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_NATIVE_FILE_SYSTEM_NATIVE_FILE_SYSTEM_MANAGER_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_NATIVE_FILE_SYSTEM_NATIVE_FILE_SYSTEM_MANAGER_MOJOM_SHARED_INTERNAL_H_
...
struct ChooseFileSystemEntryType_Data {
 public:
  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(ChooseFileSystemEntryAcceptsOption_Data));
      new (data()) ChooseFileSystemEntryAcceptsOption_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ChooseFileSystemEntryAcceptsOption_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ChooseFileSystemEntryAcceptsOption_Data>(index_);
    }
    ChooseFileSystemEntryAcceptsOption_Data* operator->() { return data(); }
...
struct ChooseFileSystemEntryAcceptsOption_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    ChooseFileSystemEntryAcceptsOption_Data::BufferWriter writer;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_NATIVE_FILE_SYSTEM_NATIVE_FILE_SYSTEM_MANAGER_MOJOM_SHARED_INTERNAL_H_