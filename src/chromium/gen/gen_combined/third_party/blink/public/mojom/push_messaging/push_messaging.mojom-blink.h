...
struct blink_mojom_internal_PushErrorType_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::PushErrorType& left, const ::blink::mojom::PushErrorType& right) {
    return left == right;
  }
...
struct HashTraits<::blink::mojom::PushErrorType>
    : public GenericHashTraits<::blink::mojom::PushErrorType> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::blink::mojom::PushErrorType& value) {
    return value == static_cast<::blink::mojom::PushErrorType>(-1000000);
  }
  static void ConstructDeletedValue(::blink::mojom::PushErrorType& slot, bool) {
    slot = static_cast<::blink::mojom::PushErrorType>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::PushErrorType& value) {
    return value == static_cast<::blink::mojom::PushErrorType>(-1000001);
  }
};
}  // namespace WTF
...
class PLATFORM_EXPORT PushMessaging
 ...
 public:
  ...
  using SubscribeCallback = base::OnceCallback<void(::blink::mojom::blink::PushRegistrationStatus, const base::Optional<::blink::KURL>&, PushSubscriptionOptionsPtr, const base::Optional<WTF::Vector<uint8_t>>&, const base::Optional<WTF::Vector<uint8_t>>&)>;
  
  virtual void Subscribe(int32_t render_frame_id, int64_t service_worker_registration_id, PushSubscriptionOptionsPtr options, bool user_gesture, SubscribeCallback callback) = 0;
  ...
  using GetSubscriptionCallback = base::OnceCallback<void(::blink::mojom::blink::PushGetRegistrationStatus, const base::Optional<::blink::KURL>&, PushSubscriptionOptionsPtr, const base::Optional<WTF::Vector<uint8_t>>&, const base::Optional<WTF::Vector<uint8_t>>&)>;
...
class PLATFORM_EXPORT PushMessagingProxy
 ...
 public:
  ...
  void Subscribe(int32_t render_frame_id, int64_t service_worker_registration_id, PushSubscriptionOptionsPtr options, bool user_gesture, SubscribeCallback callback) final;
...
class PLATFORM_EXPORT PushSubscriptionOptions {
 public:
  ...
  PushSubscriptionOptions(
      ...
      const WTF::String& application_server_key);
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PushSubscriptionOptions::DataView, WTF::Vector<uint8_t>>(input);
  }
  ...
  WTF::String application_server_key;
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PushSubscriptionOptions::DataView,
