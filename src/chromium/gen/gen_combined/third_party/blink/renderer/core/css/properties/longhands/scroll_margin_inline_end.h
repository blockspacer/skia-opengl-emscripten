...
class ScrollMarginInlineEnd final : public Longhand {
 public:
  constexpr ScrollMarginInlineEnd() : Longhand(CSSPropertyID::kScrollMarginInlineEnd,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "scroll-margin-inline-end"; }
