...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_MOJO_MOJO_READ_MESSAGE_FLAGS_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_MOJO_MOJO_READ_MESSAGE_FLAGS_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_MOJO_MOJO_READ_MESSAGE_FLAGS_H_
