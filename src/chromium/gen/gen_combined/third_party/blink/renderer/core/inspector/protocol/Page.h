...
class CORE_EXPORT FontFamilies : public Serializable{
...
class CORE_EXPORT FontSizes : public Serializable{
...
class CORE_EXPORT FrameRequestedNavigationNotification : public Serializable{
...
class CORE_EXPORT DownloadWillBeginNotification : public Serializable{
...
class CORE_EXPORT CompilationCacheProducedNotification : public Serializable{
