...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_END_STYLE_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_END_STYLE_H_
...
// Implements the 'border-inline-end-style' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderInlineEndStyle final : public Longhand {
 public:
  constexpr BorderInlineEndStyle() : Longhand(CSSPropertyID::kBorderInlineEndStyle,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "border-inline-end-style"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_END_STYLE_H_
