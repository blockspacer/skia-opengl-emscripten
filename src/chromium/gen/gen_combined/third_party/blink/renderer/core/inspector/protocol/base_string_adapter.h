...
#ifndef blink_protocol_BASE_STRING_ADAPTER_H
#define blink_protocol_BASE_STRING_ADAPTER_H
...
class CORE_EXPORT StringBuilder {
 public:
  StringBuilder();
  ~StringBuilder();
...
#endif // !defined(blink_protocol_BASE_STRING_ADAPTER_H)
