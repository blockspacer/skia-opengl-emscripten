...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_MOJO_MOJO_DUPLICATE_BUFFER_HANDLE_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_MOJO_MOJO_DUPLICATE_BUFFER_HANDLE_OPTIONS_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_MOJO_MOJO_DUPLICATE_BUFFER_HANDLE_OPTIONS_H_
