...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_COLOR_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_COLOR_H_
...
// Implements the 'border-block-start-color' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderBlockStartColor final : public Longhand {
 public:
  constexpr BorderBlockStartColor() : Longhand(CSSPropertyID::kBorderBlockStartColor,
    0
    | kProperty
  ...
  const char* GetPropertyName() const override { return "border-block-start-color"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_COLOR_H_
