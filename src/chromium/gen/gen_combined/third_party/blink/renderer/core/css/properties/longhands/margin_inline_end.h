...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_INLINE_END_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_INLINE_END_H_
...
// Implements the 'margin-inline-end' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class MarginInlineEnd final : public Longhand {
 public:
  constexpr MarginInlineEnd() : Longhand(CSSPropertyID::kMarginInlineEnd,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "margin-inline-end"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_INLINE_END_H_
