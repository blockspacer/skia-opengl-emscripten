...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_END_STYLE_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_END_STYLE_H_
...
// Implements the 'border-block-end-style' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderBlockEndStyle final : public Longhand {
 public:
  constexpr BorderBlockEndStyle() : Longhand(CSSPropertyID::kBorderBlockEndStyle,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "border-block-end-style"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_END_STYLE_H_
