...
class ScrollMarginBlockStart final : public Longhand {
 public:
  constexpr ScrollMarginBlockStart() : Longhand(CSSPropertyID::kScrollMarginBlockStart,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "scroll-margin-block-start"; }
