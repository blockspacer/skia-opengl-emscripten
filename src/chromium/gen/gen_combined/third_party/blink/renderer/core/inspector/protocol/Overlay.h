...
public:
    ...
    virtual DispatchResponse getHighlightObjectForTest(int in_nodeId, Maybe<bool> in_includeDistance, std::unique_ptr<protocol::DictionaryValue>* out_highlight) = 0;
