...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_PADDING_INLINE_END_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_PADDING_INLINE_END_H_
...
// Implements the 'padding-inline-end' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class PaddingInlineEnd final : public Longhand {
 public:
  constexpr PaddingInlineEnd() : Longhand(CSSPropertyID::kPaddingInlineEnd,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "padding-inline-end"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_PADDING_INLINE_END_H_
