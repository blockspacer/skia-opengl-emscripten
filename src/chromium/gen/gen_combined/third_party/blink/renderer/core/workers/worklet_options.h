...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_WORKERS_WORKLET_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_WORKERS_WORKLET_OPTIONS_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_WORKERS_WORKLET_OPTIONS_H_
