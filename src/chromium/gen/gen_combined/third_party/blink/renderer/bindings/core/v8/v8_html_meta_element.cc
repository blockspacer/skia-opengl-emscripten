...
static void HttpEquivAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setAttribute(html_names::kHttpEquivAttr, cpp_value);
}
...
static void ContentAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setAttribute(html_names::kContentAttr, cpp_value);
}
...
static void SchemeAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setAttribute(html_names::kSchemeAttr, cpp_value);
}
...
void V8HTMLMetaElement::NameAttributeSetterCallback(
  ...
  html_meta_element_v8_internal::NameAttributeSetter(v8_value, info);
}
...
void V8HTMLMetaElement::HttpEquivAttributeSetterCallback(
  ...
  html_meta_element_v8_internal::HttpEquivAttributeSetter(v8_value, info);
}
...
void V8HTMLMetaElement::ContentAttributeSetterCallback(
  ...
  html_meta_element_v8_internal::ContentAttributeSetter(v8_value, info);
}
...
void V8HTMLMetaElement::SchemeAttributeSetterCallback(
  ...
  html_meta_element_v8_internal::SchemeAttributeSetter(v8_value, info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8HTMLMetaElementAccessors[] = {
...
static void InstallV8HTMLMetaElementTemplate(
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HTMLMetaElementAccessors, base::size(kV8HTMLMetaElementAccessors));
...
HTMLMetaElement* NativeValueTraits<HTMLMetaElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HTMLMetaElement* native_value = V8HTMLMetaElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
