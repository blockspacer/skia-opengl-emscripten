...
static const v8::Eternal<v8::Name>* eternalV8RTCRtpCodecCapabilityKeys(v8::Isolate* isolate) {
...
void V8RTCRtpCodecCapability::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, RTCRtpCodecCapability* impl, ExceptionState& exception_state) {
  if (IsUndefinedOrNull(v8_value)) {
    exception_state.ThrowTypeError("Missing required member(s): clockRate, mimeType.");
    return;
  }
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8RTCRtpCodecCapabilityKeys(isolate);
  ...
  if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&sdp_fmtp_line_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
v8::Local<v8::Value> RTCRtpCodecCapability::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8RTCRtpCodecCapability(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8RTCRtpCodecCapability(const RTCRtpCodecCapability* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8RTCRtpCodecCapabilityKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  ...
  if (sdp_fmtp_line_has_value_or_default &&
      !create_property(3, sdp_fmtp_line_value)) {
    return false;
  }
...
RTCRtpCodecCapability* NativeValueTraits<RTCRtpCodecCapability>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  RTCRtpCodecCapability* impl = RTCRtpCodecCapability::Create();
  V8RTCRtpCodecCapability::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
