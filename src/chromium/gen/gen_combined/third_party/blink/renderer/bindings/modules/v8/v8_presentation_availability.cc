...
#endif
const WrapperTypeInfo v8_presentation_availability_wrapper_type_info = {
    gin::kEmbedderBlink,
    V8PresentationAvailability::DomTemplate,
    V8PresentationAvailability::InstallConditionalFeatures,
...
const WrapperTypeInfo& PresentationAvailability::wrapper_type_info_ = v8_presentation_availability_wrapper_type_info;
...
namespace presentation_availability_v8_internal {
...
void V8PresentationAvailability::ValueAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  presentation_availability_v8_internal::ValueAttributeGetter(info);
}
...
void V8PresentationAvailability::OnchangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  presentation_availability_v8_internal::OnchangeAttributeGetter(info);
}

void V8PresentationAvailability::OnchangeAttributeSetterCallback(
  ...
  presentation_availability_v8_internal::OnchangeAttributeSetter(v8_value, info);
}
...
static void InstallV8PresentationAvailabilityTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8PresentationAvailability::GetWrapperTypeInfo()->interface_name, V8EventTarget::DomTemplate(isolate, world), V8PresentationAvailability::kInternalFieldCount);
...
v8::Local<v8::FunctionTemplate> V8PresentationAvailability::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8PresentationAvailability::GetWrapperTypeInfo()),
      InstallV8PresentationAvailabilityTemplate);
}

bool V8PresentationAvailability::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8PresentationAvailability::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8PresentationAvailability::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8PresentationAvailability::GetWrapperTypeInfo(), v8_value);
}

PresentationAvailability* V8PresentationAvailability::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

PresentationAvailability* NativeValueTraits<PresentationAvailability>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PresentationAvailability* native_value = V8PresentationAvailability::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
...
void V8PresentationAvailability::InstallConditionalFeatures(
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "value", V8PresentationAvailability::ValueAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
