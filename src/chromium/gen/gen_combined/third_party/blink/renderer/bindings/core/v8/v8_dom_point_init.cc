...
void V8DOMPointInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, DOMPointInit* impl, ExceptionState& exception_state) {
  ...
  if (w_value.IsEmpty() || w_value->IsUndefined()) {
    ...
    double w_cpp_value = NativeValueTraits<IDLUnrestrictedDouble>::NativeValue(isolate, w_value, exception_state);
  ...
  if (z_value.IsEmpty() || z_value->IsUndefined()) {
    ...
    double z_cpp_value = NativeValueTraits<IDLUnrestrictedDouble>::NativeValue(isolate, z_value, exception_state);
    if (exception_state.HadException())
      return;
...
bool toV8DOMPointInit(const DOMPointInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasW()) {
    ...
    w_value = v8::Number::New(isolate, 1);
    w_has_value_or_default = true;
  }
  ...
  if (impl->hasZ()) {
    ...
    z_value = v8::Number::New(isolate, 0);
    z_has_value_or_default = true;
  }
...
DOMPointInit* NativeValueTraits<DOMPointInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMPointInit* impl = DOMPointInit::Create();
  V8DOMPointInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
