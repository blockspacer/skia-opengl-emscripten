...
v8::Maybe<void> V8EventListener::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Event* event) {
  ...
  v8::Local<v8::Value> v8_event = ToV8(event, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_event };
...
void V8EventListener::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Event* event) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      handleEvent(callback_this_value, event);
...
v8::Maybe<void> V8EventListener::InvokeWithoutRunnabilityCheck(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Event* event) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "EventListener",
          "handleEvent");
...
v8::Maybe<void> V8PersistentCallbackInterface<V8EventListener>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Event* event) {
  return Proxy()->handleEvent(
      callback_this_value, event);
}

void V8PersistentCallbackInterface<V8EventListener>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Event* event) {
