...
MODULES_EXPORT extern const WrapperTypeInfo v8_payment_request_wrapper_type_info;
...
class V8PaymentRequest {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_payment_request_wrapper_type_info;
  }
  ...
  MODULES_EXPORT static void OnpaymentmethodchangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void OnpaymentmethodchangeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void HasEnrolledInstrumentMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
