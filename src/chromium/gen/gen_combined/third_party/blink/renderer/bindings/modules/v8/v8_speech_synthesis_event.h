...
MODULES_EXPORT extern const WrapperTypeInfo v8_speech_synthesis_event_wrapper_type_info;
...
class V8SpeechSynthesisEvent {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_speech_synthesis_event_wrapper_type_info;
  }
  ...
  MODULES_EXPORT static void CharLengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
