...
v8::Maybe<void> V8VoidFunction::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
void V8VoidFunction::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8VoidFunction>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

void V8PersistentCallbackFunction<V8VoidFunction>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
