...
v8::Maybe<void> V8ReportingObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
...
void V8ReportingObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8ReportingObserverCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, reports, observer);
}

void V8PersistentCallbackFunction<V8ReportingObserverCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
