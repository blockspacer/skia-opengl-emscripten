...
v8::Maybe<void> V8CustomElementFormDisabledCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool disabled) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "CustomElementFormDisabledCallback",
          "invoke");
  ...
  v8::Local<v8::Value> v8_disabled = v8::Boolean::New(GetIsolate(), disabled);
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_disabled };
...
void V8CustomElementFormDisabledCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool disabled) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, disabled);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

v8::Maybe<void> V8PersistentCallbackFunction<V8CustomElementFormDisabledCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool disabled) {
  return Proxy()->Invoke(
      callback_this_value, disabled);
}

void V8PersistentCallbackFunction<V8CustomElementFormDisabledCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool disabled) {
