...
v8::Maybe<void> V8CustomElementFormStateRestoreCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileOrUSVStringOrFormData value, const String& mode) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "CustomElementFormStateRestoreCallback",
          "invoke");
...
#if DCHECK_IS_ON()
  {
    ...
    ExceptionState exception_state(GetIsolate(),
                                   ...
                                   "CustomElementFormStateRestoreCallback",
                                   "invoke");
    if (!IsValidEnum(mode, kValidModeValues, base::size(kValidModeValues), "FormStateRestoreMode", exception_state)) { //
      NOTREACHED();
      return v8::Nothing<void>();
    }
  }
  ...
  v8::Local<v8::Value> v8_value = ToV8(value, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_mode = V8String(GetIsolate(), mode);
  constexpr int argc = 2;
  v8::Local<v8::Value> argv[] = { v8_value, v8_mode };
...
void V8CustomElementFormStateRestoreCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileOrUSVStringOrFormData value, const String& mode) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, value, mode);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

v8::Maybe<void> V8PersistentCallbackFunction<V8CustomElementFormStateRestoreCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileOrUSVStringOrFormData value, const String& mode) {
  return Proxy()->Invoke(
      callback_this_value, value, mode);
}

void V8PersistentCallbackFunction<V8CustomElementFormStateRestoreCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileOrUSVStringOrFormData value, const String& mode) {
