...
v8::Maybe<void> V8NavigatorUserMediaErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMExceptionOrOverconstrainedError error) {
...
void V8NavigatorUserMediaErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMExceptionOrOverconstrainedError error) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8NavigatorUserMediaErrorCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMExceptionOrOverconstrainedError error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

void V8PersistentCallbackFunction<V8NavigatorUserMediaErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMExceptionOrOverconstrainedError error) {
