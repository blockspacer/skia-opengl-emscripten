...
void V8EffectTiming::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, EffectTiming* impl, ExceptionState& exception_state) {
...
bool toV8EffectTiming(const EffectTiming* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasDirection()) {
    ...
    direction_value = V8String(isolate, "normal");
    direction_has_value_or_default = true;
  }
  ...
  if (impl->hasDuration()) {
    ...
    duration_value = ToV8(UnrestrictedDoubleOrString::FromString("auto"), creationContext, isolate);
    duration_has_value_or_default = true;
  }
  ...
  if (impl->hasEndDelay()) {
    ...
    end_delay_value = v8::Number::New(isolate, 0);
    end_delay_has_value_or_default = true;
  }
  ...
  if (impl->hasFill()) {
    ...
    fill_value = V8String(isolate, "auto");
    fill_has_value_or_default = true;
  }
  ...
  if (impl->hasIterationStart()) {
    ...
    iteration_start_value = v8::Number::New(isolate, 0);
    iteration_start_has_value_or_default = true;
  }
  ...
  if (impl->hasIterations()) {
    ...
    iterations_value = v8::Number::New(isolate, 1);
    iterations_has_value_or_default = true;
  }
...
EffectTiming* NativeValueTraits<EffectTiming>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  EffectTiming* impl = EffectTiming::Create();
  V8EffectTiming::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
