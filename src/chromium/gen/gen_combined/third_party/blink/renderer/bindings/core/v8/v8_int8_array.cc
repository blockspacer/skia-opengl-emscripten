...
#endif
const WrapperTypeInfo v8_int8_array_wrapper_type_info = {
    gin::kEmbedderBlink,
    nullptr,
    nullptr,
    "Int8Array",
...
DOMInt8Array* V8Int8Array::ToImpl(v8::Local<v8::Object> object) {
  ...
  if (script_wrappable)
    return script_wrappable->ToImpl<DOMInt8Array>();

  v8::Local<v8::Int8Array> v8_view = object.As<v8::Int8Array>();
  v8::Local<v8::Object> array_buffer = v8_view->Buffer();
  DOMInt8Array* typed_array = nullptr;
  if (array_buffer->IsArrayBuffer()) {
    typed_array = DOMInt8Array::Create(
  ...
  return typed_array->ToImpl<DOMInt8Array>();
}

DOMInt8Array* V8Int8Array::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return value->IsInt8Array() ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMInt8Array* NativeValueTraits<DOMInt8Array>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMInt8Array* native_value = V8Int8Array::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
