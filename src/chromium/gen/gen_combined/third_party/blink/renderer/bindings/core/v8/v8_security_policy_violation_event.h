...
CORE_EXPORT extern const WrapperTypeInfo v8_security_policy_violation_event_wrapper_type_info;
...
class V8SecurityPolicyViolationEvent {
 ...
 public:
  ...
  CORE_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_security_policy_violation_event_wrapper_type_info;
  }
