...
CORE_EXPORT extern WrapperTypeInfo v8_navigator_wrapper_type_info;
...
class V8Navigator {
 ...
 public:
  ...
  CORE_EXPORT static constexpr WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_navigator_wrapper_type_info;
  }
  ...
  CORE_EXPORT static void InstallV8NavigatorTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
  ...
  CORE_EXPORT static void SchedulingAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void UserActivationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);

  CORE_EXPORT static void GetUserAgentMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
 ...
 private:
  static InstallTemplateFunction install_v8_navigator_template_function_;
};
