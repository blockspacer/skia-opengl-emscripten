...
extern const WrapperTypeInfo v8_static_selection_wrapper_type_info;
...
class V8StaticSelection {
 ...
 public:
  ...
  static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_static_selection_wrapper_type_info;
  }
  ...
  static void IsCollapsedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
