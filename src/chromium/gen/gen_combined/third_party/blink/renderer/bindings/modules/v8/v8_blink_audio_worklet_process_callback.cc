...
v8::Maybe<ScriptValue> V8BlinkAudioWorkletProcessCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue inputs, ScriptValue outputs, ScriptValue paramValues) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "BlinkAudioWorkletProcessCallback",
          "invoke");
  ...
  v8::Local<v8::Value> v8_inputs = inputs.V8Value();
  v8::Local<v8::Value> v8_outputs = outputs.V8Value();
  v8::Local<v8::Value> v8_paramValues = paramValues.V8Value();
  constexpr int argc = 3;
  v8::Local<v8::Value> argv[] = { v8_inputs, v8_outputs, v8_paramValues };
...
v8::Maybe<ScriptValue> V8BlinkAudioWorkletProcessCallback::Construct(ScriptValue inputs, ScriptValue outputs, ScriptValue paramValues) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "BlinkAudioWorkletProcessCallback",
          "construct");
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8BlinkAudioWorkletProcessCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue inputs, ScriptValue outputs, ScriptValue paramValues) {
  return Proxy()->Invoke(
      callback_this_value, inputs, outputs, paramValues);
}
