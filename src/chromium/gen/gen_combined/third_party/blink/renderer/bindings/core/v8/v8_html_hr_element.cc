...
static void NoShadeAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "HTMLHRElement", "noShade");
  CEReactionsScope ce_reactions_scope;
  ...
  impl->SetBooleanAttribute(html_names::kNoshadeAttr, cpp_value);
}
...
void V8HTMLHRElement::AlignAttributeSetterCallback(
  ...
  html_hr_element_v8_internal::AlignAttributeSetter(v8_value, info);
}
...
void V8HTMLHRElement::ColorAttributeSetterCallback(
  ...
  html_hr_element_v8_internal::ColorAttributeSetter(v8_value, info);
}
...
void V8HTMLHRElement::NoShadeAttributeSetterCallback(
  ...
  html_hr_element_v8_internal::NoShadeAttributeSetter(v8_value, info);
}
...
void V8HTMLHRElement::SizeAttributeSetterCallback(
  ...
  html_hr_element_v8_internal::SizeAttributeSetter(v8_value, info);
}
...
void V8HTMLHRElement::WidthAttributeSetterCallback(
  ...
  html_hr_element_v8_internal::WidthAttributeSetter(v8_value, info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8HTMLHRElementAccessors[] = {
    { "align", V8HTMLHRElement::AlignAttributeGetterCallback, V8HTMLHRElement::AlignAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "color", V8HTMLHRElement::ColorAttributeGetterCallback, V8HTMLHRElement::ColorAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "noShade", V8HTMLHRElement::NoShadeAttributeGetterCallback, V8HTMLHRElement::NoShadeAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "size", V8HTMLHRElement::SizeAttributeGetterCallback, V8HTMLHRElement::SizeAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "width", V8HTMLHRElement::WidthAttributeGetterCallback, V8HTMLHRElement::WidthAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8HTMLHRElementTemplate(
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HTMLHRElementAccessors, base::size(kV8HTMLHRElementAccessors));
...
HTMLHRElement* NativeValueTraits<HTMLHRElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HTMLHRElement* native_value = V8HTMLHRElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
