...
#endif
const WrapperTypeInfo v8_face_detector_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& FaceDetector::wrapper_type_info_ = v8_face_detector_wrapper_type_info;
...
namespace face_detector_v8_internal {

static void DetectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "FaceDetector", "detect");
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "FaceDetector");

  FaceDetectorOptions* face_detector_options;
  if (!info[0]->IsNullOrUndefined() && !info[0]->IsObject()) {
    exception_state.ThrowTypeError("parameter 1 ('faceDetectorOptions') is not an object.");
    return;
  }
  face_detector_options = NativeValueTraits<FaceDetectorOptions>::NativeValue(info.GetIsolate(), info[0], exception_state);
  if (exception_state.HadException())
    return;

  ExecutionContext* execution_context = ToExecutionContext(
      info.NewTarget().As<v8::Object>()->CreationContext());
  FaceDetector* impl = FaceDetector::Create(execution_context, face_detector_options);
  v8::Local<v8::Object> wrapper = info.Holder();
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8FaceDetector::GetWrapperTypeInfo(), wrapper);
...
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kShapeDetection_FaceDetectorConstructor);
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("FaceDetector"));
    return;
  }
  ...
  face_detector_v8_internal::Constructor(info);
}
...
void V8FaceDetector::DetectMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  face_detector_v8_internal::DetectMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8FaceDetectorMethods[] = {
...
static void InstallV8FaceDetectorTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8FaceDetector::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8FaceDetector::kInternalFieldCount);
  interface_template->SetCallHandler(face_detector_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, kV8FaceDetectorMethods, base::size(kV8FaceDetectorMethods));
...
v8::Local<v8::FunctionTemplate> V8FaceDetector::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8FaceDetector::GetWrapperTypeInfo()),
      InstallV8FaceDetectorTemplate);
}

bool V8FaceDetector::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8FaceDetector::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8FaceDetector::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8FaceDetector::GetWrapperTypeInfo(), v8_value);
}

FaceDetector* V8FaceDetector::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

FaceDetector* NativeValueTraits<FaceDetector>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  FaceDetector* native_value = V8FaceDetector::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
