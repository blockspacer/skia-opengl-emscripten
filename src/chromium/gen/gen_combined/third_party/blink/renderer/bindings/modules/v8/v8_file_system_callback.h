...
template <>
class V8PersistentCallbackInterface<V8FileSystemCallback> final : public V8PersistentCallbackInterfaceBase {
 ...
 public:
  ...
  MODULES_EXPORT v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMFileSystem* fileSystem) WARN_UNUSED_RESULT;
  MODULES_EXPORT void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMFileSystem* fileSystem);
