...
v8::Maybe<void> V8MetadataCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Metadata* metadata) {
  ...
  v8::Local<v8::Value> v8_metadata = ToV8(metadata, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_metadata };
...
void V8MetadataCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Metadata* metadata) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8MetadataCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Metadata* metadata) {
  return Proxy()->handleEvent(
      callback_this_value, metadata);
}

void V8PersistentCallbackInterface<V8MetadataCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Metadata* metadata) {
