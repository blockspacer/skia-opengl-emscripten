...
static const v8::Eternal<v8::Name>* eternalV8GPUBindGroupLayoutDescriptorKeys(v8::Isolate* isolate) {
...
void V8GPUBindGroupLayoutDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GPUBindGroupLayoutDescriptor* impl, ExceptionState& exception_state) {
  if (IsUndefinedOrNull(v8_value)) {
    exception_state.ThrowTypeError("Missing required member(s): bindings.");
    return;
  }
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GPUBindGroupLayoutDescriptorKeys(isolate);
  ...
  if (bindings_value.IsEmpty() || bindings_value->IsUndefined()) {
    ...
    HeapVector<Member<GPUBindGroupLayoutBinding>> bindings_cpp_value = NativeValueTraits<IDLSequence<GPUBindGroupLayoutBinding>>::NativeValue(isolate, bindings_value, exception_state);
...
GPUBindGroupLayoutDescriptor* NativeValueTraits<GPUBindGroupLayoutDescriptor>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GPUBindGroupLayoutDescriptor* impl = GPUBindGroupLayoutDescriptor::Create();
