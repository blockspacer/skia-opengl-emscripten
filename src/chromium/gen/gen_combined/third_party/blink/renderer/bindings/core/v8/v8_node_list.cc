...
#endif
const WrapperTypeInfo v8_node_list_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& NodeList::wrapper_type_info_ = v8_node_list_wrapper_type_info;
...
namespace node_list_v8_internal {
...
static void ItemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "NodeList", "item");
...
void V8NodeList::LengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  node_list_v8_internal::LengthAttributeGetter(info);
}
...
void V8NodeList::ItemMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  node_list_v8_internal::ItemMethod(info);
}

void V8NodeList::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertyGetter");

  node_list_v8_internal::IndexedPropertyGetter(index, info);
}

void V8NodeList::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  node_list_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8NodeList::IndexedPropertySetterCallback(
    uint32_t index,
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8NodeListAccessors[] = {
    { "length", V8NodeList::LengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasNoSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8NodeListMethods[] = {
...
static void InstallV8NodeListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8NodeList::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8NodeList::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8NodeListAccessors, base::size(kV8NodeListAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8NodeListMethods, base::size(kV8NodeListMethods));
...
v8::Local<v8::FunctionTemplate> V8NodeList::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8NodeList::GetWrapperTypeInfo()),
      InstallV8NodeListTemplate);
}

bool V8NodeList::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8NodeList::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8NodeList::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8NodeList::GetWrapperTypeInfo(), v8_value);
}

NodeList* V8NodeList::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

NodeList* NativeValueTraits<NodeList>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  NodeList* native_value = V8NodeList::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
