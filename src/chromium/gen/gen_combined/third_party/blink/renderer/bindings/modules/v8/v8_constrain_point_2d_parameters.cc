...
void V8ConstrainPoint2DParameters::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ConstrainPoint2DParameters* impl, ExceptionState& exception_state) {
  ...
  if (exact_value.IsEmpty() || exact_value->IsUndefined()) {
    ...
    HeapVector<Member<Point2D>> exact_cpp_value = NativeValueTraits<IDLSequence<Point2D>>::NativeValue(isolate, exact_value, exception_state);
  ...
  if (ideal_value.IsEmpty() || ideal_value->IsUndefined()) {
    ...
    HeapVector<Member<Point2D>> ideal_cpp_value = NativeValueTraits<IDLSequence<Point2D>>::NativeValue(isolate, ideal_value, exception_state);
    if (exception_state.HadException())
      return;
...
ConstrainPoint2DParameters* NativeValueTraits<ConstrainPoint2DParameters>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  ConstrainPoint2DParameters* impl = ConstrainPoint2DParameters::Create();
  V8ConstrainPoint2DParameters::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
