...
namespace shadow_root_partial_v8_internal {
...
void V8ShadowRootPartial::PictureInPictureElementAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8ShadowRoot_PictureInPictureElement_AttributeGetter);

  shadow_root_partial_v8_internal::PictureInPictureElementAttributeGetter(info);
}
...
void V8ShadowRootPartial::InstallV8ShadowRootTemplate(
  ...
  V8ShadowRoot::InstallV8ShadowRootTemplate(isolate, world, interface_template);
