...
void V8Point2D::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, Point2D* impl, ExceptionState& exception_state) {
...
Point2D* NativeValueTraits<Point2D>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  Point2D* impl = Point2D::Create();
  V8Point2D::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
