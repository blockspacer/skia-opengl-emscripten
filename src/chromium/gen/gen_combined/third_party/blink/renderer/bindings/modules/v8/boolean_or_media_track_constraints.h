...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_BOOLEAN_OR_MEDIA_TRACK_CONSTRAINTS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_BOOLEAN_OR_MEDIA_TRACK_CONSTRAINTS_H_
...
class MODULES_EXPORT BooleanOrMediaTrackConstraints final {
 ...
 public:
  ...
  void SetMediaTrackConstraints(MediaTrackConstraints*);
  static BooleanOrMediaTrackConstraints FromMediaTrackConstraints(MediaTrackConstraints*);
 ...
 private:
  ...
  bool boolean_;
  Member<MediaTrackConstraints> media_track_constraints_;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_BOOLEAN_OR_MEDIA_TRACK_CONSTRAINTS_H_
