...
#endif
const WrapperTypeInfo v8_html_font_element_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLFontElement::wrapper_type_info_ = v8_html_font_element_wrapper_type_info;
...
namespace html_font_element_v8_internal {
...
static void ColorAttributeSetter(
  ...
  impl->setAttribute(html_names::kColorAttr, cpp_value);
}
...
static void FaceAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueString(info, impl->FastGetAttribute(html_names::kFaceAttr), info.GetIsolate());
}

static void FaceAttributeSetter(
    v8::Local<v8::Value> v8_value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  ALLOW_UNUSED_LOCAL(isolate);
  ...
  impl->setAttribute(html_names::kFaceAttr, cpp_value);
}
...
static void SizeAttributeSetter(
  ...
  impl->setAttribute(html_names::kSizeAttr, cpp_value);
}
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("HTMLFontElement"));
    return;
  }
  ...
  V8HTMLConstructor::HtmlConstructor(
      info, *V8HTMLFontElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLFontElement);
}
...
void V8HTMLFontElement::ColorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_font_element_v8_internal::ColorAttributeGetter(info);
}

void V8HTMLFontElement::ColorAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFontElement_color_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_font_element_v8_internal::ColorAttributeSetter(v8_value, info);
}
...
void V8HTMLFontElement::FaceAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_font_element_v8_internal::FaceAttributeGetter(info);
}

void V8HTMLFontElement::FaceAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFontElement_face_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_font_element_v8_internal::FaceAttributeSetter(v8_value, info);
}
...
void V8HTMLFontElement::SizeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_font_element_v8_internal::SizeAttributeGetter(info);
}

void V8HTMLFontElement::SizeAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFontElement_size_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  html_font_element_v8_internal::SizeAttributeSetter(v8_value, info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8HTMLFontElementAccessors[] = {
...
static void InstallV8HTMLFontElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8HTMLFontElement::GetWrapperTypeInfo()->interface_name, V8HTMLElement::DomTemplate(isolate, world), V8HTMLFontElement::kInternalFieldCount);
  interface_template->SetCallHandler(html_font_element_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HTMLFontElementAccessors, base::size(kV8HTMLFontElementAccessors));
...
v8::Local<v8::FunctionTemplate> V8HTMLFontElement::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8HTMLFontElement::GetWrapperTypeInfo()),
      InstallV8HTMLFontElementTemplate);
}

bool V8HTMLFontElement::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8HTMLFontElement::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8HTMLFontElement::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8HTMLFontElement::GetWrapperTypeInfo(), v8_value);
}

HTMLFontElement* V8HTMLFontElement::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

HTMLFontElement* NativeValueTraits<HTMLFontElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HTMLFontElement* native_value = V8HTMLFontElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
