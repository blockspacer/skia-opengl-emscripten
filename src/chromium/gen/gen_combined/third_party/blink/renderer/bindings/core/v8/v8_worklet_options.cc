...
void V8WorkletOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, WorkletOptions* impl, ExceptionState& exception_state) {
...
WorkletOptions* NativeValueTraits<WorkletOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  WorkletOptions* impl = WorkletOptions::Create();
  V8WorkletOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
