...
static const v8::Eternal<v8::Name>* eternalV8CookieStoreDeleteOptionsKeys(v8::Isolate* isolate) {
...
void V8CookieStoreDeleteOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, CookieStoreDeleteOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8CookieStoreDeleteOptionsKeys(isolate);
  ...
  if (!v8Object->Get(context, keys[2].Get(isolate)).ToLocal(&path_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
v8::Local<v8::Value> CookieStoreDeleteOptions::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8CookieStoreDeleteOptions(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8CookieStoreDeleteOptions(const CookieStoreDeleteOptions* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8CookieStoreDeleteOptionsKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
CookieStoreDeleteOptions* NativeValueTraits<CookieStoreDeleteOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  CookieStoreDeleteOptions* impl = CookieStoreDeleteOptions::Create();
  V8CookieStoreDeleteOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
