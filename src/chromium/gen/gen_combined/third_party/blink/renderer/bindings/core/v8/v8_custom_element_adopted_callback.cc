...
v8::Maybe<void> V8CustomElementAdoptedCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Document* oldOwner, Document* newOwner) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "CustomElementAdoptedCallback",
          "invoke");
  ...
  v8::Local<v8::Value> v8_oldOwner = ToV8(oldOwner, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_newOwner = ToV8(newOwner, argument_creation_context, GetIsolate());
  constexpr int argc = 2;
  v8::Local<v8::Value> argv[] = { v8_oldOwner, v8_newOwner };
...
void V8CustomElementAdoptedCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Document* oldOwner, Document* newOwner) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, oldOwner, newOwner);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

v8::Maybe<void> V8PersistentCallbackFunction<V8CustomElementAdoptedCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Document* oldOwner, Document* newOwner) {
  return Proxy()->Invoke(
      callback_this_value, oldOwner, newOwner);
}

void V8PersistentCallbackFunction<V8CustomElementAdoptedCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Document* oldOwner, Document* newOwner) {
