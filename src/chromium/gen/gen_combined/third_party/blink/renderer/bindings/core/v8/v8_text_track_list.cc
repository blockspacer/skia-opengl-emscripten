...
#endif
const WrapperTypeInfo v8_text_track_list_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& TextTrackList::wrapper_type_info_ = v8_text_track_list_wrapper_type_info;
...
namespace text_track_list_v8_internal {
...
void V8TextTrackList::LengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  text_track_list_v8_internal::LengthAttributeGetter(info);
}
...
void V8TextTrackList::OnchangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  text_track_list_v8_internal::OnchangeAttributeGetter(info);
}

void V8TextTrackList::OnchangeAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_onchange_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  text_track_list_v8_internal::OnchangeAttributeSetter(v8_value, info);
}
...
void V8TextTrackList::OnaddtrackAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  text_track_list_v8_internal::OnaddtrackAttributeGetter(info);
}

void V8TextTrackList::OnaddtrackAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_onaddtrack_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  text_track_list_v8_internal::OnaddtrackAttributeSetter(v8_value, info);
}
...
void V8TextTrackList::OnremovetrackAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  text_track_list_v8_internal::OnremovetrackAttributeGetter(info);
}

void V8TextTrackList::OnremovetrackAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_onremovetrack_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  text_track_list_v8_internal::OnremovetrackAttributeSetter(v8_value, info);
}
...
void V8TextTrackList::GetTrackByIdMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  text_track_list_v8_internal::GetTrackByIdMethod(info);
}

void V8TextTrackList::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_IndexedPropertyGetter");

  text_track_list_v8_internal::IndexedPropertyGetter(index, info);
}

void V8TextTrackList::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  text_track_list_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8TextTrackList::IndexedPropertySetterCallback(
    uint32_t index,
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8TextTrackListAccessors[] = {
    { "length", V8TextTrackList::LengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
...
static constexpr V8DOMConfiguration::MethodConfiguration kV8TextTrackListMethods[] = {
...
static void InstallV8TextTrackListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8TextTrackList::GetWrapperTypeInfo()->interface_name, V8EventTarget::DomTemplate(isolate, world), V8TextTrackList::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8TextTrackListAccessors, base::size(kV8TextTrackListAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8TextTrackListMethods, base::size(kV8TextTrackListMethods));
...
v8::Local<v8::FunctionTemplate> V8TextTrackList::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8TextTrackList::GetWrapperTypeInfo()),
      InstallV8TextTrackListTemplate);
}

bool V8TextTrackList::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8TextTrackList::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8TextTrackList::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8TextTrackList::GetWrapperTypeInfo(), v8_value);
}

TextTrackList* V8TextTrackList::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

TextTrackList* NativeValueTraits<TextTrackList>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  TextTrackList* native_value = V8TextTrackList::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
