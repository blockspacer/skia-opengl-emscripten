...
v8::Maybe<void> V8PerformanceObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
...
void V8PerformanceObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8PerformanceObserverCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, entries, observer);
}

void V8PersistentCallbackFunction<V8PerformanceObserverCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
