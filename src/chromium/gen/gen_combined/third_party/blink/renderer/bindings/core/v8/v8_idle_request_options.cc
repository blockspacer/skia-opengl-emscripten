...
void V8IdleRequestOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, IdleRequestOptions* impl, ExceptionState& exception_state) {
...
bool toV8IdleRequestOptions(const IdleRequestOptions* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasTimeout()) {
    ...
    timeout_value = v8::Integer::NewFromUnsigned(isolate, 0u);
    timeout_has_value_or_default = true;
  }
...
IdleRequestOptions* NativeValueTraits<IdleRequestOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  IdleRequestOptions* impl = IdleRequestOptions::Create();
  V8IdleRequestOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
