...
#endif
const WrapperTypeInfo v8_webgl_lose_context_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& WebGLLoseContext::wrapper_type_info_ = v8_webgl_lose_context_wrapper_type_info;
...
namespace webgl_lose_context_v8_internal {
...
void V8WebGLLoseContext::LoseContextMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  webgl_lose_context_v8_internal::LoseContextMethod(info);
}
...
void V8WebGLLoseContext::RestoreContextMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  webgl_lose_context_v8_internal::RestoreContextMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8WebGLLoseContextMethods[] = {
...
static void InstallV8WebGLLoseContextTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8WebGLLoseContext::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8WebGLLoseContext::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, kV8WebGLLoseContextMethods, base::size(kV8WebGLLoseContextMethods));
...
v8::Local<v8::FunctionTemplate> V8WebGLLoseContext::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8WebGLLoseContext::GetWrapperTypeInfo()),
      InstallV8WebGLLoseContextTemplate);
}

bool V8WebGLLoseContext::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8WebGLLoseContext::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8WebGLLoseContext::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8WebGLLoseContext::GetWrapperTypeInfo(), v8_value);
}

WebGLLoseContext* V8WebGLLoseContext::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

WebGLLoseContext* NativeValueTraits<WebGLLoseContext>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  WebGLLoseContext* native_value = V8WebGLLoseContext::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
