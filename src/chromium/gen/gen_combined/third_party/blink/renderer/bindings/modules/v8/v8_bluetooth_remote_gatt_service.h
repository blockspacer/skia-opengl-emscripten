...
MODULES_EXPORT extern const WrapperTypeInfo v8_bluetooth_remote_gatt_service_wrapper_type_info;
...
class V8BluetoothRemoteGATTService {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_bluetooth_remote_gatt_service_wrapper_type_info;
  }
