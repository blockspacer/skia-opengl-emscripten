...
CORE_EXPORT extern WrapperTypeInfo v8_html_canvas_element_wrapper_type_info;
...
class V8HTMLCanvasElement {
 ...
 public:
  ...
  CORE_EXPORT static constexpr WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_html_canvas_element_wrapper_type_info;
  }
  ...
  CORE_EXPORT static void InstallV8HTMLCanvasElementTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
 ...
 private:
  static InstallTemplateFunction install_v8_html_canvas_element_template_function_;
};
