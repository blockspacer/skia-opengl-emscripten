...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SHARED_ARRAY_BUFFER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SHARED_ARRAY_BUFFER_H_
...
CORE_EXPORT extern const WrapperTypeInfo v8_shared_array_buffer_wrapper_type_info;
...
class V8SharedArrayBuffer {
 ...
 public:
  ...
  CORE_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_shared_array_buffer_wrapper_type_info;
  }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SHARED_ARRAY_BUFFER_H_
