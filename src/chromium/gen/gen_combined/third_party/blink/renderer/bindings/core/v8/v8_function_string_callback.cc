...
v8::Maybe<void> V8FunctionStringCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& data) {
...
void V8FunctionStringCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& data) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8FunctionStringCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& data) {
  return Proxy()->Invoke(
      callback_this_value, data);
}

void V8PersistentCallbackFunction<V8FunctionStringCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& data) {
