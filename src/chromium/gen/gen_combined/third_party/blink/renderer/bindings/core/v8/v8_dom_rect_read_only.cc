...
#endif
const WrapperTypeInfo v8_dom_rect_read_only_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& DOMRectReadOnly::wrapper_type_info_ = v8_dom_rect_read_only_wrapper_type_info;
...
namespace dom_rect_read_only_v8_internal {
...
static void FromRectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "DOMRectReadOnly", "fromRect");
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "DOMRectReadOnly");
  ...
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8DOMRectReadOnly::GetWrapperTypeInfo(), wrapper);
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("DOMRectReadOnly"));
    return;
  }
  ...
  dom_rect_read_only_v8_internal::Constructor(info);
}
...
void V8DOMRectReadOnly::XAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::XAttributeGetter(info);
}
...
void V8DOMRectReadOnly::YAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::YAttributeGetter(info);
}
...
void V8DOMRectReadOnly::WidthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::WidthAttributeGetter(info);
}
...
void V8DOMRectReadOnly::HeightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::HeightAttributeGetter(info);
}
...
void V8DOMRectReadOnly::TopAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::TopAttributeGetter(info);
}
...
void V8DOMRectReadOnly::RightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::RightAttributeGetter(info);
}
...
void V8DOMRectReadOnly::BottomAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::BottomAttributeGetter(info);
}
...
void V8DOMRectReadOnly::LeftAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::LeftAttributeGetter(info);
}
...
void V8DOMRectReadOnly::FromRectMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::FromRectMethod(info);
}
...
void V8DOMRectReadOnly::ToJSONMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_rect_read_only_v8_internal::ToJSONMethod(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8DOMRectReadOnlyAccessors[] = {
    { "x", V8DOMRectReadOnly::XAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "y", V8DOMRectReadOnly::YAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "width", V8DOMRectReadOnly::WidthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "height", V8DOMRectReadOnly::HeightAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "top", V8DOMRectReadOnly::TopAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "right", V8DOMRectReadOnly::RightAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "bottom", V8DOMRectReadOnly::BottomAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "left", V8DOMRectReadOnly::LeftAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8DOMRectReadOnlyMethods[] = {
...
static void InstallV8DOMRectReadOnlyTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8DOMRectReadOnly::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8DOMRectReadOnly::kInternalFieldCount);
  interface_template->SetCallHandler(dom_rect_read_only_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8DOMRectReadOnlyAccessors, base::size(kV8DOMRectReadOnlyAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8DOMRectReadOnlyMethods, base::size(kV8DOMRectReadOnlyMethods));
...
v8::Local<v8::FunctionTemplate> V8DOMRectReadOnly::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8DOMRectReadOnly::GetWrapperTypeInfo()),
      InstallV8DOMRectReadOnlyTemplate);
}

bool V8DOMRectReadOnly::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8DOMRectReadOnly::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8DOMRectReadOnly::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8DOMRectReadOnly::GetWrapperTypeInfo(), v8_value);
}

DOMRectReadOnly* V8DOMRectReadOnly::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMRectReadOnly* NativeValueTraits<DOMRectReadOnly>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMRectReadOnly* native_value = V8DOMRectReadOnly::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
