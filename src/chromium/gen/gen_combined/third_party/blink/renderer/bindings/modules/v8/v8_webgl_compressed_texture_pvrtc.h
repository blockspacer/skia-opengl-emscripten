...
MODULES_EXPORT extern const WrapperTypeInfo v8_webgl_compressed_texture_pvrtc_wrapper_type_info;
...
class V8WebGLCompressedTexturePVRTC {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_webgl_compressed_texture_pvrtc_wrapper_type_info;
  }
