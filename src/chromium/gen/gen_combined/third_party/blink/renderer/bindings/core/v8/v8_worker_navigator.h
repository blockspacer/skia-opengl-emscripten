...
CORE_EXPORT extern WrapperTypeInfo v8_worker_navigator_wrapper_type_info;
...
class V8WorkerNavigator {
 ...
 public:
  ...
  CORE_EXPORT static constexpr WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_worker_navigator_wrapper_type_info;
  }
  ...
  CORE_EXPORT static void InstallV8WorkerNavigatorTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
 ...
 private:
  static InstallTemplateFunction install_v8_worker_navigator_template_function_;
};
