...
MODULES_EXPORT extern const WrapperTypeInfo v8_rtc_peer_connection_ice_event_wrapper_type_info;
...
class V8RTCPeerConnectionIceEvent {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_rtc_peer_connection_ice_event_wrapper_type_info;
  }
