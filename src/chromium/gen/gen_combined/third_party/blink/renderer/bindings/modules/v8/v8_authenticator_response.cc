...
AuthenticatorResponse* NativeValueTraits<AuthenticatorResponse>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  AuthenticatorResponse* native_value = V8AuthenticatorResponse::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
