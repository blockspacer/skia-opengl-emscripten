...
void V8CookieChangeEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, CookieChangeEventInit* impl, ExceptionState& exception_state) {
...
CookieChangeEventInit* NativeValueTraits<CookieChangeEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  CookieChangeEventInit* impl = CookieChangeEventInit::Create();
  V8CookieChangeEventInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
