...
#endif
const WrapperTypeInfo v8_css_import_rule_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& CSSImportRule::wrapper_type_info_ = v8_css_import_rule_wrapper_type_info;
...
namespace css_import_rule_v8_internal {
...
static void MediaAttributeSetter(
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "CSSImportRule", "media");
...
static void StyleSheetAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  CSSStyleSheet* cpp_value(WTF::GetPtr(impl->styleSheet()));
...
void V8CSSImportRule::HrefAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  css_import_rule_v8_internal::HrefAttributeGetter(info);
}
...
void V8CSSImportRule::MediaAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  css_import_rule_v8_internal::MediaAttributeGetter(info);
}

void V8CSSImportRule::MediaAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSImportRule_media_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  css_import_rule_v8_internal::MediaAttributeSetter(v8_value, info);
}
...
void V8CSSImportRule::StyleSheetAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  css_import_rule_v8_internal::StyleSheetAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8CSSImportRuleAccessors[] = {
    { "href", V8CSSImportRule::HrefAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "media", V8CSSImportRule::MediaAttributeGetterCallback, V8CSSImportRule::MediaAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "styleSheet", V8CSSImportRule::StyleSheetAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8CSSImportRuleTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8CSSImportRule::GetWrapperTypeInfo()->interface_name, V8CSSRule::DomTemplate(isolate, world), V8CSSImportRule::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8CSSImportRuleAccessors, base::size(kV8CSSImportRuleAccessors));
...
v8::Local<v8::FunctionTemplate> V8CSSImportRule::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8CSSImportRule::GetWrapperTypeInfo()),
      InstallV8CSSImportRuleTemplate);
}

bool V8CSSImportRule::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8CSSImportRule::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8CSSImportRule::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8CSSImportRule::GetWrapperTypeInfo(), v8_value);
}

CSSImportRule* V8CSSImportRule::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

CSSImportRule* NativeValueTraits<CSSImportRule>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  CSSImportRule* native_value = V8CSSImportRule::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
