...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8HashChangeEventAccessors[] = {
...
static void InstallV8HashChangeEventTemplate(
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HashChangeEventAccessors, base::size(kV8HashChangeEventAccessors));
...
HashChangeEvent* NativeValueTraits<HashChangeEvent>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HashChangeEvent* native_value = V8HashChangeEvent::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
