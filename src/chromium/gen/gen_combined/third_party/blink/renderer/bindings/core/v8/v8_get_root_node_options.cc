...
void V8GetRootNodeOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, GetRootNodeOptions* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[0].Get(isolate)).ToLocal(&composed_value)) {
...
bool toV8GetRootNodeOptions(const GetRootNodeOptions* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (composed_has_value_or_default &&
      !create_property(0, composed_value)) {
    return false;
  }
...
GetRootNodeOptions* NativeValueTraits<GetRootNodeOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  GetRootNodeOptions* impl = GetRootNodeOptions::Create();
  V8GetRootNodeOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
