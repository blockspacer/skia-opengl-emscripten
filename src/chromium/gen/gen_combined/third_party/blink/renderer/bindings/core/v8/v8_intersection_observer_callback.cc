...
v8::Maybe<void> V8IntersectionObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
...
void V8IntersectionObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8IntersectionObserverCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, entries, observer);
}

void V8PersistentCallbackFunction<V8IntersectionObserverCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
