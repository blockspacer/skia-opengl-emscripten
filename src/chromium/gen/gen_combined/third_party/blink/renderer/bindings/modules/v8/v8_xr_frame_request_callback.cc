...
v8::Maybe<void> V8XRFrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double time, XRFrame* frame) {
...
void V8XRFrameRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double time, XRFrame* frame) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8XRFrameRequestCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double time, XRFrame* frame) {
  return Proxy()->Invoke(
      callback_this_value, time, frame);
}

void V8PersistentCallbackFunction<V8XRFrameRequestCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double time, XRFrame* frame) {
