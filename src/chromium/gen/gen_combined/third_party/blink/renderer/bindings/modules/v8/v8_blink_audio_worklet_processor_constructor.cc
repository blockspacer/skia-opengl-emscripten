...
v8::Maybe<ScriptValue> V8BlinkAudioWorkletProcessorConstructor::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue options) {
  ...
  v8::Local<v8::Value> argv[] = { v8_options };
...
v8::Maybe<ScriptValue> V8BlinkAudioWorkletProcessorConstructor::Construct(ScriptValue options) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "BlinkAudioWorkletProcessorConstructor",
          "construct");
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8BlinkAudioWorkletProcessorConstructor>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue options) {
  return Proxy()->Invoke(
      callback_this_value, options);
}
