...
void V8PaymentMethodData::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PaymentMethodData* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[1].Get(isolate)).ToLocal(&supported_methods_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
bool toV8PaymentMethodData(const PaymentMethodData* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (supported_methods_has_value_or_default &&
      !create_property(1, supported_methods_value)) {
    return false;
  }
...
PaymentMethodData* NativeValueTraits<PaymentMethodData>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PaymentMethodData* impl = PaymentMethodData::Create();
  V8PaymentMethodData::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
