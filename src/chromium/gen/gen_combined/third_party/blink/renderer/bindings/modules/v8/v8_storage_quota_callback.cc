...
v8::Maybe<void> V8StorageQuotaCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t grantedQuotaInBytes) {
...
void V8StorageQuotaCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t grantedQuotaInBytes) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8StorageQuotaCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t grantedQuotaInBytes) {
  return Proxy()->Invoke(
      callback_this_value, grantedQuotaInBytes);
}

void V8PersistentCallbackFunction<V8StorageQuotaCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t grantedQuotaInBytes) {
