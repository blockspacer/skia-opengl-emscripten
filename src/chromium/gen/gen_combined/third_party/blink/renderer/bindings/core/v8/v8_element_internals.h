...
template <>
struct NativeValueTraits<ElementInternals> : public NativeValueTraitsBase<ElementInternals> {
  CORE_EXPORT static ElementInternals* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static ElementInternals* NullValue() { return nullptr; }
};
