...
#endif
const WrapperTypeInfo v8_svg_filter_element_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& SVGFilterElement::wrapper_type_info_ = v8_svg_filter_element_wrapper_type_info;
...
namespace svg_filter_element_v8_internal {
...
void V8SVGFilterElement::FilterUnitsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::FilterUnitsAttributeGetter(info);
}
...
void V8SVGFilterElement::PrimitiveUnitsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::PrimitiveUnitsAttributeGetter(info);
}
...
void V8SVGFilterElement::XAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::XAttributeGetter(info);
}
...
void V8SVGFilterElement::YAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::YAttributeGetter(info);
}
...
void V8SVGFilterElement::WidthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::WidthAttributeGetter(info);
}
...
void V8SVGFilterElement::HeightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::HeightAttributeGetter(info);
}
...
void V8SVGFilterElement::HrefAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_filter_element_v8_internal::HrefAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8SVGFilterElementAccessors[] = {
    { "filterUnits", V8SVGFilterElement::FilterUnitsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "primitiveUnits", V8SVGFilterElement::PrimitiveUnitsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "x", V8SVGFilterElement::XAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "y", V8SVGFilterElement::YAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "width", V8SVGFilterElement::WidthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "height", V8SVGFilterElement::HeightAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "href", V8SVGFilterElement::HrefAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8SVGFilterElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8SVGFilterElement::GetWrapperTypeInfo()->interface_name, V8SVGElement::DomTemplate(isolate, world), V8SVGFilterElement::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8SVGFilterElementAccessors, base::size(kV8SVGFilterElementAccessors));
...
v8::Local<v8::FunctionTemplate> V8SVGFilterElement::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8SVGFilterElement::GetWrapperTypeInfo()),
      InstallV8SVGFilterElementTemplate);
}

bool V8SVGFilterElement::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8SVGFilterElement::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8SVGFilterElement::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8SVGFilterElement::GetWrapperTypeInfo(), v8_value);
}

SVGFilterElement* V8SVGFilterElement::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

SVGFilterElement* NativeValueTraits<SVGFilterElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SVGFilterElement* native_value = V8SVGFilterElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
