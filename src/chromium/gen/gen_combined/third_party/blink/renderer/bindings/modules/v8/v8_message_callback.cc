...
const char* V8MessageCallback::NameInHeapSnapshot() const {
  return "V8MessageCallback";
}

v8::Maybe<void> V8MessageCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const NDEFMessage*& message) {
...
void V8MessageCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const NDEFMessage*& message) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8MessageCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const NDEFMessage*& message) {
  return Proxy()->Invoke(
      callback_this_value, message);
}

void V8PersistentCallbackFunction<V8MessageCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const NDEFMessage*& message) {
