...
#endif
const WrapperTypeInfo v8_html_all_collection_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLAllCollection::wrapper_type_info_ = v8_html_all_collection_wrapper_type_info;
...
namespace html_all_collection_v8_internal {
...
void V8HTMLAllCollection::LengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_all_collection_v8_internal::LengthAttributeGetter(info);
}
...
void V8HTMLAllCollection::NamedItemMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_all_collection_v8_internal::NamedItemMethod(info);
}
...
void V8HTMLAllCollection::NamedPropertyGetterCallback(
  ...
  html_all_collection_v8_internal::NamedPropertyGetter(property_name, info);
}

void V8HTMLAllCollection::NamedPropertyQueryCallback(
  ...
  html_all_collection_v8_internal::NamedPropertyQuery(property_name, info);
}

void V8HTMLAllCollection::NamedPropertyEnumeratorCallback(
    const v8::PropertyCallbackInfo<v8::Array>& info) {
  html_all_collection_v8_internal::NamedPropertyEnumerator(info);
}

void V8HTMLAllCollection::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_IndexedPropertyGetter");

  html_all_collection_v8_internal::IndexedPropertyGetter(index, info);
}

void V8HTMLAllCollection::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  html_all_collection_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8HTMLAllCollection::IndexedPropertySetterCallback(
    uint32_t index,
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8HTMLAllCollectionAccessors[] = {
    { "length", V8HTMLAllCollection::LengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8HTMLAllCollectionMethods[] = {
...
static void InstallV8HTMLAllCollectionTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8HTMLAllCollection::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8HTMLAllCollection::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HTMLAllCollectionAccessors, base::size(kV8HTMLAllCollectionAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8HTMLAllCollectionMethods, base::size(kV8HTMLAllCollectionMethods));
  ...
  instance_template->SetCallAsFunctionHandler(V8HTMLAllCollection::LegacyCallCustom);
...
v8::Local<v8::FunctionTemplate> V8HTMLAllCollection::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8HTMLAllCollection::GetWrapperTypeInfo()),
      InstallV8HTMLAllCollectionTemplate);
}

bool V8HTMLAllCollection::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8HTMLAllCollection::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8HTMLAllCollection::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8HTMLAllCollection::GetWrapperTypeInfo(), v8_value);
}

HTMLAllCollection* V8HTMLAllCollection::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

HTMLAllCollection* NativeValueTraits<HTMLAllCollection>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HTMLAllCollection* native_value = V8HTMLAllCollection::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
