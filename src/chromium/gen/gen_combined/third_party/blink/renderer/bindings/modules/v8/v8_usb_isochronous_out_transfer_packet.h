...
MODULES_EXPORT extern const WrapperTypeInfo v8_usb_isochronous_out_transfer_packet_wrapper_type_info;
...
class V8USBIsochronousOutTransferPacket {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_usb_isochronous_out_transfer_packet_wrapper_type_info;
  }
