...
void V8ImageObject::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ImageObject* impl, ExceptionState& exception_state) {
...
ImageObject* NativeValueTraits<ImageObject>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  ImageObject* impl = ImageObject::Create();
  V8ImageObject::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
