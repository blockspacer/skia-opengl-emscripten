...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_EVENT_LISTENER_OPTIONS_OR_BOOLEAN_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_EVENT_LISTENER_OPTIONS_OR_BOOLEAN_H_
...
class CORE_EXPORT EventListenerOptionsOrBoolean final {
 ...
 private:
  ...
  bool boolean_;
  Member<EventListenerOptions> event_listener_options_;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_EVENT_LISTENER_OPTIONS_OR_BOOLEAN_H_
