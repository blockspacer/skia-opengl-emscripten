...
v8::Maybe<ScriptValue> V8LayoutCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<CustomLayoutChild>>& children, ScriptValue edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) {
  ...
  v8::Local<v8::Value> v8_children = ToV8(children, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_edges = edges.V8Value();
  v8::Local<v8::Value> v8_constraints = ToV8(constraints, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_styleMap = ToV8(styleMap, argument_creation_context, GetIsolate());
  constexpr int argc = 4;
  v8::Local<v8::Value> argv[] = { v8_children, v8_edges, v8_constraints, v8_styleMap };
...
v8::Maybe<ScriptValue> V8LayoutCallback::Construct(const HeapVector<Member<CustomLayoutChild>>& children, ScriptValue edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "LayoutCallback",
          "construct");
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8LayoutCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<CustomLayoutChild>>& children, ScriptValue edges, CustomLayoutConstraints* constraints, StylePropertyMapReadOnly* styleMap) {
  return Proxy()->Invoke(
      callback_this_value, children, edges, constraints, styleMap);
}
