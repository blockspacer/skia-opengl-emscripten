...
#endif
const WrapperTypeInfo v8_svg_fe_morphology_element_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& SVGFEMorphologyElement::wrapper_type_info_ = v8_svg_fe_morphology_element_wrapper_type_info;
...
namespace svg_fe_morphology_element_v8_internal {
...
void V8SVGFEMorphologyElement::SVGMORPHOLOGYOPERATORUNKNOWNConstantGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8SVGFEMorphologyElement::SVGMORPHOLOGYOPERATORERODEConstantGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8SVGFEMorphologyElement::SVGMORPHOLOGYOPERATORDILATEConstantGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8SVGFEMorphologyElement::In1AttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::In1AttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::OperatorAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::OperatorAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::RadiusXAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::RadiusXAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::RadiusYAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::RadiusYAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::XAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::XAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::YAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::YAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::WidthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::WidthAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::HeightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::HeightAttributeGetter(info);
}
...
void V8SVGFEMorphologyElement::ResultAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_morphology_element_v8_internal::ResultAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8SVGFEMorphologyElementAccessors[] = {
    { "in1", V8SVGFEMorphologyElement::In1AttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "operator", V8SVGFEMorphologyElement::OperatorAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "radiusX", V8SVGFEMorphologyElement::RadiusXAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "radiusY", V8SVGFEMorphologyElement::RadiusYAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "x", V8SVGFEMorphologyElement::XAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "y", V8SVGFEMorphologyElement::YAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "width", V8SVGFEMorphologyElement::WidthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "height", V8SVGFEMorphologyElement::HeightAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "result", V8SVGFEMorphologyElement::ResultAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8SVGFEMorphologyElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8SVGFEMorphologyElement::GetWrapperTypeInfo()->interface_name, V8SVGElement::DomTemplate(isolate, world), V8SVGFEMorphologyElement::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallConstantWithGetter(
      ...
      "SVG_MORPHOLOGY_OPERATOR_UNKNOWN", V8SVGFEMorphologyElement::SVGMORPHOLOGYOPERATORUNKNOWNConstantGetterCallback);
  V8DOMConfiguration::InstallConstantWithGetter(
      isolate, interface_template, prototype_template,
      "SVG_MORPHOLOGY_OPERATOR_ERODE", V8SVGFEMorphologyElement::SVGMORPHOLOGYOPERATORERODEConstantGetterCallback);
  V8DOMConfiguration::InstallConstantWithGetter(
      isolate, interface_template, prototype_template,
      "SVG_MORPHOLOGY_OPERATOR_DILATE", V8SVGFEMorphologyElement::SVGMORPHOLOGYOPERATORDILATEConstantGetterCallback);
  V8DOMConfiguration::InstallAccessors(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8SVGFEMorphologyElementAccessors, base::size(kV8SVGFEMorphologyElementAccessors));
...
v8::Local<v8::FunctionTemplate> V8SVGFEMorphologyElement::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8SVGFEMorphologyElement::GetWrapperTypeInfo()),
      InstallV8SVGFEMorphologyElementTemplate);
}

bool V8SVGFEMorphologyElement::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8SVGFEMorphologyElement::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8SVGFEMorphologyElement::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8SVGFEMorphologyElement::GetWrapperTypeInfo(), v8_value);
}

SVGFEMorphologyElement* V8SVGFEMorphologyElement::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

SVGFEMorphologyElement* NativeValueTraits<SVGFEMorphologyElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SVGFEMorphologyElement* native_value = V8SVGFEMorphologyElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
