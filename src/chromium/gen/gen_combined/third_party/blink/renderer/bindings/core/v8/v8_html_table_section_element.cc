...
void V8HTMLTableSectionElement::AlignAttributeSetterCallback(
  ...
  html_table_section_element_v8_internal::AlignAttributeSetter(v8_value, info);
}
...
void V8HTMLTableSectionElement::ChAttributeSetterCallback(
  ...
  html_table_section_element_v8_internal::ChAttributeSetter(v8_value, info);
}
...
void V8HTMLTableSectionElement::ChOffAttributeSetterCallback(
  ...
  html_table_section_element_v8_internal::ChOffAttributeSetter(v8_value, info);
}
...
void V8HTMLTableSectionElement::VAlignAttributeSetterCallback(
  ...
  html_table_section_element_v8_internal::VAlignAttributeSetter(v8_value, info);
}
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8HTMLTableSectionElementAccessors[] = {
...
static void InstallV8HTMLTableSectionElementTemplate(
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HTMLTableSectionElementAccessors, base::size(kV8HTMLTableSectionElementAccessors));
...
HTMLTableSectionElement* NativeValueTraits<HTMLTableSectionElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HTMLTableSectionElement* native_value = V8HTMLTableSectionElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
