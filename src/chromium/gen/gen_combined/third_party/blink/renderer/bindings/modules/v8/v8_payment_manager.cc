...
#endif
const WrapperTypeInfo v8_payment_manager_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& PaymentManager::wrapper_type_info_ = v8_payment_manager_wrapper_type_info;
...
namespace payment_manager_v8_internal {
...
static void InstrumentsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentInstruments* cpp_value(WTF::GetPtr(impl->instruments()));
...
static void UserHintAttributeSetter(
...
void V8PaymentManager::InstrumentsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  payment_manager_v8_internal::InstrumentsAttributeGetter(info);
}
...
void V8PaymentManager::UserHintAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  payment_manager_v8_internal::UserHintAttributeGetter(info);
}

void V8PaymentManager::UserHintAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentManager_userHint_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  payment_manager_v8_internal::UserHintAttributeSetter(v8_value, info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8PaymentManagerAccessors[] = {
    { "instruments", V8PaymentManager::InstrumentsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
...
static void InstallV8PaymentManagerTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8PaymentManager::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8PaymentManager::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8PaymentManagerAccessors, base::size(kV8PaymentManagerAccessors));
...
v8::Local<v8::FunctionTemplate> V8PaymentManager::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8PaymentManager::GetWrapperTypeInfo()),
      InstallV8PaymentManagerTemplate);
}

bool V8PaymentManager::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8PaymentManager::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8PaymentManager::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8PaymentManager::GetWrapperTypeInfo(), v8_value);
}

PaymentManager* V8PaymentManager::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

PaymentManager* NativeValueTraits<PaymentManager>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PaymentManager* native_value = V8PaymentManager::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
