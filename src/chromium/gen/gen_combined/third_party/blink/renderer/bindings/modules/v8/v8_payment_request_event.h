...
MODULES_EXPORT extern const WrapperTypeInfo v8_payment_request_event_wrapper_type_info;
...
class V8PaymentRequestEvent {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_payment_request_event_wrapper_type_info;
  }
  ...
  MODULES_EXPORT static void ChangePaymentMethodMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
