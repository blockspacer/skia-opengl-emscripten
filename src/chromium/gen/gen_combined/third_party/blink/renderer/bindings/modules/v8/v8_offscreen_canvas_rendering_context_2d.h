...
MODULES_EXPORT extern const WrapperTypeInfo v8_offscreen_canvas_rendering_context_2d_wrapper_type_info;
...
class V8OffscreenCanvasRenderingContext2D {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_offscreen_canvas_rendering_context_2d_wrapper_type_info;
  }
