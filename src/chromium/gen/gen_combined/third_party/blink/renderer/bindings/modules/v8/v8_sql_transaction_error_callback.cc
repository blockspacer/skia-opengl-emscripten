...
v8::Maybe<void> V8SQLTransactionErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLError* error) {
...
void V8SQLTransactionErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLError* error) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8SQLTransactionErrorCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLError* error) {
  return Proxy()->handleEvent(
      callback_this_value, error);
}

void V8PersistentCallbackInterface<V8SQLTransactionErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLError* error) {
