...
MODULES_EXPORT extern const WrapperTypeInfo v8_worklet_animation_wrapper_type_info;
...
class V8WorkletAnimation {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_worklet_animation_wrapper_type_info;
  }
  ...
  MODULES_EXPORT static void EffectAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void StartTimeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void PlaybackRateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void PlaybackRateAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
