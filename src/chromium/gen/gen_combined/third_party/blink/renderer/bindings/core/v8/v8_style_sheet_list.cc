...
#endif
const WrapperTypeInfo v8_style_sheet_list_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& StyleSheetList::wrapper_type_info_ = v8_style_sheet_list_wrapper_type_info;
...
namespace style_sheet_list_v8_internal {
...
static void ItemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "StyleSheetList", "item");
...
void V8StyleSheetList::LengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  style_sheet_list_v8_internal::LengthAttributeGetter(info);
}
...
void V8StyleSheetList::ItemMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kV8StyleSheetList_Item_Method);
  style_sheet_list_v8_internal::ItemMethod(info);
}

void V8StyleSheetList::NamedPropertyGetterCallback(
  ...
  style_sheet_list_v8_internal::NamedPropertyGetter(property_name, info);
}

void V8StyleSheetList::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_IndexedPropertyGetter");

  style_sheet_list_v8_internal::IndexedPropertyGetter(index, info);
}

void V8StyleSheetList::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  style_sheet_list_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8StyleSheetList::IndexedPropertySetterCallback(
    uint32_t index,
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8StyleSheetListAccessors[] = {
    { "length", V8StyleSheetList::LengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8StyleSheetListMethods[] = {
...
static void InstallV8StyleSheetListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8StyleSheetList::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8StyleSheetList::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8StyleSheetListAccessors, base::size(kV8StyleSheetListAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8StyleSheetListMethods, base::size(kV8StyleSheetListMethods));
...
v8::Local<v8::FunctionTemplate> V8StyleSheetList::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8StyleSheetList::GetWrapperTypeInfo()),
      InstallV8StyleSheetListTemplate);
}

bool V8StyleSheetList::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8StyleSheetList::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8StyleSheetList::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8StyleSheetList::GetWrapperTypeInfo(), v8_value);
}

StyleSheetList* V8StyleSheetList::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

StyleSheetList* NativeValueTraits<StyleSheetList>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  StyleSheetList* native_value = V8StyleSheetList::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
