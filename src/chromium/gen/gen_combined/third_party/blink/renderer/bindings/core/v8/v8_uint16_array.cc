...
#endif
const WrapperTypeInfo v8_uint16_array_wrapper_type_info = {
    gin::kEmbedderBlink,
    nullptr,
    nullptr,
    "Uint16Array",
...
DOMUint16Array* V8Uint16Array::ToImpl(v8::Local<v8::Object> object) {
  ...
  if (script_wrappable)
    return script_wrappable->ToImpl<DOMUint16Array>();

  v8::Local<v8::Uint16Array> v8_view = object.As<v8::Uint16Array>();
  v8::Local<v8::Object> array_buffer = v8_view->Buffer();
  DOMUint16Array* typed_array = nullptr;
  if (array_buffer->IsArrayBuffer()) {
    typed_array = DOMUint16Array::Create(
  ...
  return typed_array->ToImpl<DOMUint16Array>();
}

DOMUint16Array* V8Uint16Array::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return value->IsUint16Array() ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMUint16Array* NativeValueTraits<DOMUint16Array>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMUint16Array* native_value = V8Uint16Array::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
