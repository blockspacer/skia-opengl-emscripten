...
v8::Maybe<void> V8BlobCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Blob* blob) {
...
void V8BlobCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Blob* blob) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8BlobCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Blob* blob) {
  return Proxy()->Invoke(
      callback_this_value, blob);
}

void V8PersistentCallbackFunction<V8BlobCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Blob* blob) {
