...
DOMUint8ClampedArray* V8Uint8ClampedArray::ToImpl(v8::Local<v8::Object> object) {
  ...
  return typed_array->ToImpl<DOMUint8ClampedArray>();
}

DOMUint8ClampedArray* V8Uint8ClampedArray::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return value->IsUint8ClampedArray() ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMUint8ClampedArray* NativeValueTraits<DOMUint8ClampedArray>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMUint8ClampedArray* native_value = V8Uint8ClampedArray::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
