...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_APPLICATION_CACHE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_APPLICATION_CACHE_H_
...
CORE_EXPORT extern const WrapperTypeInfo v8_application_cache_wrapper_type_info;
...
class V8ApplicationCache {
 ...
 public:
  ...
  CORE_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_application_cache_wrapper_type_info;
  }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_APPLICATION_CACHE_H_
