...
RTCQuicStreamEventInit::RTCQuicStreamEventInit() {
}

RTCQuicStreamEventInit::~RTCQuicStreamEventInit() = default;

void RTCQuicStreamEventInit::Trace(blink::Visitor* visitor) {
