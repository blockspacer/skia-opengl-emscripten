...
#ifndef PERFETTO_PROTOS_PERFETTO_TRACE_FTRACE_REGULATOR_PROTO_H_
#define PERFETTO_PROTOS_PERFETTO_TRACE_FTRACE_REGULATOR_PROTO_H_
...
class PERFETTO_EXPORT RegulatorSetVoltageCompleteFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
    kValFieldNumber = 2,
...
class PERFETTO_EXPORT RegulatorSetVoltageFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
    kMinFieldNumber = 2,
...
class PERFETTO_EXPORT RegulatorEnableDelayFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT RegulatorEnableCompleteFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT RegulatorEnableFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT RegulatorDisableCompleteFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
  };
...
class PERFETTO_EXPORT RegulatorDisableFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
  };
