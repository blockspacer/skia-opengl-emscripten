...
#include "media/mojo/interfaces/media_log.mojom-params-data.h"
#include "media/mojo/interfaces/media_log.mojom-shared-message-ids.h"

#include "media/mojo/interfaces/media_log.mojom-blink-import-headers.h"
...
void MediaLogProxy::AddEvent(
  ...
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::MediaLog::AddEvent");
#endif
  ...
  message.set_method_name("AddEvent");
#endif
...
bool MediaLogStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kMediaLog_AddEvent_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)<class 'jinja2::utils::Namespace'>::MediaLog::AddEvent",
