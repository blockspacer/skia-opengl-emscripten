...
#ifndef MEDIA_MOJO_INTERFACES_WATCH_TIME_RECORDER_MOJOM_IMPORT_HEADERS_H_
#define MEDIA_MOJO_INTERFACES_WATCH_TIME_RECORDER_MOJOM_IMPORT_HEADERS_H_
...
#endif  // MEDIA_MOJO_INTERFACES_WATCH_TIME_RECORDER_MOJOM_IMPORT_HEADERS_H_