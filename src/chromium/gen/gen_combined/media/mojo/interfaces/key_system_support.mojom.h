...
#include "media/mojo/interfaces/key_system_support.mojom-forward.h"
...
class  KeySystemCapability {
 public:
  ...
  KeySystemCapability(
      const std::vector<media::VideoCodec>& video_codecs,
      bool supports_vp9_profile2,
      const std::vector<media::EncryptionMode>& encryption_schemes,
      const std::vector<media::VideoCodec>& hw_secure_video_codecs,
      const std::vector<media::EncryptionMode>& hw_secure_encryption_schemes,
      const std::vector<media::CdmSessionType>& session_types);
  ...
  std::vector<media::EncryptionMode> hw_secure_encryption_schemes;
