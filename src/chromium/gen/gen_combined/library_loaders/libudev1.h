...
#ifndef LIBRARY_LOADER_LIBUDEV1_H
#define LIBRARY_LOADER_LIBUDEV1_H

#include "third_party/libudev/libudev1.h"
#define LIBRARY_LOADER_LIBUDEV1_H_DLOPEN
...
class LibUdev1Loader {
 ...
 private:
  ...
  LibUdev1Loader(const LibUdev1Loader&);
  void operator=(const LibUdev1Loader&);
};

#endif  // LIBRARY_LOADER_LIBUDEV1_H
