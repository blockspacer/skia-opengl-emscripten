...
#include "ui/base/ime/mojo/ime_engine_factory_registry.mojom-import-headers.h"
...
void ImeEngineFactoryRegistryProxy::ActivateFactory(
    ::ime::mojom::ImeEngineFactoryPtr in_factory) {
...
bool ImeEngineFactoryRegistryStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kImeEngineFactoryRegistry_ActivateFactory_Name: {
      ...
      bool success = true;
      ::ime::mojom::ImeEngineFactoryPtr p_factory{};
