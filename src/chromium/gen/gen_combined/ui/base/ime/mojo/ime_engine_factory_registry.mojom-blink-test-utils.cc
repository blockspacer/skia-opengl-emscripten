...
#include "ui/base/ime/mojo/ime_engine_factory_registry.mojom-blink-test-utils.h"
...
void ImeEngineFactoryRegistryInterceptorForTesting::ActivateFactory(::ime::mojom::blink::ImeEngineFactoryPtr factory) {
