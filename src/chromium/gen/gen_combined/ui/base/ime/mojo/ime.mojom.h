...
#ifndef UI_BASE_IME_MOJO_IME_MOJOM_H_
#define UI_BASE_IME_MOJO_IME_MOJOM_H_
...
class  ImeEngine
 ...
 public:
  ...
  virtual void UpdateSurroundingInfo(const std::string& text, int32_t cursor, int32_t anchor, int32_t offset) = 0;

  
  virtual void UpdateCompositionBounds(const std::vector<gfx::Rect>& bounds) = 0;
};
...
class  ImeEngineClient
 ...
 public:
  ...
  virtual void UpdateCompositionText(const ui::CompositionText& composition_text, uint32_t cursor_pos, bool visible) = 0;

  
  virtual void DeleteSurroundingText(int32_t offset, uint32_t length) = 0;

  
  virtual void SendKeyEvent(std::unique_ptr<ui::Event> key_event) = 0;
...
class  ImeEngineProxy
 ...
 public:
  ...
  void UpdateSurroundingInfo(const std::string& text, int32_t cursor, int32_t anchor, int32_t offset) final;
  void UpdateCompositionBounds(const std::vector<gfx::Rect>& bounds) final;
...
class  ImeEngineClientProxy
 ...
 public:
  ...
  void CommitText(const std::string& text) final;
  void UpdateCompositionText(const ui::CompositionText& composition_text, uint32_t cursor_pos, bool visible) final;
  void DeleteSurroundingText(int32_t offset, uint32_t length) final;
  void SendKeyEvent(std::unique_ptr<ui::Event> key_event) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EditorInfo::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::ime::mojom::EditorInfo::DataView,
                                         ::ime::mojom::EditorInfoPtr> {
  static bool IsNull(const ::ime::mojom::EditorInfoPtr& input) { return !input; }
  static void SetToNull(::ime::mojom::EditorInfoPtr* output) { output->reset(); }

  static decltype(::ime::mojom::EditorInfo::type) type(
      const ::ime::mojom::EditorInfoPtr& input) {
    return input->type;
  }

  static decltype(::ime::mojom::EditorInfo::mode) mode(
      const ::ime::mojom::EditorInfoPtr& input) {
    return input->mode;
  }

  static decltype(::ime::mojom::EditorInfo::flags) flags(
      const ::ime::mojom::EditorInfoPtr& input) {
    return input->flags;
  }

  static decltype(::ime::mojom::EditorInfo::focus_reason) focus_reason(
      const ::ime::mojom::EditorInfoPtr& input) {
    return input->focus_reason;
  }

  static decltype(::ime::mojom::EditorInfo::should_do_learning) should_do_learning(
      const ::ime::mojom::EditorInfoPtr& input) {
    return input->should_do_learning;
  }

  static bool Read(::ime::mojom::EditorInfo::DataView input, ::ime::mojom::EditorInfoPtr* output);
};

}  // namespace mojo

#endif  // UI_BASE_IME_MOJO_IME_MOJOM_H_