...
bool CompositorFrameMetadata_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->latency_info, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->referenced_surfaces, 9, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->deadline, 10, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->activation_dependencies, 11, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->begin_frame_ack, 13, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->local_surface_id_allocation_time, 19, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->local_surface_id_allocation_time, validation_context))
    return false;
