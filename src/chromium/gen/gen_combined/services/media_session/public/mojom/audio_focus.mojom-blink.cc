...
void AudioFocusManagerProxy::RequestAudioFocus(
    AudioFocusRequestClientRequest in_client, ::media_session::mojom::blink::MediaSessionPtr in_media_session, ::media_session::mojom::blink::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, RequestAudioFocusCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AudioFocusManagerProxy::RequestGroupedAudioFocus(
    AudioFocusRequestClientRequest in_client, ::media_session::mojom::blink::MediaSessionPtr in_media_session, ::media_session::mojom::blink::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, const base::UnguessableToken& in_group_id, RequestGroupedAudioFocusCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool AudioFocusManagerStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kAudioFocusManager_RequestAudioFocus_Name: {
      ...
      ::media_session::mojom::blink::MediaSessionPtr p_media_session{};
      ::media_session::mojom::blink::MediaSessionInfoPtr p_session_info{};
      AudioFocusType p_type{};
