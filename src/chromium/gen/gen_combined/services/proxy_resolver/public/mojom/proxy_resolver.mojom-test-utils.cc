...
void ProxyResolverRequestClientInterceptorForTesting::ResolveDns(const std::string& host, net::ProxyResolveDnsOperation operation, HostResolverRequestClientPtr client) {
...
void ProxyResolverFactoryRequestClientInterceptorForTesting::ResolveDns(const std::string& host, net::ProxyResolveDnsOperation operation, HostResolverRequestClientPtr client) {
  GetForwardingInterface()->ResolveDns(std::move(host), std::move(operation), std::move(client));
}
