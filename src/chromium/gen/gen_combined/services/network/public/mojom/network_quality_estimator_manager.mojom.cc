...
void NetworkQualityEstimatorManagerClientProxy::OnNetworkQualityChanged(
  ...
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::NetworkQualityEstimatorManagerClient::OnNetworkQualityChanged");
#endif
...
bool NetworkQualityEstimatorManagerClientStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kNetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)<class 'jinja2::utils::Namespace'>::NetworkQualityEstimatorManagerClient::OnNetworkQualityChanged",
...
bool NetworkQualityEstimatorManagerClientRequestValidator::Accept(mojo::Message* message) {
  ...
  mojo::internal::ValidationContext validation_context(
    ...
    "NetworkQualityEstimatorManagerClient RequestValidator");
  ...
  switch (message->header()->name) {
    case internal::kNetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Name: {
      ...
      if (!mojo::internal::ValidateMessagePayload<
               internal::NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Params_Data>(
                  message, &validation_context)) {
        return false;
      }
      return true;
...
void NetworkQualityEstimatorManagerProxy::RequestNotifications(
    NetworkQualityEstimatorManagerClientPtr in_client_ptr) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::NetworkQualityEstimatorManager::RequestNotifications");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  mojo::internal::Serialize<::network::mojom::NetworkQualityEstimatorManagerClientPtrDataView>(
      in_client_ptr, &params->client_ptr, &serialization_context);
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      !mojo::internal::IsHandleOrInterfaceValid(params->client_ptr),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
      "invalid client_ptr in NetworkQualityEstimatorManager.RequestNotifications request");
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
...
bool NetworkQualityEstimatorManagerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kNetworkQualityEstimatorManager_RequestNotifications_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)<class 'jinja2::utils::Namespace'>::NetworkQualityEstimatorManager::RequestNotifications",
          "message", message->name());
#endif
      base::TaskAnnotator::ScopedSetIpcProgramCounter scoped_ipc_pc(
          base::GetProgramCounter());
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      NetworkQualityEstimatorManagerClientPtr p_client_ptr{};
...
bool NetworkQualityEstimatorManagerRequestValidator::Accept(mojo::Message* message) {
  ...
  mojo::internal::ValidationContext validation_context(
    message->payload(), message->payload_num_bytes(),
    message->handles()->size(), message->payload_num_interface_ids(), message,
    "NetworkQualityEstimatorManager RequestValidator");
  ...
  switch (message->header()->name) {
    case internal::kNetworkQualityEstimatorManager_RequestNotifications_Name: {
      ...
      if (!mojo::internal::ValidateMessagePayload<
               internal::NetworkQualityEstimatorManager_RequestNotifications_Params_Data>(
                  message, &validation_context)) {
        return false;
      }
      return true;
