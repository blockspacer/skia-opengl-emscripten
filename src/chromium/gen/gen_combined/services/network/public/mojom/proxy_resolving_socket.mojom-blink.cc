...
void ProxyResolvingSocketProxy::UpgradeToTLS(
    ::network::mojom::blink::HostPortPairPtr in_host_port_pair, ::network::mojom::blink::MutableNetworkTrafficAnnotationTagPtr in_traffic_annotation, ::network::mojom::blink::TLSClientSocketRequest in_request, ::network::mojom::blink::SocketObserverPtr in_observer, UpgradeToTLSCallback callback) {
...
void ProxyResolvingSocketFactoryProxy::CreateProxyResolvingSocket(
    const ::blink::KURL& in_url, ProxyResolvingSocketOptionsPtr in_options, ::network::mojom::blink::MutableNetworkTrafficAnnotationTagPtr in_traffic_annotation, ProxyResolvingSocketRequest in_socket, ::network::mojom::blink::SocketObserverPtr in_observer, CreateProxyResolvingSocketCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
