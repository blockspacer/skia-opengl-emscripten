...
template <>
struct DefaultHash<::network::mojom::NetworkContext_DomainReliabilityClearMode> {
  using Hash = network_mojom_internal_NetworkContext_DomainReliabilityClearMode_DataHashFn;
};
}  // namespace WTF
