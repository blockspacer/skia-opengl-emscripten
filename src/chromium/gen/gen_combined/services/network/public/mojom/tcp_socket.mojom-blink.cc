...
size_t TCPConnectedSocketOptions::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->no_delay);
  return seed;
}
...
void TCPBoundSocketProxy::Connect(
    ::network::mojom::blink::AddressListPtr in_remote_addr_list, TCPConnectedSocketOptionsPtr in_tcp_connected_socket_options, TCPConnectedSocketRequest in_socket, SocketObserverPtr in_observer, ConnectCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void TCPConnectedSocketProxy::UpgradeToTLS(
    ::network::mojom::blink::HostPortPairPtr in_host_port_pair, ::network::mojom::blink::TLSClientSocketOptionsPtr in_options, ::network::mojom::blink::MutableNetworkTrafficAnnotationTagPtr in_traffic_annotation, ::network::mojom::blink::TLSClientSocketRequest in_request, SocketObserverPtr in_observer, UpgradeToTLSCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class TCPServerSocket_Accept_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, ::network::mojom::blink::IPEndPointPtr in_remote_addr, TCPConnectedSocketPtr in_connected_socket, mojo::ScopedDataPipeConsumerHandle in_send_stream, mojo::ScopedDataPipeProducerHandle in_receive_stream);
