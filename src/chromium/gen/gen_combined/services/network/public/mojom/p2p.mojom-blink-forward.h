...
namespace mojom {
namespace blink {
using P2PSocketType = P2PSocketType;  // Alias for definition in the parent namespace.
using P2PSocketOption = P2PSocketOption;  // Alias for definition in the parent namespace.
