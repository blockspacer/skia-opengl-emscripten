...
void TrialComparisonCertVerifierReportClientProxy::SendTrialReport(
    const std::string& in_hostname, const scoped_refptr<net::X509Certificate>& in_cert, bool in_enable_rev_checking, bool in_require_rev_checking_local_anchors, bool in_enable_sha1_local_anchors, bool in_disable_symantec_enforcement, const net::CertVerifyResult& in_primary_result, const net::CertVerifyResult& in_trial_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool TrialComparisonCertVerifierReportClientStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kTrialComparisonCertVerifierReportClient_SendTrialReport_Name: {
      ...
      net::CertVerifyResult p_primary_result{};
      net::CertVerifyResult p_trial_result{};
...
// static
bool StructTraits<::network::mojom::TrialComparisonCertVerifierParams::DataView, ::network::mojom::TrialComparisonCertVerifierParamsPtr>::Read(
    ::network::mojom::TrialComparisonCertVerifierParams::DataView input,
    ::network::mojom::TrialComparisonCertVerifierParamsPtr* output) {
  bool success = true;
  ::network::mojom::TrialComparisonCertVerifierParamsPtr result(::network::mojom::TrialComparisonCertVerifierParams::New());
