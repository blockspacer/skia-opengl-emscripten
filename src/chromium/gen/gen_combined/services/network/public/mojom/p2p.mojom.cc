...
void P2PSocketManagerProxy::CreateSocket(
    network::P2PSocketType in_type, const net::IPEndPoint& in_local_address, const network::P2PPortRange& in_port_range, const network::P2PHostAndIPEndPoint& in_remote_address, P2PSocketClientPtr in_client, P2PSocketRequest in_socket) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void P2PSocketClientProxy::IncomingTcpConnection(
    const net::IPEndPoint& in_socket_address, P2PSocketPtr in_socket, P2PSocketClientRequest in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
