...
DnsConfigOverrides::DnsConfigOverrides(
    base::Optional<WTF::Vector<::network::mojom::blink::IPEndPointPtr>> nameservers_in,
    const base::Optional<WTF::Vector<WTF::String>>& search_in,
...
void ResolveHostClientProxy::OnComplete(
    int32_t in_result, ::network::mojom::blink::AddressListPtr in_resolved_addresses) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void HostResolverProxy::ResolveHost(
    ::network::mojom::blink::HostPortPairPtr in_host, ResolveHostParametersPtr in_optional_parameters, ResolveHostClientPtr in_response_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void HostResolverProxy::MdnsListen(
    ::network::mojom::blink::HostPortPairPtr in_host, DnsQueryType in_query_type, MdnsListenClientPtr in_response_client, MdnsListenCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
