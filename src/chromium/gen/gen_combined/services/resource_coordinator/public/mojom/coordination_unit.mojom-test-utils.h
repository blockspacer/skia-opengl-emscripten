...
#ifndef SERVICES_RESOURCE_COORDINATOR_PUBLIC_MOJOM_COORDINATION_UNIT_MOJOM_TEST_UTILS_H_
#define SERVICES_RESOURCE_COORDINATOR_PUBLIC_MOJOM_COORDINATION_UNIT_MOJOM_TEST_UTILS_H_
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) DocumentCoordinationUnitInterceptorForTesting : public DocumentCoordinationUnit {
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) DocumentCoordinationUnitAsyncWaiter {
 public:
...
#endif  // SERVICES_RESOURCE_COORDINATOR_PUBLIC_MOJOM_COORDINATION_UNIT_MOJOM_TEST_UTILS_H_