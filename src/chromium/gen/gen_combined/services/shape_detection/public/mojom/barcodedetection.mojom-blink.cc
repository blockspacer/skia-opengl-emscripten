...
void BarcodeDetectionProxy::Detect(
  ...
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::BarcodeDetection::Detect");
#endif
...
bool BarcodeDetection_Detect_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "<class 'jinja2::utils::Namespace'>::BarcodeDetection::DetectCallback",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)<class 'jinja2::utils::Namespace'>::BarcodeDetection::DetectCallback",
               "message", message.name());
#endif
...
bool BarcodeDetectionStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kBarcodeDetection_Detect_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)<class 'jinja2::utils::Namespace'>::BarcodeDetection::Detect",
          "message", message->name());
#endif
