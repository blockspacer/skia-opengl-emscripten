...
#include "components/services/filesystem/public/interfaces/file.mojom-blink-import-headers.h"
...
bool File::Read(uint32_t num_bytes_to_read, int64_t offset, ::filesystem::mojom::blink::Whence whence, ::base::File::Error* out_error, base::Optional<WTF::Vector<uint8_t>>* out_bytes_read) {
  NOTREACHED();
  return false;
}
bool File::Write(const WTF::Vector<uint8_t>& bytes_to_write, int64_t offset, ::filesystem::mojom::blink::Whence whence, ::base::File::Error* out_error, uint32_t* out_num_bytes_written) {
  NOTREACHED();
  return false;
}
...
bool File::Seek(int64_t offset, ::filesystem::mojom::blink::Whence whence, ::base::File::Error* out_error, int64_t* out_position) {
  NOTREACHED();
  return false;
}
bool File::Stat(::base::File::Error* out_error, ::filesystem::mojom::blink::FileInformationPtr* out_file_information) {
  NOTREACHED();
  return false;
}
...
bool File::Touch(::filesystem::mojom::blink::TimespecOrNowPtr atime, ::filesystem::mojom::blink::TimespecOrNowPtr mtime, ::base::File::Error* out_error) {
  NOTREACHED();
  return false;
}
...
class File_Read_HandleSyncResponse
 ...
 public:
  File_Read_HandleSyncResponse(
      bool* result, ::base::File::Error* out_error, base::Optional<WTF::Vector<uint8_t>>* out_bytes_read)
 ...
 private:
  ...
  base::Optional<WTF::Vector<uint8_t>>* out_bytes_read_;DISALLOW_COPY_AND_ASSIGN(File_Read_HandleSyncResponse);
};
...
class File_Stat_HandleSyncResponse
 ...
 private:
  bool* result_;
  ::base::File::Error* out_error_;
  ::filesystem::mojom::blink::FileInformationPtr* out_file_information_;DISALLOW_COPY_AND_ASSIGN(File_Stat_HandleSyncResponse);
};
...
bool FileProxy::Read(
    uint32_t param_num_bytes_to_read, int64_t param_offset, ::filesystem::mojom::blink::Whence param_whence, ::base::File::Error* out_param_error, base::Optional<WTF::Vector<uint8_t>>* out_param_bytes_read) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileProxy::Read(
    uint32_t in_num_bytes_to_read, int64_t in_offset, ::filesystem::mojom::blink::Whence in_whence, ReadCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::File::Read");
#endif
  const bool kExpectsResponse = true;
...
bool FileProxy::Write(
    const WTF::Vector<uint8_t>& param_bytes_to_write, int64_t param_offset, ::filesystem::mojom::blink::Whence param_whence, ::base::File::Error* out_param_error, uint32_t* out_param_num_bytes_written) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileProxy::Write(
    const WTF::Vector<uint8_t>& in_bytes_to_write, int64_t in_offset, ::filesystem::mojom::blink::Whence in_whence, WriteCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::File::Write");
#endif
  const bool kExpectsResponse = true;
...
bool FileProxy::Seek(
    int64_t param_offset, ::filesystem::mojom::blink::Whence param_whence, ::base::File::Error* out_param_error, int64_t* out_param_position) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileProxy::Seek(
    int64_t in_offset, ::filesystem::mojom::blink::Whence in_whence, SeekCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::File::Seek");
#endif
  const bool kExpectsResponse = true;
...
bool FileProxy::Stat(
    ::base::File::Error* out_param_error, ::filesystem::mojom::blink::FileInformationPtr* out_param_file_information) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileProxy::Touch(
    ::filesystem::mojom::blink::TimespecOrNowPtr param_atime, ::filesystem::mojom::blink::TimespecOrNowPtr param_mtime, ::base::File::Error* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileProxy::Touch(
    ::filesystem::mojom::blink::TimespecOrNowPtr in_atime, ::filesystem::mojom::blink::TimespecOrNowPtr in_mtime, TouchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::File::Touch");
#endif
  const bool kExpectsResponse = true;
...
class File_Read_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::base::File::Error in_error, const base::Optional<WTF::Vector<uint8_t>>& in_bytes_read);
...
bool File_Read_ForwardToCallback::Accept(
  ...
  base::Optional<WTF::Vector<uint8_t>> p_bytes_read{};
...
bool FileStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kFile_Read_Name: {
      ...
      int64_t p_offset{};
      ::filesystem::mojom::blink::Whence p_whence{};
...
std::move(p_whence), std::move(callback));
    ...
    case internal::kFile_Write_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      WTF::Vector<uint8_t> p_bytes_to_write{};
      int64_t p_offset{};
      ::filesystem::mojom::blink::Whence p_whence{};
...
std::move(p_size), std::move(callback));
    ...
    case internal::kFile_Touch_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::filesystem::mojom::blink::TimespecOrNowPtr p_atime{};
      ::filesystem::mojom::blink::TimespecOrNowPtr p_mtime{};
