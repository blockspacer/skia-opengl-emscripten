...
class UI_DEVTOOLS_EXPORT BinaryValue : public Value {
public:
...
#ifndef ui_devtools_protocol_encoding_h
#define ui_devtools_protocol_encoding_h
...
#endif // !defined(ui_devtools_protocol_encoding_h)
