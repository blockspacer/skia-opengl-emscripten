...
TF_BUILTIN(ProxyGetProperty, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi> block6(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi, Object> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi, Object> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi, Object, JSReceiver, Object, JSReceiver> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi, Object, JSReceiver, Object, JSReceiver, JSReceiver> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi, Object, JSReceiver, Object> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSProxy, Name, Object, Smi, Object, JSReceiver, Object, JSReceiver> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 24);
    compiler::TNode<BoolT> tmp5;
    USE(tmp5);
    tmp5 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).TaggedIsNotSmi(compiler::TNode<Object>{tmp2}));
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'TaggedIsNotSmi(name)\' failed", "../../v8/src/builtins/proxy-get-property.tq", 24);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 25);
    compiler::TNode<BoolT> tmp16;
    USE(tmp16);
    tmp16 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).IsName(compiler::TNode<HeapObject>{tmp13}));
    ca_.Branch(tmp16, &block3, &block4, tmp11, tmp12, tmp13, tmp14, tmp15);
  }
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'IsName(name)\' failed", "../../v8/src/builtins/proxy-get-property.tq", 25);
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 26);
    compiler::TNode<BoolT> tmp27;
    USE(tmp27);
    tmp27 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).IsPrivateSymbol(compiler::TNode<HeapObject>{tmp24}));
    compiler::TNode<BoolT> tmp28;
    USE(tmp28);
    tmp28 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).Word32BinaryNot(compiler::TNode<BoolT>{tmp27}));
    ca_.Branch(tmp28, &block5, &block6, tmp22, tmp23, tmp24, tmp25, tmp26);
  }
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'!IsPrivateSymbol(name)\' failed", "../../v8/src/builtins/proxy-get-property.tq", 26);
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Bind(&block5, &tmp34, &tmp35, &tmp36, &tmp37, &tmp38);
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 29);
    compiler::TNode<IntPtrT> tmp39 = ca_.IntPtrConstant(JSProxy::kHandlerOffset);
    USE(tmp39);
    compiler::TNode<Object>tmp40 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp35, tmp39});
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 32);
    compiler::TNode<Oddball> tmp41;
    USE(tmp41);
    tmp41 = BaseBuiltinsFromDSLAssembler(state_).Null();
    compiler::TNode<BoolT> tmp42;
    USE(tmp42);
    tmp42 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).WordEqual(compiler::TNode<Object>{tmp40}, compiler::TNode<HeapObject>{tmp41}));
    ca_.Branch(tmp42, &block7, &block8, tmp34, tmp35, tmp36, tmp37, tmp38, tmp40);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 33);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp43}, MessageTemplate::kProxyRevoked, "get");
  }
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 37);
    compiler::TNode<JSReceiver> tmp55;
    USE(tmp55);
    tmp55 = ca_.UncheckedCast<JSReceiver>(BaseBuiltinsFromDSLAssembler(state_).UnsafeCast10JSReceiver(compiler::TNode<Context>{tmp49}, compiler::TNode<Object>{tmp54}));
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 40);
    compiler::TNode<IntPtrT> tmp56 = ca_.IntPtrConstant(JSProxy::kTargetOffset);
    USE(tmp56);
    compiler::TNode<Object>tmp57 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp50, tmp56});
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 46);
    compiler::TNode<JSReceiver> tmp58;
    USE(tmp58);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp58 = BaseBuiltinsFromDSLAssembler(state_).GetMethod(compiler::TNode<Context>{tmp49}, compiler::TNode<Object>{tmp55}, "get", &label0);
    ca_.Goto(&block11, tmp49, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp57, tmp55, tmp58);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block12, tmp49, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp57, tmp55);
    }
  }
  ...
  if (block12.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp67;
    ca_.Bind(&block12, &tmp59, &tmp60, &tmp61, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67);
    ca_.Goto(&block10, tmp59, tmp60, tmp61, tmp62, tmp63, tmp64, tmp65, tmp66);
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Bind(&block11, &tmp68, &tmp69, &tmp70, &tmp71, &tmp72, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77);
    ca_.Goto(&block9, tmp68, tmp69, tmp70, tmp71, tmp72, tmp73, tmp74, tmp75, tmp77);
  }

  if (block10.is_used()) {
    compiler::TNode<Context> tmp78;
    compiler::TNode<JSProxy> tmp79;
    compiler::TNode<Name> tmp80;
    compiler::TNode<Object> tmp81;
    compiler::TNode<Smi> tmp82;
    compiler::TNode<Object> tmp83;
    compiler::TNode<JSReceiver> tmp84;
    compiler::TNode<Object> tmp85;
    ca_.Bind(&block10, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85);
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 48);
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 47);
    compiler::TNode<Object> tmp86;
    tmp86 = CodeStubAssembler(state_).CallRuntime(Runtime::kGetPropertyWithReceiver, tmp78, tmp85, tmp80, tmp81, tmp82); 
    USE(tmp86);
  ...
  if (block9.is_used()) {
    ...
    ca_.Bind(&block9, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91, &tmp92, &tmp93, &tmp94, &tmp95);
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 46);
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 52);
    compiler::TNode<Object> tmp96;
    USE(tmp96);
    tmp96 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).Call(compiler::TNode<Context>{tmp87}, compiler::TNode<JSReceiver>{tmp95}, compiler::TNode<Object>{tmp93}, compiler::TNode<Object>{tmp94}, compiler::TNode<Object>{tmp89}, compiler::TNode<Object>{tmp90}));
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-get-property.tq", 65);
    compiler::TNode<Object> tmp97;
    USE(tmp97);
    tmp97 = ca_.UncheckedCast<Object>(ProxiesCodeStubAssembler(state_).CheckGetSetTrapResult(compiler::TNode<Context>{tmp87}, compiler::TNode<Object>{tmp94}, compiler::TNode<JSProxy>{tmp88}, compiler::TNode<Name>{tmp89}, compiler::TNode<Object>{tmp96}, JSProxy::AccessKind::kGet));
...
TF_BUILTIN(ProxyRevoke, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 14);
    compiler::TNode<IntPtrT> tmp1;
    USE(tmp1);
    tmp1 = ca_.UncheckedCast<IntPtrT>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr13ATContextSlot23ATconstexpr_ContextSlot(Context::MIN_CONTEXT_SLOTS));
    compiler::TNode<Object> tmp2;
    USE(tmp2);
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 17);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 22);
    compiler::TNode<Oddball> tmp10;
    USE(tmp10);
    tmp10 = BaseBuiltinsFromDSLAssembler(state_).Null();
    compiler::TNode<IntPtrT> tmp11;
    USE(tmp11);
    tmp11 = ca_.UncheckedCast<IntPtrT>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr13ATContextSlot23ATconstexpr_ContextSlot(Context::MIN_CONTEXT_SLOTS));
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 25);
    compiler::TNode<JSProxy> tmp12;
    USE(tmp12);
    tmp12 = ca_.UncheckedCast<JSProxy>(BaseBuiltinsFromDSLAssembler(state_).UnsafeCast7JSProxy(compiler::TNode<Context>{tmp8}, compiler::TNode<Object>{tmp9}));
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 28);
    compiler::TNode<IntPtrT> tmp13 = ca_.IntPtrConstant(JSProxy::kTargetOffset);
    USE(tmp13);
    compiler::TNode<Oddball> tmp14;
    USE(tmp14);
    tmp14 = BaseBuiltinsFromDSLAssembler(state_).Null();
    CodeStubAssembler(state_).StoreReference(CodeStubAssembler::Reference{tmp12, tmp13}, tmp14);
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 31);
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/proxy-revoke.tq", 34);
