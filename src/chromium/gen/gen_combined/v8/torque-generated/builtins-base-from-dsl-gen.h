...
class V8_EXPORT_PRIVATE BaseBuiltinsFromDSLAssembler {
 public:
  ...
  compiler::TNode<JSIteratorResult> NewJSIteratorResult(compiler::TNode<Context> p_context, compiler::TNode<Object> p_value, compiler::TNode<Oddball> p_done);
  ...
  compiler::TNode<Oddball> Cast6ATNull(compiler::TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError);
  ...
  compiler::TNode<JSStringIterator> Cast16JSStringIterator(compiler::TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError);
  ...
  compiler::TNode<Oddball> Cast7Oddball(compiler::TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError);
  compiler::TNode<Symbol> Cast6Symbol(compiler::TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError);
  ...
  compiler::TNode<DebugInfo> Cast9DebugInfo(compiler::TNode<Context> p_context, compiler::TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError);
  compiler::TNode<CoverageInfo> Cast12CoverageInfo(compiler::TNode<Context> p_context, compiler::TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError);
  ...
  compiler::TNode<Float32T> Convert9ATfloat329ATfloat64(compiler::TNode<Float64T> p_f);
  compiler::TNode<Float32T> Convert9ATfloat3220UT5ATSmi10HeapNumber(compiler::TNode<Number> p_n);
  ...
  compiler::TNode<Map> GetFastPackedElementsJSArrayMap(compiler::TNode<Context> p_context);
  ...
  compiler::TNode<Map> GetIteratorResultMap(compiler::TNode<Context> p_context);
  compiler::TNode<Map> GetInitialStringIteratorMap(compiler::TNode<Context> p_context);
  compiler::TNode<JSReceiver> GetReflectApply(compiler::TNode<Context> p_context);
  compiler::TNode<RegExpMatchInfo> GetRegExpLastMatchInfo(compiler::TNode<Context> p_context);
  ...
  compiler::TNode<JSReceiver> GetMethod(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, const char* p_name, compiler::CodeAssemblerLabel* label_IfNullOrUndefined);
  ...
  compiler::TNode<Int32T> LoadSharedFunctionInfoUniqueId(compiler::TNode<SharedFunctionInfo> p_o);
  void StoreSharedFunctionInfoUniqueId(compiler::TNode<SharedFunctionInfo> p_o, compiler::TNode<Int32T> p_v);
  ...
  void _method_JSTypedArray_AttachOffHeapBuffer(compiler::TNode<JSTypedArray> p_this, compiler::TNode<JSArrayBuffer> p_buffer, compiler::TNode<Map> p_map, compiler::TNode<UintPtrT> p_byteOffset);
  ...
  compiler::TNode<Smi> _method_RegExpMatchInfo_NumberOfCaptures(compiler::TNode<Context> p_context, compiler::TNode<RegExpMatchInfo> p_this);
  ...
  compiler::TNode<Int32T> LoadFeedbackVectorDeoptCount(compiler::TNode<FeedbackVector> p_o);
  void StoreFeedbackVectorDeoptCount(compiler::TNode<FeedbackVector> p_o, compiler::TNode<Int32T> p_v);
  ...
  compiler::TNode<Foreign> LoadJSPluralRulesIcuDecimalFormat(compiler::TNode<JSPluralRules> p_o);
  void StoreJSPluralRulesIcuDecimalFormat(compiler::TNode<JSPluralRules> p_o, compiler::TNode<Foreign> p_v);
  ...
  compiler::TNode<CoverageInfo> UnsafeCast12CoverageInfo(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  ...
  compiler::TNode<BoolT> Is14ATFastJSRegExp14ATFastJSRegExp(compiler::TNode<Context> p_context, compiler::TNode<JSRegExp> p_o);
  compiler::TNode<JSStringIterator> Cast16JSStringIterator(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError);
  ...
  compiler::TNode<BoolT> Is7Context20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  ...
  compiler::TNode<BoolT> Is23UT11ATFrameType7Context20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  compiler::TNode<BoolT> Is12CoverageInfo20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  ...
  void BranchIf14ATFastJSRegExp14ATFastJSRegExp(compiler::TNode<Context> p_context, compiler::TNode<JSRegExp> p_o, compiler::CodeAssemblerLabel* label_True, compiler::CodeAssemblerLabel* label_False);
  ...
  void BranchIf7Context20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_True, compiler::CodeAssemblerLabel* label_False);
  ...
  void BranchIf23UT11ATFrameType7Context20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_True, compiler::CodeAssemblerLabel* label_False);
  void BranchIf12CoverageInfo20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_True, compiler::CodeAssemblerLabel* label_False);
  ...
  compiler::TNode<CoverageInfo> Cast12CoverageInfo(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError);
