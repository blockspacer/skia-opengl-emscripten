...
compiler::TNode<BuiltinPtr> TypedArrayBuiltinsFromDSLAssembler::GetLoadFnForElementsKind(compiler::TNode<Int32T> p_elementsKind) {
  ...
  if (block21.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/typed-array.tq:135:9");
  ...
  if (block36.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/typed-array.tq:149:9");
    CodeStubAssembler(state_).Unreachable();
  }
...
void TypedArrayBuiltinsFromDSLAssembler::TypedArrayMerge(compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_comparefn, compiler::TNode<FixedArray> p_source, compiler::TNode<Smi> p_from, compiler::TNode<Smi> p_middle, compiler::TNode<Smi> p_to, compiler::TNode<FixedArray> p_target) {
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array.tq", 252);
  ...
  if (block19.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'left == middle\' failed", "../../v8/src/builtins/typed-array.tq", 252);
  }
...
TF_BUILTIN(TypedArrayMergeSort, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array.tq", 262);
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'to - from > 1\' failed", "../../v8/src/builtins/typed-array.tq", 262);
  }
...
USE(parameter1);
  ...
  if (block13.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/typed-array.tq:307:48");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block35.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/typed-array.tq:333:9");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block50.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/typed-array.tq:352:9");
    CodeStubAssembler(state_).Unreachable();
  }
