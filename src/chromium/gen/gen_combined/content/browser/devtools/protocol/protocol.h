...
class CONTENT_EXPORT BinaryValue : public Value {
public:
...
#ifndef content_protocol_encoding_h
#define content_protocol_encoding_h
...
#endif // !defined(content_protocol_encoding_h)
