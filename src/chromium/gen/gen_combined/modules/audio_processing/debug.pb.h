...
class RuntimeSetting : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.audioproc.RuntimeSetting) */ {
 public:
  ...
  static const int kCaptureFixedPostGainFieldNumber = 3;
  ...
  static const int kPlayoutVolumeChangeFieldNumber = 4;
  ::google::protobuf::int32 playout_volume_change() const;
  void set_playout_volume_change(::google::protobuf::int32 value);
 ...
 private:
  ...
  void set_has_capture_fixed_post_gain();
  void clear_has_capture_fixed_post_gain();
  void set_has_playout_volume_change();
  void clear_has_playout_volume_change();
  ...
  ::google::protobuf::int32 playout_volume_change_;
  friend struct ::protobuf_debug_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline void RuntimeSetting::set_has_capture_fixed_post_gain() {
  _has_bits_[0] |= 0x00000004u;
}
inline void RuntimeSetting::clear_has_capture_fixed_post_gain() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void RuntimeSetting::clear_capture_fixed_post_gain() {
  capture_fixed_post_gain_ = 0;
  clear_has_capture_fixed_post_gain();
}
...
inline void RuntimeSetting::set_has_playout_volume_change() {
  _has_bits_[0] |= 0x00000008u;
}
inline void RuntimeSetting::clear_has_playout_volume_change() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void RuntimeSetting::clear_playout_volume_change() {
  playout_volume_change_ = 0;
  clear_has_playout_volume_change();
}
inline ::google::protobuf::int32 RuntimeSetting::playout_volume_change() const {
  // @@protoc_insertion_point(field_get:webrtc.audioproc.RuntimeSetting.playout_volume_change)
  return playout_volume_change_;
}
inline void RuntimeSetting::set_playout_volume_change(::google::protobuf::int32 value) {
