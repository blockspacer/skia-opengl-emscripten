...
#include "device/usb/public/mojom/device_manager.mojom-blink-import-headers.h"
...
void UsbDeviceManagerProxy::EnumerateDevicesAndSetClient(
    ::device::mojom::blink::UsbDeviceManagerClientAssociatedPtrInfo in_client, EnumerateDevicesAndSetClientCallback callback) {
...
void UsbDeviceManagerProxy::GetDevice(
    const WTF::String& in_guid, ::device::mojom::blink::UsbDeviceRequest in_device_request, ::device::mojom::blink::UsbDeviceClientPtr in_device_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void UsbDeviceManagerProxy::SetClient(
    ::device::mojom::blink::UsbDeviceManagerClientAssociatedPtrInfo in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool UsbDeviceManagerStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kUsbDeviceManager_GetDevice_Name: {
      ...
      ::device::mojom::blink::UsbDeviceClientPtr p_device_client{};
...
std::move(p_device_client));
    ...
    case internal::kUsbDeviceManager_SetClient_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::device::mojom::blink::UsbDeviceManagerClientAssociatedPtrInfo p_client{};
