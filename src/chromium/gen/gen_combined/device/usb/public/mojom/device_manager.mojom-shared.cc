...
bool UsbDeviceManager_EnumerateDevicesAndSetClient_Params_Data::Validate(
  ...
  const UsbDeviceManager_EnumerateDevicesAndSetClient_Params_Data* object = static_cast<const UsbDeviceManager_EnumerateDevicesAndSetClient_Params_Data*>(data);
...
bool UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParams_Data* object = static_cast<const UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParams_Data*>(data);
