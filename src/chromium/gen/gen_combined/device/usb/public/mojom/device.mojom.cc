...
#ifndef DEVICE_USB_PUBLIC_MOJOM_DEVICE_MOJOM_JUMBO_H_
#define DEVICE_USB_PUBLIC_MOJOM_DEVICE_MOJOM_JUMBO_H_
...
UsbDeviceInfo::UsbDeviceInfo(
    ...
    const base::Optional<GURL>& webusb_landing_page_in,
