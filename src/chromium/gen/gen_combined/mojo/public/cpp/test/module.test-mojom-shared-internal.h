  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(Union_Data));
      new (data()) Union_Data();
    }
    ...
    Union_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<Union_Data>(index_);
    }
    Union_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(Struct_Data));
    ...
    Struct_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<Struct_Data>(index_);
    }
    Struct_Data* operator->() { return data(); }
...
struct Struct_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    Struct_Data::BufferWriter writer;
