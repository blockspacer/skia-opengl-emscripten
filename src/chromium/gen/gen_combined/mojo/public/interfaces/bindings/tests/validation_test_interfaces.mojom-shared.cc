...
std::ostream& operator<<(std::ostream& os, EnumA value) {
  switch(value) {
    case EnumA::ENUM_A_0:
      return os << "EnumA::ENUM_A_0";
    case EnumA::ENUM_A_1:
      return os << "EnumA::ENUM_A_1";
    default:
      return os << "Unknown EnumA value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, EnumB value) {
  switch(value) {
    case EnumB::ENUM_B_0:
      return os << "EnumB::ENUM_B_0";
    case EnumB::ENUM_B_1:
      return os << "EnumB::ENUM_B_1";
    case EnumB::ENUM_B_2:
      return os << "EnumB::ENUM_B_2";
    default:
      return os << "Unknown EnumB value: " << static_cast<int32_t>(value);
  }
}

std::ostream& operator<<(std::ostream& os, EmptyEnum value) {
  return os << "Unknown EmptyEnum value: " << static_cast<int32_t>(value);
}

std::ostream& operator<<(std::ostream& os, ExtensibleEmptyEnum value) {
  return os << "Unknown ExtensibleEmptyEnum value: " << static_cast<int32_t>(value);
}

std::ostream& operator<<(std::ostream& os, BasicEnum value) {
  switch(value) {
    case BasicEnum::D:
      return os << "BasicEnum::D";
    case BasicEnum::A:
      return os << "BasicEnum::{A, C}";
    case BasicEnum::B:
      return os << "BasicEnum::B";
    case BasicEnum::E:
      return os << "BasicEnum::E";
    default:
      return os << "Unknown BasicEnum value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, StructWithEnum_EnumWithin value) {
  switch(value) {
    case StructWithEnum_EnumWithin::A:
      return os << "StructWithEnum_EnumWithin::A";
    case StructWithEnum_EnumWithin::B:
      return os << "StructWithEnum_EnumWithin::B";
    case StructWithEnum_EnumWithin::C:
      return os << "StructWithEnum_EnumWithin::C";
    case StructWithEnum_EnumWithin::D:
      return os << "StructWithEnum_EnumWithin::D";
    default:
      return os << "Unknown StructWithEnum_EnumWithin value: " << static_cast<int32_t>(value);
  }
}
