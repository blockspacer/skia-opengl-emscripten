...
TestWTFCodeGeneration::TestWTFCodeGeneration(
    ...
    const WTF::Vector<WTF::String>& strs_in,
    const WTF::Vector<WTF::String>& nullable_strs_in,
    const WTF::Vector<WTF::Vector<int32_t>>& arrays_in,
    const WTF::Vector<bool>& bools_in,
    ...
    const WTF::Vector<WTF::HashMap<WTF::String, WTF::String>>& str_maps_in)
    : str(std::move(str_in)),
