...
class  TestStruct {
 public:
  ...
  TestStruct(
      ...
      const WTF::Vector<bool>& f_bool_array,
      const WTF::Vector<int32_t>& f_int32_array,
      const WTF::Vector<TestEnum>& f_enum_array,
      WTF::Vector<mojo::PendingRemote<TestInterface>> f_interface_array,
      const WTF::Vector<WTF::Vector<int32_t>>& f_nested_array,
