...
#include "services/resource_coordinator/public/mojom/coordination_unit.mojom-test-utils.h"
...
void DocumentCoordinationUnitInterceptorForTesting::SetLifecycleState(::resource_coordinator::mojom::LifecycleState state) {
