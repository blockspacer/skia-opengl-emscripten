...
#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_TRIAL_COMPARISON_CERT_VERIFIER_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_TRIAL_COMPARISON_CERT_VERIFIER_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/trial_comparison_cert_verifier.mojom-blink-forward.h"
...
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierConfigClient
...
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierReportClient
 ...
 public:
  ...
  virtual void SendTrialReport(const WTF::String& hostname, ::network::mojom::blink::X509CertificatePtr cert, bool enable_rev_checking, bool require_rev_checking_local_anchors, bool enable_sha1_local_anchors, bool disable_symantec_enforcement, ::network::mojom::blink::CertVerifyResultPtr primary_result, ::network::mojom::blink::CertVerifyResultPtr trial_result) = 0;
};

class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierConfigClientProxy
...
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierReportClientProxy
 ...
 public:
  ...
  void SendTrialReport(const WTF::String& hostname, ::network::mojom::blink::X509CertificatePtr cert, bool enable_rev_checking, bool require_rev_checking_local_anchors, bool enable_sha1_local_anchors, bool disable_symantec_enforcement, ::network::mojom::blink::CertVerifyResultPtr primary_result, ::network::mojom::blink::CertVerifyResultPtr trial_result) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierConfigClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierReportClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierConfigClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierReportClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT TrialComparisonCertVerifierParams {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TrialComparisonCertVerifierParams::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::TrialComparisonCertVerifierParams::DataView,
                                         ::network::mojom::blink::TrialComparisonCertVerifierParamsPtr> {
  static bool IsNull(const ::network::mojom::blink::TrialComparisonCertVerifierParamsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::TrialComparisonCertVerifierParamsPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::TrialComparisonCertVerifierParams::initial_allowed) initial_allowed(
      const ::network::mojom::blink::TrialComparisonCertVerifierParamsPtr& input) {
    return input->initial_allowed;
  }

  static  decltype(::network::mojom::blink::TrialComparisonCertVerifierParams::config_client_request)& config_client_request(
       ::network::mojom::blink::TrialComparisonCertVerifierParamsPtr& input) {
    return input->config_client_request;
  }

  static  decltype(::network::mojom::blink::TrialComparisonCertVerifierParams::report_client)& report_client(
       ::network::mojom::blink::TrialComparisonCertVerifierParamsPtr& input) {
    return input->report_client;
  }

  static bool Read(::network::mojom::blink::TrialComparisonCertVerifierParams::DataView input, ::network::mojom::blink::TrialComparisonCertVerifierParamsPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_TRIAL_COMPARISON_CERT_VERIFIER_MOJOM_BLINK_H_