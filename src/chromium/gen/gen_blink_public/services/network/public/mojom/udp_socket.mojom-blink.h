...
class BLINK_PLATFORM_EXPORT UDPSocket
 ...
 public:
  ...
  virtual void JoinGroup(::network::mojom::blink::IPAddressPtr group_address, JoinGroupCallback callback) = 0;


  using LeaveGroupCallback = base::OnceCallback<void(int32_t)>;
  
  virtual void LeaveGroup(::network::mojom::blink::IPAddressPtr group_address, LeaveGroupCallback callback) = 0;
  ...
  virtual void SendTo(::network::mojom::blink::IPEndPointPtr dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, ::network::mojom::blink::MutableNetworkTrafficAnnotationTagPtr traffic_annotation, SendToCallback callback) = 0;
...
class BLINK_PLATFORM_EXPORT UDPSocketReceiver
...
class BLINK_PLATFORM_EXPORT UDPSocketProxy
 ...
 public:
  ...
  void JoinGroup(::network::mojom::blink::IPAddressPtr group_address, JoinGroupCallback callback) final;
  void LeaveGroup(::network::mojom::blink::IPAddressPtr group_address, LeaveGroupCallback callback) final;
  ...
  void SendTo(::network::mojom::blink::IPEndPointPtr dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, ::network::mojom::blink::MutableNetworkTrafficAnnotationTagPtr traffic_annotation, SendToCallback callback) final;
...
class BLINK_PLATFORM_EXPORT UDPSocketReceiverProxy
...
class BLINK_PLATFORM_EXPORT UDPSocketReceiverStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT UDPSocketReceiverRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
