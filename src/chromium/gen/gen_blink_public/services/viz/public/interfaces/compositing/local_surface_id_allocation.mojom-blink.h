...
#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_LOCAL_SURFACE_ID_ALLOCATION_MOJOM_BLINK_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_LOCAL_SURFACE_ID_ALLOCATION_MOJOM_BLINK_H_
...
#include "services/viz/public/interfaces/compositing/local_surface_id_allocation.mojom-blink-forward.h"
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LocalSurfaceIdAllocation::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::viz::mojom::blink::LocalSurfaceIdAllocation::DataView,
                                         ::viz::mojom::blink::LocalSurfaceIdAllocationPtr> {
  static bool IsNull(const ::viz::mojom::blink::LocalSurfaceIdAllocationPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::LocalSurfaceIdAllocationPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::blink::LocalSurfaceIdAllocation::local_surface_id)& local_surface_id(
      const ::viz::mojom::blink::LocalSurfaceIdAllocationPtr& input) {
    return input->local_surface_id;
  }

  static const decltype(::viz::mojom::blink::LocalSurfaceIdAllocation::allocation_time)& allocation_time(
      const ::viz::mojom::blink::LocalSurfaceIdAllocationPtr& input) {
    return input->allocation_time;
  }

  static bool Read(::viz::mojom::blink::LocalSurfaceIdAllocation::DataView input, ::viz::mojom::blink::LocalSurfaceIdAllocationPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_LOCAL_SURFACE_ID_ALLOCATION_MOJOM_BLINK_H_