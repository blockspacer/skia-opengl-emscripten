...
class  CompositorFrameSinkClient
 ...
 public:
  ...
  virtual void OnBeginFrame(const viz::BeginFrameArgs& args, const base::flat_map<uint32_t, gfx::PresentationFeedback>& presentations) = 0;
...
class  CompositorFrameSinkClientProxy
 ...
 public:
  ...
  void OnBeginFrame(const viz::BeginFrameArgs& args, const base::flat_map<uint32_t, gfx::PresentationFeedback>& presentations) final;
