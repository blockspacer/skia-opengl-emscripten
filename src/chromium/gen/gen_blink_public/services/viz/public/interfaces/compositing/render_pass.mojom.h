...
#include "services/viz/public/interfaces/compositing/render_pass.mojom-forward.h"
...
struct  StructTraits<::viz::mojom::RenderPass::DataView,
  ...
  static const decltype(::viz::mojom::RenderPass::backdrop_filters)& backdrop_filters(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->backdrop_filters;
  }

  static const decltype(::viz::mojom::RenderPass::backdrop_filter_bounds)& backdrop_filter_bounds(
      const ::viz::mojom::RenderPassPtr& input) {
