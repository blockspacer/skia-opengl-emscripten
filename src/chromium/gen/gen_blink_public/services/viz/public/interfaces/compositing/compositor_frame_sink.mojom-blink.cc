...
#include "services/viz/public/interfaces/compositing/compositor_frame_sink.mojom-blink-import-headers.h"
...
void CompositorFrameSinkClientProxy::OnBeginFrame(
    const viz::BeginFrameArgs& in_args, WTF::HashMap<uint32_t, ::gfx::mojom::blink::PresentationFeedbackPtr> in_presentations) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_resources));
    ...
    case internal::kCompositorFrameSinkClient_OnBeginFrame_Name: {
      ...
      WTF::HashMap<uint32_t, ::gfx::mojom::blink::PresentationFeedbackPtr> p_presentations{};
