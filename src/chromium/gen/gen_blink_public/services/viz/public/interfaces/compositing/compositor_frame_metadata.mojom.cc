...
#include "services/viz/public/interfaces/compositing/compositor_frame_metadata.mojom-import-headers.h"


#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COMPOSITOR_FRAME_METADATA_MOJOM_JUMBO_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COMPOSITOR_FRAME_METADATA_MOJOM_JUMBO_H_
...
CompositorFrameMetadata::CompositorFrameMetadata(
    ...
    const std::vector<viz::SurfaceRange>& referenced_surfaces_in,
