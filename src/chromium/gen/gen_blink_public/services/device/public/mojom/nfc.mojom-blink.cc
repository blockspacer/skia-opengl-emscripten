...
void NFCClientProxy::OnWatch(
    const WTF::Vector<uint32_t>& in_watch_ids, NDEFMessagePtr in_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
// static
bool StructTraits<::device::mojom::blink::NDEFRecordTypeFilter::DataView, ::device::mojom::blink::NDEFRecordTypeFilterPtr>::Read(
    ::device::mojom::blink::NDEFRecordTypeFilter::DataView input,
    ::device::mojom::blink::NDEFRecordTypeFilterPtr* output) {
  bool success = true;
  ::device::mojom::blink::NDEFRecordTypeFilterPtr result(::device::mojom::blink::NDEFRecordTypeFilter::New());
