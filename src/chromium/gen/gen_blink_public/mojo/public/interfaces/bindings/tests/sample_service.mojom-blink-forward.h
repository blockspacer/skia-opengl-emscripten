...
template <>
struct DefaultHash<::sample::Bar_Type> {
  using Hash = sample_internal_Bar_Type_DataHashFn;
};
}  // namespace WTF
...
template <>
struct DefaultHash<::sample::Service_BazOptions> {
  using Hash = sample_internal_Service_BazOptions_DataHashFn;
};
}  // namespace WTF
