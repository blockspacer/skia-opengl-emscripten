...
Foo::Foo(
    ...
    const base::Optional<WTF::Vector<WTF::Vector<bool>>>& array_of_array_of_bools_in,
    const base::Optional<WTF::Vector<WTF::Vector<WTF::Vector<WTF::String>>>>& multi_array_of_strings_in,
    const base::Optional<WTF::Vector<bool>>& array_of_bools_in)
...
DefaultsTest::DefaultsTest(
    ...
    double a16_in,
    double a17_in,
    const WTF::Vector<uint8_t>& a18_in,
