...
#ifndef DEVICE_GAMEPAD_PUBLIC_MOJOM_GAMEPAD_MOJOM_BLINK_TEST_UTILS_H_
#define DEVICE_GAMEPAD_PUBLIC_MOJOM_GAMEPAD_MOJOM_BLINK_TEST_UTILS_H_
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM_BLINK) GamepadObserverInterceptorForTesting : public GamepadObserver {
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM_BLINK) GamepadObserverAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM_BLINK) GamepadMonitorInterceptorForTesting : public GamepadMonitor {
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM_BLINK) GamepadMonitorAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM_BLINK) GamepadHapticsManagerInterceptorForTesting : public GamepadHapticsManager {
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM_BLINK) GamepadHapticsManagerAsyncWaiter {
 public:
...
#endif  // DEVICE_GAMEPAD_PUBLIC_MOJOM_GAMEPAD_MOJOM_BLINK_TEST_UTILS_H_