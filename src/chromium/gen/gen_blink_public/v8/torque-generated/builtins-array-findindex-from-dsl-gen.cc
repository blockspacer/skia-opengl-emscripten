...
TF_BUILTIN(ArrayFindIndexLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:17:61");
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:18:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:19:54");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:20:57");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayFindIndexLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:33:5");
    CodeStubAssembler(state_).Unreachable();
  }
}
...
TF_BUILTIN(ArrayFindIndexLoopAfterCallbackLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:47:61");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:48:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:49:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-findindex.tq:50:57");
    CodeStubAssembler(state_).Unreachable();
  }
