...
TF_BUILTIN(ArrayForEachLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:13:61");
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:14:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:15:54");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:16:57");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayForEachLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:30:61");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:31:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:32:54");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-foreach.tq:33:57");
    CodeStubAssembler(state_).Unreachable();
  }
