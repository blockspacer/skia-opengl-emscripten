...
TF_BUILTIN(StringRepeat, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/string-repeat.tq", 10);
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'count >= 0\' failed", "../../v8/src/builtins/string-repeat.tq", 10);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/string-repeat.tq", 11);
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'string != kEmptyString\' failed", "../../v8/src/builtins/string-repeat.tq", 11);
  }
...
TF_BUILTIN(StringPrototypeRepeat, CodeStubAssembler) {
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/string-repeat.tq", 53);
  ...
  if (block19.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'IsNumberNormalized(heapNum)\' failed", "../../v8/src/builtins/string-repeat.tq", 53);
  }
