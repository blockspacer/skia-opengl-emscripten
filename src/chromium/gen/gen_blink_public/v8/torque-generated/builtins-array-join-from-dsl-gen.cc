...
ArrayJoinBuiltinsFromDSLAssembler::Buffer ArrayJoinBuiltinsFromDSLAssembler::NewBuffer(compiler::TNode<UintPtrT> p_len, compiler::TNode<String> p_sep) {
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 220);
    compiler::TNode<IntPtrT> tmp15;
    USE(tmp15);
  ...
  if (block7.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'cappedBufferSize > 0\' failed", "../../v8/src/builtins/array-join.tq", 220);
  }
...
compiler::TNode<String> ArrayJoinBuiltinsFromDSLAssembler::BufferJoin(compiler::TNode<Context> p_context, ArrayJoinBuiltinsFromDSLAssembler::Buffer p_buffer, compiler::TNode<String> p_sep) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 231);
  ...
  if (block3.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'IsValidPositiveSmi(buffer.totalStringLength)\' failed", "../../v8/src/builtins/array-join.tq", 231);
  }
  ...
  if (block13.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-join.tq:250:11");
    CodeStubAssembler(state_).Unreachable();
  }
...
compiler::TNode<Object> ArrayJoinBuiltinsFromDSLAssembler::ArrayJoin12JSTypedArray(compiler::TNode<Context> p_context, bool p_useToLocaleString, compiler::TNode<JSReceiver> p_receiver, compiler::TNode<String> p_sep, compiler::TNode<Number> p_lenNumber, compiler::TNode<Object> p_locales, compiler::TNode<Object> p_options) {
  ...
  if (block21.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-join.tq:398:9");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block36.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-join.tq:412:9");
    CodeStubAssembler(state_).Unreachable();
  }
...
compiler::TNode<FixedArray> ArrayJoinBuiltinsFromDSLAssembler::LoadJoinStack(compiler::TNode<Context> p_context, compiler::CodeAssemblerLabel* label_IfUninitialized) {
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 432);
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'IsFixedArray(stack)\' failed", "../../v8/src/builtins/array-join.tq", 432);
  }
...
TF_BUILTIN(JoinStackPop, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-join.tq:512:5");
    CodeStubAssembler(state_).Unreachable();
  }
}
...
void ArrayJoinBuiltinsFromDSLAssembler::JoinStackPopInline(compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_receiver) {
  ...
  if (block3.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../v8/src/builtins/array-join.tq:518:19");
    CodeStubAssembler(state_).Unreachable();
  }
...
compiler::TNode<FixedArray> ArrayJoinBuiltinsFromDSLAssembler::StoreAndGrowFixedArray5ATSmi(compiler::TNode<FixedArray> p_fixedArray, compiler::TNode<IntPtrT> p_index, compiler::TNode<Smi> p_element) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 135);
    compiler::TNode<BoolT> tmp4;
    USE(tmp4);
  ...
  if (block3.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'index <= length\' failed", "../../v8/src/builtins/array-join.tq", 135);
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 142);
  ...
  if (block8.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'index < newLength\' failed", "../../v8/src/builtins/array-join.tq", 142);
  }
...
TF_BUILTIN(LoadJoinTypedElement17ATFixedInt32Array, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 56);
    compiler::TNode<IntPtrT> tmp4 = ca_.IntPtrConstant(JSArrayBufferView::kBufferOffset);
    USE(tmp4);
    compiler::TNode<JSArrayBuffer>tmp5 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp3, tmp4});
    compiler::TNode<BoolT> tmp6;
    USE(tmp6);
    tmp6 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).IsDetachedBuffer(compiler::TNode<JSArrayBuffer>{tmp5}));
    compiler::TNode<BoolT> tmp7;
    USE(tmp7);
    tmp7 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).Word32BinaryNot(compiler::TNode<BoolT>{tmp6}));
    ca_.Branch(tmp7, &block1, &block2, tmp0, tmp1, tmp2, tmp3);
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert \'!IsDetachedBuffer(typedArray.buffer)\' failed", "../../v8/src/builtins/array-join.tq", 56);
  }
  ...
  if (block1.is_used()) {
    ...
    USE(tmp16);
    tmp16 = ca_.UncheckedCast<RawPtrT>(TypedArrayBuiltinsAssembler(state_).LoadDataPtr(compiler::TNode<JSTypedArray>{tmp15}));
    compiler::TNode<Smi> tmp17;
    USE(tmp17);
    tmp17 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).UnsafeCast5ATSmi(compiler::TNode<Context>{tmp12}, compiler::TNode<Object>{tmp14}));
    ca_.SetSourcePosition("../../v8/src/builtins/array-join.tq", 57);
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType17ATFixedInt32Array()), CodeStubAssembler::SMI_PARAMETERS));
...
TF_BUILTIN(LoadJoinTypedElement19ATFixedFloat32Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType19ATFixedFloat32Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement19ATFixedFloat64Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType19ATFixedFloat64Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement24ATFixedUint8ClampedArray, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType24ATFixedUint8ClampedArray()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement21ATFixedBigUint64Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType21ATFixedBigUint64Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement20ATFixedBigInt64Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType20ATFixedBigInt64Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement17ATFixedUint8Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType17ATFixedUint8Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement16ATFixedInt8Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType16ATFixedInt8Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement18ATFixedUint16Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType18ATFixedUint16Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement17ATFixedInt16Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType17ATFixedInt16Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
...
TF_BUILTIN(LoadJoinTypedElement18ATFixedUint32Array, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(compiler::TNode<RawPtrT>{tmp16}, compiler::TNode<Smi>{tmp17}, (TypedArrayBuiltinsFromDSLAssembler(state_).KindForArrayType18ATFixedUint32Array()), CodeStubAssembler::SMI_PARAMETERS));
    CodeStubAssembler(state_).Return(tmp18);
  }
}
