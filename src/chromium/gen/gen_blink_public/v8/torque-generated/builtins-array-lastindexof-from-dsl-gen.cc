...
compiler::TNode<Object> ArrayLastindexofBuiltinsFromDSLAssembler::TryFastArrayLastIndexOf(compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_receiver, compiler::TNode<Object> p_searchElement, compiler::TNode<Number> p_from, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 96);
    compiler::TNode<BoolT> tmp69;
    USE(tmp69);
    tmp69 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).IsDoubleElementsKind(compiler::TNode<Int32T>{tmp68}));
    ca_.Branch(tmp69, &block11, &block12, tmp61, tmp62, tmp63, tmp64, tmp65, tmp66, tmp67, tmp68);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Bind(&block12, &tmp70, &tmp71, &tmp72, &tmp73, &tmp74, &tmp75, &tmp76, &tmp77);
    CodeStubAssembler(state_).FailAssert("Torque assert \'IsDoubleElementsKind(kind)\' failed", "../../v8/src/builtins/array-lastindexof.tq", 96);
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Bind(&block11, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85);
    ...
    USE(tmp86);
    tmp86 = ca_.UncheckedCast<Smi>(ArrayLastindexofBuiltinsFromDSLAssembler(state_).FastArrayLastIndexOf16FixedDoubleArray(compiler::TNode<Context>{tmp78}, compiler::TNode<JSArray>{tmp82}, compiler::TNode<Smi>{tmp84}, compiler::TNode<Object>{tmp80}));
    ca_.Goto(&block2, tmp78, tmp79, tmp80, tmp81, tmp86);
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Bind(&block2, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91);
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 82);
    ca_.Goto(&block13, tmp87, tmp88, tmp89, tmp90, tmp91);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block13, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96);
  return compiler::TNode<Object>{tmp96};
}
...
compiler::TNode<Smi> ArrayLastindexofBuiltinsFromDSLAssembler::FastArrayLastIndexOf10FixedArray(compiler::TNode<Context> p_context, compiler::TNode<JSArray> p_array, compiler::TNode<Smi> p_from, compiler::TNode<Object> p_searchElement) {
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 48);
    compiler::TNode<BoolT> tmp68;
    USE(tmp68);
    tmp68 = ca_.UncheckedCast<BoolT>(BaseBuiltinsFromDSLAssembler(state_).Is13ATFastJSArray7JSArray(compiler::TNode<Context>{tmp60}, compiler::TNode<JSArray>{tmp61}));
    ca_.Branch(tmp68, &block13, &block14, tmp60, tmp61, tmp62, tmp63, tmp64, tmp65, tmp66, tmp67);
  }
  ...
  if (block14.is_used()) {
    ...
    ca_.Bind(&block14, &tmp69, &tmp70, &tmp71, &tmp72, &tmp73, &tmp74, &tmp75, &tmp76);
    CodeStubAssembler(state_).FailAssert("Torque assert \'Is<FastJSArray>(array)\' failed", "../../v8/src/builtins/array-lastindexof.tq", 48);
  }
  ...
  if (block13.is_used()) {
    ...
    compiler::TNode<Object> tmp80;
    compiler::TNode<FixedArrayBase> tmp81;
    compiler::TNode<Smi> tmp82;
    compiler::TNode<Object> tmp83;
    compiler::TNode<Oddball> tmp84;
    ca_.Bind(&block13, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84);
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 49);
    ca_.Goto(&block1, tmp77, tmp78, tmp79, tmp80, tmp82);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Bind(&block12, &tmp85, &tmp86, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91, &tmp92);
    ...
    ca_.Goto(&block7, tmp85, tmp86, tmp87, tmp88, tmp89, tmp90);
  }
  ...
  if (block8.is_used()) {
    ...
    compiler::TNode<Object> tmp96;
    compiler::TNode<FixedArrayBase> tmp97;
    compiler::TNode<Smi> tmp98;
    ca_.Bind(&block8, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98);
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 42);
    ca_.Goto(&block7, tmp93, tmp94, tmp95, tmp96, tmp97, tmp98);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block7, &tmp99, &tmp100, &tmp101, &tmp102, &tmp103, &tmp104);
    ...
    USE(tmp106);
    tmp106 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiSub(compiler::TNode<Smi>{tmp104}, compiler::TNode<Smi>{tmp105}));
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 41);
    ca_.Goto(&block6, tmp99, tmp100, tmp101, tmp102, tmp103, tmp106);
  }
  ...
  if (block5.is_used()) {
    ...
    compiler::TNode<FixedArrayBase> tmp111;
    compiler::TNode<Smi> tmp112;
    ca_.Bind(&block5, &tmp107, &tmp108, &tmp109, &tmp110, &tmp111, &tmp112);
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 57);
    compiler::TNode<BoolT> tmp113;
    USE(tmp113);
    tmp113 = ca_.UncheckedCast<BoolT>(BaseBuiltinsFromDSLAssembler(state_).Is13ATFastJSArray7JSArray(compiler::TNode<Context>{tmp107}, compiler::TNode<JSArray>{tmp108}));
    ca_.Branch(tmp113, &block15, &block16, tmp107, tmp108, tmp109, tmp110, tmp111, tmp112);
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Bind(&block16, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119);
    CodeStubAssembler(state_).FailAssert("Torque assert \'Is<FastJSArray>(array)\' failed", "../../v8/src/builtins/array-lastindexof.tq", 57);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Bind(&block15, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125);
    ...
    ca_.Goto(&block1, tmp120, tmp121, tmp122, tmp123, tmp126);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp127, &tmp128, &tmp129, &tmp130, &tmp131);
    ca_.SetSourcePosition("../../v8/src/builtins/array-lastindexof.tq", 28);
    ca_.Goto(&block17, tmp127, tmp128, tmp129, tmp130, tmp131);
  }
    ...
    ca_.Bind(&block17, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136);
  return compiler::TNode<Smi>{tmp136};
}
