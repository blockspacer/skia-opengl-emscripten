...
#ifndef UI_GFX_MOJO_COLOR_SPACE_MOJOM_BLINK_JUMBO_H_
#define UI_GFX_MOJO_COLOR_SPACE_MOJOM_BLINK_JUMBO_H_
#endif
namespace gfx {
namespace mojom {
namespace blink {
...
ColorSpace::ColorSpace(
    ...
    const WTF::Vector<float>& custom_primary_matrix_in,
    const WTF::Vector<float>& custom_transfer_params_in)
