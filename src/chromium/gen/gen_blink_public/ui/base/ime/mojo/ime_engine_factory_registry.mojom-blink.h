...
#ifndef UI_BASE_IME_MOJO_IME_ENGINE_FACTORY_REGISTRY_MOJOM_BLINK_H_
#define UI_BASE_IME_MOJO_IME_ENGINE_FACTORY_REGISTRY_MOJOM_BLINK_H_
...
#include "ui/base/ime/mojo/ime_engine_factory_registry.mojom-blink-forward.h"
...
class  ImeEngineFactoryRegistry
 ...
 public:
  ...
  virtual void ActivateFactory(::ime::mojom::blink::ImeEngineFactoryPtr factory) = 0;
};
...
class  ImeEngineFactoryRegistryProxy
 ...
 public:
  ...
  void ActivateFactory(::ime::mojom::blink::ImeEngineFactoryPtr factory) final;
...
#endif  // UI_BASE_IME_MOJO_IME_ENGINE_FACTORY_REGISTRY_MOJOM_BLINK_H_