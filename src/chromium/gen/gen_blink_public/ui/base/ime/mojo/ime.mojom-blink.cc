...
#include "ui/base/ime/mojo/ime.mojom-blink-import-headers.h"
...
EditorInfo::EditorInfo(
    ::ui::mojom::blink::TextInputType type_in,
    ::ui::mojom::blink::TextInputMode mode_in,
    int32_t flags_in,
    ::ui::mojom::blink::FocusReason focus_reason_in,
...
size_t EditorInfo::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->focus_reason);
  seed = mojo::internal::WTFHash(seed, this->should_do_learning);
  return seed;
}
...
void ImeEngineProxy::ProcessKeyEvent(
    ::ui::mojom::blink::EventPtr in_key_event, ProcessKeyEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ImeEngineProxy::UpdateSurroundingInfo(
    const WTF::String& in_text, int32_t in_cursor, int32_t in_anchor, int32_t in_offset) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ImeEngineProxy::UpdateCompositionBounds(
    const WTF::Vector<::blink::WebRect>& in_bounds) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_offset));
    ...
    case internal::kImeEngine_UpdateCompositionBounds_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      WTF::Vector<::blink::WebRect> p_bounds{};
...
bool ImeEngineStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kImeEngine_ProcessKeyEvent_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::ui::mojom::blink::EventPtr p_key_event{};
...
void ImeEngineClientProxy::UpdateCompositionText(
    ::ui::mojom::blink::CompositionTextPtr in_composition_text, uint32_t in_cursor_pos, bool in_visible) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ImeEngineClientProxy::SendKeyEvent(
    ::ui::mojom::blink::EventPtr in_key_event) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_text));
    ...
    case internal::kImeEngineClient_UpdateCompositionText_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::ui::mojom::blink::CompositionTextPtr p_composition_text{};
...
// static
bool StructTraits<::ime::mojom::blink::EditorInfo::DataView, ::ime::mojom::blink::EditorInfoPtr>::Read(
    ::ime::mojom::blink::EditorInfo::DataView input,
    ::ime::mojom::blink::EditorInfoPtr* output) {
  bool success = true;
  ::ime::mojom::blink::EditorInfoPtr result(::ime::mojom::blink::EditorInfo::New());
