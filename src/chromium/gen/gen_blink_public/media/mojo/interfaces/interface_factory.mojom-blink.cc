...
#include "media/mojo/interfaces/interface_factory.mojom-blink-import-headers.h"
...
void InterfaceFactoryProxy::CreateDefaultRenderer(
    const WTF::String& in_audio_device_id, ::media::mojom::blink::RendererRequest in_renderer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateCdmProxy(
    ::mojo_base::mojom::blink::TokenPtr in_cdm_guid, ::media::mojom::blink::CdmProxyRequest in_cdm_proxy) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_decryptor));
    ...
    case internal::kInterfaceFactory_CreateCdmProxy_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::mojo_base::mojom::blink::TokenPtr p_cdm_guid{};
