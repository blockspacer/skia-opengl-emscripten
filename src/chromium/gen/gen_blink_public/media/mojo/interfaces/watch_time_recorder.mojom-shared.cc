...
bool SecondaryPlaybackProperties_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->audio_decoder_name, 3, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams audio_decoder_name_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->audio_decoder_name, validation_context,
                                         &audio_decoder_name_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->video_decoder_name, 4, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams video_decoder_name_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->video_decoder_name, validation_context,
                                         &video_decoder_name_validate_params)) {
    return false;
  }
