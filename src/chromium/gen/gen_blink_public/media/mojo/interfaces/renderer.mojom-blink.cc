...
#include "media/mojo/interfaces/renderer.mojom-blink-import-headers.h"
...
void RendererProxy::Initialize(
    RendererClientAssociatedPtrInfo in_client, base::Optional<WTF::Vector<::media::mojom::blink::DemuxerStreamPtrInfo>> in_streams, const base::Optional<::blink::KURL>& in_media_url, const base::Optional<::blink::KURL>& in_first_party_for_cookies, bool in_allow_credentials, InitializeCallback callback) {
