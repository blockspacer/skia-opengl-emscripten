...
#include "media/mojo/interfaces/video_decoder.mojom-blink-import-headers.h"
...
SupportedVideoDecoderConfig::SupportedVideoDecoderConfig(
    ::media::mojom::blink::VideoCodecProfile profile_min_in,
    ::media::mojom::blink::VideoCodecProfile profile_max_in,
    const ::blink::WebSize& coded_size_min_in,
    const ::blink::WebSize& coded_size_max_in,
...
class VideoDecoder_GetSupportedConfigs_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::HashMap<VideoDecoderImplementation, WTF::Vector<SupportedVideoDecoderConfigPtr>> in_supported_configs);
...
bool VideoDecoder_GetSupportedConfigs_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  WTF::HashMap<VideoDecoderImplementation, WTF::Vector<SupportedVideoDecoderConfigPtr>> p_supported_configs{};
...
bool VideoDecoderStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    ...
    case internal::kVideoDecoder_Construct_Name: {
      ...
      VideoDecoderImplementation p_implementation{};
...
void VideoDecoderClientProxy::OnVideoFrameDecoded(
    ::media::mojom::blink::VideoFramePtr in_frame, bool in_can_read_without_stalling, const base::Optional<base::UnguessableToken>& in_release_token) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
