...
std::ostream& operator<<(std::ostream& os, AudioLogComponent value) {
  switch(value) {
    case AudioLogComponent::kInputController:
      return os << "AudioLogComponent::kInputController";
    case AudioLogComponent::kOutputController:
      return os << "AudioLogComponent::kOutputController";
    case AudioLogComponent::kOutputStream:
      return os << "AudioLogComponent::kOutputStream";
    default:
      return os << "Unknown AudioLogComponent value: " << static_cast<int32_t>(value);
  }
}
...
bool AudioLog_OnProcessingStateChanged_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnProcessingStateChanged_Params_Data* object = static_cast<const AudioLog_OnProcessingStateChanged_Params_Data*>(data);
...
bool AudioLogFactory_CreateAudioLog_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLogFactory_CreateAudioLog_Params_Data* object = static_cast<const AudioLogFactory_CreateAudioLog_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->audio_log_request, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->audio_log_request,
                                                 validation_context)) {
    return false;
  }
