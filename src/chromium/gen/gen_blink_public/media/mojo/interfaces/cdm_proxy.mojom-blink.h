...
class BLINK_PLATFORM_EXPORT CdmProxy
 ...
 public:
  ...
  using SetKeyCallback = base::OnceCallback<void(CdmProxy::Status)>;
  
  virtual void SetKey(uint32_t crypto_session_id, const WTF::Vector<uint8_t>& key_id, CdmProxy::KeyType key_type, const WTF::Vector<uint8_t>& key_blob, SetKeyCallback callback) = 0;


  using RemoveKeyCallback = base::OnceCallback<void(CdmProxy::Status)>;
  
  virtual void RemoveKey(uint32_t crypto_session_id, const WTF::Vector<uint8_t>& key_id, RemoveKeyCallback callback) = 0;
};
...
class BLINK_PLATFORM_EXPORT CdmProxyClient
...
class BLINK_PLATFORM_EXPORT CdmProxyProxy
    : public CdmProxy {
 public:
  ...
  void SetKey(uint32_t crypto_session_id, const WTF::Vector<uint8_t>& key_id, CdmProxy::KeyType key_type, const WTF::Vector<uint8_t>& key_blob, SetKeyCallback callback) final;
  void RemoveKey(uint32_t crypto_session_id, const WTF::Vector<uint8_t>& key_id, RemoveKeyCallback callback) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};

class BLINK_PLATFORM_EXPORT CdmProxyClientProxy
...
class BLINK_PLATFORM_EXPORT CdmProxyStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT CdmProxyClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT CdmProxyRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT CdmProxyClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT CdmProxyResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
