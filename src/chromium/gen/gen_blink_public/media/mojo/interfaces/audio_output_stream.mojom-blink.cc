...
#include "media/mojo/interfaces/audio_output_stream.mojom-blink-import-headers.h"
...
void AudioOutputStreamProviderProxy::Acquire(
    ::media::mojom::blink::AudioParametersPtr in_params, AudioOutputStreamProviderClientPtr in_client, const base::Optional<base::UnguessableToken>& in_processing_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AudioOutputStreamProviderClientProxy::Created(
    AudioOutputStreamPtr in_stream, ::media::mojom::blink::ReadWriteAudioDataPipePtr in_data_pipe) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
