...
#if !defined(LIBRARY_LOADER_LIBUDEV1_H_DLOPEN) && !defined(LIBRARY_LOADER_LIBUDEV1_H_DT_NEEDED)
#error neither LIBRARY_LOADER_LIBUDEV1_H_DLOPEN nor LIBRARY_LOADER_LIBUDEV1_H_DT_NEEDED defined
#endif
#if defined(LIBRARY_LOADER_LIBUDEV1_H_DLOPEN) && defined(LIBRARY_LOADER_LIBUDEV1_H_DT_NEEDED)
#error both LIBRARY_LOADER_LIBUDEV1_H_DLOPEN and LIBRARY_LOADER_LIBUDEV1_H_DT_NEEDED defined
#endif

LibUdev1Loader::LibUdev1Loader() : loaded_(false) {
}
...
bool LibUdev1Loader::Load(const std::string& library_name) {
  if (loaded_)
    return false;

#if defined(LIBRARY_LOADER_LIBUDEV1_H_DLOPEN)
...
#endif
#if defined(LIBRARY_LOADER_LIBUDEV1_H_DT_NEEDED)
...
void LibUdev1Loader::CleanUp(bool unload) {
#if defined(LIBRARY_LOADER_LIBUDEV1_H_DLOPEN)
  if (unload) {
    dlclose(library_);
    library_ = NULL;
