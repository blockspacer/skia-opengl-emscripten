...
#include "components/services/filesystem/public/interfaces/directory.mojom-blink-import-headers.h"
...
bool Directory::Read(::base::File::Error* out_error, base::Optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_directory_contents) {
  NOTREACHED();
  return false;
}
bool Directory::OpenFile(const WTF::String& path, ::filesystem::mojom::blink::FileRequest file, uint32_t open_flags, ::base::File::Error* out_error) {
  NOTREACHED();
  return false;
}
...
bool Directory::OpenDirectory(const WTF::String& path, DirectoryRequest directory, uint32_t open_flags, ::base::File::Error* out_error) {
  NOTREACHED();
  return false;
}
...
class Directory_Read_HandleSyncResponse
 ...
 public:
  Directory_Read_HandleSyncResponse(
      bool* result, ::base::File::Error* out_error, base::Optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_directory_contents)
 ...
 private:
  ...
  base::Optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_directory_contents_;DISALLOW_COPY_AND_ASSIGN(Directory_Read_HandleSyncResponse);
};
...
bool DirectoryProxy::Read(
    ::base::File::Error* out_param_error, base::Optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_param_directory_contents) {
...
bool DirectoryProxy::OpenFile(
    const WTF::String& param_path, ::filesystem::mojom::blink::FileRequest param_file, uint32_t param_open_flags, ::base::File::Error* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DirectoryProxy::OpenFile(
    const WTF::String& in_path, ::filesystem::mojom::blink::FileRequest in_file, uint32_t in_open_flags, OpenFileCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::Directory::OpenFile");
#endif
  const bool kExpectsResponse = true;
...
bool DirectoryProxy::OpenDirectory(
    const WTF::String& param_path, DirectoryRequest param_directory, uint32_t param_open_flags, ::base::File::Error* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DirectoryProxy::OpenDirectory(
    const WTF::String& in_path, DirectoryRequest in_directory, uint32_t in_open_flags, OpenDirectoryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::Directory::OpenDirectory");
#endif
  const bool kExpectsResponse = true;
...
class Directory_Read_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::base::File::Error in_error, base::Optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>> in_directory_contents);
...
bool Directory_Read_ForwardToCallback::Accept(
  ...
  base::Optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>> p_directory_contents{};
...
bool DirectoryStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kDirectory_OpenFile_Name: {
      ...
      bool success = true;
      WTF::String p_path{};
      ::filesystem::mojom::blink::FileRequest p_file{};
