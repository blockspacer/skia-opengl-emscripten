...
void SharedWorkerFactoryProxy::CreateSharedWorker(
    ::blink::mojom::blink::SharedWorkerInfoPtr in_info, bool in_pause_on_start, const base::UnguessableToken& in_devtools_worker_token, ::blink::mojom::blink::RendererPreferencesPtr in_renderer_preferences, ::blink::mojom::blink::RendererPreferenceWatcherRequest in_preference_watcher_request, ::blink::mojom::blink::WorkerContentSettingsProxyPtr in_content_settings, ::blink::mojom::blink::ServiceWorkerProviderInfoForWorkerPtr in_service_worker_provider_info, int32_t in_appcache_host_id, ::network::mojom::blink::URLLoaderFactoryPtr in_main_script_loader_factory, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr in_main_script_load_params, ::blink::mojom::blink::URLLoaderFactoryBundlePtr in_subresource_loader_factories, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr in_controller_info, ::blink::mojom::blink::SharedWorkerHostPtr in_host, ::blink::mojom::blink::SharedWorkerRequest in_shared_worker, ::service_manager::mojom::blink::InterfaceProviderPtr in_interface_provider) {
...
bool SharedWorkerFactoryStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kSharedWorkerFactory_CreateSharedWorker_Name: {
      ...
      ::blink::mojom::blink::RendererPreferencesPtr p_renderer_preferences{};
      ::blink::mojom::blink::RendererPreferenceWatcherRequest p_preference_watcher_request{};
      ::blink::mojom::blink::WorkerContentSettingsProxyPtr p_content_settings{};
      ::blink::mojom::blink::ServiceWorkerProviderInfoForWorkerPtr p_service_worker_provider_info{};
      int32_t p_appcache_host_id{};
      ::network::mojom::blink::URLLoaderFactoryPtr p_main_script_loader_factory{};
      ...
      ::blink::mojom::blink::SharedWorkerHostPtr p_host{};
      ::blink::mojom::blink::SharedWorkerRequest p_shared_worker{};
      ::service_manager::mojom::blink::InterfaceProviderPtr p_interface_provider{};
