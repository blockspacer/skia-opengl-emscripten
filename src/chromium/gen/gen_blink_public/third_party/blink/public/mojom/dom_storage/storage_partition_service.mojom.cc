...
#include "third_party/blink/public/mojom/dom_storage/storage_partition_service.mojom-import-headers.h"
...
void StoragePartitionServiceProxy::OpenLocalStorage(
    const url::Origin& in_origin, ::blink::mojom::StorageAreaRequest in_area) {
...
void StoragePartitionServiceProxy::OpenSessionStorage(
    const std::string& in_namespace_id, ::blink::mojom::SessionStorageNamespaceRequest in_session_namespace) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StoragePartitionServiceStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kStoragePartitionService_OpenLocalStorage_Name: {
      ...
      bool success = true;
      url::Origin p_origin{};
      ::blink::mojom::StorageAreaRequest p_area{};
...
std::move(p_area));
    ...
    case internal::kStoragePartitionService_OpenSessionStorage_Name: {
      ...
      ::blink::mojom::SessionStorageNamespaceRequest p_session_namespace{};
