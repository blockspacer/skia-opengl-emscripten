...
void ServiceWorkerProxy::InitializeGlobalScope(
    ServiceWorkerHostAssociatedPtrInfo in_service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr in_registration_info, FetchHandlerExistence in_fetch_handler_existence) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchCookieChangeEvent(
    const ::blink::WebCanonicalCookie& in_cookie, ::network::mojom::blink::CookieChangeCause in_cause, DispatchCookieChangeEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchNotificationClickEvent(
    const WTF::String& in_notification_id, ::blink::mojom::blink::NotificationDataPtr in_notification_data, int32_t in_action_index, const WTF::String& in_reply, DispatchNotificationClickEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchPushEvent(
    const WTF::String& in_payload, DispatchPushEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchSyncEvent(
    const WTF::String& in_id, bool in_last_chance, base::TimeDelta in_timeout, DispatchSyncEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchAbortPaymentEvent(
    ::payments::mojom::blink::PaymentHandlerResponseCallbackPtr in_result_of_abort_payment, DispatchAbortPaymentEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchCanMakePaymentEvent(
    ::payments::mojom::blink::CanMakePaymentEventDataPtr in_event_data, ::payments::mojom::blink::PaymentHandlerResponseCallbackPtr in_result_of_can_make_payment, DispatchCanMakePaymentEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerProxy::DispatchPaymentRequestEvent(
    ::payments::mojom::blink::PaymentRequestEventDataPtr in_request_data, ::payments::mojom::blink::PaymentHandlerResponseCallbackPtr in_response_callback, DispatchPaymentRequestEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class ServiceWorker_DispatchInstallEvent_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::ServiceWorkerEventStatus in_status, bool in_has_fetch_handler);
...
std::move(p_registration), std::move(callback));
    ...
    case internal::kServiceWorker_DispatchCookieChangeEvent_Name: {
      ...
      ::network::mojom::blink::CookieChangeCause p_cause{};
...
std::move(p_timeout), std::move(callback));
    ...
    case internal::kServiceWorker_DispatchAbortPaymentEvent_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::payments::mojom::blink::PaymentHandlerResponseCallbackPtr p_result_of_abort_payment{};
...
std::move(p_result_of_abort_payment), std::move(callback));
    ...
    case internal::kServiceWorker_DispatchCanMakePaymentEvent_Name: {
      ...
      ::payments::mojom::blink::PaymentHandlerResponseCallbackPtr p_result_of_can_make_payment{};
...
std::move(p_result_of_can_make_payment), std::move(callback));
    ...
    case internal::kServiceWorker_DispatchPaymentRequestEvent_Name: {
      ...
      ::payments::mojom::blink::PaymentHandlerResponseCallbackPtr p_response_callback{};
