...
#include "third_party/blink/public/mojom/native_file_system/native_file_system_directory_handle.mojom-blink-import-headers.h"
...
NativeFileSystemHandle::NativeFileSystemHandle() : tag_(Tag::FILE) {
  data_.file = new ::blink::mojom::blink::NativeFileSystemFileHandlePtrInfo;
}
...
void NativeFileSystemDirectoryHandleProxy::GetFile(
    const WTF::String& in_name, bool in_create, GetFileCallback callback) {
...
void NativeFileSystemDirectoryHandleProxy::GetDirectory(
    const WTF::String& in_name, bool in_create, GetDirectoryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NativeFileSystemDirectoryHandleProxy::MoveFrom(
    ::blink::mojom::blink::NativeFileSystemTransferTokenPtr in_source, const WTF::String& in_name, MoveFromCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NativeFileSystemDirectoryHandleProxy::CopyFrom(
    ::blink::mojom::blink::NativeFileSystemTransferTokenPtr in_source, const WTF::String& in_name, CopyFromCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class NativeFileSystemDirectoryHandle_GetFile_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, ::blink::mojom::blink::NativeFileSystemFileHandlePtr in_file);
...
bool NativeFileSystemDirectoryHandle_GetFile_ForwardToCallback::Accept(
  ...
  ::blink::mojom::blink::NativeFileSystemFileHandlePtr p_file{};
...
class NativeFileSystemDirectoryHandle_GetDirectory_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, NativeFileSystemDirectoryHandlePtr in_directory);
...
class NativeFileSystemDirectoryHandle_GetEntries_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, WTF::Vector<NativeFileSystemEntryPtr> in_entries);
...
bool NativeFileSystemDirectoryHandle_GetEntries_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::mojom::blink::NativeFileSystemErrorPtr p_result{};
  WTF::Vector<NativeFileSystemEntryPtr> p_entries{};
...
class NativeFileSystemDirectoryHandle_MoveFrom_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::NativeFileSystemErrorPtr in_result, NativeFileSystemEntryPtr in_entry);
...
std::move(p_create), std::move(callback));
    ...
    case internal::kNativeFileSystemDirectoryHandle_MoveFrom_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::blink::NativeFileSystemTransferTokenPtr p_source{};
      WTF::String p_name{};
...
// static
bool StructTraits<::blink::mojom::blink::NativeFileSystemEntry::DataView, ::blink::mojom::blink::NativeFileSystemEntryPtr>::Read(
    ::blink::mojom::blink::NativeFileSystemEntry::DataView input,
    ::blink::mojom::blink::NativeFileSystemEntryPtr* output) {
  bool success = true;
  ::blink::mojom::blink::NativeFileSystemEntryPtr result(::blink::mojom::blink::NativeFileSystemEntry::New());
...
// static
bool UnionTraits<::blink::mojom::blink::NativeFileSystemHandle::DataView, ::blink::mojom::blink::NativeFileSystemHandlePtr>::Read(
    ::blink::mojom::blink::NativeFileSystemHandle::DataView input,
    ::blink::mojom::blink::NativeFileSystemHandlePtr* output) {
  using UnionType = ::blink::mojom::blink::NativeFileSystemHandle;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::FILE: {
      *output = UnionType::NewFile(
          input.TakeFile<::blink::mojom::blink::NativeFileSystemFileHandlePtrInfo>());
      break;
    }
    case Tag::DIRECTORY: {
      *output = UnionType::NewDirectory(
          input.TakeDirectory<::blink::mojom::blink::NativeFileSystemDirectoryHandlePtrInfo>());
      break;
    }
    default:
      return false;
