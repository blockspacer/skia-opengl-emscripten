...
std::ostream& operator<<(std::ostream& os, UserIdleState value) {
  switch(value) {
    case UserIdleState::kActive:
      return os << "UserIdleState::kActive";
    case UserIdleState::kIdle:
      return os << "UserIdleState::kIdle";
    default:
      return os << "Unknown UserIdleState value: " << static_cast<int32_t>(value);
  }
}
...
std::ostream& operator<<(std::ostream& os, ScreenIdleState value) {
  switch(value) {
    case ScreenIdleState::kLocked:
      return os << "ScreenIdleState::kLocked";
    case ScreenIdleState::kUnlocked:
      return os << "ScreenIdleState::kUnlocked";
    default:
      return os << "Unknown ScreenIdleState value: " << static_cast<int32_t>(value);
  }
}
