...
void PictureInPictureServiceProxy::StartSession(
    uint32_t in_player_id, const base::Optional<viz::SurfaceId>& in_surface_id, const ::blink::WebSize& in_natural_size, bool in_show_play_pause_button, bool in_show_mute_button, StartSessionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PictureInPictureServiceProxy::UpdateSession(
    uint32_t in_player_id, const base::Optional<viz::SurfaceId>& in_surface_id, const ::blink::WebSize& in_natural_size, bool in_show_play_pause_button, bool in_show_mute_button) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
