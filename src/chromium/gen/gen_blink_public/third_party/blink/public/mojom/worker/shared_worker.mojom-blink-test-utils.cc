...
void SharedWorkerInterceptorForTesting::BindDevToolsAgent(::blink::mojom::blink::DevToolsAgentHostAssociatedPtrInfo agent_host, ::blink::mojom::blink::DevToolsAgentAssociatedRequest agent) {
