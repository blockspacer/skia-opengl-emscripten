...
void AutoplayConfigurationClientProxy::AddAutoplayFlags(
  ...
  TRACE_EVENT0("mojom", "<class 'jinja2::utils::Namespace'>::AutoplayConfigurationClient::AddAutoplayFlags");
#endif
...
bool AutoplayConfigurationClientStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kAutoplayConfigurationClient_AddAutoplayFlags_Name: {
      ...
      TRACE_EVENT1(
          "mojom",
          "(Impl)<class 'jinja2::utils::Namespace'>::AutoplayConfigurationClient::AddAutoplayFlags",
