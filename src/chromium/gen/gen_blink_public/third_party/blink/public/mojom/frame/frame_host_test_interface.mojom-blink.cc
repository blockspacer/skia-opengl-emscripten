...
#include "third_party/blink/public/mojom/frame/frame_host_test_interface.mojom-blink-import-headers.h"
...
void FrameHostTestInterfaceProxy::Ping(
    const ::blink::KURL& in_source_url, const WTF::String& in_source_event) {
