...
bool NonPersistentNotificationListener_OnClick_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NonPersistentNotificationListener_OnClick_ResponseParams_Data* object = static_cast<const NonPersistentNotificationListener_OnClick_ResponseParams_Data*>(data);
