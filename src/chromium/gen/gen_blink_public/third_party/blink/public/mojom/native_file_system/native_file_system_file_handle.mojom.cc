...
void NativeFileSystemFileHandleProxy::Write(
    uint64_t in_offset, ::blink::mojom::BlobPtr in_data, WriteCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class NativeFileSystemFileHandle_Write_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::NativeFileSystemErrorPtr in_result, uint64_t in_bytes_written);
