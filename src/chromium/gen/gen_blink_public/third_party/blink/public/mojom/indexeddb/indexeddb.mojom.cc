...
IDBKeyRange::IDBKeyRange(
    const ::blink::IndexedDBKey& lower_in,
    const ::blink::IndexedDBKey& upper_in,
    bool lower_open_in,
    bool upper_open_in)
...
IDBIndexMetadata::IDBIndexMetadata(
    ...
    const ::blink::IndexedDBKeyPath& key_path_in,
    bool unique_in,
    bool multi_entry_in)
    : id(std::move(id_in)),
...
IDBDatabaseMetadata::IDBDatabaseMetadata(
    ...
    const base::flat_map<int64_t, ::blink::IndexedDBObjectStoreMetadata>& object_stores_in)
    : id(std::move(id_in)),
      name(std::move(name_in)),
...
IDBIndexKeys::IDBIndexKeys(
    int64_t index_id_in,
    const std::vector<::blink::IndexedDBKey>& index_keys_in)
...
IDBValue::IDBValue(
    const std::vector<uint8_t>& bits_in,
    std::vector<IDBBlobInfoPtr> blob_or_file_info_in)
...
IDBReturnValue::IDBReturnValue(
    IDBValuePtr value_in,
    const ::blink::IndexedDBKey& primary_key_in,
    const ::blink::IndexedDBKeyPath& key_path_in)
...
IDBObservation::IDBObservation(
    ...
    const ::blink::IndexedDBKeyRange& key_range_in,
    IDBValuePtr value_in)
...
IDBObserverChanges::IDBObserverChanges(
    ...
    base::flat_map<int32_t, IDBObserverTransactionPtr> transaction_map_in,
    std::vector<IDBObservationPtr> observations_in)
...
IDBError::IDBError(
    ...
    const base::string16& error_message_in)
...
IDBCursorValue::IDBCursorValue(
    const std::vector<::blink::IndexedDBKey>& keys_in,
    const std::vector<::blink::IndexedDBKey>& primary_keys_in,
    std::vector<IDBValuePtr> values_in)
...
void IDBCallbacksProxy::SuccessNamesAndVersionsList(
    std::vector<IDBNameAndVersionPtr> in_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBCallbacksProxy::UpgradeNeeded(
    IDBDatabaseAssociatedPtrInfo in_database, int64_t in_old_version, IDBDataLoss in_data_loss, const std::string& in_data_loss_message, const ::blink::IndexedDBDatabaseMetadata& in_db_metadata) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBCallbacksProxy::SuccessDatabase(
    IDBDatabaseAssociatedPtrInfo in_database, const ::blink::IndexedDBDatabaseMetadata& in_metadata) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBCallbacksProxy::SuccessCursor(
    IDBCursorAssociatedPtrInfo in_cursor, const ::blink::IndexedDBKey& in_key, const ::blink::IndexedDBKey& in_primary_key, IDBValuePtr in_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBCallbacksProxy::SuccessArray(
    std::vector<IDBReturnValuePtr> in_values) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBCallbacksProxy::SuccessKey(
    const ::blink::IndexedDBKey& in_key) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_message));
    ...
    case internal::kIDBCallbacks_SuccessNamesAndVersionsList_Name: {
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      std::vector<IDBNameAndVersionPtr> p_value{};
...
void IDBCursorProxy::CursorContinue(
    const ::blink::IndexedDBKey& in_key, const ::blink::IndexedDBKey& in_primary_key, CursorContinueCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBTransactionProxy::CreateObjectStore(
    int64_t in_object_store_id, const base::string16& in_name, const ::blink::IndexedDBKeyPath& in_key_path, bool in_auto_increment) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBTransactionProxy::Put(
    int64_t in_object_store_id, IDBValuePtr in_value, const ::blink::IndexedDBKey& in_key, IDBPutMode in_mode, const std::vector<::blink::IndexedDBIndexKeys>& in_index_keys, IDBCallbacksAssociatedPtrInfo in_callbacks) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::CreateTransaction(
    IDBTransactionAssociatedRequest in_transaction_request, int64_t in_transaction_id, const std::vector<int64_t>& in_object_store_ids, IDBTransactionMode in_mode) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::Get(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const ::blink::IndexedDBKeyRange& in_key_range, bool in_key_only, IDBCallbacksAssociatedPtrInfo in_callbacks) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::GetAll(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const ::blink::IndexedDBKeyRange& in_key_range, bool in_key_only, int64_t in_max_count, IDBCallbacksAssociatedPtrInfo in_callbacks) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::OpenCursor(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const ::blink::IndexedDBKeyRange& in_key_range, IDBCursorDirection in_direction, bool in_key_only, IDBTaskType in_task_type, IDBCallbacksAssociatedPtrInfo in_callbacks) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::Count(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const ::blink::IndexedDBKeyRange& in_key_range, IDBCallbacksAssociatedPtrInfo in_callbacks) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::DeleteRange(
    int64_t in_transaction_id, int64_t in_object_store_id, const ::blink::IndexedDBKeyRange& in_key_range, IDBCallbacksAssociatedPtrInfo in_callbacks) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBDatabaseProxy::CreateIndex(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const base::string16& in_name, const ::blink::IndexedDBKeyPath& in_key_path, bool in_unique, bool in_multi_entry) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBFactoryProxy::Open(
    IDBCallbacksAssociatedPtrInfo in_callbacks, IDBDatabaseCallbacksAssociatedPtrInfo in_database_callbacks, const base::string16& in_name, int64_t in_version, IDBTransactionAssociatedRequest in_version_change_transaction_request, int64_t in_transaction_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void IDBFactoryProxy::DeleteDatabase(
    IDBCallbacksAssociatedPtrInfo in_callbacks, const base::string16& in_name, bool in_force_close) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
// static
bool StructTraits<::blink::mojom::IDBKey::DataView, ::blink::mojom::IDBKeyPtr>::Read(
    ::blink::mojom::IDBKey::DataView input,
    ::blink::mojom::IDBKeyPtr* output) {
  bool success = true;
  ::blink::mojom::IDBKeyPtr result(::blink::mojom::IDBKey::New());
...
bool StructTraits<::blink::mojom::IDBKeyPath::DataView, ::blink::mojom::IDBKeyPathPtr>::Read(
    ::blink::mojom::IDBKeyPath::DataView input,
    ::blink::mojom::IDBKeyPathPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBKeyRange::DataView, ::blink::mojom::IDBKeyRangePtr>::Read(
    ::blink::mojom::IDBKeyRange::DataView input,
    ::blink::mojom::IDBKeyRangePtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBIndexMetadata::DataView, ::blink::mojom::IDBIndexMetadataPtr>::Read(
    ::blink::mojom::IDBIndexMetadata::DataView input,
    ::blink::mojom::IDBIndexMetadataPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBObjectStoreMetadata::DataView, ::blink::mojom::IDBObjectStoreMetadataPtr>::Read(
    ::blink::mojom::IDBObjectStoreMetadata::DataView input,
    ::blink::mojom::IDBObjectStoreMetadataPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBDatabaseMetadata::DataView, ::blink::mojom::IDBDatabaseMetadataPtr>::Read(
    ::blink::mojom::IDBDatabaseMetadata::DataView input,
    ::blink::mojom::IDBDatabaseMetadataPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBNameAndVersion::DataView, ::blink::mojom::IDBNameAndVersionPtr>::Read(
    ::blink::mojom::IDBNameAndVersion::DataView input,
    ::blink::mojom::IDBNameAndVersionPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBIndexKeys::DataView, ::blink::mojom::IDBIndexKeysPtr>::Read(
    ::blink::mojom::IDBIndexKeys::DataView input,
    ::blink::mojom::IDBIndexKeysPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBFileInfo::DataView, ::blink::mojom::IDBFileInfoPtr>::Read(
    ::blink::mojom::IDBFileInfo::DataView input,
    ::blink::mojom::IDBFileInfoPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBBlobInfo::DataView, ::blink::mojom::IDBBlobInfoPtr>::Read(
    ::blink::mojom::IDBBlobInfo::DataView input,
    ::blink::mojom::IDBBlobInfoPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBValue::DataView, ::blink::mojom::IDBValuePtr>::Read(
    ::blink::mojom::IDBValue::DataView input,
    ::blink::mojom::IDBValuePtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBReturnValue::DataView, ::blink::mojom::IDBReturnValuePtr>::Read(
    ::blink::mojom::IDBReturnValue::DataView input,
    ::blink::mojom::IDBReturnValuePtr* output) {
  bool success = true;
...
// static
bool StructTraits<::blink::mojom::IDBObservation::DataView, ::blink::mojom::IDBObservationPtr>::Read(
    ::blink::mojom::IDBObservation::DataView input,
    ::blink::mojom::IDBObservationPtr* output) {
  bool success = true;
  ::blink::mojom::IDBObservationPtr result(::blink::mojom::IDBObservation::New());
...
// static
bool StructTraits<::blink::mojom::IDBObserverTransaction::DataView, ::blink::mojom::IDBObserverTransactionPtr>::Read(
    ::blink::mojom::IDBObserverTransaction::DataView input,
    ::blink::mojom::IDBObserverTransactionPtr* output) {
  bool success = true;
  ::blink::mojom::IDBObserverTransactionPtr result(::blink::mojom::IDBObserverTransaction::New());
...
// static
bool StructTraits<::blink::mojom::IDBObserverChanges::DataView, ::blink::mojom::IDBObserverChangesPtr>::Read(
    ::blink::mojom::IDBObserverChanges::DataView input,
    ::blink::mojom::IDBObserverChangesPtr* output) {
  bool success = true;
  ::blink::mojom::IDBObserverChangesPtr result(::blink::mojom::IDBObserverChanges::New());
...
bool StructTraits<::blink::mojom::IDBError::DataView, ::blink::mojom::IDBErrorPtr>::Read(
    ::blink::mojom::IDBError::DataView input,
    ::blink::mojom::IDBErrorPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::IDBCursorValue::DataView, ::blink::mojom::IDBCursorValuePtr>::Read(
    ::blink::mojom::IDBCursorValue::DataView input,
    ::blink::mojom::IDBCursorValuePtr* output) {
  bool success = true;
...
// static
bool UnionTraits<::blink::mojom::IDBKeyData::DataView, ::blink::mojom::IDBKeyDataPtr>::Read(
    ::blink::mojom::IDBKeyData::DataView input,
    ::blink::mojom::IDBKeyDataPtr* output) {
  using UnionType = ::blink::mojom::IDBKeyData;
...
bool UnionTraits<::blink::mojom::IDBKeyPathData::DataView, ::blink::mojom::IDBKeyPathDataPtr>::Read(
    ::blink::mojom::IDBKeyPathData::DataView input,
    ::blink::mojom::IDBKeyPathDataPtr* output) {
