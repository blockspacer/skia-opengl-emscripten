...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeechRecognitionHypothesis::DataView,
                                         ::blink::mojom::SpeechRecognitionHypothesisPtr> {
  ...
  static const decltype(::blink::mojom::SpeechRecognitionHypothesis::utterance)& utterance(
      const ::blink::mojom::SpeechRecognitionHypothesisPtr& input) {
    return input->utterance;
  }

  static decltype(::blink::mojom::SpeechRecognitionHypothesis::confidence) confidence(
      const ::blink::mojom::SpeechRecognitionHypothesisPtr& input) {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeechRecognitionResult::DataView,
                                         ::blink::mojom::SpeechRecognitionResultPtr> {
  ...
  static const decltype(::blink::mojom::SpeechRecognitionResult::hypotheses)& hypotheses(
      const ::blink::mojom::SpeechRecognitionResultPtr& input) {
    return input->hypotheses;
  }

  static decltype(::blink::mojom::SpeechRecognitionResult::is_provisional) is_provisional(
      const ::blink::mojom::SpeechRecognitionResultPtr& input) {
