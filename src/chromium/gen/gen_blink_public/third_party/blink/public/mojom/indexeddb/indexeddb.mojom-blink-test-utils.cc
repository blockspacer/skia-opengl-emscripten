...
void IDBCallbacksInterceptorForTesting::Error(int32_t code, const WTF::String& message) {
...
void IDBCallbacksInterceptorForTesting::SuccessStringList(const WTF::Vector<WTF::String>& value) {
...
void IDBCallbacksInterceptorForTesting::UpgradeNeeded(IDBDatabaseAssociatedPtrInfo database, int64_t old_version, IDBDataLoss data_loss, const WTF::String& data_loss_message, const ::blink::IDBDatabaseMetadata& db_metadata) {
...
void IDBCallbacksInterceptorForTesting::SuccessDatabase(IDBDatabaseAssociatedPtrInfo database, const ::blink::IDBDatabaseMetadata& metadata) {
  GetForwardingInterface()->SuccessDatabase(std::move(database), std::move(metadata));
}
void IDBCallbacksInterceptorForTesting::SuccessCursor(IDBCursorAssociatedPtrInfo cursor, std::unique_ptr<::blink::IDBKey> key, std::unique_ptr<::blink::IDBKey> primary_key, base::Optional<std::unique_ptr<::blink::IDBValue>> value) {
...
void IDBCallbacksInterceptorForTesting::SuccessArray(WTF::Vector<IDBReturnValuePtr> values) {
  GetForwardingInterface()->SuccessArray(std::move(values));
}
void IDBCallbacksInterceptorForTesting::SuccessKey(std::unique_ptr<::blink::IDBKey> key) {
...
void IDBDatabaseCallbacksInterceptorForTesting::Abort(int64_t transaction_id, int32_t code, const WTF::String& message) {
...
void IDBTransactionInterceptorForTesting::Put(int64_t object_store_id, std::unique_ptr<::blink::IDBValue> value, std::unique_ptr<::blink::IDBKey> key, IDBPutMode mode, WTF::Vector<::blink::IDBIndexKeys> index_keys, IDBCallbacksAssociatedPtrInfo callbacks) {
...
void IDBDatabaseInterceptorForTesting::CreateTransaction(IDBTransactionAssociatedRequest transaction_request, int64_t transaction_id, const WTF::Vector<int64_t>& object_store_ids, IDBTransactionMode mode) {
...
void IDBDatabaseInterceptorForTesting::RemoveObservers(const WTF::Vector<int32_t>& observers) {
  GetForwardingInterface()->RemoveObservers(std::move(observers));
}
void IDBDatabaseInterceptorForTesting::Get(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, bool key_only, IDBCallbacksAssociatedPtrInfo callbacks) {
...
void IDBDatabaseInterceptorForTesting::GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, bool key_only, int64_t max_count, IDBCallbacksAssociatedPtrInfo callbacks) {
...
void IDBDatabaseInterceptorForTesting::OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, IDBCallbacksAssociatedPtrInfo callbacks) {
...
void IDBDatabaseInterceptorForTesting::Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, IDBCallbacksAssociatedPtrInfo callbacks) {
...
void IDBDatabaseInterceptorForTesting::DeleteRange(int64_t transaction_id, int64_t object_store_id, IDBKeyRangePtr key_range, IDBCallbacksAssociatedPtrInfo callbacks) {
...
void IDBFactoryInterceptorForTesting::Open(IDBCallbacksAssociatedPtrInfo callbacks, IDBDatabaseCallbacksAssociatedPtrInfo database_callbacks, const WTF::String& name, int64_t version, IDBTransactionAssociatedRequest version_change_transaction_request, int64_t transaction_id) {
...
void IDBFactoryInterceptorForTesting::DeleteDatabase(IDBCallbacksAssociatedPtrInfo callbacks, const WTF::String& name, bool force_close) {
