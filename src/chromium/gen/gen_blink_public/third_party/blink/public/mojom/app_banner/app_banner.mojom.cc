...
void AppBannerControllerProxy::BannerPromptRequest(
    AppBannerServicePtr in_service, AppBannerEventRequest in_event, const std::vector<std::string>& in_platform, bool in_require_gesture, BannerPromptRequestCallback callback) {
