...
#include "third_party/blink/public/mojom/native_file_system/native_file_system_manager.mojom-import-headers.h"
...
ChooseFileSystemEntryAcceptsOption::ChooseFileSystemEntryAcceptsOption(
    ...
    const std::vector<std::string>& mime_types_in,
    const std::vector<std::string>& extensions_in)
...
class NativeFileSystemManager_GetSandboxedFileSystem_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::NativeFileSystemErrorPtr in_result, ::blink::mojom::NativeFileSystemDirectoryHandlePtr in_directory);
...
bool NativeFileSystemManager_GetSandboxedFileSystem_ForwardToCallback::Accept(
  ...
  ::blink::mojom::NativeFileSystemDirectoryHandlePtr p_directory{};
