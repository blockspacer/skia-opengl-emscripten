...
class PLATFORM_EXPORT AnchorElementMetricsHost
 ...
 public:
  ...
  virtual void ReportAnchorElementMetricsOnLoad(WTF::Vector<AnchorElementMetricsPtr> metrics) = 0;
};
...
class PLATFORM_EXPORT AnchorElementMetricsHostProxy
 ...
 public:
  ...
  void ReportAnchorElementMetricsOnLoad(WTF::Vector<AnchorElementMetricsPtr> metrics) final;
