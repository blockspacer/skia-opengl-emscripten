...
#include "third_party/blink/public/mojom/sms/sms_manager.mojom-blink-import-headers.h"
...
// static
bool StructTraits<::blink::mojom::blink::SmsMessage::DataView, ::blink::mojom::blink::SmsMessagePtr>::Read(
    ::blink::mojom::blink::SmsMessage::DataView input,
    ::blink::mojom::blink::SmsMessagePtr* output) {
  bool success = true;
  ::blink::mojom::blink::SmsMessagePtr result(::blink::mojom::blink::SmsMessage::New());
