...
bool DateTimeSuggestion_Data::Validate(
  ...
  const DateTimeSuggestion_Data* object = static_cast<const DateTimeSuggestion_Data*>(data);
...
bool DateTimeDialogValue_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DateTimeDialogValue_Data* object = static_cast<const DateTimeDialogValue_Data*>(data);
...
bool DateTimeChooser_OpenDateTimeDialog_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DateTimeChooser_OpenDateTimeDialog_Params_Data* object = static_cast<const DateTimeChooser_OpenDateTimeDialog_Params_Data*>(data);
...
bool DateTimeChooser_OpenDateTimeDialog_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DateTimeChooser_OpenDateTimeDialog_ResponseParams_Data* object = static_cast<const DateTimeChooser_OpenDateTimeDialog_ResponseParams_Data*>(data);
