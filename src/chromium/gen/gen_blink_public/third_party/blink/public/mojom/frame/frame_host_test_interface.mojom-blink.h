...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_FRAME_HOST_TEST_INTERFACE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_FRAME_HOST_TEST_INTERFACE_MOJOM_BLINK_H_
...
class PLATFORM_EXPORT FrameHostTestInterface
 ...
 public:
  ...
  virtual void Ping(const ::blink::KURL& source_url, const WTF::String& source_event) = 0;
...
class PLATFORM_EXPORT FrameHostTestInterfaceProxy
 ...
 public:
  ...
  void Ping(const ::blink::KURL& source_url, const WTF::String& source_event) final;
  void GetName(GetNameCallback callback) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class PLATFORM_EXPORT FrameHostTestInterfaceStubDispatch {
 public:
...
class PLATFORM_EXPORT FrameHostTestInterfaceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT FrameHostTestInterfaceResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_FRAME_HOST_TEST_INTERFACE_MOJOM_BLINK_H_