...
void CacheStorageCacheProxy::Match(
    ::blink::mojom::blink::FetchAPIRequestPtr in_request, CacheQueryOptionsPtr in_query_options, int64_t in_trace_id, MatchCallback callback) {
...
void CacheStorageCacheProxy::SetSideData(
    const ::blink::KURL& in_url, base::Time in_response_time, const WTF::Vector<uint8_t>& in_side_data, int64_t in_trace_id, SetSideDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_trace_id), std::move(callback));
    ...
    case internal::kCacheStorageCache_SetSideData_Name: {
      ...
      WTF::Vector<uint8_t> p_side_data{};
      int64_t p_trace_id{};
...
void CacheStorageProxy::Match(
    ::blink::mojom::blink::FetchAPIRequestPtr in_request, MultiCacheQueryOptionsPtr in_match_options, int64_t in_trace_id, MatchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
