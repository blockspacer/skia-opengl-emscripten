...
ServiceWorkerProviderInfoForWorker::ServiceWorkerProviderInfoForWorker(
    ::blink::mojom::blink::ServiceWorkerContainerHostAssociatedPtrInfo host_ptr_info_in,
    ::blink::mojom::blink::ServiceWorkerContainerAssociatedRequest client_request_in)
...
ServiceWorkerProviderInfoForStartWorker::ServiceWorkerProviderInfoForStartWorker(
    ::blink::mojom::blink::ServiceWorkerContainerHostAssociatedPtrInfo host_ptr_info_in,
    ::blink::mojom::blink::ServiceWorkerContainerAssociatedRequest client_request_in,
    ::network::mojom::blink::URLLoaderFactoryPtrInfo script_loader_factory_ptr_info_in,
    ::blink::mojom::blink::CacheStoragePtrInfo cache_storage_in,
    ::service_manager::mojom::blink::InterfaceProviderPtrInfo interface_provider_in)
    : host_ptr_info(std::move(host_ptr_info_in)),
      client_request(std::move(client_request_in)),
...
void ServiceWorkerWorkerClientProxy::OnControllerChanged(
    ::blink::mojom::blink::ControllerServiceWorkerMode in_mode) {
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerProviderInfoForWorker::DataView, ::blink::mojom::blink::ServiceWorkerProviderInfoForWorkerPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerProviderInfoForWorker::DataView input,
    ::blink::mojom::blink::ServiceWorkerProviderInfoForWorkerPtr* output) {
  bool success = true;
  ::blink::mojom::blink::ServiceWorkerProviderInfoForWorkerPtr result(::blink::mojom::blink::ServiceWorkerProviderInfoForWorker::New());
...
bool StructTraits<::blink::mojom::blink::ServiceWorkerProviderInfoForStartWorker::DataView, ::blink::mojom::blink::ServiceWorkerProviderInfoForStartWorkerPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerProviderInfoForStartWorker::DataView input,
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerProviderInfoForWindow::DataView, ::blink::mojom::blink::ServiceWorkerProviderInfoForWindowPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerProviderInfoForWindow::DataView input,
    ::blink::mojom::blink::ServiceWorkerProviderInfoForWindowPtr* output) {
  bool success = true;
  ::blink::mojom::blink::ServiceWorkerProviderInfoForWindowPtr result(::blink::mojom::blink::ServiceWorkerProviderInfoForWindow::New());
