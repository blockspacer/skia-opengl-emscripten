...
class PLATFORM_EXPORT SharedWorkerConnector
 ...
 public:
  ...
  virtual void Connect(::blink::mojom::blink::SharedWorkerInfoPtr info, ::blink::mojom::blink::SharedWorkerClientPtr client, ::blink::mojom::blink::SharedWorkerCreationContextType creation_context_type, mojo::ScopedMessagePipeHandle message_port, ::blink::mojom::blink::BlobURLTokenPtr blob_url_token) = 0;
};

class PLATFORM_EXPORT SharedWorkerConnectorProxy
 ...
 public:
  ...
  void Connect(::blink::mojom::blink::SharedWorkerInfoPtr info, ::blink::mojom::blink::SharedWorkerClientPtr client, ::blink::mojom::blink::SharedWorkerCreationContextType creation_context_type, mojo::ScopedMessagePipeHandle message_port, ::blink::mojom::blink::BlobURLTokenPtr blob_url_token) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class PLATFORM_EXPORT SharedWorkerConnectorStubDispatch {
 public:
...
class PLATFORM_EXPORT SharedWorkerConnectorRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
