...
void FindInPageInterceptorForTesting::ActivateNearestFindResult(int32_t request_id, const ::blink::WebFloatPoint& point) {
...
void FindInPageClientInterceptorForTesting::SetActiveMatch(int32_t request_id, const ::blink::WebRect& active_match_rect, int32_t active_match_ordinal, FindMatchUpdateType update_type) {
