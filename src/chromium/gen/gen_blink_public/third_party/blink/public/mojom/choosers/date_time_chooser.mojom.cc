...
DateTimeSuggestion::DateTimeSuggestion(
    double value_in,
    const base::string16& localized_value_in,
...
bool StructTraits<::blink::mojom::DateTimeSuggestion::DataView, ::blink::mojom::DateTimeSuggestionPtr>::Read(
    ::blink::mojom::DateTimeSuggestion::DataView input,
    ::blink::mojom::DateTimeSuggestionPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::DateTimeDialogValue::DataView, ::blink::mojom::DateTimeDialogValuePtr>::Read(
    ::blink::mojom::DateTimeDialogValue::DataView input,
    ::blink::mojom::DateTimeDialogValuePtr* output) {
  bool success = true;
