 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SpeechRecognitionGrammar::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SpeechRecognitionGrammar::DataView,
                                         ::blink::mojom::blink::SpeechRecognitionGrammarPtr> {
  ...
  static const decltype(::blink::mojom::blink::SpeechRecognitionGrammar::url)& url(
      const ::blink::mojom::blink::SpeechRecognitionGrammarPtr& input) {
    return input->url;
  }

  static decltype(::blink::mojom::blink::SpeechRecognitionGrammar::weight) weight(
      const ::blink::mojom::blink::SpeechRecognitionGrammarPtr& input) {
    return input->weight;
  }
