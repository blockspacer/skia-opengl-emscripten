...
bool ServiceWorkerContainerHost_CloneContainerHost_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_CloneContainerHost_Params_Data* object = static_cast<const ServiceWorkerContainerHost_CloneContainerHost_Params_Data*>(data);
...
bool ServiceWorkerContainerHost_HintToUpdateServiceWorker_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_HintToUpdateServiceWorker_Params_Data* object = static_cast<const ServiceWorkerContainerHost_HintToUpdateServiceWorker_Params_Data*>(data);
...
bool ServiceWorkerContainerHost_OnExecutionReady_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_OnExecutionReady_Params_Data* object = static_cast<const ServiceWorkerContainerHost_OnExecutionReady_Params_Data*>(data);
