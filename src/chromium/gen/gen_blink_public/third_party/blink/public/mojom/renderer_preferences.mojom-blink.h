...
#include "ui/gfx/mojo/font_render_params.mojom-blink.h"
...
class PLATFORM_EXPORT RendererPreferences {
 public:
  ...
  RendererPreferences(
      ...
      const WTF::String& webrtc_ip_handling_policy,
      uint16_t webrtc_udp_min_port,
      uint16_t webrtc_udp_max_port,
      const WTF::String& user_agent_override,
      const WTF::String& accept_languages,
      bool disable_client_blocked_error_page,
      bool plugin_fullscreen_allowed,
      const WTF::String& network_contry_iso,
      const WTF::String& system_font_family_name);
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RendererPreferences::DataView, WTF::Vector<uint8_t>>(input);
  }
  ...
  WTF::String user_agent_override;
  ...
  WTF::String network_contry_iso;
  
  WTF::String system_font_family_name;
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::RendererPreferences::DataView,
  ...
  static decltype(::blink::mojom::blink::RendererPreferences::disable_client_blocked_error_page) disable_client_blocked_error_page(
      const ::blink::mojom::blink::RendererPreferencesPtr& input) {
  ...
  static const decltype(::blink::mojom::blink::RendererPreferences::network_contry_iso)& network_contry_iso(
      const ::blink::mojom::blink::RendererPreferencesPtr& input) {
    return input->network_contry_iso;
  }

  static const decltype(::blink::mojom::blink::RendererPreferences::system_font_family_name)& system_font_family_name(
      const ::blink::mojom::blink::RendererPreferencesPtr& input) {
