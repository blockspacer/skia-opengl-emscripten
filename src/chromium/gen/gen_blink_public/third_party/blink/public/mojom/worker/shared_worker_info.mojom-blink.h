...
class PLATFORM_EXPORT SharedWorkerInfo {
 public:
  ...
  SharedWorkerInfo(
      ...
      ::blink::mojom::blink::ContentSecurityPolicyType content_security_policy_type,
      ::blink::mojom::blink::IPAddressSpace creation_address_space);
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SharedWorkerInfo::DataView,
  ...
  static const decltype(::blink::mojom::blink::SharedWorkerInfo::name)& name(
      const ::blink::mojom::blink::SharedWorkerInfoPtr& input) {
    return input->name;
  }
