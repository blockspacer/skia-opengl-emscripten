...
#endif
const WrapperTypeInfo v8_device_motion_event_wrapper_type_info = {
    gin::kEmbedderBlink,
    V8DeviceMotionEvent::DomTemplate,
    V8DeviceMotionEvent::InstallConditionalFeatures,
    "DeviceMotionEvent",
...
const WrapperTypeInfo& DeviceMotionEvent::wrapper_type_info_ = v8_device_motion_event_wrapper_type_info;
...
namespace device_motion_event_v8_internal {
...
static void AccelerationAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  DeviceMotionEventAcceleration* cpp_value(WTF::GetPtr(impl->acceleration()));
...
static void AccelerationIncludingGravityAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  DeviceMotionEventAcceleration* cpp_value(WTF::GetPtr(impl->accelerationIncludingGravity()));
...
static void RotationRateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  DeviceMotionEventRotationRate* cpp_value(WTF::GetPtr(impl->rotationRate()));
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "DeviceMotionEvent");
  ...
  DeviceMotionEventInit* event_init_dict;
  type = info[0];
  if (!type.Prepare())
    return;
  ...
  event_init_dict = NativeValueTraits<DeviceMotionEventInit>::NativeValue(info.GetIsolate(), info[1], exception_state);
  if (exception_state.HadException())
    return;

  DeviceMotionEvent* impl = DeviceMotionEvent::Create(type, event_init_dict);
  v8::Local<v8::Object> wrapper = info.Holder();
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8DeviceMotionEvent::GetWrapperTypeInfo(), wrapper);
...
MODULES_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("DeviceMotionEvent"));
    return;
  }
  ...
  device_motion_event_v8_internal::Constructor(info);
}
...
void V8DeviceMotionEvent::AccelerationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  device_motion_event_v8_internal::AccelerationAttributeGetter(info);
}
...
void V8DeviceMotionEvent::AccelerationIncludingGravityAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  device_motion_event_v8_internal::AccelerationIncludingGravityAttributeGetter(info);
}
...
void V8DeviceMotionEvent::RotationRateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  device_motion_event_v8_internal::RotationRateAttributeGetter(info);
}
...
void V8DeviceMotionEvent::IntervalAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  device_motion_event_v8_internal::IntervalAttributeGetter(info);
}
...
void V8DeviceMotionEvent::IsTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  device_motion_event_v8_internal::IsTrustedAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8DeviceMotionEventAccessors[] = {
    { "isTrusted", V8DeviceMotionEvent::IsTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8DeviceMotionEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8DeviceMotionEvent::GetWrapperTypeInfo()->interface_name, V8Event::DomTemplate(isolate, world), V8DeviceMotionEvent::kInternalFieldCount);
  interface_template->SetCallHandler(device_motion_event_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8DeviceMotionEventAccessors, base::size(kV8DeviceMotionEventAccessors));
...
v8::Local<v8::FunctionTemplate> V8DeviceMotionEvent::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8DeviceMotionEvent::GetWrapperTypeInfo()),
      InstallV8DeviceMotionEventTemplate);
}

bool V8DeviceMotionEvent::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8DeviceMotionEvent::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8DeviceMotionEvent::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8DeviceMotionEvent::GetWrapperTypeInfo(), v8_value);
}

DeviceMotionEvent* V8DeviceMotionEvent::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DeviceMotionEvent* NativeValueTraits<DeviceMotionEvent>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DeviceMotionEvent* native_value = V8DeviceMotionEvent::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
...
void V8DeviceMotionEvent::InstallConditionalFeatures(
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context || !RuntimeEnabledFeatures::RestrictDeviceSensorEventsToSecureContextsEnabled()) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "interval", V8DeviceMotionEvent::IntervalAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
          { "acceleration", V8DeviceMotionEvent::AccelerationAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
          { "accelerationIncludingGravity", V8DeviceMotionEvent::AccelerationIncludingGravityAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
          { "rotationRate", V8DeviceMotionEvent::RotationRateAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
      };
      V8DOMConfiguration::InstallAccessors(
