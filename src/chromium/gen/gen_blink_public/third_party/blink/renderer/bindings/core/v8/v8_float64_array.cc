...
#endif
const WrapperTypeInfo v8_float64_array_wrapper_type_info = {
    gin::kEmbedderBlink,
    nullptr,
    nullptr,
    "Float64Array",
...
DOMFloat64Array* V8Float64Array::ToImpl(v8::Local<v8::Object> object) {
  ...
  if (script_wrappable)
    return script_wrappable->ToImpl<DOMFloat64Array>();

  v8::Local<v8::Float64Array> v8_view = object.As<v8::Float64Array>();
  v8::Local<v8::Object> array_buffer = v8_view->Buffer();
  DOMFloat64Array* typed_array = nullptr;
  if (array_buffer->IsArrayBuffer()) {
    typed_array = DOMFloat64Array::Create(
  ...
  return typed_array->ToImpl<DOMFloat64Array>();
}

DOMFloat64Array* V8Float64Array::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return value->IsFloat64Array() ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMFloat64Array* NativeValueTraits<DOMFloat64Array>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMFloat64Array* native_value = V8Float64Array::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
