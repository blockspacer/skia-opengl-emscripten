...
template <>
class V8PersistentCallbackFunction<V8CustomElementAdoptedCallback> final : public V8PersistentCallbackFunctionBase {
  using V8CallbackFunction = V8CustomElementAdoptedCallback;
 ...
 public:
  ...
  v8::Maybe<void> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Document* oldOwner, Document* newOwner) WARN_UNUSED_RESULT;
  CORE_EXPORT void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Document* oldOwner, Document* newOwner);
...
// V8CustomElementAdoptedCallback is designed to be used with wrapper-tracing.
...
Persistent<V8CustomElementAdoptedCallback> WrapPersistent(V8CustomElementAdoptedCallback*) = delete;
