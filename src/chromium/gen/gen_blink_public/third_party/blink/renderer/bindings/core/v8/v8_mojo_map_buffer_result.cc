...
void V8MojoMapBufferResult::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MojoMapBufferResult* impl, ExceptionState& exception_state) {
...
MojoMapBufferResult* NativeValueTraits<MojoMapBufferResult>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MojoMapBufferResult* impl = MojoMapBufferResult::Create();
  V8MojoMapBufferResult::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
