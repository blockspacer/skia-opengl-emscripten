...
void V8AudioBufferOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, AudioBufferOptions* impl, ExceptionState& exception_state) {
...
AudioBufferOptions* NativeValueTraits<AudioBufferOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  AudioBufferOptions* impl = AudioBufferOptions::Create();
  V8AudioBufferOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
