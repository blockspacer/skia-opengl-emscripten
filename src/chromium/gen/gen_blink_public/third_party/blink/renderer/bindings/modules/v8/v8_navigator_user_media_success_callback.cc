...
v8::Maybe<void> V8NavigatorUserMediaSuccessCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, MediaStream* stream) {
...
void V8NavigatorUserMediaSuccessCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, MediaStream* stream) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8NavigatorUserMediaSuccessCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, MediaStream* stream) {
  return Proxy()->Invoke(
      callback_this_value, stream);
}

void V8PersistentCallbackFunction<V8NavigatorUserMediaSuccessCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, MediaStream* stream) {
