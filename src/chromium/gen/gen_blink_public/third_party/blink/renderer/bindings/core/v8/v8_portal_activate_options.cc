...
static const v8::Eternal<v8::Name>* eternalV8PortalActivateOptionsKeys(v8::Isolate* isolate) {
...
void V8PortalActivateOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PortalActivateOptions* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PortalActivateOptionsKeys(isolate);
...
v8::Local<v8::Value> PortalActivateOptions::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8PortalActivateOptions(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8PortalActivateOptions(const PortalActivateOptions* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8PortalActivateOptionsKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
...
PortalActivateOptions* NativeValueTraits<PortalActivateOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PortalActivateOptions* impl = PortalActivateOptions::Create();
  V8PortalActivateOptions::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
