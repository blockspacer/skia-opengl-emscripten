...
#endif
const WrapperTypeInfo v8_idb_observer_changes_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& IDBObserverChanges::wrapper_type_info_ = v8_idb_observer_changes_wrapper_type_info;
...
namespace idb_observer_changes_v8_internal {
...
static void DatabaseAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  IDBDatabase* cpp_value(WTF::GetPtr(impl->database()));
...
static void RecordsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValue(info, impl->records(script_state).V8Value());
}
...
void V8IDBObserverChanges::DatabaseAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  idb_observer_changes_v8_internal::DatabaseAttributeGetter(info);
}
...
void V8IDBObserverChanges::TransactionAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  idb_observer_changes_v8_internal::TransactionAttributeGetter(info);
}
...
void V8IDBObserverChanges::RecordsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  idb_observer_changes_v8_internal::RecordsAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8IDBObserverChangesAccessors[] = {
    { "database", V8IDBObserverChanges::DatabaseAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "transaction", V8IDBObserverChanges::TransactionAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "records", V8IDBObserverChanges::RecordsAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8IDBObserverChangesTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8IDBObserverChanges::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8IDBObserverChanges::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8IDBObserverChangesAccessors, base::size(kV8IDBObserverChangesAccessors));
...
v8::Local<v8::FunctionTemplate> V8IDBObserverChanges::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8IDBObserverChanges::GetWrapperTypeInfo()),
      InstallV8IDBObserverChangesTemplate);
}

bool V8IDBObserverChanges::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8IDBObserverChanges::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8IDBObserverChanges::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8IDBObserverChanges::GetWrapperTypeInfo(), v8_value);
}

IDBObserverChanges* V8IDBObserverChanges::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

IDBObserverChanges* NativeValueTraits<IDBObserverChanges>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  IDBObserverChanges* native_value = V8IDBObserverChanges::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
