...
#endif
const WrapperTypeInfo v8_ext_srgb_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& EXTsRGB::wrapper_type_info_ = v8_ext_srgb_wrapper_type_info;
...
namespace ext_srgb_v8_internal {
...
static void InstallV8EXTsRGBTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8EXTsRGB::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8EXTsRGB::kInternalFieldCount);
...
v8::Local<v8::FunctionTemplate> V8EXTsRGB::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8EXTsRGB::GetWrapperTypeInfo()),
      InstallV8EXTsRGBTemplate);
}

bool V8EXTsRGB::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8EXTsRGB::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8EXTsRGB::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8EXTsRGB::GetWrapperTypeInfo(), v8_value);
}

EXTsRGB* V8EXTsRGB::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

EXTsRGB* NativeValueTraits<EXTsRGB>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  EXTsRGB* native_value = V8EXTsRGB::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
