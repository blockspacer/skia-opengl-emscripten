...
#endif
const WrapperTypeInfo v8_svg_view_element_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& SVGViewElement::wrapper_type_info_ = v8_svg_view_element_wrapper_type_info;
...
namespace svg_view_element_v8_internal {
...
static void ZoomAndPanAttributeSetter(
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "SVGViewElement", "zoomAndPan");
...
void V8SVGViewElement::ViewBoxAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_view_element_v8_internal::ViewBoxAttributeGetter(info);
}
...
void V8SVGViewElement::PreserveAspectRatioAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_view_element_v8_internal::PreserveAspectRatioAttributeGetter(info);
}
...
void V8SVGViewElement::ZoomAndPanAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_view_element_v8_internal::ZoomAndPanAttributeGetter(info);
}

void V8SVGViewElement::ZoomAndPanAttributeSetterCallback(
  ...
  svg_view_element_v8_internal::ZoomAndPanAttributeSetter(v8_value, info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8SVGViewElementAccessors[] = {
    { "viewBox", V8SVGViewElement::ViewBoxAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "preserveAspectRatio", V8SVGViewElement::PreserveAspectRatioAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
...
static void InstallV8SVGViewElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8SVGViewElement::GetWrapperTypeInfo()->interface_name, V8SVGElement::DomTemplate(isolate, world), V8SVGViewElement::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8SVGViewElementAccessors, base::size(kV8SVGViewElementAccessors));
...
v8::Local<v8::FunctionTemplate> V8SVGViewElement::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8SVGViewElement::GetWrapperTypeInfo()),
      InstallV8SVGViewElementTemplate);
}

bool V8SVGViewElement::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8SVGViewElement::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8SVGViewElement::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8SVGViewElement::GetWrapperTypeInfo(), v8_value);
}

SVGViewElement* V8SVGViewElement::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

SVGViewElement* NativeValueTraits<SVGViewElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SVGViewElement* native_value = V8SVGViewElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
