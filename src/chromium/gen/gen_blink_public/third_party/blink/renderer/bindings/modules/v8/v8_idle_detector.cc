...
static void StateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  IdleState* cpp_value(WTF::GetPtr(impl->state()));
  ...
  V8PrivateProperty::GetSymbol(
      info.GetIsolate(), "KeepAlive#IdleDetector#state")
      .Set(holder, v8_value);
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "IdleDetector");
  ...
  IdleDetector* impl = IdleDetector::Create(script_state, options, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
void V8IdleDetector::StateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_IdleDetector_state_Getter");

  idle_detector_v8_internal::StateAttributeGetter(info);
}
...
void V8IdleDetector::StopMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_IdleDetector_stop");

  idle_detector_v8_internal::StopMethod(info);
}
...
IdleDetector* NativeValueTraits<IdleDetector>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  IdleDetector* native_value = V8IdleDetector::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
  ...
  if (!prototype_object.IsEmpty() || !interface_object.IsEmpty()) {
    if (is_secure_context) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "state", V8IdleDetector::StateAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    ...
    if (is_secure_context) {
      {
        ...
        const V8DOMConfiguration::MethodConfiguration kConfigurations[] = {
            {"stop", V8IdleDetector::StopMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds}
        };
        for (const auto& config : kConfigurations) {
          V8DOMConfiguration::InstallMethod(
              isolate, world, instance_object, prototype_object,
