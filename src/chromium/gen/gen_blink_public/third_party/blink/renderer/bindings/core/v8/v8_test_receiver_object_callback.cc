...
v8::Maybe<void> V8TestReceiverObjectCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
void V8TestReceiverObjectCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8TestReceiverObjectCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

void V8PersistentCallbackFunction<V8TestReceiverObjectCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
