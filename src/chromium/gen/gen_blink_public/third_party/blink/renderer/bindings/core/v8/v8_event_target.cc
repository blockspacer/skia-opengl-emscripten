...
#endif
const WrapperTypeInfo v8_event_target_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& EventTarget::wrapper_type_info_ = v8_event_target_wrapper_type_info;
...
namespace event_target_v8_internal {
...
static void RemoveEventListenerMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "EventTarget", "removeEventListener");
  ...
  V8EventListenerOptionsOrBoolean::ToImpl(info.GetIsolate(), info[2], options, UnionTypeConversionMode::kNotNullable, exception_state);
  if (exception_state.HadException())
    return;
...
static void DispatchEventMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "EventTarget", "dispatchEvent");
  ...
  if (!event) {
    exception_state.ThrowTypeError("parameter 1 is not of type 'Event'.");
    return;
  }

  bool result = impl->dispatchEventForBindings(event, exception_state);
  if (exception_state.HadException()) {
    return;
  }
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  EventTarget* impl = EventTarget::Create(script_state);
  v8::Local<v8::Object> wrapper = info.Holder();
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8EventTarget::GetWrapperTypeInfo(), wrapper);
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("EventTarget"));
    return;
  }
  ...
  event_target_v8_internal::Constructor(info);
}
...
void V8EventTarget::AddEventListenerMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  event_target_v8_internal::AddEventListenerMethod(info);
}
...
void V8EventTarget::RemoveEventListenerMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  event_target_v8_internal::RemoveEventListenerMethod(info);
}
...
void V8EventTarget::DispatchEventMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  event_target_v8_internal::DispatchEventMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8EventTargetMethods[] = {
...
static void InstallV8EventTargetTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8EventTarget::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8EventTarget::kInternalFieldCount);
  interface_template->SetCallHandler(event_target_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, kV8EventTargetMethods, base::size(kV8EventTargetMethods));
...
void V8EventTarget::InstallRuntimeEnabledFeaturesImpl(
    ...
    v8::Local<v8::Object> prototype,
    v8::Local<v8::Function> interface) {
  v8::Local<v8::FunctionTemplate> interface_template = V8EventTarget::GetWrapperTypeInfo()->DomTemplate(isolate, world);
  v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_template);
  ALLOW_UNUSED_LOCAL(signature);
}

v8::Local<v8::FunctionTemplate> V8EventTarget::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8EventTarget::GetWrapperTypeInfo()),
      InstallV8EventTargetTemplate);
}

bool V8EventTarget::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8EventTarget::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8EventTarget::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8EventTarget::GetWrapperTypeInfo(), v8_value);
}

EventTarget* V8EventTarget::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

EventTarget* NativeValueTraits<EventTarget>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  EventTarget* native_value = V8EventTarget::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
