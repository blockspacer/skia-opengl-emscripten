...
class MODULES_EXPORT V8FileWriterCallback final : public CallbackInterfaceBase {
 public:
  ...
  v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter);
};

template <>
class V8PersistentCallbackInterface<V8FileWriterCallback> final : public V8PersistentCallbackInterfaceBase {
 ...
 public:
  ...
  MODULES_EXPORT v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter) WARN_UNUSED_RESULT;
  MODULES_EXPORT void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter);
