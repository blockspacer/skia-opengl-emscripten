...
#endif
const WrapperTypeInfo v8_dom_point_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& DOMPoint::wrapper_type_info_ = v8_dom_point_wrapper_type_info;
...
namespace dom_point_v8_internal {
...
static void XAttributeSetter(
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "DOMPoint", "x");
...
static void YAttributeSetter(
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "DOMPoint", "y");
...
static void ZAttributeSetter(
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "DOMPoint", "z");
...
static void WAttributeSetter(
  ...
  ExceptionState exception_state(isolate, ExceptionState::kSetterContext, "DOMPoint", "w");
...
static void FromPointMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "DOMPoint", "fromPoint");
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "DOMPoint");
  ...
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8DOMPoint::GetWrapperTypeInfo(), wrapper);
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("DOMPoint"));
    return;
  }
  ...
  dom_point_v8_internal::Constructor(info);
}
...
void V8DOMPoint::XAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_point_v8_internal::XAttributeGetter(info);
}

void V8DOMPoint::XAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMPoint_x_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  dom_point_v8_internal::XAttributeSetter(v8_value, info);
}
...
void V8DOMPoint::YAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_point_v8_internal::YAttributeGetter(info);
}

void V8DOMPoint::YAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMPoint_y_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  dom_point_v8_internal::YAttributeSetter(v8_value, info);
}
...
void V8DOMPoint::ZAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_point_v8_internal::ZAttributeGetter(info);
}

void V8DOMPoint::ZAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMPoint_z_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  dom_point_v8_internal::ZAttributeSetter(v8_value, info);
}
...
void V8DOMPoint::WAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_point_v8_internal::WAttributeGetter(info);
}

void V8DOMPoint::WAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMPoint_w_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  dom_point_v8_internal::WAttributeSetter(v8_value, info);
}
...
void V8DOMPoint::FromPointMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_point_v8_internal::FromPointMethod(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8DOMPointAccessors[] = {
    { "x", V8DOMPoint::XAttributeGetterCallback, V8DOMPoint::XAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "y", V8DOMPoint::YAttributeGetterCallback, V8DOMPoint::YAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "z", V8DOMPoint::ZAttributeGetterCallback, V8DOMPoint::ZAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "w", V8DOMPoint::WAttributeGetterCallback, V8DOMPoint::WAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8DOMPointMethods[] = {
...
static void InstallV8DOMPointTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8DOMPoint::GetWrapperTypeInfo()->interface_name, V8DOMPointReadOnly::DomTemplate(isolate, world), V8DOMPoint::kInternalFieldCount);
  interface_template->SetCallHandler(dom_point_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8DOMPointAccessors, base::size(kV8DOMPointAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8DOMPointMethods, base::size(kV8DOMPointMethods));
...
v8::Local<v8::FunctionTemplate> V8DOMPoint::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8DOMPoint::GetWrapperTypeInfo()),
      InstallV8DOMPointTemplate);
}

bool V8DOMPoint::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8DOMPoint::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8DOMPoint::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8DOMPoint::GetWrapperTypeInfo(), v8_value);
}

DOMPoint* V8DOMPoint::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMPoint* NativeValueTraits<DOMPoint>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMPoint* native_value = V8DOMPoint::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
