...
v8::Maybe<void> V8EntriesCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Entry>>& entries) {
  ...
  v8::Local<v8::Value> argv[] = { v8_entries };
...
void V8EntriesCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Entry>>& entries) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8EntriesCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Entry>>& entries) {
  return Proxy()->handleEvent(
      callback_this_value, entries);
}

void V8PersistentCallbackInterface<V8EntriesCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<Entry>>& entries) {
