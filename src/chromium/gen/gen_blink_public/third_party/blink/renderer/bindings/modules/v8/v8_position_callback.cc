...
v8::Maybe<void> V8PositionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Geoposition* position) {
...
void V8PositionCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Geoposition* position) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8PositionCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Geoposition* position) {
  return Proxy()->Invoke(
      callback_this_value, position);
}

void V8PersistentCallbackFunction<V8PositionCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Geoposition* position) {
