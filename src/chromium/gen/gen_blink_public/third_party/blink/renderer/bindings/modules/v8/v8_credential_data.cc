...
void V8CredentialData::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, CredentialData* impl, ExceptionState& exception_state) {
...
CredentialData* NativeValueTraits<CredentialData>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  CredentialData* impl = CredentialData::Create();
  V8CredentialData::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
