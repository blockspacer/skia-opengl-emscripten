...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HTML_VIDEO_ELEMENT_PARTIAL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HTML_VIDEO_ELEMENT_PARTIAL_H_
...
class V8HTMLVideoElementPartial {
 ...
 public:
  ...
  static void InstallAutoPictureInPicture(ScriptState*, v8::Local<v8::Object> instance);
  static void InstallAutoPictureInPicture(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface);
  static void InstallAutoPictureInPicture(ScriptState*);
  ...
  static void AutoPictureInPictureAttributeGetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
  static void AutoPictureInPictureAttributeSetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
 ...
 private:
  static void InstallV8HTMLVideoElementTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
};

}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HTML_VIDEO_ELEMENT_PARTIAL_H_
