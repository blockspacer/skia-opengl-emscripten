...
#endif
const WrapperTypeInfo v8_dom_string_list_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& DOMStringList::wrapper_type_info_ = v8_dom_string_list_wrapper_type_info;
...
namespace dom_string_list_v8_internal {
...
static void ItemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "DOMStringList", "item");
...
void V8DOMStringList::LengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_string_list_v8_internal::LengthAttributeGetter(info);
}
...
void V8DOMStringList::ItemMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_string_list_v8_internal::ItemMethod(info);
}
...
void V8DOMStringList::ContainsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  dom_string_list_v8_internal::ContainsMethod(info);
}

void V8DOMStringList::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMStringList_IndexedPropertyGetter");

  dom_string_list_v8_internal::IndexedPropertyGetter(index, info);
}

void V8DOMStringList::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  dom_string_list_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8DOMStringList::IndexedPropertySetterCallback(
    uint32_t index,
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8DOMStringListAccessors[] = {
    { "length", V8DOMStringList::LengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8DOMStringListMethods[] = {
...
static void InstallV8DOMStringListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8DOMStringList::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8DOMStringList::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8DOMStringListAccessors, base::size(kV8DOMStringListAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8DOMStringListMethods, base::size(kV8DOMStringListMethods));
...
v8::Local<v8::FunctionTemplate> V8DOMStringList::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8DOMStringList::GetWrapperTypeInfo()),
      InstallV8DOMStringListTemplate);
}

bool V8DOMStringList::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8DOMStringList::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8DOMStringList::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8DOMStringList::GetWrapperTypeInfo(), v8_value);
}

DOMStringList* V8DOMStringList::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMStringList* NativeValueTraits<DOMStringList>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMStringList* native_value = V8DOMStringList::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
