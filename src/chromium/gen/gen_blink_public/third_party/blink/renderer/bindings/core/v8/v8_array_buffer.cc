...
const WrapperTypeInfo& DOMArrayBuffer::wrapper_type_info_ = v8_array_buffer_wrapper_type_info;
...
DOMArrayBuffer* V8ArrayBuffer::ToImplWithTypeCheck(
...
DOMArrayBuffer* NativeValueTraits<DOMArrayBuffer>::NativeValue(
  ...
  DOMArrayBuffer* native_value = V8ArrayBuffer::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
