...
#endif
const WrapperTypeInfo v8_video_playback_quality_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& VideoPlaybackQuality::wrapper_type_info_ = v8_video_playback_quality_wrapper_type_info;
...
namespace video_playback_quality_v8_internal {
...
void V8VideoPlaybackQuality::CreationTimeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  video_playback_quality_v8_internal::CreationTimeAttributeGetter(info);
}
...
void V8VideoPlaybackQuality::TotalVideoFramesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  video_playback_quality_v8_internal::TotalVideoFramesAttributeGetter(info);
}
...
void V8VideoPlaybackQuality::DroppedVideoFramesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  video_playback_quality_v8_internal::DroppedVideoFramesAttributeGetter(info);
}
...
void V8VideoPlaybackQuality::CorruptedVideoFramesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  video_playback_quality_v8_internal::CorruptedVideoFramesAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8VideoPlaybackQualityAccessors[] = {
    { "creationTime", V8VideoPlaybackQuality::CreationTimeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "totalVideoFrames", V8VideoPlaybackQuality::TotalVideoFramesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "droppedVideoFrames", V8VideoPlaybackQuality::DroppedVideoFramesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
...
static void InstallV8VideoPlaybackQualityTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8VideoPlaybackQuality::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8VideoPlaybackQuality::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8VideoPlaybackQualityAccessors, base::size(kV8VideoPlaybackQualityAccessors));
...
v8::Local<v8::FunctionTemplate> V8VideoPlaybackQuality::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8VideoPlaybackQuality::GetWrapperTypeInfo()),
      InstallV8VideoPlaybackQualityTemplate);
}

bool V8VideoPlaybackQuality::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8VideoPlaybackQuality::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8VideoPlaybackQuality::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8VideoPlaybackQuality::GetWrapperTypeInfo(), v8_value);
}

VideoPlaybackQuality* V8VideoPlaybackQuality::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

VideoPlaybackQuality* NativeValueTraits<VideoPlaybackQuality>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  VideoPlaybackQuality* native_value = V8VideoPlaybackQuality::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
