...
v8::Maybe<bool> V8SQLStatementErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLTransaction* transaction, SQLError* error) {
  ...
  v8::Local<v8::Value> argv[] = { v8_transaction, v8_error };
...
v8::Maybe<bool> V8PersistentCallbackInterface<V8SQLStatementErrorCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLTransaction* transaction, SQLError* error) {
