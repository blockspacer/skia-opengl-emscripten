...
v8::Maybe<void> V8IdleRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IdleDeadline* deadline) {
...
void V8IdleRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IdleDeadline* deadline) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8IdleRequestCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IdleDeadline* deadline) {
  return Proxy()->Invoke(
      callback_this_value, deadline);
}

void V8PersistentCallbackFunction<V8IdleRequestCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IdleDeadline* deadline) {
