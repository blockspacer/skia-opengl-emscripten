...
v8::Maybe<void> V8TestInterfaceCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLDivElement* divElement) {
...
void V8TestInterfaceCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLDivElement* divElement) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8TestInterfaceCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLDivElement* divElement) {
  return Proxy()->Invoke(
      callback_this_value, divElement);
}

void V8PersistentCallbackFunction<V8TestInterfaceCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLDivElement* divElement) {
