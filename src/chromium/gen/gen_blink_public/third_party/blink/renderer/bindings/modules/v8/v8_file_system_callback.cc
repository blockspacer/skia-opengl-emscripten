...
v8::Maybe<void> V8FileSystemCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMFileSystem* fileSystem) {
  ...
  v8::Local<v8::Value> v8_fileSystem = ToV8(fileSystem, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_fileSystem };
...
void V8FileSystemCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMFileSystem* fileSystem) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8FileSystemCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMFileSystem* fileSystem) {
  return Proxy()->handleEvent(
      callback_this_value, fileSystem);
}

void V8PersistentCallbackInterface<V8FileSystemCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMFileSystem* fileSystem) {
