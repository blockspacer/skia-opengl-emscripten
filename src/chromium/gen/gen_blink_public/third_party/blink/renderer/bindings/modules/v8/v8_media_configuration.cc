...
void V8MediaConfiguration::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MediaConfiguration* impl, ExceptionState& exception_state) {
  ...
  if (audio_value.IsEmpty() || audio_value->IsUndefined()) {
    ...
    AudioConfiguration* audio_cpp_value = NativeValueTraits<AudioConfiguration>::NativeValue(isolate, audio_value, exception_state);
  ...
  if (video_value.IsEmpty() || video_value->IsUndefined()) {
    ...
    VideoConfiguration* video_cpp_value = NativeValueTraits<VideoConfiguration>::NativeValue(isolate, video_value, exception_state);
    if (exception_state.HadException())
      return;
...
MediaConfiguration* NativeValueTraits<MediaConfiguration>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MediaConfiguration* impl = MediaConfiguration::Create();
  V8MediaConfiguration::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
