...
v8::Maybe<String> V8CreateHTMLCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& input) {
...
v8::Maybe<String> V8PersistentCallbackFunction<V8CreateHTMLCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& input) {
  return Proxy()->Invoke(
