...
const char* V8ScrollStateCallback::NameInHeapSnapshot() const {
  return "V8ScrollStateCallback";
}

v8::Maybe<void> V8ScrollStateCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScrollState* scrollState) {
...
void V8ScrollStateCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScrollState* scrollState) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8ScrollStateCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScrollState* scrollState) {
  return Proxy()->Invoke(
      callback_this_value, scrollState);
}

void V8PersistentCallbackFunction<V8ScrollStateCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScrollState* scrollState) {
