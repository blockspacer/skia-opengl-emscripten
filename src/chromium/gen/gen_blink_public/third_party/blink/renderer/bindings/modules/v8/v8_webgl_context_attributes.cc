...
void V8WebGLContextAttributes::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, WebGLContextAttributes* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[3].Get(isolate)).ToLocal(&desynchronized_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[4].Get(isolate)).ToLocal(&fail_if_major_performance_caveat_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[5].Get(isolate)).ToLocal(&power_preference_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  if (power_preference_value.IsEmpty() || power_preference_value->IsUndefined()) {
    ...
    if (!IsValidEnum(power_preference_cpp_value, kValidValues, base::size(kValidValues), "WebGLPowerPreference", exception_state))
      return;
    impl->setPowerPreference(power_preference_cpp_value);
  }

  v8::Local<v8::Value> premultiplied_alpha_value;
  if (!v8Object->Get(context, keys[6].Get(isolate)).ToLocal(&premultiplied_alpha_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[7].Get(isolate)).ToLocal(&preserve_drawing_buffer_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[8].Get(isolate)).ToLocal(&stencil_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::WebXREnabled(executionContext)) {
    ...
    if (!v8Object->Get(context, keys[9].Get(isolate)).ToLocal(&xr_compatible_value)) {
      exception_state.RethrowV8Exception(block.Exception());
      return;
    }
...
bool toV8WebGLContextAttributes(const WebGLContextAttributes* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (desynchronized_has_value_or_default &&
      !create_property(3, desynchronized_value)) {
    return false;
  }
  ...
  if (fail_if_major_performance_caveat_has_value_or_default &&
      !create_property(4, fail_if_major_performance_caveat_value)) {
    return false;
  }
  ...
  if (power_preference_has_value_or_default &&
      !create_property(5, power_preference_value)) {
    return false;
  }
  ...
  if (premultiplied_alpha_has_value_or_default &&
      !create_property(6, premultiplied_alpha_value)) {
    return false;
  }
  ...
  if (preserve_drawing_buffer_has_value_or_default &&
      !create_property(7, preserve_drawing_buffer_value)) {
    return false;
  }
  ...
  if (stencil_has_value_or_default &&
      !create_property(8, stencil_value)) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::WebXREnabled(executionContext)) {
    ...
    if (xr_compatible_has_value_or_default &&
        !create_property(9, xr_compatible_value)) {
      return false;
    }
  }
...
WebGLContextAttributes* NativeValueTraits<WebGLContextAttributes>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  WebGLContextAttributes* impl = WebGLContextAttributes::Create();
  V8WebGLContextAttributes::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
