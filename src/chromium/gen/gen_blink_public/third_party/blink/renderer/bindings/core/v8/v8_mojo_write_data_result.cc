...
void V8MojoWriteDataResult::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, MojoWriteDataResult* impl, ExceptionState& exception_state) {
...
MojoWriteDataResult* NativeValueTraits<MojoWriteDataResult>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  MojoWriteDataResult* impl = MojoWriteDataResult::Create();
  V8MojoWriteDataResult::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
