...
v8::Maybe<ScriptValue> V8NoArgumentConstructor::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8NoArgumentConstructor>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}
