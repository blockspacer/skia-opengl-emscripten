...
class CORE_EXPORT V8ResizeObserverCallback final : public CallbackFunctionBase {
 public:
  static V8ResizeObserverCallback* Create(v8::Local<v8::Function> callback_function) {
    return MakeGarbageCollected<V8ResizeObserverCallback>(callback_function);
  }
  ...
  v8::Maybe<void> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) WARN_UNUSED_RESULT;

  // Performs "invoke", and then reports an exception, if any, to the global
  // error handler such as DevTools' console.
  void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer);
};

template <>
class V8PersistentCallbackFunction<V8ResizeObserverCallback> final : public V8PersistentCallbackFunctionBase {
 ...
 public:
  ...
  v8::Maybe<void> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) WARN_UNUSED_RESULT;
  CORE_EXPORT void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer);
