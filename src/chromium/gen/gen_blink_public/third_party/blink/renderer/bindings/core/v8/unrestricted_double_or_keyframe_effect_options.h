...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_UNRESTRICTED_DOUBLE_OR_KEYFRAME_EFFECT_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_UNRESTRICTED_DOUBLE_OR_KEYFRAME_EFFECT_OPTIONS_H_
...
class CORE_EXPORT UnrestrictedDoubleOrKeyframeEffectOptions final {
 ...
 public:
  ...
  void SetKeyframeEffectOptions(KeyframeEffectOptions*);
  static UnrestrictedDoubleOrKeyframeEffectOptions FromKeyframeEffectOptions(KeyframeEffectOptions*);
 ...
 private:
  ...
  Member<KeyframeEffectOptions> keyframe_effect_options_;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_UNRESTRICTED_DOUBLE_OR_KEYFRAME_EFFECT_OPTIONS_H_
