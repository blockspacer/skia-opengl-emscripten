...
v8::Maybe<String> V8TestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& message1, const String& message2) {
...
v8::Maybe<String> V8PersistentCallbackFunction<V8TestCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& message1, const String& message2) {
  return Proxy()->Invoke(
