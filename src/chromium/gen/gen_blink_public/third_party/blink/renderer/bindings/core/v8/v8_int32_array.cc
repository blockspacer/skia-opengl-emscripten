...
#endif
const WrapperTypeInfo v8_int32_array_wrapper_type_info = {
    gin::kEmbedderBlink,
    nullptr,
    nullptr,
    "Int32Array",
...
DOMInt32Array* V8Int32Array::ToImpl(v8::Local<v8::Object> object) {
  ...
  if (script_wrappable)
    return script_wrappable->ToImpl<DOMInt32Array>();

  v8::Local<v8::Int32Array> v8_view = object.As<v8::Int32Array>();
  v8::Local<v8::Object> array_buffer = v8_view->Buffer();
  DOMInt32Array* typed_array = nullptr;
  if (array_buffer->IsArrayBuffer()) {
    typed_array = DOMInt32Array::Create(
  ...
  return typed_array->ToImpl<DOMInt32Array>();
}

DOMInt32Array* V8Int32Array::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return value->IsInt32Array() ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMInt32Array* NativeValueTraits<DOMInt32Array>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMInt32Array* native_value = V8Int32Array::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
