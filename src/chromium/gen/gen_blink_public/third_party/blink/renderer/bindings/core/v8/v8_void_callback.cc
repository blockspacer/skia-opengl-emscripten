...
v8::Maybe<void> V8VoidCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
void V8VoidCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8VoidCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  return Proxy()->handleEvent(
      callback_this_value);
}

void V8PersistentCallbackInterface<V8VoidCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
