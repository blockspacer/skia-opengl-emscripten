...
v8::Maybe<void> V8FrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double highResTime) {
...
void V8FrameRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double highResTime) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8FrameRequestCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double highResTime) {
  return Proxy()->Invoke(
      callback_this_value, highResTime);
}

void V8PersistentCallbackFunction<V8FrameRequestCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, double highResTime) {
