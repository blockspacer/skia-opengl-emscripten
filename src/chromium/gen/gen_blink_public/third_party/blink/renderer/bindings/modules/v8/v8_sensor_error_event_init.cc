...
void V8SensorErrorEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, SensorErrorEventInit* impl, ExceptionState& exception_state) {
  ...
  if (error_value.IsEmpty() || error_value->IsUndefined()) {
    ...
    DOMException* error_cpp_value = V8DOMException::ToImplWithTypeCheck(isolate, error_value);
    if (!error_cpp_value) {
      exception_state.ThrowTypeError("member error is not of type DOMException.");
      return;
    }
...
SensorErrorEventInit* NativeValueTraits<SensorErrorEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SensorErrorEventInit* impl = SensorErrorEventInit::Create();
  V8SensorErrorEventInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
