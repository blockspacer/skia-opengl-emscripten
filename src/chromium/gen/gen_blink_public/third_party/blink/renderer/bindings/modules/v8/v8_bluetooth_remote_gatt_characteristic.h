...
MODULES_EXPORT extern const WrapperTypeInfo v8_bluetooth_remote_gatt_characteristic_wrapper_type_info;
...
class V8BluetoothRemoteGATTCharacteristic {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_bluetooth_remote_gatt_characteristic_wrapper_type_info;
  }
