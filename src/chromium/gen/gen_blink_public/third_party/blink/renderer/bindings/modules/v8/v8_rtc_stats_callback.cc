...
const char* V8RTCStatsCallback::NameInHeapSnapshot() const {
  return "V8RTCStatsCallback";
}

v8::Maybe<void> V8RTCStatsCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCStatsResponse* response) {
...
void V8RTCStatsCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCStatsResponse* response) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8RTCStatsCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCStatsResponse* response) {
  return Proxy()->Invoke(
      callback_this_value, response);
}

void V8PersistentCallbackFunction<V8RTCStatsCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCStatsResponse* response) {
