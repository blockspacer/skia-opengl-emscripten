...
v8::Maybe<Vector<String>> V8TestSequenceCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const Vector<int32_t>& numbers) {
...
v8::Maybe<Vector<String>> V8PersistentCallbackFunction<V8TestSequenceCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const Vector<int32_t>& numbers) {
  return Proxy()->Invoke(
