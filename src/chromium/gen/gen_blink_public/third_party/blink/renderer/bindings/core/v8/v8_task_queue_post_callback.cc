...
const char* V8TaskQueuePostCallback::NameInHeapSnapshot() const {
  return "V8TaskQueuePostCallback";
}

v8::Maybe<void> V8TaskQueuePostCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "TaskQueuePostCallback",
          "invoke");
...
void V8TaskQueuePostCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8TaskQueuePostCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

void V8PersistentCallbackFunction<V8TaskQueuePostCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
