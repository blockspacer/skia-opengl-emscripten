...
v8::Maybe<void> V8MediaSessionActionHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
void V8MediaSessionActionHandler::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8MediaSessionActionHandler>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

void V8PersistentCallbackFunction<V8MediaSessionActionHandler>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value) {
