...
v8::Maybe<void> V8EntryCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry) {
  ...
  v8::Local<v8::Value> v8_entry = ToV8(entry, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_entry };
...
void V8EntryCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8EntryCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry) {
  return Proxy()->handleEvent(
      callback_this_value, entry);
}

void V8PersistentCallbackInterface<V8EntryCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry) {
