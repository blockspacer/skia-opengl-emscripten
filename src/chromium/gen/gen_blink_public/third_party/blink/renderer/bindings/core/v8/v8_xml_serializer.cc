...
#endif
const WrapperTypeInfo v8_xml_serializer_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& XMLSerializer::wrapper_type_info_ = v8_xml_serializer_wrapper_type_info;
...
namespace xml_serializer_v8_internal {
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8XMLSerializer::GetWrapperTypeInfo(), wrapper);
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("XMLSerializer"));
    return;
  }
  ...
  xml_serializer_v8_internal::Constructor(info);
}
...
void V8XMLSerializer::SerializeToStringMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  xml_serializer_v8_internal::SerializeToStringMethod(info);
}

static constexpr V8DOMConfiguration::MethodConfiguration kV8XMLSerializerMethods[] = {
...
static void InstallV8XMLSerializerTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8XMLSerializer::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8XMLSerializer::kInternalFieldCount);
  interface_template->SetCallHandler(xml_serializer_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, kV8XMLSerializerMethods, base::size(kV8XMLSerializerMethods));
...
v8::Local<v8::FunctionTemplate> V8XMLSerializer::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8XMLSerializer::GetWrapperTypeInfo()),
      InstallV8XMLSerializerTemplate);
}

bool V8XMLSerializer::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8XMLSerializer::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8XMLSerializer::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8XMLSerializer::GetWrapperTypeInfo(), v8_value);
}

XMLSerializer* V8XMLSerializer::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

XMLSerializer* NativeValueTraits<XMLSerializer>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  XMLSerializer* native_value = V8XMLSerializer::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
