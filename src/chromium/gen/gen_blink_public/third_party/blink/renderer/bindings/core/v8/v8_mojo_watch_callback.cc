...
v8::Maybe<void> V8MojoWatchCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint32_t result) {
...
void V8MojoWatchCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint32_t result) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8MojoWatchCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint32_t result) {
  return Proxy()->Invoke(
      callback_this_value, result);
}

void V8PersistentCallbackFunction<V8MojoWatchCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint32_t result) {
