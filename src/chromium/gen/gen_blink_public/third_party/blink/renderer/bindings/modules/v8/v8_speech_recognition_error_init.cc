...
void V8SpeechRecognitionErrorInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, SpeechRecognitionErrorInit* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[1].Get(isolate)).ToLocal(&message_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
bool toV8SpeechRecognitionErrorInit(const SpeechRecognitionErrorInit* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (message_has_value_or_default &&
      !create_property(1, message_value)) {
    return false;
  }
...
SpeechRecognitionErrorInit* NativeValueTraits<SpeechRecognitionErrorInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SpeechRecognitionErrorInit* impl = SpeechRecognitionErrorInit::Create();
  V8SpeechRecognitionErrorInit::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
