...
const WrapperTypeInfo& DOMArrayBufferView::wrapper_type_info_ = v8_array_buffer_view_wrapper_type_info;
...
DOMArrayBufferView* V8ArrayBufferView::ToImpl(v8::Local<v8::Object> object) {
  ...
  if (script_wrappable)
    return script_wrappable->ToImpl<DOMArrayBufferView>();
...
DOMArrayBufferView* V8ArrayBufferView::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return value->IsArrayBufferView() ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

DOMArrayBufferView* NativeValueTraits<DOMArrayBufferView>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DOMArrayBufferView* native_value = V8ArrayBufferView::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
