...
#endif
const WrapperTypeInfo v8_idle_deadline_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& IdleDeadline::wrapper_type_info_ = v8_idle_deadline_wrapper_type_info;
...
namespace idle_deadline_v8_internal {
...
void V8IdleDeadline::DidTimeoutAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  idle_deadline_v8_internal::DidTimeoutAttributeGetter(info);
}
...
void V8IdleDeadline::TimeRemainingMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  idle_deadline_v8_internal::TimeRemainingMethod(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8IdleDeadlineAccessors[] = {
    { "didTimeout", V8IdleDeadline::DidTimeoutAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};

static constexpr V8DOMConfiguration::MethodConfiguration kV8IdleDeadlineMethods[] = {
...
static void InstallV8IdleDeadlineTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8IdleDeadline::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8IdleDeadline::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8IdleDeadlineAccessors, base::size(kV8IdleDeadlineAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8IdleDeadlineMethods, base::size(kV8IdleDeadlineMethods));
...
v8::Local<v8::FunctionTemplate> V8IdleDeadline::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8IdleDeadline::GetWrapperTypeInfo()),
      InstallV8IdleDeadlineTemplate);
}

bool V8IdleDeadline::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8IdleDeadline::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8IdleDeadline::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8IdleDeadline::GetWrapperTypeInfo(), v8_value);
}

IdleDeadline* V8IdleDeadline::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

IdleDeadline* NativeValueTraits<IdleDeadline>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  IdleDeadline* native_value = V8IdleDeadline::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
