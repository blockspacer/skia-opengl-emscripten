...
v8::Maybe<void> V8DecodeSuccessCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, AudioBuffer* decodedData) {
...
void V8DecodeSuccessCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, AudioBuffer* decodedData) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8DecodeSuccessCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, AudioBuffer* decodedData) {
  return Proxy()->Invoke(
      callback_this_value, decodedData);
}

void V8PersistentCallbackFunction<V8DecodeSuccessCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, AudioBuffer* decodedData) {
