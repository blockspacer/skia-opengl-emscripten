...
v8::Maybe<ScriptValue> V8LockGrantedCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Lock* lock) {
...
v8::Maybe<ScriptValue> V8LockGrantedCallback::Construct(Lock* lock) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "LockGrantedCallback",
          "construct");
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8LockGrantedCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Lock* lock) {
  return Proxy()->Invoke(
