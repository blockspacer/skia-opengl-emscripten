...
v8::Maybe<void> V8RTCSessionDescriptionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCSessionDescription* description) {
...
void V8RTCSessionDescriptionCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCSessionDescription* description) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8RTCSessionDescriptionCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCSessionDescription* description) {
  return Proxy()->Invoke(
      callback_this_value, description);
}

void V8PersistentCallbackFunction<V8RTCSessionDescriptionCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, RTCSessionDescription* description) {
