...
v8::Maybe<String> V8CreateScriptCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& input) {
  ...
  v8::Local<v8::Value> v8_input = V8String(GetIsolate(), input);
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_input };
...
v8::Maybe<String> V8PersistentCallbackFunction<V8CreateScriptCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& input) {
  return Proxy()->Invoke(
      callback_this_value, input);
}
