...
v8::Maybe<void> V8CustomElementFormAssociatedCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLFormElement* form) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "CustomElementFormAssociatedCallback",
          "invoke");
  ...
  v8::Local<v8::Value> v8_form = ToV8(form, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_form };
...
void V8CustomElementFormAssociatedCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLFormElement* form) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, form);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

v8::Maybe<void> V8PersistentCallbackFunction<V8CustomElementFormAssociatedCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLFormElement* form) {
  return Proxy()->Invoke(
      callback_this_value, form);
}

void V8PersistentCallbackFunction<V8CustomElementFormAssociatedCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, HTMLFormElement* form) {
