...
v8::Maybe<void> V8RemotePlaybackAvailabilityCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool available) {
...
void V8RemotePlaybackAvailabilityCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool available) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8RemotePlaybackAvailabilityCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool available) {
  return Proxy()->Invoke(
      callback_this_value, available);
}

void V8PersistentCallbackFunction<V8RemotePlaybackAvailabilityCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, bool available) {
