...
static const v8::Eternal<v8::Name>* eternalV8PayerErrorsKeys(v8::Isolate* isolate) {
...
void V8PayerErrors::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PayerErrors* impl, ExceptionState& exception_state) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PayerErrorsKeys(isolate);
  ...
  if (email_value.IsEmpty() || email_value->IsUndefined()) {
    ...
    V8StringResource<> email_cpp_value = email_value;
    if (!email_cpp_value.Prepare(exception_state))
      return;
  ...
  if (!v8Object->Get(context, keys[2].Get(isolate)).ToLocal(&phone_value)) {
    exception_state.RethrowV8Exception(block.Exception());
    return;
  }
...
v8::Local<v8::Value> PayerErrors::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8PayerErrors(this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8PayerErrors(const PayerErrors* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8PayerErrorsKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  ...
  if (impl->hasEmail()) {
    email_value = V8String(isolate, impl->email());
...
PayerErrors* NativeValueTraits<PayerErrors>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PayerErrors* impl = PayerErrors::Create();
  V8PayerErrors::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
