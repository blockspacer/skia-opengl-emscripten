...
v8::Maybe<void> V8ResizeObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
...
void V8ResizeObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8ResizeObserverCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, entries, observer);
}

void V8PersistentCallbackFunction<V8ResizeObserverCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
