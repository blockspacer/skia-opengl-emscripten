...
class MODULES_EXPORT V8EntryCallback final : public CallbackInterfaceBase {
 public:
  ...
  v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry);
};

template <>
class V8PersistentCallbackInterface<V8EntryCallback> final : public V8PersistentCallbackInterfaceBase {
 ...
 public:
  ...
  MODULES_EXPORT v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry) WARN_UNUSED_RESULT;
  MODULES_EXPORT void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Entry* entry);
