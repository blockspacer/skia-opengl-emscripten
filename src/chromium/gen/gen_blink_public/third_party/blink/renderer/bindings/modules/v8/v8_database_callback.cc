...
v8::Maybe<void> V8DatabaseCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Database* database) {
...
void V8DatabaseCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Database* database) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8DatabaseCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Database* database) {
  return Proxy()->Invoke(
      callback_this_value, database);
}

void V8PersistentCallbackFunction<V8DatabaseCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, Database* database) {
