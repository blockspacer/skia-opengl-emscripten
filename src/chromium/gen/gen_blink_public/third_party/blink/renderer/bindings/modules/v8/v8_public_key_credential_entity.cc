...
void V8PublicKeyCredentialEntity::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PublicKeyCredentialEntity* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[0].Get(isolate)).ToLocal(&icon_value)) {
...
PublicKeyCredentialEntity* NativeValueTraits<PublicKeyCredentialEntity>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PublicKeyCredentialEntity* impl = PublicKeyCredentialEntity::Create();
  V8PublicKeyCredentialEntity::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
