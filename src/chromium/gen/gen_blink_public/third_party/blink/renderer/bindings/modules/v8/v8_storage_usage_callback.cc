...
v8::Maybe<void> V8StorageUsageCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t currentUsageInBytes, uint64_t currentQuotaInBytes) {
...
void V8StorageUsageCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t currentUsageInBytes, uint64_t currentQuotaInBytes) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8StorageUsageCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t currentUsageInBytes, uint64_t currentQuotaInBytes) {
  return Proxy()->Invoke(
      callback_this_value, currentUsageInBytes, currentQuotaInBytes);
}

void V8PersistentCallbackFunction<V8StorageUsageCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, uint64_t currentUsageInBytes, uint64_t currentQuotaInBytes) {
