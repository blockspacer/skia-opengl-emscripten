...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEDICATED_WORKER_GLOBAL_SCOPE_PARTIAL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEDICATED_WORKER_GLOBAL_SCOPE_PARTIAL_H_
...
class V8DedicatedWorkerGlobalScopePartial {
 ...
 private:
  static void InstallV8DedicatedWorkerGlobalScopeTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
};

}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEDICATED_WORKER_GLOBAL_SCOPE_PARTIAL_H_
