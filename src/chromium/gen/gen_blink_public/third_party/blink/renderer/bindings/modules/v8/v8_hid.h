...
MODULES_EXPORT extern const WrapperTypeInfo v8_hid_wrapper_type_info;
...
class V8HID {
 ...
 public:
  ...
  static HID* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<HID>();
  }
  MODULES_EXPORT static HID* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);

  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_hid_wrapper_type_info;
  }
...
template <>
struct NativeValueTraits<HID> : public NativeValueTraitsBase<HID> {
  MODULES_EXPORT static HID* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static HID* NullValue() { return nullptr; }
};
