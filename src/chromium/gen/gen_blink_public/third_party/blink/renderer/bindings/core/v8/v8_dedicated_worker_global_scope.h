...
CORE_EXPORT extern WrapperTypeInfo v8_dedicated_worker_global_scope_wrapper_type_info;
...
class V8DedicatedWorkerGlobalScope {
 ...
 public:
  ...
  CORE_EXPORT static constexpr WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_dedicated_worker_global_scope_wrapper_type_info;
  }
  ...
  CORE_EXPORT static void InstallV8DedicatedWorkerGlobalScopeTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interface_template);
 ...
 private:
  static InstallTemplateFunction install_v8_dedicated_worker_global_scope_template_function_;
};
