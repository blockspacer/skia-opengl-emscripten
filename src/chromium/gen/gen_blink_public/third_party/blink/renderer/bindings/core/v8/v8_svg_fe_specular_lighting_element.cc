...
#endif
const WrapperTypeInfo v8_svg_fe_specular_lighting_element_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& SVGFESpecularLightingElement::wrapper_type_info_ = v8_svg_fe_specular_lighting_element_wrapper_type_info;
...
namespace svg_fe_specular_lighting_element_v8_internal {
...
void V8SVGFESpecularLightingElement::In1AttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::In1AttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::SurfaceScaleAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::SurfaceScaleAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::SpecularConstantAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::SpecularConstantAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::SpecularExponentAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::SpecularExponentAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::KernelUnitLengthXAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::KernelUnitLengthXAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::KernelUnitLengthYAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::KernelUnitLengthYAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::XAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::XAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::YAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::YAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::WidthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::WidthAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::HeightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::HeightAttributeGetter(info);
}
...
void V8SVGFESpecularLightingElement::ResultAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  svg_fe_specular_lighting_element_v8_internal::ResultAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8SVGFESpecularLightingElementAccessors[] = {
    { "in1", V8SVGFESpecularLightingElement::In1AttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "surfaceScale", V8SVGFESpecularLightingElement::SurfaceScaleAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    ...
    { "x", V8SVGFESpecularLightingElement::XAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "y", V8SVGFESpecularLightingElement::YAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "width", V8SVGFESpecularLightingElement::WidthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "height", V8SVGFESpecularLightingElement::HeightAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "result", V8SVGFESpecularLightingElement::ResultAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8SVGFESpecularLightingElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8SVGFESpecularLightingElement::GetWrapperTypeInfo()->interface_name, V8SVGElement::DomTemplate(isolate, world), V8SVGFESpecularLightingElement::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8SVGFESpecularLightingElementAccessors, base::size(kV8SVGFESpecularLightingElementAccessors));
...
v8::Local<v8::FunctionTemplate> V8SVGFESpecularLightingElement::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8SVGFESpecularLightingElement::GetWrapperTypeInfo()),
      InstallV8SVGFESpecularLightingElementTemplate);
}

bool V8SVGFESpecularLightingElement::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8SVGFESpecularLightingElement::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8SVGFESpecularLightingElement::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8SVGFESpecularLightingElement::GetWrapperTypeInfo(), v8_value);
}

SVGFESpecularLightingElement* V8SVGFESpecularLightingElement::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

SVGFESpecularLightingElement* NativeValueTraits<SVGFESpecularLightingElement>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  SVGFESpecularLightingElement* native_value = V8SVGFESpecularLightingElement::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
