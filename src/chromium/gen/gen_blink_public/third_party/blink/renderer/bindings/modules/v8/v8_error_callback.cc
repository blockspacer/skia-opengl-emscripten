...
v8::Maybe<void> V8ErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
void V8ErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8ErrorCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
  return Proxy()->handleEvent(
      callback_this_value, error);
}

void V8PersistentCallbackInterface<V8ErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
