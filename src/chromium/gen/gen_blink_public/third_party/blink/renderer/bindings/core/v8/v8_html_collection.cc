...
#endif
const WrapperTypeInfo v8_html_collection_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLCollection::wrapper_type_info_ = v8_html_collection_wrapper_type_info;
...
namespace html_collection_v8_internal {
...
static void ItemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kExecutionContext, "HTMLCollection", "item");
...
void V8HTMLCollection::LengthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_collection_v8_internal::LengthAttributeGetter(info);
}
...
void V8HTMLCollection::ItemMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_collection_v8_internal::ItemMethod(info);
}
...
void V8HTMLCollection::NamedItemMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  html_collection_v8_internal::NamedItemMethod(info);
}

void V8HTMLCollection::NamedPropertyGetterCallback(
  ...
  html_collection_v8_internal::NamedPropertyGetter(property_name, info);
}

void V8HTMLCollection::NamedPropertyQueryCallback(
  ...
  html_collection_v8_internal::NamedPropertyQuery(property_name, info);
}

void V8HTMLCollection::NamedPropertyEnumeratorCallback(
    const v8::PropertyCallbackInfo<v8::Array>& info) {
  html_collection_v8_internal::NamedPropertyEnumerator(info);
}

void V8HTMLCollection::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLCollection_IndexedPropertyGetter");

  html_collection_v8_internal::IndexedPropertyGetter(index, info);
}

void V8HTMLCollection::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  html_collection_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8HTMLCollection::IndexedPropertySetterCallback(
    uint32_t index,
...
static void InstallV8HTMLCollectionTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8HTMLCollection::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8HTMLCollection::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8HTMLCollectionAccessors, base::size(kV8HTMLCollectionAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instance_template, prototype_template, interface_template,
      signature, kV8HTMLCollectionMethods, base::size(kV8HTMLCollectionMethods));
...
v8::Local<v8::FunctionTemplate> V8HTMLCollection::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8HTMLCollection::GetWrapperTypeInfo()),
      InstallV8HTMLCollectionTemplate);
}

bool V8HTMLCollection::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8HTMLCollection::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8HTMLCollection::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8HTMLCollection::GetWrapperTypeInfo(), v8_value);
}

HTMLCollection* V8HTMLCollection::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

HTMLCollection* NativeValueTraits<HTMLCollection>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  HTMLCollection* native_value = V8HTMLCollection::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
