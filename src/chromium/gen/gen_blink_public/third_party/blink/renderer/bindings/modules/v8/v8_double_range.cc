...
void V8DoubleRange::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, DoubleRange* impl, ExceptionState& exception_state) {
  ...
  if (max_value.IsEmpty() || max_value->IsUndefined()) {
    ...
    double max_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, max_value, exception_state);
  ...
  if (min_value.IsEmpty() || min_value->IsUndefined()) {
    ...
    double min_cpp_value = NativeValueTraits<IDLDouble>::NativeValue(isolate, min_value, exception_state);
    if (exception_state.HadException())
      return;
...
bool toV8DoubleRange(const DoubleRange* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl->hasMax()) {
    max_value = v8::Number::New(isolate, impl->max());
  ...
  if (impl->hasMin()) {
    min_value = v8::Number::New(isolate, impl->min());
...
DoubleRange* NativeValueTraits<DoubleRange>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  DoubleRange* impl = DoubleRange::Create();
  V8DoubleRange::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
