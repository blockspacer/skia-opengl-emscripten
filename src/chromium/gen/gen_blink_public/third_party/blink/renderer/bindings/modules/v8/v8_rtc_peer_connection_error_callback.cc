...
v8::Maybe<void> V8RTCPeerConnectionErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
void V8RTCPeerConnectionErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8RTCPeerConnectionErrorCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

void V8PersistentCallbackFunction<V8RTCPeerConnectionErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
