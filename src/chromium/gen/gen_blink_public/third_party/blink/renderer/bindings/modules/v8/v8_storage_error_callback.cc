...
v8::Maybe<void> V8StorageErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMError* error) {
...
void V8StorageErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMError* error) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8StorageErrorCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMError* error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

void V8PersistentCallbackFunction<V8StorageErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMError* error) {
