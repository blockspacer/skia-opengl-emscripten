...
const char* V8IDBObserverCallback::NameInHeapSnapshot() const {
  return "V8IDBObserverCallback";
}

v8::Maybe<void> V8IDBObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IDBObserverChanges* changes) {
...
void V8IDBObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IDBObserverChanges* changes) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8IDBObserverCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IDBObserverChanges* changes) {
  return Proxy()->Invoke(
      callback_this_value, changes);
}

void V8PersistentCallbackFunction<V8IDBObserverCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, IDBObserverChanges* changes) {
