...
void V8PushPermissionDescriptor::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, PushPermissionDescriptor* impl, ExceptionState& exception_state) {
  ...
  if (!v8Object->Get(context, keys[0].Get(isolate)).ToLocal(&user_visible_only_value)) {
...
bool toV8PushPermissionDescriptor(const PushPermissionDescriptor* impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (user_visible_only_has_value_or_default &&
      !create_property(0, user_visible_only_value)) {
    return false;
  }
...
PushPermissionDescriptor* NativeValueTraits<PushPermissionDescriptor>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  PushPermissionDescriptor* impl = PushPermissionDescriptor::Create();
  V8PushPermissionDescriptor::ToImpl(isolate, value, impl, exception_state);
  return impl;
}
