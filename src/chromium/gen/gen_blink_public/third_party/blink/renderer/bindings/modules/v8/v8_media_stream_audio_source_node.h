...
MODULES_EXPORT extern const WrapperTypeInfo v8_media_stream_audio_source_node_wrapper_type_info;
...
class V8MediaStreamAudioSourceNode {
 ...
 public:
  ...
  MODULES_EXPORT static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
    return &v8_media_stream_audio_source_node_wrapper_type_info;
  }
