...
static void LockedAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kGetterContext, "WritableStream", "locked");
...
static void GetWriterMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ScriptValue result = impl->getWriter(script_state, exception_state);
  if (exception_state.HadException()) {
    return;
  }
  V8SetReturnValue(info, result.V8Value());
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8WritableStream::ConstructorCustom(info);
}
...
static void InstallV8WritableStreamTemplate(
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8WritableStreamAccessors, base::size(kV8WritableStreamAccessors));
...
WritableStream* NativeValueTraits<WritableStream>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  WritableStream* native_value = V8WritableStream::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
