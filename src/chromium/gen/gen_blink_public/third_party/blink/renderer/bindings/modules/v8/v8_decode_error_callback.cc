...
v8::Maybe<void> V8DecodeErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
void V8DecodeErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8DecodeErrorCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

void V8PersistentCallbackFunction<V8DecodeErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, DOMException* error) {
