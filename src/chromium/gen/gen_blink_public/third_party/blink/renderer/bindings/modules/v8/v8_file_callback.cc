...
v8::Maybe<void> V8FileCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, File* file) {
  ...
  v8::Local<v8::Value> v8_file = ToV8(file, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_file };
...
void V8FileCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, File* file) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8FileCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, File* file) {
  return Proxy()->handleEvent(
      callback_this_value, file);
}

void V8PersistentCallbackInterface<V8FileCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, File* file) {
