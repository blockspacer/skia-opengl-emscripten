...
v8::Maybe<void> V8MutationCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
...
void V8MutationCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8MutationCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, mutations, observer);
}

void V8PersistentCallbackFunction<V8MutationCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
