...
v8::Maybe<void> V8FileWriterCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter) {
  ...
  v8::Local<v8::Value> v8_fileWriter = ToV8(fileWriter, argument_creation_context, GetIsolate());
  constexpr int argc = 1;
  v8::Local<v8::Value> argv[] = { v8_fileWriter };
...
void V8FileWriterCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8FileWriterCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter) {
  return Proxy()->handleEvent(
      callback_this_value, fileWriter);
}

void V8PersistentCallbackInterface<V8FileWriterCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, FileWriter* fileWriter) {
