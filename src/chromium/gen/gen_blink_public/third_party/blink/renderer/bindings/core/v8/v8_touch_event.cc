...
#endif
const WrapperTypeInfo v8_touch_event_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& TouchEvent::wrapper_type_info_ = v8_touch_event_wrapper_type_info;
...
namespace touch_event_v8_internal {
...
static void TouchesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TouchList* cpp_value(WTF::GetPtr(impl->touches()));
...
static void TargetTouchesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TouchList* cpp_value(WTF::GetPtr(impl->targetTouches()));
...
static void ChangedTouchesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TouchList* cpp_value(WTF::GetPtr(impl->changedTouches()));
...
static void Constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exception_state(info.GetIsolate(), ExceptionState::kConstructionContext, "TouchEvent");
  ...
  TouchEventInit* event_init_dict;
  type = info[0];
  if (!type.Prepare())
    return;
  ...
  event_init_dict = NativeValueTraits<TouchEventInit>::NativeValue(info.GetIsolate(), info[1], exception_state);
  if (exception_state.HadException())
    return;

  TouchEvent* impl = TouchEvent::Create(type, event_init_dict);
  v8::Local<v8::Object> wrapper = info.Holder();
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), V8TouchEvent::GetWrapperTypeInfo(), wrapper);
...
CORE_EXPORT void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(
        info.GetIsolate(),
        ExceptionMessages::ConstructorNotCallableAsFunction("TouchEvent"));
    return;
  }
  ...
  touch_event_v8_internal::Constructor(info);
}
...
void V8TouchEvent::TouchesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::TouchesAttributeGetter(info);
}
...
void V8TouchEvent::TargetTouchesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::TargetTouchesAttributeGetter(info);
}
...
void V8TouchEvent::ChangedTouchesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::ChangedTouchesAttributeGetter(info);
}
...
void V8TouchEvent::AltKeyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::AltKeyAttributeGetter(info);
}
...
void V8TouchEvent::MetaKeyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::MetaKeyAttributeGetter(info);
}
...
void V8TouchEvent::CtrlKeyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::CtrlKeyAttributeGetter(info);
}
...
void V8TouchEvent::ShiftKeyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::ShiftKeyAttributeGetter(info);
}
...
void V8TouchEvent::IsTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  touch_event_v8_internal::IsTrustedAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8TouchEventAccessors[] = {
    { "touches", V8TouchEvent::TouchesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "targetTouches", V8TouchEvent::TargetTouchesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "changedTouches", V8TouchEvent::ChangedTouchesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "altKey", V8TouchEvent::AltKeyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "metaKey", V8TouchEvent::MetaKeyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "ctrlKey", V8TouchEvent::CtrlKeyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "shiftKey", V8TouchEvent::ShiftKeyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "isTrusted", V8TouchEvent::IsTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8TouchEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8TouchEvent::GetWrapperTypeInfo()->interface_name, V8UIEvent::DomTemplate(isolate, world), V8TouchEvent::kInternalFieldCount);
  interface_template->SetCallHandler(touch_event_v8_internal::ConstructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8TouchEventAccessors, base::size(kV8TouchEventAccessors));
...
v8::Local<v8::FunctionTemplate> V8TouchEvent::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8TouchEvent::GetWrapperTypeInfo()),
      InstallV8TouchEventTemplate);
}

bool V8TouchEvent::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8TouchEvent::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8TouchEvent::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8TouchEvent::GetWrapperTypeInfo(), v8_value);
}

TouchEvent* V8TouchEvent::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

TouchEvent* NativeValueTraits<TouchEvent>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  TouchEvent* native_value = V8TouchEvent::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
