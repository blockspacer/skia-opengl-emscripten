...
v8::Maybe<ScriptValue> V8AnimatorConstructor::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue options, ScriptValue state) {
  ...
  v8::Local<v8::Value> v8_options = options.V8Value();
  v8::Local<v8::Value> v8_state = state.V8Value();
  constexpr int argc = 2;
  v8::Local<v8::Value> argv[] = { v8_options, v8_state };
...
v8::Maybe<ScriptValue> V8AnimatorConstructor::Construct(ScriptValue options, ScriptValue state) {
  ScriptState* callback_relevant_script_state =
      CallbackRelevantScriptStateOrThrowException(
          "AnimatorConstructor",
          "construct");
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8AnimatorConstructor>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue options, ScriptValue state) {
  return Proxy()->Invoke(
      callback_this_value, options, state);
}
