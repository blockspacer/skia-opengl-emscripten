...
#endif
const WrapperTypeInfo v8_radio_node_list_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& RadioNodeList::wrapper_type_info_ = v8_radio_node_list_wrapper_type_info;
...
namespace radio_node_list_v8_internal {
...
void V8RadioNodeList::ValueAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  radio_node_list_v8_internal::ValueAttributeGetter(info);
}

void V8RadioNodeList::ValueAttributeSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RadioNodeList_value_Setter");

  v8::Local<v8::Value> v8_value = info[0];

  radio_node_list_v8_internal::ValueAttributeSetter(v8_value, info);
}

void V8RadioNodeList::IndexedPropertyGetterCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RadioNodeList_IndexedPropertyGetter");

  radio_node_list_v8_internal::IndexedPropertyGetter(index, info);
}

void V8RadioNodeList::IndexedPropertyDescriptorCallback(
    uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  radio_node_list_v8_internal::IndexedPropertyDescriptor(index, info);
}

void V8RadioNodeList::IndexedPropertySetterCallback(
    uint32_t index,
...
static constexpr V8DOMConfiguration::AccessorConfiguration kV8RadioNodeListAccessors[] = {
    { "value", V8RadioNodeList::ValueAttributeGetterCallback, V8RadioNodeList::ValueAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8RadioNodeListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8RadioNodeList::GetWrapperTypeInfo()->interface_name, V8NodeList::DomTemplate(isolate, world), V8RadioNodeList::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8RadioNodeListAccessors, base::size(kV8RadioNodeListAccessors));
...
v8::Local<v8::FunctionTemplate> V8RadioNodeList::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8RadioNodeList::GetWrapperTypeInfo()),
      InstallV8RadioNodeListTemplate);
}

bool V8RadioNodeList::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8RadioNodeList::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8RadioNodeList::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8RadioNodeList::GetWrapperTypeInfo(), v8_value);
}

RadioNodeList* V8RadioNodeList::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

RadioNodeList* NativeValueTraits<RadioNodeList>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  RadioNodeList* native_value = V8RadioNodeList::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
