...
v8::Maybe<void> V8NotificationPermissionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& permission) {
...
#if DCHECK_IS_ON()
  {
    const char* kValidPermissionValues[] = {
        "default",
        "denied",
        "granted",
    };
    ExceptionState exception_state(GetIsolate(),
                                   ...
                                   "NotificationPermissionCallback",
                                   "invoke");
    if (!IsValidEnum(permission, kValidPermissionValues, base::size(kValidPermissionValues), "NotificationPermission", exception_state)) { //
      NOTREACHED();
      return v8::Nothing<void>();
    }
  }
...
void V8NotificationPermissionCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& permission) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8NotificationPermissionCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& permission) {
  return Proxy()->Invoke(
      callback_this_value, permission);
}

void V8PersistentCallbackFunction<V8NotificationPermissionCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, const String& permission) {
