...
#endif
const WrapperTypeInfo v8_vr_pose_wrapper_type_info = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& VRPose::wrapper_type_info_ = v8_vr_pose_wrapper_type_info;
...
void V8VRPose::PositionAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  vr_pose_v8_internal::PositionAttributeGetter(info);
}
...
void V8VRPose::LinearVelocityAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(execution_context_for_measurement, WebFeature::kVRPoseLinearVelocity);

  vr_pose_v8_internal::LinearVelocityAttributeGetter(info);
}
...
void V8VRPose::LinearAccelerationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kVRPoseLinearAcceleration);

  vr_pose_v8_internal::LinearAccelerationAttributeGetter(info);
}
...
void V8VRPose::OrientationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  vr_pose_v8_internal::OrientationAttributeGetter(info);
}
...
void V8VRPose::AngularVelocityAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kVRPoseAngularVelocity);

  vr_pose_v8_internal::AngularVelocityAttributeGetter(info);
}
...
void V8VRPose::AngularAccelerationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExecutionContext* execution_context_for_measurement = CurrentExecutionContext(info.GetIsolate());
  UseCounter::Count(execution_context_for_measurement, WebFeature::kVRPoseAngularAcceleration);

  vr_pose_v8_internal::AngularAccelerationAttributeGetter(info);
}

static constexpr V8DOMConfiguration::AccessorConfiguration kV8VRPoseAccessors[] = {
    { "position", V8VRPose::PositionAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "linearVelocity", V8VRPose::LinearVelocityAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "linearAcceleration", V8VRPose::LinearAccelerationAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "orientation", V8VRPose::OrientationAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "angularVelocity", V8VRPose::AngularVelocityAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
    { "angularAcceleration", V8VRPose::AngularAccelerationAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAlwaysCallGetter, V8DOMConfiguration::kAllWorlds },
};
...
static void InstallV8VRPoseTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interface_template, V8VRPose::GetWrapperTypeInfo()->interface_name, v8::Local<v8::FunctionTemplate>(), V8VRPose::kInternalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, kV8VRPoseAccessors, base::size(kV8VRPoseAccessors));
...
v8::Local<v8::FunctionTemplate> V8VRPose::DomTemplate(
    v8::Isolate* isolate, const DOMWrapperWorld& world) {
  return V8DOMConfiguration::DomClassTemplate(
      isolate, world, const_cast<WrapperTypeInfo*>(V8VRPose::GetWrapperTypeInfo()),
      InstallV8VRPoseTemplate);
}

bool V8VRPose::HasInstance(v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->HasInstance(V8VRPose::GetWrapperTypeInfo(), v8_value);
}

v8::Local<v8::Object> V8VRPose::FindInstanceInPrototypeChain(
    v8::Local<v8::Value> v8_value, v8::Isolate* isolate) {
  return V8PerIsolateData::From(isolate)->FindInstanceInPrototypeChain(
      V8VRPose::GetWrapperTypeInfo(), v8_value);
}

VRPose* V8VRPose::ToImplWithTypeCheck(
    v8::Isolate* isolate, v8::Local<v8::Value> value) {
  return HasInstance(value, isolate) ? ToImpl(v8::Local<v8::Object>::Cast(value)) : nullptr;
}

VRPose* NativeValueTraits<VRPose>::NativeValue(
    v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state) {
  VRPose* native_value = V8VRPose::ToImplWithTypeCheck(isolate, value);
  if (!native_value) {
