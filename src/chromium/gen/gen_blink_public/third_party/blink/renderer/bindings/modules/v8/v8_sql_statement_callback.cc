...
v8::Maybe<void> V8SQLStatementCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
  ...
  v8::Local<v8::Value> v8_resultSet = ToV8(resultSet, argument_creation_context, GetIsolate());
  constexpr int argc = 2;
  v8::Local<v8::Value> argv[] = { v8_transaction, v8_resultSet };
...
void V8SQLStatementCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8SQLStatementCallback>::handleEvent(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
  return Proxy()->handleEvent(
      callback_this_value, transaction, resultSet);
}

void V8PersistentCallbackInterface<V8SQLStatementCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
