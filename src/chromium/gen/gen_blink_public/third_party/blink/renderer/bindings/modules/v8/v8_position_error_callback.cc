...
v8::Maybe<void> V8PositionErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PositionError* positionError) {
...
void V8PositionErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PositionError* positionError) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8PositionErrorCallback>::Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PositionError* positionError) {
  return Proxy()->Invoke(
      callback_this_value, positionError);
}

void V8PersistentCallbackFunction<V8PositionErrorCallback>::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, PositionError* positionError) {
