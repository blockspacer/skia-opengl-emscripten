...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_BLOCK_END_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_BLOCK_END_H_
...
// Implements the 'margin-block-end' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class MarginBlockEnd final : public Longhand {
 public:
  constexpr MarginBlockEnd() : Longhand(CSSPropertyID::kMarginBlockEnd,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "margin-block-end"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_BLOCK_END_H_
