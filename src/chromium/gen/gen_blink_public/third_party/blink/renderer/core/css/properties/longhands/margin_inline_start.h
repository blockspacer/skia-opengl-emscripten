...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_INLINE_START_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_INLINE_START_H_
...
// Implements the 'margin-inline-start' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class MarginInlineStart final : public Longhand {
 public:
  constexpr MarginInlineStart() : Longhand(CSSPropertyID::kMarginInlineStart,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "margin-inline-start"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_MARGIN_INLINE_START_H_
