...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_START_COLOR_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_START_COLOR_H_
...
// Implements the 'border-inline-start-color' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderInlineStartColor final : public Longhand {
 public:
  constexpr BorderInlineStartColor() : Longhand(CSSPropertyID::kBorderInlineStartColor,
    0
    | kProperty
  ...
  const char* GetPropertyName() const override { return "border-inline-start-color"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_START_COLOR_H_
