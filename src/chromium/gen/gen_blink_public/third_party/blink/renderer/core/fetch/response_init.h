...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_FETCH_RESPONSE_INIT_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_FETCH_RESPONSE_INIT_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_FETCH_RESPONSE_INIT_H_
