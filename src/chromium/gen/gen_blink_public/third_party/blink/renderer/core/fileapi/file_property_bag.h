...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_FILEAPI_FILE_PROPERTY_BAG_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_FILEAPI_FILE_PROPERTY_BAG_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_FILEAPI_FILE_PROPERTY_BAG_H_
