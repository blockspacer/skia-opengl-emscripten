...
// clang-format off
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_ANIMATION_EFFECT_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_ANIMATION_EFFECT_TIMING_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_ANIMATION_EFFECT_TIMING_H_
