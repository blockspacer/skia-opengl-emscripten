...
class WebkitHyphenateCharacter final : public Longhand {
 public:
  constexpr WebkitHyphenateCharacter() : Longhand(CSSPropertyID::kWebkitHyphenateCharacter,
    0
    | kProperty
    | kInherited
    ,
  ...
  const char* GetPropertyName() const override { return "-webkit-hyphenate-character"; }
