...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_INSET_INLINE_END_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_INSET_INLINE_END_H_
...
// Implements the 'inset-inline-end' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class InsetInlineEnd final : public Longhand {
 public:
  constexpr InsetInlineEnd() : Longhand(CSSPropertyID::kInsetInlineEnd,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "inset-inline-end"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_INSET_INLINE_END_H_
