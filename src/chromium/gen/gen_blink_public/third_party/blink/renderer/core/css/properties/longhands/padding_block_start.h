...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_PADDING_BLOCK_START_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_PADDING_BLOCK_START_H_
...
// Implements the 'padding-block-start' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class PaddingBlockStart final : public Longhand {
 public:
  constexpr PaddingBlockStart() : Longhand(CSSPropertyID::kPaddingBlockStart,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "padding-block-start"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_PADDING_BLOCK_START_H_
