...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_INSET_BLOCK_START_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_INSET_BLOCK_START_H_
...
// Implements the 'inset-block-start' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class InsetBlockStart final : public Longhand {
 public:
  constexpr InsetBlockStart() : Longhand(CSSPropertyID::kInsetBlockStart,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "inset-block-start"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_INSET_BLOCK_START_H_
