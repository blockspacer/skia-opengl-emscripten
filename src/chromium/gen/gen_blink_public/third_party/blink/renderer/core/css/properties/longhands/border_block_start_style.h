...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_STYLE_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_STYLE_H_
...
// Implements the 'border-block-start-style' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderBlockStartStyle final : public Longhand {
 public:
  constexpr BorderBlockStartStyle() : Longhand(CSSPropertyID::kBorderBlockStartStyle,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "border-block-start-style"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_STYLE_H_
