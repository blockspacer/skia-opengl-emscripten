...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_WIDTH_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_WIDTH_H_
...
// Implements the 'border-block-start-width' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderBlockStartWidth final : public Longhand {
 public:
  constexpr BorderBlockStartWidth() : Longhand(CSSPropertyID::kBorderBlockStartWidth,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "border-block-start-width"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_START_WIDTH_H_
