...
class WebkitPerspectiveOriginY final : public Longhand {
 public:
  constexpr WebkitPerspectiveOriginY() : Longhand(CSSPropertyID::kWebkitPerspectiveOriginY,
    0
    | kInterpolable
    | kProperty
    ,
  ...
  const char* GetPropertyName() const override { return "-webkit-perspective-origin-y"; }
