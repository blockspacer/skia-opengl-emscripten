...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_END_COLOR_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_END_COLOR_H_
...
// Implements the 'border-block-end-color' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderBlockEndColor final : public Longhand {
 public:
  constexpr BorderBlockEndColor() : Longhand(CSSPropertyID::kBorderBlockEndColor,
    0
    | kProperty
  ...
  const char* GetPropertyName() const override { return "border-block-end-color"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_BLOCK_END_COLOR_H_
