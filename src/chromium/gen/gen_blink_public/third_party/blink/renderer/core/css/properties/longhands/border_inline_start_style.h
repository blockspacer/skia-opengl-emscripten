...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_START_STYLE_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_START_STYLE_H_
...
// Implements the 'border-inline-start-style' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderInlineStartStyle final : public Longhand {
 public:
  constexpr BorderInlineStartStyle() : Longhand(CSSPropertyID::kBorderInlineStartStyle,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "border-inline-start-style"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_START_STYLE_H_
