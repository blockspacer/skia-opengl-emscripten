...
class WebkitMaskBoxImageSlice final : public Longhand {
 public:
  constexpr WebkitMaskBoxImageSlice() : Longhand(CSSPropertyID::kWebkitMaskBoxImageSlice,
    0
    | kInterpolable
    | kProperty
    ,
  ...
  const char* GetPropertyName() const override { return "-webkit-mask-box-image-slice"; }
