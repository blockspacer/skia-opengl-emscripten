...
class ScrollMarginInlineStart final : public Longhand {
 public:
  constexpr ScrollMarginInlineStart() : Longhand(CSSPropertyID::kScrollMarginInlineStart,
    0
    | kProperty
    ,
    '\0'
  ...
  const char* GetPropertyName() const override { return "scroll-margin-inline-start"; }
