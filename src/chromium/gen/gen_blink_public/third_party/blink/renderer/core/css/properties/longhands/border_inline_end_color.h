...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_END_COLOR_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_END_COLOR_H_
...
// Implements the 'border-inline-end-color' CSS property
// See src/third_party/blink/renderer/core/css/properties/README.md
class BorderInlineEndColor final : public Longhand {
 public:
  constexpr BorderInlineEndColor() : Longhand(CSSPropertyID::kBorderInlineEndColor,
    0
    | kProperty
  ...
  const char* GetPropertyName() const override { return "border-inline-end-color"; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_INLINE_END_COLOR_H_
