...
GPURenderPassDepthStencilAttachmentDescriptor::~GPURenderPassDepthStencilAttachmentDescriptor() = default;

void GPURenderPassDepthStencilAttachmentDescriptor::Trace(blink::Visitor* visitor) {
