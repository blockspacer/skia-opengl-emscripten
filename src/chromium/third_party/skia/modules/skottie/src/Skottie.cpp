...
//printf("Animation::Builder::make 1\n");
    TRACE_EVENT0("skottie", TRACE_FUNC);
//printf("Animation::Builder::make 2\n");
...
//printf("Animation::Builder::make 6\n");
...
//printf("Animation::Builder::make 7\n");
...
//printf("Animation::Builder::make 8\n");
...
//printf("Animation::Builder::make 9\n");
    SkASSERT(resolvedProvider);
//printf("Animation::Builder::make 10\n");
...
//printf("Animation::Builder::make 11\n");
    auto scene = builder.parse(json);

//printf("Animation::Builder::make 12\n");
...
void Animation::render(SkCanvas* canvas, const SkRect* dstR, RenderFlags renderFlags) const {
    //printf("Animation::render1...\n");
    TRACE_EVENT0("skottie", TRACE_FUNC);
    //printf("Animation::render2...\n");

    if (!fScene)
        return;

    //printf("Animation::render3...\n");
    SkAutoCanvasRestore restore(canvas, true);

    //printf("Animation::render4...\n");
    ...
    //printf("Animation::render5...\n");
    canvas->clipRect(srcR);

    //printf("Animation::render6...\n");
    fScene->render(canvas);
    //printf("Animation::render7...\n");
}
