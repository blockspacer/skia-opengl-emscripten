...
//printf("SkPathRef::CreateEmpty 0\n");
    static SkOnce once;
//printf("SkPathRef::CreateEmpty 1\n");
    // TODO: hang in threaded wasm
    once([]{
        //printf("SkPathRef::once 0\n");
        gEmpty = new SkPathRef;
        //printf("SkPathRef::once 1\n");
        gEmpty->computeBounds();   // Avoids races later to be the first to do this.
        //printf("SkPathRef::once 3\n");
    });
//printf("SkPathRef::CreateEmpty 2\n");
    return SkRef(gEmpty);
}
