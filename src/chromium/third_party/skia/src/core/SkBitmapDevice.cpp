...
void SkBitmapDevice::drawOval(const SkRect& oval, const SkPaint& paint) {
  //printf("SkBitmapDevice::drawOval 0\n");
    SkPath path;
  //printf("SkBitmapDevice::drawOval 1\n");
    path.addOval(oval);
  //printf("SkBitmapDevice::drawOval 2\n");
    // call the VIRTUAL version, so any subclasses who do handle drawPath aren't
    // required to override drawOval.
    this->drawPath(path, paint, true);
  //printf("SkBitmapDevice::drawOval 3\n");
}
...
void SkBitmapDevice::drawBitmap(const SkBitmap& bitmap, const SkMatrix& matrix,
    ...
    //printf("SkBitmapDevice::drawBitmap 2 \n");
}
...
void SkBitmapDevice::drawBitmapRect(const SkBitmap& bitmap,
    ...
    //printf("SkBitmapDevice goto USE_SHADER \n");
