...
void SkGpuDevice::drawOval(const SkRect& oval, const SkPaint& paint) {
  //printf("SkGpuDevice::drawOval 1\n");
    ASSERT_SINGLE_OWNER
  //printf("SkGpuDevice::drawOval 2\n");
    GR_CREATE_TRACE_MARKER_CONTEXT("SkGpuDevice", "drawOval", fContext.get());
  //printf("SkGpuDevice::drawOval 3\n");
...
void SkGpuDevice::drawGlyphRunList(const SkGlyphRunList& glyphRunList) {
    //printf("SkGpuDevice::drawGlyphRunList 0.1\n");
    ASSERT_SINGLE_OWNER
    ...
    //printf("SkGpuDevice::drawGlyphRunList 0.2\n");
}
