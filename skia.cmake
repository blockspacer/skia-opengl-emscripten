...
message(FATAL_ERROR "NOT DEFINED: ENABLE_ZLIB")
endif(NOT DEFINED ENABLE_ZLIB)
if(NOT DEFINED SK_USE_SYSTEM_ZLIB)
message(FATAL_ERROR "NOT DEFINED: SK_USE_SYSTEM_ZLIB")
endif(NOT DEFINED SK_USE_SYSTEM_ZLIB)
if(ENABLE_ZLIB)
  set(SK_IS_zlib "true")
...
configure_file("${CMAKE_CURRENT_SOURCE_DIR}/codegen/skia/args.gn.in" "${SKIA_BUILD_DIR}/args.gn" @ONLY)

# NOTE: will use args.gn generated by configure_file
set(CONFIGURE_COMMAND "${SKIA_SRC_DIR}/bin/gn;gen;--root=${SKIA_SRC_DIR};${SKIA_BUILD_DIR}")
